...
| | |
|---|---:|
| المهارات في الأرشيف | **964** |
| نطاق المتابعة اليومية | **أعلى 1,000** |
| مهارات محفوظة خارج النطاق 📌 | **12** |
| مهارات رسمية ⭐ | **316** |
| مكرّرات محذوفة 🧹 | **48** |
| إجمالي المهارات على skills.sh | **9,708** |
| آخر تحديث | **2026-09-04** |

## 🆕 أحدث الإضافات

- **remotion-render** — `skills-101/superpowers` (70,326 تثبيت)
- **expo-ui** — `expo/skills` (18,174 تثبيت)
