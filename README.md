...
| | |
|---|---:|
| المهارات في الأرشيف | **1,027** |
| نطاق المتابعة اليومية | **أعلى 1,000** |
| مهارات محفوظة خارج النطاق 📌 | **113** |
| مهارات رسمية ⭐ | **318** |
| مكرّرات محذوفة 🧹 | **86** |
| إجمالي المهارات على skills.sh | **9,831** |
| آخر تحديث | **2026-09-26** |

## 🆕 أحدث الإضافات

- **ios-design** — `uizze.sh` (54,672 تثبيت)
- **anti-prose-slop** — `proseify.xyz` (25,040 تثبيت)
