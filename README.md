...
| | |
|---|---:|
| المهارات في الأرشيف | **960** |
| نطاق المتابعة اليومية | **أعلى 1,000** |
| مهارات محفوظة خارج النطاق 📌 | **8** |
| مهارات رسمية ⭐ | **316** |
| مكرّرات محذوفة 🧹 | **48** |
| إجمالي المهارات على skills.sh | **9,698** |
| آخر تحديث | **2026-09-01** |

## 🆕 أحدث الإضافات

- **modern-web-guidance** — `googlechrome/modern-web-guidance` (17,799 تثبيت)
