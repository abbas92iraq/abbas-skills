...
| | |
|---|---:|
| المهارات في الأرشيف | **959** |
| نطاق المتابعة اليومية | **أعلى 1,000** |
| مهارات محفوظة خارج النطاق 📌 | **7** |
| مهارات رسمية ⭐ | **316** |
| مكرّرات محذوفة 🧹 | **48** |
| إجمالي المهارات على skills.sh | **9,691** |
| آخر تحديث | **2026-08-28** |

## 🆕 أحدث الإضافات

- **retro** — `mattpocock/skills` (20,916 تثبيت)
- **animate-expo** — `emilkowalski/skills` (18,529 تثبيت)
- **sandbox-stable** — `cloudflare/skills` (17,836 تثبيت)
- **sandbox-next** — `cloudflare/skills` (17,693 تثبيت)
- **sandbox-migrate-to-next** — `cloudflare/skills` (17,663 تثبيت)
