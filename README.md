...
| | |
|---|---:|
| المهارات في الأرشيف | **1,023** |
| نطاق المتابعة اليومية | **أعلى 1,000** |
| مهارات محفوظة خارج النطاق 📌 | **95** |
| مهارات رسمية ⭐ | **318** |
| مكرّرات محذوفة 🧹 | **74** |
| إجمالي المهارات على skills.sh | **9,828** |
| آخر تحديث | **2026-09-22** |

## 🆕 أحدث الإضافات

- **ai-video-generation** — `genmedia-labs/skills` (603,635 تثبيت)
- **ai-image-generation** — `genmedia-labs/skills` (602,818 تثبيت)
- **hyperframes-studio** — `heygen-com/hyperframes` (29,430 تثبيت)
