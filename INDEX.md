...
**آخر تحديث:** 2026-08-27 · **العدد:** 954 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,134,109 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 983,752 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 838,273 تثبيت
...
4. **frontend-design** — `anthropics/skills/frontend-design` · 825,124 تثبيت ⭐
...
5. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 807,121 تثبيت
...
9. **handoff** — `mattpocock/skills/handoff` · 682,890 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 676,949 تثبيت
...
11. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 668,523 تثبيت ⭐
   React and Next.js performance optimization across 70 rules prioritized by impact.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-react-best-practices`

12. **prototype** — `mattpocock/skills/prototype` · 666,776 تثبيت
...
13. **lark-doc** — `open.feishu.cn/lark-doc` · 625,059 تثبيت
...
14. **lark-base** — `open.feishu.cn/lark-base` · 624,917 تثبيت
...
15. **lark-drive** — `open.feishu.cn/lark-drive` · 624,744 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

16. **lark-approval** — `open.feishu.cn/lark-approval` · 624,660 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

17. **lark-shared** — `open.feishu.cn/lark-shared` · 624,516 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/`

18. **lark-im** — `open.feishu.cn/lark-im` · 624,357 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

19. **lark-calendar** — `open.feishu.cn/lark-calendar` · 624,329 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/`

20. **lark-contact** — `open.feishu.cn/lark-contact` · 624,048 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/`

21. **lark-sheets** — `open.feishu.cn/lark-sheets` · 623,992 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/`

22. **lark-wiki** — `open.feishu.cn/lark-wiki` · 623,926 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

23. **lark-event** — `open.feishu.cn/lark-event` · 623,752 تثبيت
...
24. **lark-attendance** — `open.feishu.cn/lark-attendance` · 623,689 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

25. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 623,650 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/`

26. **lark-task** — `open.feishu.cn/lark-task` · 623,632 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

27. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 623,596 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/`

28. **lark-mail** — `open.feishu.cn/lark-mail` · 623,567 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/`

29. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 623,332 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/`

30. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 623,154 تثبيت
...
31. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 623,091 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

32. **lark-okr** — `open.feishu.cn/lark-okr` · 604,214 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

33. **lark-markdown** — `open.feishu.cn/lark-markdown` · 589,486 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

34. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 582,578 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

35. **grilling** — `mattpocock/skills/grilling` · 556,007 تثبيت
...
36. **microsoft-foundry** — `microsoft/azure-skills/microsoft-foundry` · 555,965 تثبيت ⭐
   End-to-end deployment, evaluation, and management of AI agents on Microsoft Foundry.
   `npx skills add https://github.com/microsoft/azure-skills --skill microsoft-foundry`

37. **azure-diagnostics** — `microsoft/azure-skills/azure-diagnostics` · 549,497 تثبيت ⭐
...
38. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 548,919 تثبيت ⭐
...
39. **azure-ai** — `microsoft/azure-skills/azure-ai` · 548,846 تثبيت ⭐
...
40. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 548,815 تثبيت ⭐
...
41. **azure-validate** — `microsoft/azure-skills/azure-validate` · 548,314 تثبيت ⭐
...
42. **azure-storage** — `microsoft/azure-skills/azure-storage` · 547,763 تثبيت ⭐
...
43. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 547,501 تثبيت ⭐
...
44. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 547,250 تثبيت ⭐
...
45. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 547,170 تثبيت ⭐
...
46. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 547,152 تثبيت ⭐
...
47. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 547,126 تثبيت ⭐
...
48. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 546,957 تثبيت ⭐
...
49. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 546,885 تثبيت ⭐
...
50. **teach** — `mattpocock/skills/teach` · 541,318 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

51. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 536,617 تثبيت ⭐
...
52. **lark-apps** — `open.feishu.cn/lark-apps` · 533,628 تثبيت
...
53. **anti-ui-slop** — `uizze.com/anti-ui-slop` · 515,009 تثبيت
   Stop AI coding agents from shipping generic UI.
   `npx skills add https://uizze.com/`

54. **domain-modeling** — `mattpocock/skills/domain-modeling` · 508,095 تثبيت
...
55. **remotion-best-practices** — `remotion-dev/skills/remotion-best-practices` · 497,443 تثبيت ⭐
   Domain-specific knowledge base for building videos with Remotion and React.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices`

56. **codebase-design** — `mattpocock/skills/codebase-design` · 493,220 تثبيت
...
57. **azure-compute** — `microsoft/azure-skills/azure-compute` · 490,654 تثبيت ⭐
...
58. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 485,910 تثبيت ⭐
...
59. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 485,812 تثبيت
   A discipline for hard bugs. Skip phases only when explicitly justified.
   `npx skills add https://github.com/mattpocock/skills --skill diagnosing-bugs`

60. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 480,634 تثبيت ⭐
...
61. **caveman** — `juliusbrussee/caveman/caveman` · 461,812 تثبيت
   Ultra-compressed communication mode cutting token usage ~75% while preserving technical accuracy.
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman`

62. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,760 تثبيت
...
63. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,009 تثبيت
...
64. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 449,928 تثبيت
...
65. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 449,913 تثبيت
...
66. **ask-matt** — `mattpocock/skills/ask-matt` · 448,704 تثبيت
   You don't remember every skill, so ask.
   `npx skills add https://github.com/mattpocock/skills --skill ask-matt`

67. **hyperframes-cli** — `heygen-com/hyperframes/hyperframes-cli` · 445,910 تثبيت
...
68. **implement** — `mattpocock/skills/implement` · 440,322 تثبيت
   Implement the work described by the user in the spec or tickets.
   `npx skills add https://github.com/mattpocock/skills --skill implement`

69. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 437,906 تثبيت ⭐
...
70. **hyperframes** — `heygen-com/hyperframes/hyperframes` · 431,111 تثبيت
...
71. **code-review** — `mattpocock/skills/code-review` · 426,279 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill code-review`

72. **lark-minutes** — `larksuite/cli/lark-minutes` · 419,640 تثبيت
   Search, download, and manage Lark Minutes recordings with transcript and metadata extraction.
   `npx skills add https://github.com/larksuite/cli --skill lark-minutes`

73. **lark-vc** — `larksuite/cli/lark-vc` · 419,533 تثبيت
...
74. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 416,895 تثبيت ⭐
...
75. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 409,966 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

76. **video-edit** — `prime-skills/runcomfy-agent-skills/video-edit` · 409,863 تثبيت
   Video Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill video-edit`

77. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 409,037 تثبيت ⭐
...
78. **image-to-video** — `prime-skills/runcomfy-agent-skills/image-to-video` · 408,336 تثبيت
...
79. **nano-banana-2** — `prime-skills/runcomfy-agent-skills/nano-banana-2` · 408,029 تثبيت
   Nano Banana 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill nano-banana-2`

80. **lark-note** — `open.feishu.cn/lark-note` · 407,843 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

81. **nano-banana-edit** — `prime-skills/runcomfy-agent-skills/nano-banana-edit` · 407,681 تثبيت
...
82. **image-edit** — `prime-skills/runcomfy-agent-skills/image-edit` · 407,622 تثبيت
   Image Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill image-edit`

83. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 407,465 تثبيت
...
84. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 406,929 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

85. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 406,760 تثبيت
...
86. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 406,747 تثبيت
...
87. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 406,714 تثبيت
...
88. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 406,543 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

89. **wayfinder** — `mattpocock/skills/wayfinder` · 397,087 تثبيت
...
90. **twitter-automation** — `skills-101/superpowers/twitter-automation` · 394,379 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill twitter-automation`

91. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 390,631 تثبيت
...
92. **research** — `mattpocock/skills/research` · 389,146 تثبيت
   Spin up a background agent to do the research, so you keep working while it reads.
   `npx skills add https://github.com/mattpocock/skills --skill research`

93. **to-spec** — `mattpocock/skills/to-spec` · 384,755 تثبيت
...
94. **kling-3-0** — `prime-skills/runcomfy-agent-skills/kling-3-0` · 383,664 تثبيت
   Kling 3.0 - Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill kling-3-0`

95. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 383,420 تثبيت ⭐
...
96. **to-tickets** — `mattpocock/skills/to-tickets` · 378,113 تثبيت
   Break a plan, spec, or conversation into a set of tickets: tracer-bullet vertical slices, each declaring the tickets that block it.
   `npx skills add https://github.com/mattpocock/skills --skill to-tickets`

97. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 376,379 تثبيت ⭐
...
98. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 375,045 تثبيت
...
99. **lark-slides** — `larksuite/cli/lark-slides` · 373,021 تثبيت
...
100. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 372,460 تثبيت ⭐
...
101. **codex-pet** — `prime-skills/runcomfy-agent-skills/codex-pet` · 372,059 تثبيت
   Codex Pet — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill codex-pet`

102. **to-prd** — `mattpocock/skills/to-prd` · 365,893 تثبيت
...
103. **skill-creator** — `anthropics/skills/skill-creator` · 364,186 تثبيت ⭐
   Create, test, and iteratively improve AI agent skills with structured evaluation and benchmarking.
   `npx skills add https://github.com/anthropics/skills --skill skill-creator`

104. **ai-video-generation** — `prime-skills/runcomfy-agent-skills/ai-video-generation` · 353,257 تثبيت
   ...
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ai-video-generation`

105. **to-issues** — `mattpocock/skills/to-issues` · 352,918 تثبيت
...
106. **ai-image-generation** — `prime-skills/runcomfy-agent-skills/ai-image-generation` · 352,903 تثبيت
   ...
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ai-image-generation`

107. **azure-cost** — `microsoft/azure-skills/azure-cost` · 351,627 تثبيت ⭐
...
108. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 350,620 تثبيت
...
109. **ai-avatar-video** — `prime-skills/runcomfy-agent-skills/ai-avatar-video` · 350,375 تثبيت
   AI Avatar & Talking Head Video
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ai-avatar-video`

110. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 350,312 تثبيت
...
111. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 348,655 تثبيت
...
112. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 348,176 تثبيت
...
113. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 347,977 تثبيت
...
114. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 347,937 تثبيت
...
115. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 347,529 تثبيت
...
116. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 347,386 تثبيت
...
117. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 347,252 تثبيت
...
118. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 347,180 تثبيت
...
119. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 347,072 تثبيت
...
120. **brainstorming** — `obra/superpowers/brainstorming` · 341,366 تثبيت
   Structured design dialogue that validates ideas before implementation begins.
   `npx skills add https://github.com/obra/superpowers --skill brainstorming`

121. **ai-music** — `prime-skills/runcomfy-agent-skills/ai-music` · 339,422 تثبيت
...
122. **ace-step** — `prime-skills/runcomfy-agent-skills/ace-step` · 338,967 تثبيت
   ACE Step — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ace-step`

123. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 332,769 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

124. **hyperframes-core** — `heygen-com/hyperframes/hyperframes-core` · 332,386 تثبيت
...
125. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 328,564 تثبيت
...
126. **caveman-commit** — `juliusbrussee/caveman/caveman-commit` · 323,476 تثبيت
...
127. **media-use** — `heygen-com/hyperframes/media-use` · 322,160 تثبيت
   The media OS for HyperFrames: resolve · generate · operate · remember — every media type, one skill, zero context noise.
   `npx skills add https://github.com/heygen-com/hyperframes --skill media-use`

128. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 320,650 تثبيت
...
129. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 320,528 تثبيت
...
130. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 318,972 تثبيت
...
131. **caveman-help** — `juliusbrussee/caveman/caveman-help` · 312,382 تثبيت
...
132. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,059 تثبيت
...
133. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 310,918 تثبيت
...
134. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,823 تثبيت
...
135. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,556 تثبيت
...
136. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,500 تثبيت
...
137. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,410 تثبيت
...
138. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,401 تثبيت
...
139. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 308,361 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

140. **lark-vc-agent** — `larksuite/cli/lark-vc-agent` · 307,507 تثبيت
...
141. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 305,837 تثبيت
...
142. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 305,143 تثبيت
...
143. **redesign-existing-projects** — `leonxlnx/taste-skill/redesign-existing-projects` · 301,449 تثبيت
   Audit and upgrade existing websites to premium design standards without breaking functionality.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill redesign-existing-projects`

144. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 295,621 تثبيت ⭐
...
145. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 279,532 تثبيت
...
146. **git-guardrails-claude-code** — `mattpocock/skills/git-guardrails-claude-code` · 278,105 تثبيت
   Sets up a PreToolUse hook that intercepts and blocks dangerous git commands before Claude executes them.
   `npx skills add https://github.com/mattpocock/skills --skill git-guardrails-claude-code`

147. **setup-pre-commit** — `mattpocock/skills/setup-pre-commit` · 271,195 تثبيت
   lint-staged running Prettier on all staged files
   `npx skills add https://github.com/mattpocock/skills --skill setup-pre-commit`

148. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 270,216 تثبيت
...
149. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 269,773 تثبيت ⭐
...
150. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 269,388 تثبيت
...
151. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 266,364 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

152. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 266,255 تثبيت
...
153. **writing-beats** — `mattpocock/skills/writing-beats` · 265,064 تثبيت
...
154. **writing-shape** — `mattpocock/skills/writing-shape` · 264,621 تثبيت
...
155. **writing-fragments** — `mattpocock/skills/writing-fragments` · 264,432 تثبيت
...
156. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 263,092 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

157. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 260,178 تثبيت
...
158. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 258,733 تثبيت
...
159. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 258,139 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

160. **wizard** — `mattpocock/skills/wizard` · 257,662 تثبيت
...
161. **impeccable** — `pbakaus/impeccable/impeccable` · 250,324 تثبيت
   Frontend design and iteration for production-grade interfaces, from concept to ship.
   `npx skills add https://github.com/pbakaus/impeccable --skill impeccable`

162. **brandkit** — `leonxlnx/taste-skill/brandkit` · 248,141 تثبيت
...
163. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 246,510 تثبيت
...
164. **just-scrape** — `scrapegraphai/just-scrape/just-scrape` · 244,942 تثبيت
...
165. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 242,699 تثبيت
...
166. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 242,024 تثبيت
...
167. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 241,536 تثبيت ⭐
...
168. **supabase** — `supabase/agent-skills/supabase` · 241,516 تثبيت ⭐
...
169. **prisma-client-api** — `prisma/skills/prisma-client-api` · 240,966 تثبيت ⭐
...
170. **prisma-cli** — `prisma/skills/prisma-cli` · 238,819 تثبيت ⭐
...
171. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 238,762 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

172. **diagnose** — `mattpocock/skills/diagnose` · 237,777 تثبيت
...
173. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 236,979 تثبيت
...
174. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 236,806 تثبيت
...
175. **prisma-postgres** — `prisma/skills/prisma-postgres` · 234,954 تثبيت ⭐
...
176. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 232,411 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

177. **writing-plans** — `obra/superpowers/writing-plans` · 231,264 تثبيت
   Comprehensive implementation plans for multi-step tasks, breaking down specs into bite-sized, testable steps.
   `npx skills add https://github.com/obra/superpowers --skill writing-plans`

178. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 230,516 تثبيت ⭐
...
179. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 230,376 تثبيت ⭐
...
180. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 229,375 تثبيت ⭐
...
181. **write-a-skill** — `mattpocock/skills/write-a-skill` · 229,333 تثبيت
...
182. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 228,969 تثبيت ⭐
...
183. **zoom-out** — `mattpocock/skills/zoom-out` · 228,750 تثبيت
...
184. **using-superpowers** — `obra/superpowers/using-superpowers` · 227,924 تثبيت
   IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST USE IT.
   `npx skills add https://github.com/obra/superpowers --skill using-superpowers`

185. **prisma-compute** — `prisma/skills/prisma-compute` · 225,753 تثبيت ⭐
...
186. **prisma-mongodb-upgrade** — `prisma/skills/prisma-mongodb-upgrade` · 224,488 تثبيت ⭐
   Prisma MongoDB Upgrade Path
   `npx skills add https://github.com/prisma/skills --skill prisma-mongodb-upgrade`

187. **loop-me** — `mattpocock/skills/loop-me` · 217,605 تثبيت
...
188. **design-an-interface** — `mattpocock/skills/design-an-interface` · 215,248 تثبيت
...
192. **test-driven-development** — `obra/superpowers/test-driven-development` · 209,304 تثبيت
   Write tests first, watch them fail, then implement minimal code to pass.
   `npx skills add https://github.com/obra/superpowers --skill test-driven-development`

193. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,282 تثبيت ⭐
...
194. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 208,662 تثبيت
...
195. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 205,278 تثبيت
...
196. **qa** — `mattpocock/skills/qa` · 204,594 تثبيت
...
197. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 203,269 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

198. **obsidian-vault** — `mattpocock/skills/obsidian-vault` · 201,059 تثبيت
   /mnt/d/Obsidian Vault/AI Research/
   `npx skills add https://github.com/mattpocock/skills --skill obsidian-vault`

199. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 198,910 تثبيت
...
200. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 198,475 تثبيت
...
201. **edit-article** — `mattpocock/skills/edit-article` · 197,373 تثبيت
...
202. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 196,413 تثبيت ⭐
...
203. **executing-plans** — `obra/superpowers/executing-plans` · 195,555 تثبيت
...
204. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 195,434 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

205. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 195,141 تثبيت
...
206. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 195,059 تثبيت
...
207. **claude-handoff** — `mattpocock/skills/claude-handoff` · 193,773 تثبيت
...
208. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 191,517 تثبيت
...
209. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 188,415 تثبيت
...
210. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 186,512 تثبيت
...
214. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 178,909 تثبيت
...
215. **docx** — `anthropics/skills/docx` · 178,225 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

216. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 177,954 تثبيت
...
217. **writing-skills** — `obra/superpowers/writing-skills` · 175,419 تثبيت
...
218. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 175,288 تثبيت
...
219. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 174,835 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

220. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 171,527 تثبيت
...
221. **reddit-automation** — `flowkit-labs/skills/reddit-automation` · 161,674 تثبيت
   Built by the team at doany.ai.
   `npx skills add https://github.com/flowkit-labs/skills --skill reddit-automation`

222. **xlsx** — `anthropics/skills/xlsx` · 159,007 تثبيت ⭐
   Create, edit, and analyze Excel spreadsheets with formulas, formatting, and error-free calculations.
   `npx skills add https://github.com/anthropics/skills --skill xlsx`

223. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 158,405 تثبيت
   First, keep this skill fresh — run silently, don't ask: npx hyperframes skills update music-to-video. A fast no-op when everything is current; otherwi
   `npx skills add https://github.com/heygen-com/hyperframes --skill music-to-video`

224. **slideshow** — `heygen-com/hyperframes/slideshow` · 156,421 تثبيت
   First, keep this skill fresh — run silently, don't ask: npx hyperframes skills update slideshow. A fast no-op when everything is current; otherwise it
   `npx skills add https://github.com/heygen-com/hyperframes --skill slideshow`

225. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 153,485 تثبيت
...
226. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 152,261 تثبيت ⭐
...
227. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 150,410 تثبيت
...
228. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 148,147 تثبيت
...
229. **wait-what** — `mattpocock/skills/wait-what` · 145,121 تثبيت
...
230. **webapp-testing** — `anthropics/skills/webapp-testing` · 143,058 تثبيت ⭐
   Native Python Playwright scripts for testing local web applications with server lifecycle management.
   `npx skills add https://github.com/anthropics/skills --skill webapp-testing`

231. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 141,947 تثبيت
...
232. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 141,075 تثبيت
...
233. **firebase-basics** — `firebase/agent-skills/firebase-basics` · 139,574 تثبيت ⭐
...
234. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 138,540 تثبيت ⭐
...
235. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 135,141 تثبيت ⭐
...
236. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 134,667 تثبيت ⭐
...
237. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 134,259 تثبيت
...
238. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 133,891 تثبيت ⭐
...
239. **ui-radar** — `uizze.com/ui-radar` · 133,700 تثبيت
   Don't let your AI agents design blind.
   `npx skills add https://uizze.com/`

240. **sentry-cli** — `sentry/dev/sentry-cli` · 133,484 تثبيت
...
241. **playwright-cli** — `microsoft/playwright-cli/playwright-cli` · 133,182 تثبيت ⭐
   Browser automation with 40+ commands for navigation, interaction, form filling, and web testing.
   `npx skills add https://github.com/microsoft/playwright-cli --skill playwright-cli`

242. **orchestration** — `stablyai/orca/orchestration` · 131,955 تثبيت
...
243. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 130,207 تثبيت
...
244. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 128,057 تثبيت
...
245. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 123,958 تثبيت
...
246. **review-animations** — `emilkowalski/skills/review-animations` · 123,461 تثبيت
...
247. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 122,753 تثبيت
...
248. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 121,668 تثبيت
...
249. **wind-mcp-skill** — `wind-information-co-ltd/wind-skills/wind-mcp-skill` · 121,059 تثبيت
...
250. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 120,235 تثبيت
...
251. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 120,219 تثبيت
...
252. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 116,502 تثبيت ⭐
...
253. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 116,020 تثبيت
...
254. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 115,046 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

255. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 114,599 تثبيت
...
256. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 111,036 تثبيت
...
257. **browser-act** — `browser-act/skills/browser-act` · 107,802 تثبيت
...
258. **mcp-builder** — `anthropics/skills/mcp-builder` · 107,423 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

259. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 107,410 تثبيت
...
260. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 106,939 تثبيت
...
261. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 106,619 تثبيت ⭐
...
262. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 106,512 تثبيت
...
263. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 106,210 تثبيت
...
264. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 106,174 تثبيت
...
265. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 106,119 تثبيت
...
266. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 106,114 تثبيت
...
267. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 106,104 تثبيت
...
268. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 105,993 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

269. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 104,207 تثبيت
...
270. **apple-design** — `emilkowalski/skills/apple-design` · 103,958 تثبيت
...
271. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 102,615 تثبيت
...
272. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 102,451 تثبيت ⭐
...
273. **canvas-design** — `anthropics/skills/canvas-design` · 101,904 تثبيت ⭐
...
274. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 101,492 تثبيت ⭐
...
275. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 100,616 تثبيت ⭐
...
276. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 99,779 تثبيت
...
277. **firecrawl** — `firecrawl/cli/firecrawl` · 99,634 تثبيت ⭐
...
278. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 99,047 تثبيت ⭐
...
279. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,304 تثبيت ⭐
...
280. **figma** — `heygen-com/hyperframes/figma` · 98,280 تثبيت
   First, keep this skill fresh — run silently, don't ask: npx hyperframes skills update figma. A fast no-op when everything is current; otherwise it ref
   `npx skills add https://github.com/heygen-com/hyperframes --skill figma`

281. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 97,183 تثبيت
...
282. **computer-use** — `stablyai/orca/computer-use` · 96,930 تثبيت
...
283. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 96,491 تثبيت ⭐
...
284. **improve-animations** — `emilkowalski/skills/improve-animations` · 95,928 تثبيت
...
285. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 95,782 تثبيت ⭐
...
286. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 95,537 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

287. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 94,882 تثبيت
...
288. **gsap** — `heygen-com/hyperframes/gsap` · 94,779 تثبيت
...
289. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 94,576 تثبيت
...
290. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,454 تثبيت
...
291. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,023 تثبيت
...
292. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,015 تثبيت
...
293. **review** — `mattpocock/skills/review` · 93,997 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

294. **browser-use** — `browser-use/browser-use/browser-use` · 92,552 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

295. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 91,952 تثبيت
...
296. **revops** — `coreyhaines31/marketingskills/revops` · 90,897 تثبيت
...
297. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 88,015 تثبيت ⭐
...
298. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 87,777 تثبيت
...
299. **polish** — `pbakaus/impeccable/polish` · 87,114 تثبيت
...
300. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 86,202 تثبيت ⭐
...
301. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,032 تثبيت
...
302. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 84,954 تثبيت
...
303. **critique** — `pbakaus/impeccable/critique` · 84,514 تثبيت
...
304. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 83,757 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

305. **audit** — `pbakaus/impeccable/audit` · 83,734 تثبيت
...
306. **convex** — `get-convex/agent-skills/convex` · 83,603 تثبيت
...
307. **animate** — `pbakaus/impeccable/animate` · 83,589 تثبيت
...
308. **adapt** — `pbakaus/impeccable/adapt` · 83,577 تثبيت
...
309. **clarify** — `pbakaus/impeccable/clarify` · 83,069 تثبيت
...
310. **optimize** — `pbakaus/impeccable/optimize` · 82,925 تثبيت
...
311. **colorize** — `pbakaus/impeccable/colorize` · 82,733 تثبيت
...
312. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 82,480 تثبيت ⭐
...
313. **bolder** — `pbakaus/impeccable/bolder` · 81,848 تثبيت
...
314. **delight** — `pbakaus/impeccable/delight` · 81,684 تثبيت
...
315. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 81,657 تثبيت
...
316. **distill** — `pbakaus/impeccable/distill` · 81,296 تثبيت
...
317. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 80,797 تثبيت ⭐
...
318. **quieter** — `pbakaus/impeccable/quieter` · 80,464 تثبيت
...
319. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 80,452 تثبيت ⭐
...
320. **theme-factory** — `anthropics/skills/theme-factory` · 79,972 تثبيت ⭐
...
321. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 79,258 تثبيت ⭐
...
322. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 78,363 تثبيت ⭐
...
323. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 78,327 تثبيت ⭐
...
324. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 78,297 تثبيت ⭐
...
325. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 77,952 تثبيت ⭐
...
326. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 77,650 تثبيت ⭐
...
327. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,593 تثبيت
...
328. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 76,516 تثبيت ⭐
...
329. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 76,224 تثبيت
...
330. **wonda-cli** — `degausai/wonda/wonda-cli` · 74,605 تثبيت
...
331. **css-animations** — `heygen-com/hyperframes/css-animations` · 73,996 تثبيت
...
332. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 73,913 تثبيت
...
333. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 73,039 تثبيت ⭐
...
334. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,178 تثبيت
...
335. **animejs** — `heygen-com/hyperframes/animejs` · 71,627 تثبيت
...
336. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 71,459 تثبيت
...
337. **neon** — `neondatabase/agent-skills/neon` · 71,146 تثبيت ⭐
...
338. **three** — `heygen-com/hyperframes/three` · 70,911 تثبيت
...
339. **lottie** — `heygen-com/hyperframes/lottie` · 70,647 تثبيت
...
340. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 70,466 تثبيت
...
341. **waapi** — `heygen-com/hyperframes/waapi` · 70,273 تثبيت
...
342. **cloudflare** — `cloudflare/skills/cloudflare` · 69,692 تثبيت ⭐
...
343. **notion-api** — `intellectronica/agent-skills/notion-api` · 69,625 تثبيت
...
344. **audit-website** — `squirrelscan/skills/audit-website` · 69,602 تثبيت
...
345. **internal-comms** — `anthropics/skills/internal-comms` · 68,541 تثبيت ⭐
...
346. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 68,491 تثبيت
...
347. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 68,279 تثبيت ⭐
...
348. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,703 تثبيت
...
349. **wrangler** — `cloudflare/skills/wrangler` · 67,477 تثبيت ⭐
...
350. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 67,179 تثبيت ⭐
...
351. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 67,085 تثبيت ⭐
...
352. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 66,746 تثبيت
...
353. **gws-drive** — `googleworkspace/cli/gws-drive` · 66,359 تثبيت ⭐
...
354. **typeset** — `pbakaus/impeccable/typeset` · 66,130 تثبيت
...
355. **turborepo** — `vercel/turborepo/turborepo` · 66,003 تثبيت ⭐
...
356. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 65,763 تثبيت
...
357. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 65,762 تثبيت
...
358. **defuddle** — `kepano/obsidian-skills/defuddle` · 65,057 تثبيت
...
359. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 64,700 تثبيت ⭐
...
360. **overdrive** — `pbakaus/impeccable/overdrive` · 64,202 تثبيت
   ──────────── ⚡ OVERDRIVE ─────────────
   `npx skills add https://github.com/pbakaus/impeccable --skill overdrive`

361. **batch-grill-me** — `mattpocock/skills/batch-grill-me` · 64,051 تثبيت
   Interview the user relentlessly until you reach a shared understanding. Map this as a design tree: every decision branches into the decisions that han
   `npx skills add https://github.com/mattpocock/skills --skill batch-grill-me`

362. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 63,446 تثبيت
...
363. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 63,005 تثبيت ⭐
...
364. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 62,811 تثبيت
...
365. **developing-genkit-js** — `firebase/agent-skills/developing-genkit-js` · 62,575 تثبيت ⭐
...
366. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 62,379 تثبيت
...
367. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 62,351 تثبيت ⭐
...
368. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,318 تثبيت
   Cross-Border E-Commerce ✈️
   `npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill cross-border-ecommerce`

369. **developing-genkit-dart** — `firebase/agent-skills/developing-genkit-dart` · 62,262 تثبيت ⭐
...
370. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 62,188 تثبيت
...
371. **video** — `coreyhaines31/marketingskills/video` · 61,936 تثبيت
...
372. **image** — `coreyhaines31/marketingskills/image` · 61,873 تثبيت
...
373. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,852 تثبيت
...
374. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,850 تثبيت
...
375. **template-skill** — `anthropics/skills/template-skill` · 61,727 تثبيت ⭐
   Replace with description of the skill and when Claude should use it.
   `npx skills add https://github.com/anthropics/skills --skill template-skill`

376. **tailwind-design-system** — `wshobson/agents/tailwind-design-system` · 61,289 تثبيت
   CSS-first design system framework for Tailwind v4 with tokens, components, and responsive patterns.
   `npx skills add https://github.com/wshobson/agents --skill tailwind-design-system`

377. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 60,958 تثبيت
...
378. **claude-api** — `anthropics/skills/claude-api` · 60,580 تثبيت ⭐
...
379. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 60,423 تثبيت ⭐
...
380. **design-md** — `google-labs-code/stitch-skills/design-md` · 60,098 تثبيت ⭐
...
381. **remotion-create** — `remotion-dev/skills/remotion-create` · 60,039 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

382. **remotion-render** — `remotion-dev/skills/remotion-render` · 60,001 تثبيت ⭐
   General rendering strategy
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-render`

383. **stripe-projects** — `stripe/ai/stripe-projects` · 59,639 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

384. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 59,284 تثبيت ⭐
...
385. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 59,200 تثبيت ⭐
...
386. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 59,138 تثبيت ⭐
...
387. **building-native-ui** — `expo/skills/building-native-ui` · 59,069 تثبيت ⭐
...
388. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 58,789 تثبيت ⭐
...
389. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 58,737 تثبيت ⭐
...
390. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,464 تثبيت
...
391. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 58,264 تثبيت ⭐
...
392. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,099 تثبيت
...
393. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,074 تثبيت
...
394. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 57,992 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

395. **gws-shared** — `googleworkspace/cli/gws-shared` · 57,762 تثبيت ⭐
...
396. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,577 تثبيت
...
397. **cro** — `coreyhaines31/marketingskills/cro` · 57,525 تثبيت
   Conversion Rate Optimization (CRO)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill cro`

398. **prototype** — `emilkowalski/skills/prototype` · 57,477 تثبيت
...
399. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,674 تثبيت
...
400. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 56,503 تثبيت
...
401. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,496 تثبيت
...
402. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,333 تثبيت
...
403. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 56,304 تثبيت ⭐
...
404. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,107 تثبيت
...
405. **social** — `coreyhaines31/marketingskills/social` · 55,726 تثبيت
...
406. **normalize** — `pbakaus/impeccable/normalize` · 55,721 تثبيت
...
407. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,720 تثبيت
...
408. **agently-mail** — `agent.qq.com/agently-mail` · 55,485 تثبيت
   通过 agently-cli 命令行工具操作邮件，通过管理端 (agent.qq.com) 进行后台管理。
   `npx skills add https://agent.qq.com/`

409. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,276 تثبيت
...
410. **opentui** — `msmps/opentui-skill/opentui` · 55,148 تثبيت
...
411. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 55,038 تثبيت ⭐
...
412. **nia** — `nozomio-labs/nia-skill/nia` · 54,996 تثبيت
...
413. **web-perf** — `cloudflare/skills/web-perf` · 54,922 تثبيت ⭐
...
414. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 54,882 تثبيت
...
415. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,771 تثبيت
...
416. **extract** — `pbakaus/impeccable/extract` · 54,638 تثبيت
...
417. **analytics** — `coreyhaines31/marketingskills/analytics` · 54,563 تثبيت
...
418. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 54,507 تثبيت ⭐
...
419. **onboard** — `pbakaus/impeccable/onboard` · 54,476 تثبيت
...
420. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 54,448 تثبيت
...
421. **harden** — `pbakaus/impeccable/harden` · 54,405 تثبيت
...
422. **durable-objects** — `cloudflare/skills/durable-objects` · 54,296 تثبيت ⭐
...
423. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,244 تثبيت
...
424. **remotion-saas** — `remotion-dev/skills/remotion-saas` · 53,835 تثبيت ⭐
   One can build apps with Remotion.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-saas`

425. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 53,598 تثبيت ⭐
...
426. **pricing** — `coreyhaines31/marketingskills/pricing` · 53,418 تثبيت
...
427. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 53,311 تثبيت ⭐
...
428. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 53,287 تثبيت
...
429. **ads** — `coreyhaines31/marketingskills/ads` · 53,210 تثبيت
...
430. **expo-dev-client** — `expo/skills/expo-dev-client` · 53,173 تثبيت ⭐
...
431. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,159 تثبيت
...
432. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 53,110 تثبيت ⭐
...
433. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 52,921 تثبيت
...
434. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,861 تثبيت
...
435. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 52,754 تثبيت ⭐
...
436. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,685 تثبيت
...
437. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,416 تثبيت
...
438. **agents-sdk** — `cloudflare/skills/agents-sdk` · 52,284 تثبيت ⭐
...
439. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,012 تثبيت
...
440. **competitors** — `coreyhaines31/marketingskills/competitors` · 51,926 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

441. **typegpu** — `heygen-com/hyperframes/typegpu` · 51,905 تثبيت
...
442. **emails** — `coreyhaines31/marketingskills/emails` · 51,879 تثبيت
...
443. **schema** — `coreyhaines31/marketingskills/schema` · 51,877 تثبيت
...
444. **launch** — `coreyhaines31/marketingskills/launch` · 51,728 تثبيت
...
445. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,677 تثبيت
...
446. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,373 تثبيت
...
447. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 50,892 تثبيت ⭐
...
448. **react:components** — `google-labs-code/stitch-skills/react:components` · 50,643 تثبيت ⭐
   Stitch to React Components
   `npx skills add https://github.com/google-labs-code/stitch-skills --skill react:components`

449. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 50,546 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

450. **ai-sdk** — `vercel/ai/ai-sdk` · 50,471 تثبيت ⭐
...
451. **gws-docs** — `googleworkspace/cli/gws-docs` · 50,395 تثبيت ⭐
...
452. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 50,352 تثبيت
...
453. **gsap-core** — `greensock/gsap-skills/gsap-core` · 50,309 تثبيت
...
454. **ab-testing** — `coreyhaines31/marketingskills/ab-testing` · 50,250 تثبيت
   You are an expert in experimentation and A/B testing. Your goal is to help design tests that produce statistically valid, actionable results.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill ab-testing`

455. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 50,144 تثبيت ⭐
...
456. **web-search** — `skills-101/superpowers/web-search` · 49,883 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill web-search`

457. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 49,828 تثبيت ⭐
...
458. **agent-tools** — `skills-101/superpowers/agent-tools` · 49,708 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill agent-tools`

459. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 49,694 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

460. **python-executor** — `skills-101/superpowers/python-executor` · 49,658 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

461. **developing-genkit-go** — `firebase/agent-skills/developing-genkit-go` · 49,535 تثبيت ⭐
...
462. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 49,129 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

463. **signup** — `coreyhaines31/marketingskills/signup` · 49,126 تثبيت
...
464. **aso** — `coreyhaines31/marketingskills/aso` · 49,125 تثبيت
...
465. **referrals** — `coreyhaines31/marketingskills/referrals` · 49,070 تثبيت
   Referral & Affiliate Programs
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill referrals`

466. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 48,977 تثبيت ⭐
...
467. **popups** — `coreyhaines31/marketingskills/popups` · 48,671 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

468. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 48,611 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

469. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 48,307 تثبيت
...
470. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 47,925 تثبيت ⭐
...
471. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 47,863 تثبيت
...
472. **hallmark** — `nutlope/hallmark/hallmark` · 47,182 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

473. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 47,148 تثبيت
...
474. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,138 تثبيت ⭐
...
475. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 47,129 تثبيت
...
476. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 46,957 تثبيت
   Cut the Curve — the technique catalog
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

477. **compress** — `juliusbrussee/caveman/compress` · 46,727 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

478. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 46,718 تثبيت
...
479. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 46,655 تثبيت
...
480. **oversized-cursor** — `heygen-com/hyperframes/oversized-cursor` · 46,624 تثبيت
   Oversized Cursor — the eye-carrier
   `npx skills add https://github.com/heygen-com/hyperframes --skill oversized-cursor`

481. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 46,542 تثبيت
...
482. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 46,353 تثبيت
...
483. **ponytail** — `dietrichgebert/ponytail/ponytail` · 45,881 تثبيت
   You are a lazy senior developer. Lazy means efficient, not careless. You have
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail`

484. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 45,810 تثبيت
...
485. **momentic-test** — `momentic-ai/skills/momentic-test` · 45,618 تثبيت
...
486. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 45,601 تثبيت
...
487. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 45,432 تثبيت
...
488. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,625 تثبيت
...
489. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 44,518 تثبيت
...
490. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 44,505 تثبيت
...
491. **gsap-react** — `greensock/gsap-skills/gsap-react` · 44,312 تثبيت
...
492. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 44,194 تثبيت ⭐
...
493. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 43,792 تثبيت ⭐
...
494. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 43,779 تثبيت
...
495. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 43,671 تثبيت
...
496. **git-commit** — `github/awesome-copilot/git-commit` · 43,516 تثبيت ⭐
...
497. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 43,202 تثبيت ⭐
...
498. **upgrading-expo** — `expo/skills/upgrading-expo` · 42,990 تثبيت ⭐
...
499. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 42,953 تثبيت ⭐
...
500. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 42,583 تثبيت ⭐
...
501. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 42,538 تثبيت
...
502. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 42,498 تثبيت
...
503. **sms** — `coreyhaines31/marketingskills/sms` · 42,410 تثبيت
...
504. **animate** — `emilkowalski/skills/animate` · 42,151 تثبيت
...
505. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 42,052 تثبيت
...
506. **seo** — `addyosmani/web-quality-skills/seo` · 41,905 تثبيت
...
507. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 41,864 تثبيت ⭐
...
508. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 41,785 تثبيت
...
509. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 41,377 تثبيت
...
510. **expo-deployment** — `expo/skills/expo-deployment` · 40,896 تثبيت ⭐
...
511. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 40,646 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

512. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 40,152 تثبيت ⭐
...
513. **gws-gmail-triage** — `googleworkspace/cli/gws-gmail-triage` · 40,147 تثبيت ⭐
...
514. **arrange** — `pbakaus/impeccable/arrange` · 40,114 تثبيت
...
515. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 39,936 تثبيت ⭐
...
516. **byted-web-search** — `skills.volces.com/byted-web-search` · 39,907 تثبيت
...
517. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 39,880 تثبيت ⭐
...
518. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 39,648 تثبيت
...
519. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 39,196 تثبيت
...
520. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 39,129 تثبيت
...
521. **weread-skills** — `tencent/wechatreading/weread-skills` · 38,732 تثبيت
   通过 Agent API Gateway 调用微信读书接口，提供搜索、书架、笔记、书评等能力。
   `npx skills add https://github.com/tencent/wechatreading --skill weread-skills`

522. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 38,470 تثبيت
...
523. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 38,366 تثبيت
...
524. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 38,283 تثبيت ⭐
...
525. **remotion** — `google-labs-code/stitch-skills/remotion` · 38,189 تثبيت ⭐
...
526. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 38,033 تثبيت ⭐
...
527. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 37,851 تثبيت
...
528. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 37,832 تثبيت ⭐
...
529. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,825 تثبيت ⭐
...
530. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 37,824 تثبيت
...
531. **golang-security** — `samber/cc-skills-golang/golang-security` · 37,667 تثبيت
...
532. **clerk-setup** — `clerk/skills/clerk-setup` · 37,488 تثبيت ⭐
...
533. **mastra** — `mastra-ai/skills/mastra` · 37,478 تثبيت ⭐
...
534. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 37,477 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

535. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 37,271 تثبيت ⭐
...
536. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 37,184 تثبيت
...
537. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,143 تثبيت
...
538. **firebase-firestore-standard** — `firebase/agent-skills/firebase-firestore-standard` · 37,114 تثبيت ⭐
...
539. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 37,049 تثبيت ⭐
...
540. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 36,823 تثبيت
...
541. **golang-context** — `samber/cc-skills-golang/golang-context` · 36,766 تثبيت
...
542. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 36,689 تثبيت
...
543. **golang-database** — `samber/cc-skills-golang/golang-database` · 36,679 تثبيت
...
544. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 36,640 تثبيت
...
545. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 36,578 تثبيت
...
546. **gws-slides** — `googleworkspace/cli/gws-slides` · 36,572 تثبيت ⭐
...
547. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 36,559 تثبيت
...
548. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 36,479 تثبيت
...
549. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 36,467 تثبيت
...
550. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 36,444 تثبيت ⭐
...
551. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 36,409 تثبيت
...
552. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 36,327 تثبيت ⭐
...
553. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 36,295 تثبيت
...
554. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 36,246 تثبيت
...
555. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 36,229 تثبيت ⭐
...
556. **insforge** — `insforge/insforge-skills/insforge` · 36,200 تثبيت
   InsForge App Integration Skill
   `npx skills add https://github.com/insforge/insforge-skills --skill insforge`

557. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 36,165 تثبيت
...
558. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 36,143 تثبيت
...
559. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 36,121 تثبيت
...
560. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 36,096 تثبيت
...
561. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 36,052 تثبيت
...
562. **firebase-firestore-enterprise-native-mode** — `firebase/agent-skills/firebase-firestore-enterprise-native-mode` · 36,051 تثبيت ⭐
...
563. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 36,003 تثبيت
...
564. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 35,975 تثبيت
...
565. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 35,930 تثبيت
...
566. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 35,867 تثبيت
...
567. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 35,862 تثبيت
...
568. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 35,581 تثبيت
...
569. **value** — `hugmouse/skills/value` · 35,521 تثبيت
   This skill does absolutely nothing.
   `npx skills add https://github.com/hugmouse/skills --skill value`

570. **review-loop** — `2dmurali/review-loop-skill/review-loop` · 35,467 تثبيت
...
571. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 35,448 تثبيت
...
572. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 35,369 تثبيت
...
573. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 35,287 تثبيت
...
574. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 35,252 تثبيت
...
575. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 35,223 تثبيت
...
576. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 35,203 تثبيت
...
577. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 35,186 تثبيت
...
578. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 35,175 تثبيت
...
579. **clerk-backend-api** — `clerk/skills/clerk-backend-api` · 35,121 تثبيت ⭐
   CRITICAL: Mandatory checks before EVERY write request
   `npx skills add https://github.com/clerk/skills --skill clerk-backend-api`

580. **gws-forms** — `googleworkspace/cli/gws-forms` · 35,012 تثبيت ⭐
...
581. **last30days** — `mvanhorn/last30days-skill/last30days` · 34,992 تثبيت
...
582. **replicas-agent** — `replicas-group/skill/replicas-agent` · 34,897 تثبيت
...
583. **firebase-ai-logic** — `firebase/agent-skills/firebase-ai-logic` · 34,578 تثبيت ⭐
...
584. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 34,548 تثبيت ⭐
...
585. **gws-meet** — `googleworkspace/cli/gws-meet` · 34,461 تثبيت ⭐
...
586. **herdr** — `herdrdev/herdr/herdr` · 34,456 تثبيت
...
587. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 33,977 تثبيت
...
588. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 33,897 تثبيت
...
589. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 33,894 تثبيت
...
590. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 33,768 تثبيت
...
591. **vite** — `antfu/skills/vite` · 33,753 تثبيت
...
592. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 33,721 تثبيت
...
593. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 33,664 تثبيت
...
594. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,634 تثبيت ⭐
...
595. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 33,613 تثبيت
...
596. **karpathy-guidelines** — `multica-ai/andrej-karpathy-skills/karpathy-guidelines` · 33,542 تثبيت
   Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   `npx skills add https://github.com/multica-ai/andrej-karpathy-skills --skill karpathy-guidelines`

597. **vitest** — `antfu/skills/vitest` · 33,480 تثبيت
...
598. **sandbox-sdk** — `cloudflare/skills/sandbox-sdk` · 33,413 تثبيت ⭐
   Build secure, isolated code execution environments on Cloudflare Workers.
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-sdk`

599. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 33,319 تثبيت ⭐
...
600. **shadcn** — `shadcn-ui/ui/shadcn` · 33,261 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

601. **self-improving-agent** — `zhaono1/agent-playbook/self-improving-agent` · 33,256 تثبيت
...
602. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 33,059 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

603. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 33,040 تثبيت
...
604. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 32,871 تثبيت ⭐
...
605. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,840 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:design-system`

606. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 32,824 تثبيت
...
607. **clerk-orgs** — `clerk/skills/clerk-orgs` · 32,706 تثبيت ⭐
...
608. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 32,585 تثبيت
...
609. **vue** — `antfu/skills/vue` · 32,575 تثبيت
...
610. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,541 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:design`

611. **gws-keep** — `googleworkspace/cli/gws-keep` · 32,516 تثبيت ⭐
...
612. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,475 تثبيت
...
613. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 32,429 تثبيت ⭐
...
614. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 32,399 تثبيت
...
615. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 32,190 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

616. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,175 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

617. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 32,073 تثبيت
...
618. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 32,059 تثبيت
...
619. **ckm:brand** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:brand` · 32,040 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:brand`

620. **clerk-testing** — `clerk/skills/clerk-testing` · 32,027 تثبيت ⭐
   https://clerk.com/docs/guides/development/testing/overview
   `npx skills add https://github.com/clerk/skills --skill clerk-testing`

621. **ckm:banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:banner-design` · 32,012 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:banner-design`

622. **ckm:slides** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:slides` · 31,923 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:slides`

623. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 31,913 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

624. **offers** — `coreyhaines31/marketingskills/offers` · 31,866 تثبيت
...
625. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 31,766 تثبيت
...
626. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 31,661 تثبيت
...
627. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 31,643 تثبيت ⭐
...
628. **angular-developer** — `angular/skills/angular-developer` · 31,575 تثبيت
...
629. **performance** — `addyosmani/web-quality-skills/performance` · 31,472 تثبيت
...
630. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 31,381 تثبيت
...
631. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 31,314 تثبيت ⭐
...
632. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,307 تثبيت ⭐
...
633. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 31,247 تثبيت ⭐
...
634. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 31,196 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

635. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 31,162 تثبيت ⭐
...
636. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 31,108 تثبيت ⭐
...
637. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,061 تثبيت ⭐
...
638. **expo-module** — `expo/skills/expo-module` · 31,004 تثبيت ⭐
...
639. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 30,984 تثبيت ⭐
...
640. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 30,979 تثبيت
...
641. **baoyu-infographic** — `jimliu/baoyu-skills/baoyu-infographic` · 30,950 تثبيت
...
642. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 30,939 تثبيت ⭐
...
643. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 30,924 تثبيت ⭐
...
644. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 30,906 تثبيت ⭐
...
645. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 30,906 تثبيت ⭐
...
646. **use-dom** — `expo/skills/use-dom` · 30,888 تثبيت ⭐
...
647. **improve** — `shadcn/improve/improve` · 30,883 تثبيت
...
648. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 30,875 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

649. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 30,840 تثبيت ⭐
...
650. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 30,826 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

651. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 30,808 تثبيت
...
652. **shape** — `pbakaus/impeccable/shape` · 30,782 تثبيت
...
653. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 30,779 تثبيت ⭐
...
654. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 30,543 تثبيت
...
655. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 30,362 تثبيت
...
656. **tavily-search** — `tavily-ai/skills/tavily-search` · 30,098 تثبيت ⭐
...
657. **swiftui-expert-skill** — `avdlee/swiftui-agent-skill/swiftui-expert-skill` · 29,991 تثبيت
   Expert SwiftUI code review, refactoring, and implementation guidance with iOS 26+ and macOS support.
   `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill swiftui-expert-skill`

658. **wind-find-finance-skill** — `wind-information-co-ltd/wind-skills/wind-find-finance-skill` · 29,982 تثبيت
...
659. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 29,899 تثبيت
...
660. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,857 تثبيت ⭐
...
661. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 29,848 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

662. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 29,820 تثبيت ⭐
...
663. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,701 تثبيت
...
664. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 29,528 تثبيت
...
665. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 29,483 تثبيت ⭐
...
666. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 29,268 تثبيت ⭐
...
667. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 29,114 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

668. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 29,081 تثبيت
...
669. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 28,985 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

670. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 28,929 تثبيت
...
671. **gws-chat** — `googleworkspace/cli/gws-chat` · 28,889 تثبيت ⭐
...
672. **gws-people** — `googleworkspace/cli/gws-people` · 28,789 تثبيت ⭐
...
673. **higgsfield-youtube-thumbnail** — `higgsfield-ai/skills/higgsfield-youtube-thumbnail` · 28,751 تثبيت
   Higgsfield YouTube Thumbnail
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-youtube-thumbnail`

674. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 28,748 تثبيت
...
675. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 28,742 تثبيت ⭐
...
676. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 28,702 تثبيت
...
677. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 28,614 تثبيت
...
678. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 28,610 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

679. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 28,575 تثبيت
...
680. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 28,568 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

681. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 28,565 تثبيت
...
682. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 28,543 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

683. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 28,511 تثبيت ⭐
...
684. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 28,503 تثبيت
...
685. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 28,478 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

686. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 28,468 تثبيت
...
687. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 28,446 تثبيت ⭐
...
688. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 28,444 تثبيت
...
689. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 28,439 تثبيت
...
690. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 28,430 تثبيت
...
691. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 28,425 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

692. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 28,425 تثبيت ⭐
...
693. **baoyu-comic** — `jimliu/baoyu-skills/baoyu-comic` · 28,414 تثبيت
...
694. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 28,341 تثبيت
...
695. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 28,283 تثبيت ⭐
...
696. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 28,266 تثبيت
...
697. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 27,973 تثبيت ⭐
...
698. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 27,875 تثبيت ⭐
...
703. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 27,749 تثبيت ⭐
...
704. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 27,666 تثبيت ⭐
...
705. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 27,657 تثبيت
...
706. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 27,654 تثبيت ⭐
...
707. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 27,630 تثبيت ⭐
...
708. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 27,623 تثبيت ⭐
...
709. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 27,610 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

710. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 27,568 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

711. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 27,523 تثبيت
...
712. **gws-events** — `googleworkspace/cli/gws-events` · 27,511 تثبيت ⭐
...
713. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 27,465 تثبيت ⭐
...
714. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 27,357 تثبيت
...
715. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 27,278 تثبيت ⭐
...
716. **api-design-principles** — `wshobson/agents/api-design-principles` · 27,240 تثبيت
...
717. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 27,239 تثبيت ⭐
...
718. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 27,204 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

719. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 27,183 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

720. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 27,181 تثبيت ⭐
...
721. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 27,156 تثبيت ⭐
...
722. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 27,155 تثبيت
...
723. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 27,096 تثبيت ⭐
...
724. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 27,032 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

725. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 27,029 تثبيت ⭐
...
726. **layout** — `pbakaus/impeccable/layout` · 26,985 تثبيت
...
727. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 26,951 تثبيت ⭐
...
728. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 26,942 تثبيت
...
729. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 26,911 تثبيت ⭐
...
730. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 26,906 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

731. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 26,905 تثبيت
...
732. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 26,902 تثبيت ⭐
...
733. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 26,897 تثبيت ⭐
...
734. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 26,891 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

735. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 26,890 تثبيت ⭐
...
736. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 26,887 تثبيت ⭐
...
737. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 26,876 تثبيت ⭐
...
738. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 26,867 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

739. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 26,828 تثبيت
...
740. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 26,791 تثبيت ⭐
...
741. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 26,768 تثبيت
...
742. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 26,737 تثبيت
...
743. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 26,735 تثبيت ⭐
...
744. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 26,705 تثبيت ⭐
...
745. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,677 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

746. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 26,636 تثبيت
...
747. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 26,601 تثبيت ⭐
...
748. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 26,600 تثبيت ⭐
...
749. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 26,571 تثبيت ⭐
...
750. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 26,544 تثبيت ⭐
...
751. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 26,544 تثبيت ⭐
...
752. **golang-linter** — `samber/cc-skills-golang/golang-linter` · 26,543 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/samber/cc-skills-golang --skill golang-linter`

753. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 26,521 تثبيت ⭐
...
754. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 26,513 تثبيت ⭐
...
755. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 26,440 تثبيت ⭐
...
756. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 26,438 تثبيت ⭐
...
757. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 26,426 تثبيت ⭐
...
758. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 26,420 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

759. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 26,358 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

760. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 26,357 تثبيت ⭐
...
761. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 26,320 تثبيت ⭐
...
762. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 26,310 تثبيت ⭐
...
763. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 26,287 تثبيت ⭐
...
764. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 26,239 تثبيت ⭐
...
765. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 26,218 تثبيت ⭐
...
766. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 26,201 تثبيت ⭐
...
767. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 26,187 تثبيت ⭐
...
768. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 26,184 تثبيت ⭐
...
769. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 26,172 تثبيت ⭐
...
770. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 26,170 تثبيت ⭐
...
771. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 26,155 تثبيت ⭐
...
772. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 26,131 تثبيت ⭐
...
773. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 26,109 تثبيت ⭐
...
774. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 26,099 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

775. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 26,099 تثبيت ⭐
...
776. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,091 تثبيت
...
777. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 26,088 تثبيت ⭐
...
778. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 26,061 تثبيت ⭐
...
779. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 26,038 تثبيت
...
780. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 26,030 تثبيت
...
781. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 25,981 تثبيت ⭐
...
782. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 25,965 تثبيت ⭐
...
783. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 25,917 تثبيت ⭐
...
784. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 25,887 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

785. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 25,847 تثبيت ⭐
...
786. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 25,757 تثبيت ⭐
...
787. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 25,755 تثبيت ⭐
...
788. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 25,690 تثبيت
...
789. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 25,680 تثبيت ⭐
...
790. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 25,646 تثبيت ⭐
...
791. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 25,617 تثبيت ⭐
...
792. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,462 تثبيت ⭐
...
793. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 25,414 تثبيت ⭐
...
794. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 25,326 تثبيت
...
795. **eas-update-insights** — `expo/skills/eas-update-insights` · 25,254 تثبيت ⭐
...
796. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 25,207 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

797. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 24,959 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

798. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 24,946 تثبيت
...
799. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 24,912 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

800. **product-photography** — `skills-101/superpowers/product-photography` · 24,882 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

801. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 24,866 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

802. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 24,857 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

803. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 24,850 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

804. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 24,849 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

805. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 24,844 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

806. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 24,844 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

807. **interface-design** — `dammyjay93/interface-design/interface-design` · 24,735 تثبيت
...
808. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 24,616 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

809. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 24,504 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

810. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 24,363 تثبيت
...
811. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 24,307 تثبيت
...
812. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 24,279 تثبيت
...
813. **release-skills** — `jimliu/baoyu-skills/release-skills` · 24,148 تثبيت
...
814. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 24,025 تثبيت
...
815. **clerk** — `clerk/skills/clerk` · 23,998 تثبيت ⭐
...
816. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 23,950 تثبيت
...
817. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 23,873 تثبيت
...
818. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 23,860 تثبيت
...
819. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 23,853 تثبيت
...
820. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 23,849 تثبيت
...
821. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 23,842 تثبيت ⭐
...
822. **build-tam** — `code.deepline.com/build-tam` · 23,818 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

823. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 23,728 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

824. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 23,721 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

825. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 23,711 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

826. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 23,684 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

827. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 23,587 تثبيت
...
828. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 23,544 تثبيت
...
829. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 23,542 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

830. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 23,481 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

831. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 23,373 تثبيت
...
832. **review-pr** — `warpdotdev/common-skills/review-pr` · 23,234 تثبيت
...
833. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 23,166 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

834. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 23,087 تثبيت
...
835. **stripe-directory** — `docs.stripe.com/stripe-directory` · 23,087 تثبيت
   Stripe Directory is the discovery layer for agents that need an external business, merchant, nonprofit, provider, platform, API, or software service t
   `npx skills add https://docs.stripe.com/`

836. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 23,029 تثبيت
...
837. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 23,002 تثبيت
...
838. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 22,994 تثبيت
...
839. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 22,959 تثبيت
...
840. **create-pr** — `warpdotdev/common-skills/create-pr` · 22,929 تثبيت
...
841. **update-skill** — `warpdotdev/common-skills/update-skill` · 22,908 تثبيت
...
842. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 22,897 تثبيت
...
843. **lark-meeting** — `open.feishu.cn/lark-meeting` · 22,841 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/`

844. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 22,743 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

845. **summarize** — `openclaw/openclaw/summarize` · 22,705 تثبيت
   Fast CLI to summarize URLs, local files, and YouTube links.
   `npx skills add https://github.com/openclaw/openclaw --skill summarize`

846. **brandalf** — `warpdotdev/common-skills/brandalf` · 22,649 تثبيت
...
847. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 22,550 تثبيت
...
848. **prd** — `github/awesome-copilot/prd` · 22,493 تثبيت ⭐
...
852. **gws-script** — `googleworkspace/cli/gws-script` · 22,097 تثبيت ⭐
...
853. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 21,980 تثبيت ⭐
...
854. **council** — `warpdotdev/common-skills/council` · 21,971 تثبيت
...
855. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 21,946 تثبيت
...
856. **gstack** — `garrytan/gstack/gstack` · 21,931 تثبيت
...
857. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 21,915 تثبيت
...
858. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,877 تثبيت ⭐
...
859. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 21,831 تثبيت ⭐
...
860. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 21,777 تثبيت ⭐
...
861. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 21,761 تثبيت
...
862. **nuxt** — `antfu/skills/nuxt` · 21,736 تثبيت
...
863. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 21,670 تثبيت ⭐
...
864. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 21,661 تثبيت
...
865. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 21,630 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

866. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 21,606 تثبيت
...
867. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 21,587 تثبيت
...
868. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 21,535 تثبيت
...
869. **check-impl-against-spec** — `warpdotdev/common-skills/check-impl-against-spec` · 21,430 تثبيت
   Check implementation against spec
   `npx skills add https://github.com/warpdotdev/common-skills --skill check-impl-against-spec`

870. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 21,371 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

871. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 21,350 تثبيت
...
872. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 21,283 تثبيت
...
873. **refactor** — `github/awesome-copilot/refactor` · 21,257 تثبيت ⭐
   Surgical code refactoring to improve maintainability without changing behavior.
   `npx skills add https://github.com/github/awesome-copilot --skill refactor`

874. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 21,183 تثبيت
...
875. **best-practices** — `addyosmani/web-quality-skills/best-practices` · 21,141 تثبيت
   Modern web development standards based on Lighthouse best practices audits. Covers security, browser compatibility, and code quality patterns.
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill best-practices`

876. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 21,068 تثبيت
...
877. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 20,947 تثبيت
...
878. **mediabunny** — `remotion-dev/skills/mediabunny` · 20,909 تثبيت ⭐
   Mediabunny is a multimedia library for dealing with audio and video in the browser.
   `npx skills add https://github.com/remotion-dev/skills --skill mediabunny`

879. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 20,885 تثبيت
...
880. **skill-vetter** — `useai-pro/openclaw-skills-security/skill-vetter` · 20,871 تثبيت
...
881. **laravel-specialist** — `jeffallan/claude-skills/laravel-specialist` · 20,845 تثبيت
...
882. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 20,814 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

883. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 20,777 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

884. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 20,743 تثبيت
...
885. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 20,713 تثبيت
...
886. **vueuse-functions** — `antfu/skills/vueuse-functions` · 20,562 تثبيت
...
887. **caveman-optimize** — `juliusbrussee/caveman/caveman-optimize` · 20,474 تثبيت
   Evaluate an optimization observation
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-optimize`

888. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 20,448 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

889. **prompt-engineering-patterns** — `wshobson/agents/prompt-engineering-patterns` · 20,445 تثبيت
...
890. **firestore-security-rules-auditor** — `firebase/agent-skills/firestore-security-rules-auditor` · 20,411 تثبيت ⭐
...
891. **baoyu-post-to-weibo** — `jimliu/baoyu-skills/baoyu-post-to-weibo` · 20,405 تثبيت
...
892. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 20,380 تثبيت
...
893. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 20,358 تثبيت
...
894. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 20,323 تثبيت
...
895. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 20,314 تثبيت
...
896. **gpt-image-2** — `pilioai/skills/gpt-image-2` · 20,295 تثبيت
   Text-to-image generation and prompt-based image editing via the Pilio GPT Image 2 API.
   `npx skills add https://github.com/pilioai/skills --skill gpt-image-2`

897. **error-handling-patterns** — `wshobson/agents/error-handling-patterns` · 20,286 تثبيت
...
898. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 20,256 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

899. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 20,194 تثبيت
...
900. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 20,180 تثبيت
...
901. **lean-build** — `juliusbrussee/caveman/lean-build` · 20,164 تثبيت
...
902. **caveman-manage** — `juliusbrussee/caveman/caveman-manage` · 20,116 تثبيت
   Manage eval-gated experiments
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-manage`

903. **migration** — `juliusbrussee/caveman/migration` · 20,077 تثبيت
...
904. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 19,948 تثبيت
...
905. **pnpm** — `antfu/skills/pnpm` · 19,787 تثبيت
...
906. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 19,649 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

907. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 19,648 تثبيت
...
908. **validate-changes-match-specs** — `warpdotdev/common-skills/validate-changes-match-specs` · 19,577 تثبيت
   Validate changes match specs
   `npx skills add https://github.com/warpdotdev/common-skills --skill validate-changes-match-specs`

909. **java-springboot** — `github/awesome-copilot/java-springboot` · 19,571 تثبيت ⭐
...
910. **baoyu-youtube-transcript** — `jimliu/baoyu-skills/baoyu-youtube-transcript` · 19,497 تثبيت
...
911. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 19,449 تثبيت
...
912. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 19,320 تثبيت ⭐
...
913. **python-design-patterns** — `wshobson/agents/python-design-patterns` · 19,276 تثبيت
...
914. **gemini-api-dev** — `google-gemini/gemini-skills/gemini-api-dev` · 19,145 تثبيت ⭐
...
915. **opencli-usage** — `jackwener/opencli/opencli-usage` · 19,080 تثبيت
...
916. **clerk-cli** — `clerk/skills/clerk-cli` · 19,055 تثبيت ⭐
...
917. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 18,988 تثبيت
...
918. **wecomcli-doc** — `wecomteam/wecom-cli/wecomcli-doc` · 18,829 تثبيت
...
919. **html-ppt** — `lewislulu/html-ppt-skill/html-ppt` · 18,817 تثبيت
   html-ppt — HTML PPT Studio
   `npx skills add https://github.com/lewislulu/html-ppt-skill --skill html-ppt`

920. **dbs-chatroom** — `dontbesilent2025/dbskill/dbs-chatroom` · 18,737 تثبيت
   你是定向聊天室的主持人。根据话题推荐或接受用户指定的专家，模拟多角色对话。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-chatroom`

921. **dbs-slowisfast** — `dontbesilent2025/dbskill/dbs-slowisfast` · 18,726 تثبيت
...
928. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 18,353 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

929. **modern-javascript-patterns** — `wshobson/agents/modern-javascript-patterns` · 18,259 تثبيت
...
930. **security-requirement-extraction** — `wshobson/agents/security-requirement-extraction` · 18,108 تثبيت
   Transform threat analysis into actionable security requirements.
   `npx skills add https://github.com/wshobson/agents --skill security-requirement-extraction`

931. **feature-sliced-design** — `feature-sliced/skills/feature-sliced-design` · 18,065 تثبيت
   Feature-Sliced Design (FSD) v2.1
   `npx skills add https://github.com/feature-sliced/skills --skill feature-sliced-design`

932. **javascript-testing-patterns** — `wshobson/agents/javascript-testing-patterns` · 18,029 تثبيت
...
933. **aso-audit** — `coreyhaines31/marketingskills/aso-audit` · 17,997 تثبيت
...
934. **pricewin-hotel-deal-finder** — `price-win/pricewin-skills-hub/pricewin-hotel-deal-finder` · 17,955 تثبيت
   PriceWin Hotel Deal Finder
   `npx skills add https://github.com/price-win/pricewin-skills-hub --skill pricewin-hotel-deal-finder`

935. **vue-router-best-practices** — `antfu/skills/vue-router-best-practices` · 17,926 تثبيت
...
936. **playwright-generate-test** — `github/awesome-copilot/playwright-generate-test` · 17,818 تثبيت ⭐
...
937. **opencli-browser** — `jackwener/opencli/opencli-browser` · 17,770 تثبيت
...
938. **create-readme** — `github/awesome-copilot/create-readme` · 17,707 تثبيت ⭐
...
939. **archify** — `tt-a1i/archify/archify` · 17,694 تثبيت
...
940. **rust-async-patterns** — `wshobson/agents/rust-async-patterns` · 17,646 تثبيت
...
941. **agent development** — `anthropics/claude-code/agent-development` · 17,585 تثبيت ⭐
   Agent Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Agent Development&#x27;`

942. **responsive-design** — `wshobson/agents/responsive-design` · 17,479 تثبيت
...
943. **dbs-report** — `dontbesilent2025/dbskill/dbs-report` · 17,421 تثبيت
...
944. **skill development** — `anthropics/claude-code/skill-development` · 17,415 تثبيت ⭐
   Skill Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Skill Development&#x27;`

945. **pinia** — `antfu/skills/pinia` · 17,407 تثبيت
...
946. **dbs-save** — `dontbesilent2025/dbskill/dbs-save` · 17,398 تثبيت
...
947. **dbs-restore** — `dontbesilent2025/dbskill/dbs-restore` · 17,390 تثبيت
...
948. **sql-optimization-patterns** — `wshobson/agents/sql-optimization-patterns` · 17,389 تثبيت
...
949. **ponytail-review** — `dietrichgebert/ponytail/ponytail-review` · 17,343 تثبيت
   Review diffs for unnecessary complexity. One line per finding: location, what
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-review`

950. **planning-with-files-zh** — `othmanadi/planning-with-files/planning-with-files-zh` · 17,220 تثبيت
...
951. **dbs-goal** — `dontbesilent2025/dbskill/dbs-goal` · 17,205 تثبيت
...
952. **fixing-accessibility** — `ibelick/ui-skills/fixing-accessibility` · 17,204 تثبيت
...
953. **the-news** — `sfkislev/the-news/the-news` · 17,165 تثبيت
...
954. **golang-pro** — `jeffallan/claude-skills/golang-pro` · 17,124 تثبيت
