...
**آخر تحديث:** 2026-09-25 · **العدد:** 1,025 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,558,506 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 1,220,484 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 1,042,636 تثبيت
...
4. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 990,715 تثبيت
...
8. **setup-matt-pocock-skills** — `mattpocock/skills/setup-matt-pocock-skills` · 889,392 تثبيت
...
9. **handoff** — `mattpocock/skills/handoff` · 865,726 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 839,066 تثبيت
...
11. **prototype** — `mattpocock/skills/prototype` · 836,817 تثبيت
...
12. **grilling** — `mattpocock/skills/grilling` · 772,396 تثبيت
...
13. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 742,388 تثبيت ⭐
   React and Next.js performance optimization across 70 rules prioritized by impact.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-react-best-practices`

14. **lark-doc** — `open.feishu.cn/lark-doc` · 728,090 تثبيت
...
15. **lark-base** — `open.feishu.cn/lark-base` · 727,809 تثبيت
...
16. **lark-drive** — `open.feishu.cn/lark-drive` · 727,674 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

17. **lark-shared** — `open.feishu.cn/lark-shared` · 727,297 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

18. **lark-im** — `open.feishu.cn/lark-im` · 727,056 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

19. **lark-approval** — `open.feishu.cn/lark-approval` · 726,983 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

20. **lark-calendar** — `open.feishu.cn/lark-calendar` · 726,863 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/`

21. **lark-sheets** — `open.feishu.cn/lark-sheets` · 726,642 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/`

22. **lark-wiki** — `open.feishu.cn/lark-wiki` · 726,420 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

23. **lark-contact** — `open.feishu.cn/lark-contact` · 726,130 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

24. **lark-slides** — `open.feishu.cn/lark-slides` · 725,881 تثبيت
   本技能文档较长，务必使用 Read 工具阅读两次，必须阅读完整全文。
   `npx skills add https://open.feishu.cn/`

25. **lark-task** — `open.feishu.cn/lark-task` · 725,865 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

26. **lark-mail** — `open.feishu.cn/lark-mail` · 725,858 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

27. **lark-minutes** — `open.feishu.cn/lark-minutes` · 725,768 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

28. **lark-event** — `open.feishu.cn/lark-event` · 725,747 تثبيت
...
29. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 725,732 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

30. **lark-attendance** — `open.feishu.cn/lark-attendance` · 725,577 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

31. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 725,523 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

32. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 725,177 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

33. **lark-vc** — `open.feishu.cn/lark-vc` · 725,087 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

34. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 725,049 تثبيت
...
35. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 724,848 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

36. **teach** — `mattpocock/skills/teach` · 708,856 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

37. **lark-okr** — `open.feishu.cn/lark-okr` · 706,342 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

38. **domain-modeling** — `mattpocock/skills/domain-modeling` · 696,806 تثبيت
...
39. **lark-markdown** — `open.feishu.cn/lark-markdown` · 691,859 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`
...
41. **codebase-design** — `mattpocock/skills/codebase-design` · 674,607 تثبيت
...
42. **hyperframes-cli** — `heygen-com/hyperframes/hyperframes-cli` · 669,745 تثبيت
...
43. **lark-vc-agent** — `open.feishu.cn/lark-vc-agent` · 669,645 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

44. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 665,194 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

45. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 661,424 تثبيت
   A discipline for hard bugs. Skip phases only when explicitly justified.
   `npx skills add https://github.com/mattpocock/skills --skill diagnosing-bugs`

46. **video-edit** — `genmedia-labs/skills/video-edit` · 657,746 تثبيت
   Video Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/genmedia-labs/skills --skill video-edit`

47. **ai-music** — `genmedia-labs/skills/ai-music` · 656,704 تثبيت
...
48. **ai-video-generation** — `genmedia-labs/skills/ai-video-generation` · 656,616 تثبيت
...
49. **image-to-video** — `genmedia-labs/skills/image-to-video` · 656,362 تثبيت
   Image-to-Video — Pro Pack on RunComfy
   `npx skills add https://github.com/genmedia-labs/skills --skill image-to-video`

50. **ai-image-generation** — `genmedia-labs/skills/ai-image-generation` · 655,634 تثبيت
...
51. **hyperframes** — `heygen-com/hyperframes/hyperframes` · 638,414 تثبيت
...
52. **lark-apps** — `open.feishu.cn/lark-apps` · 636,437 تثبيت
...
59. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 601,410 تثبيت ⭐
...
60. **azure-ai** — `microsoft/azure-skills/azure-ai` · 601,174 تثبيت ⭐
...
61. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 601,073 تثبيت ⭐
...
62. **azure-validate** — `microsoft/azure-skills/azure-validate` · 600,513 تثبيت ⭐
...
63. **azure-storage** — `microsoft/azure-skills/azure-storage` · 599,976 تثبيت ⭐
...
64. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 599,722 تثبيت ⭐
...
65. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 599,541 تثبيت ⭐
...
66. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 599,458 تثبيت ⭐
...
67. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 599,386 تثبيت ⭐
...
68. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 599,380 تثبيت ⭐
...
69. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 599,126 تثبيت ⭐
...
70. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 599,047 تثبيت ⭐
...
73. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 588,755 تثبيت ⭐
...
74. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 579,365 تثبيت
...
75. **wayfinder** — `mattpocock/skills/wayfinder` · 564,470 تثبيت
...
76. **to-spec** — `mattpocock/skills/to-spec` · 560,564 تثبيت
...
81. **remotion-best-practices** — `remotion-dev/skills/remotion-best-practices` · 541,703 تثبيت ⭐
   Domain-specific knowledge base for building videos with Remotion and React.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices`

82. **hyperframes-core** — `heygen-com/hyperframes/hyperframes-core` · 541,605 تثبيت
   Agent pitfalls (read first):
   `npx skills add https://github.com/heygen-com/hyperframes --skill hyperframes-core`

83. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 537,701 تثبيت
...
84. **caveman** — `juliusbrussee/caveman/caveman` · 537,679 تثبيت
   Ultra-compressed communication mode cutting token usage ~75% while preserving technical accuracy.
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman`

85. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 532,725 تثبيت ⭐
...
86. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 529,920 تثبيت
...
87. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 517,081 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

88. **lark-note** — `open.feishu.cn/lark-note` · 509,494 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

89. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 503,222 تثبيت
...
90. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 492,258 تثبيت ⭐
...
91. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 468,798 تثبيت ⭐
...
92. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 460,905 تثبيت ⭐
...
93. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,949 تثبيت
...
94. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,158 تثبيت
...
95. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 450,074 تثبيت
...
96. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 450,035 تثبيت
...
97. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 443,044 تثبيت ⭐
...
98. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 435,444 تثبيت ⭐
...
99. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 428,297 تثبيت ⭐
...
100. **nano-banana-2** — `prime-skills/runcomfy-agent-skills/nano-banana-2` · 422,580 تثبيت
   Nano Banana 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill nano-banana-2`

101. **image-edit** — `prime-skills/runcomfy-agent-skills/image-edit` · 422,191 تثبيت
   Image Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill image-edit`

102. **nano-banana-edit** — `prime-skills/runcomfy-agent-skills/nano-banana-edit` · 422,096 تثبيت
...
103. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 421,897 تثبيت
...
104. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 421,340 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

105. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 421,168 تثبيت
...
106. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 421,167 تثبيت
...
107. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 421,118 تثبيت
...
108. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 420,944 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

109. **design-mobile-apps** — `designed-by-ai/skills/design-mobile-apps` · 420,164 تثبيت
...
110. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 416,197 تثبيت ⭐
...
111. **wizard** — `mattpocock/skills/wizard` · 410,448 تثبيت
...
112. **azure-cost** — `microsoft/azure-skills/azure-cost` · 402,460 تثبيت ⭐
...
113. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 401,303 تثبيت
...
120. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 381,706 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

121. **writing-shape** — `mattpocock/skills/writing-shape` · 381,616 تثبيت
...
122. **writing-fragments** — `mattpocock/skills/writing-fragments` · 381,419 تثبيت
...
123. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 378,784 تثبيت
...
124. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 377,988 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

125. **caveman-commit** — `juliusbrussee/caveman/caveman-commit` · 377,635 تثبيت
...
126. **brainstorming** — `obra/superpowers/brainstorming` · 375,665 تثبيت
   Structured design dialogue that validates ideas before implementation begins.
   `npx skills add https://github.com/obra/superpowers --skill brainstorming`

127. **redesign-existing-projects** — `leonxlnx/taste-skill/redesign-existing-projects` · 375,625 تثبيت
   Audit and upgrade existing websites to premium design standards without breaking functionality.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill redesign-existing-projects`

128. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 373,780 تثبيت
...
129. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 372,494 تثبيت
...
130. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 370,085 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

131. **to-prd** — `mattpocock/skills/to-prd` · 368,231 تثبيت
...
132. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 365,072 تثبيت
...
133. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 364,747 تثبيت
...
134. **caveman-help** — `juliusbrussee/caveman/caveman-help` · 364,406 تثبيت
...
135. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 363,112 تثبيت
...
136. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 362,626 تثبيت
...
137. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 362,391 تثبيت
...
138. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 362,361 تثبيت
...
139. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 361,957 تثبيت
...
140. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 361,823 تثبيت
...
141. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 361,681 تثبيت
...
142. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 361,599 تثبيت
...
143. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 361,590 تثبيت
...
144. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 361,498 تثبيت
...
145. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 361,181 تثبيت
...
146. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 361,153 تثبيت
...
147. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 361,093 تثبيت
...
148. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 361,086 تثبيت
...
149. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 361,060 تثبيت
...
150. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 360,920 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

151. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 359,724 تثبيت
...
152. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 355,409 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

153. **to-issues** — `mattpocock/skills/to-issues` · 355,160 تثبيت
...
154. **ace-step** — `prime-skills/runcomfy-agent-skills/ace-step` · 353,381 تثبيت
   ACE Step — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ace-step`

155. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 348,966 تثبيت
...
156. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 347,347 تثبيت ⭐
...
157. **general-video** — `heygen-com/hyperframes/general-video` · 346,826 تثبيت
   Before relying on this workflow, run:
   `npx skills add https://github.com/heygen-com/hyperframes --skill general-video`

158. **loop-me** — `mattpocock/skills/loop-me` · 336,879 تثبيت
...
159. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 333,332 تثبيت
...
160. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 332,923 تثبيت
...
161. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 326,328 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

162. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 326,268 تثبيت
...
163. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 324,630 تثبيت
...
164. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 324,202 تثبيت
...
165. **wan-3-0-prime-reference-to-video** — `genmedia-labs/skills/wan-3-0-prime-reference-to-video` · 323,548 تثبيت
...
166. **seedance-2-5-image-to-video** — `genmedia-labs/skills/seedance-2-5-image-to-video` · 323,376 تثبيت
   Seedance 2.5 Image to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-image-to-video`

167. **seedance-2-5-reference-to-video** — `genmedia-labs/skills/seedance-2-5-reference-to-video` · 323,005 تثبيت
   Seedance 2.5 Reference to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-reference-to-video`

168. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 321,455 تثبيت ⭐
...
169. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 321,163 تثبيت
...
170. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 320,636 تثبيت
...
171. **brandkit** — `leonxlnx/taste-skill/brandkit` · 316,182 تثبيت
...
172. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 314,693 تثبيت
...
173. **claude-handoff** — `mattpocock/skills/claude-handoff` · 313,412 تثبيت
...
174. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 312,562 تثبيت ⭐
...
175. **prisma-client-api** — `prisma/skills/prisma-client-api` · 312,194 تثبيت ⭐
...
176. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 311,572 تثبيت
...
177. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,310 تثبيت
...
178. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 311,064 تثبيت
...
179. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,986 تثبيت
...
180. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,682 تثبيت
...
181. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,666 تثبيت
...
182. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,510 تثبيت
...
183. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,493 تثبيت
...
184. **prisma-cli** — `prisma/skills/prisma-cli` · 309,787 تثبيت ⭐
...
185. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 308,948 تثبيت
...
186. **prisma-postgres** — `prisma/skills/prisma-postgres` · 305,312 تثبيت ⭐
...
187. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 305,089 تثبيت
...
188. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 303,247 تثبيت
...
189. **wait-what** — `mattpocock/skills/wait-what` · 301,233 تثبيت
...
190. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 300,885 تثبيت
...
191. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 300,366 تثبيت ⭐
...
192. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 300,101 تثبيت ⭐
...
193. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 299,633 تثبيت ⭐
...
194. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 297,298 تثبيت
...
195. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 296,481 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

196. **prisma-compute** — `prisma/skills/prisma-compute` · 295,374 تثبيت ⭐
...
200. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 280,581 تثبيت ⭐
...
201. **embedded-captions** — `heygen-com/hyperframes/embedded-captions` · 271,849 تثبيت
...
202. **shadcn** — `shadcn/ui/shadcn` · 271,676 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

203. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 271,006 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

204. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 268,614 تثبيت
...
205. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 267,394 تثبيت
...
206. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 260,453 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

207. **writing-plans** — `obra/superpowers/writing-plans` · 258,863 تثبيت
   Comprehensive implementation plans for multi-step tasks, breaking down specs into bite-sized, testable steps.
   `npx skills add https://github.com/obra/superpowers --skill writing-plans`

208. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 256,508 تثبيت
...
209. **orca-cli** — `stablyai/orca/orca-cli` · 255,778 تثبيت
   This discovery stub loads the version-matched guide from the Orca executable used for this session.
   `npx skills add https://github.com/stablyai/orca --skill orca-cli`

210. **using-superpowers** — `obra/superpowers/using-superpowers` · 252,577 تثبيت
   IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST USE IT.
   `npx skills add https://github.com/obra/superpowers --skill using-superpowers`

211. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 245,227 تثبيت
...
212. **just-scrape** — `scrapegraphai/just-scrape/just-scrape` · 244,974 تثبيت
...
213. **orchestration** — `stablyai/orca/orchestration` · 241,509 تثبيت
...
214. **slideshow** — `heygen-com/hyperframes/slideshow` · 239,770 تثبيت
...
215. **diagnose** — `mattpocock/skills/diagnose` · 239,234 تثبيت
...
216. **requesting-code-review** — `obra/superpowers/requesting-code-review` · 237,900 تثبيت
   Dispatch code review subagents with focused context to catch issues before they compound.
   `npx skills add https://github.com/obra/superpowers --skill requesting-code-review`

217. **test-driven-development** — `obra/superpowers/test-driven-development` · 236,386 تثبيت
   Write tests first, watch them fail, then implement minimal code to pass.
   `npx skills add https://github.com/obra/superpowers --skill test-driven-development`

218. **write-a-skill** — `mattpocock/skills/write-a-skill` · 230,648 تثبيت
...
219. **zoom-out** — `mattpocock/skills/zoom-out` · 230,123 تثبيت
...
220. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 228,748 تثبيت
...
221. **pptx** — `anthropics/skills/pptx` · 226,523 تثبيت ⭐
...
222. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 221,417 تثبيت ⭐
...
223. **executing-plans** — `obra/superpowers/executing-plans` · 221,177 تثبيت
...
224. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 221,024 تثبيت
...
225. **design-an-interface** — `mattpocock/skills/design-an-interface` · 216,891 تثبيت
...
226. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 214,076 تثبيت
...
227. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 213,746 تثبيت
...
228. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 210,207 تثبيت
...
229. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,674 تثبيت ⭐
...
230. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 207,598 تثبيت
...
231. **qa** — `mattpocock/skills/qa` · 206,109 تثبيت
...
232. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 204,747 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

233. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 203,516 تثبيت ⭐
...
234. **obsidian-vault** — `mattpocock/skills/obsidian-vault` · 202,506 تثبيت
   /mnt/d/Obsidian Vault/AI Research/
   `npx skills add https://github.com/mattpocock/skills --skill obsidian-vault`

235. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 201,669 تثبيت
...
236. **pdf** — `anthropics/skills/pdf` · 200,976 تثبيت ⭐
   Comprehensive PDF processing with text extraction, merging, splitting, form filling, and OCR capabilities.
   `npx skills add https://github.com/anthropics/skills --skill pdf`

237. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 199,178 تثبيت
...
238. **writing-skills** — `obra/superpowers/writing-skills` · 198,864 تثبيت
...
239. **edit-article** — `mattpocock/skills/edit-article` · 198,820 تثبيت
...
240. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 198,666 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

241. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 195,180 تثبيت
...
242. **docx** — `anthropics/skills/docx` · 192,872 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

243. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 188,059 تثبيت ⭐
...
244. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 180,028 تثبيت
...
245. **review-animations** — `emilkowalski/skills/review-animations` · 178,226 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill review-animations`

246. **wind-mcp-skill** — `wind-alice/alicemarket/wind-mcp-skill` · 176,732 تثبيت
...
250. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 165,286 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill animation-vocabulary`

251. **playwright-cli** — `microsoft/playwright-cli/playwright-cli` · 165,021 تثبيت ⭐
   Browser automation with 40+ commands for navigation, interaction, form filling, and web testing.
   `npx skills add https://github.com/microsoft/playwright-cli --skill playwright-cli`

252. **webapp-testing** — `anthropics/skills/webapp-testing` · 163,477 تثبيت ⭐
   Native Python Playwright scripts for testing local web applications with server lifecycle management.
   `npx skills add https://github.com/anthropics/skills --skill webapp-testing`

253. **apple-design** — `emilkowalski/skills/apple-design` · 162,642 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill apple-design`

254. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 159,757 تثبيت
...
255. **firebase-basics** — `firebase/agent-skills/firebase-basics` · 158,908 تثبيت ⭐
...
256. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 158,615 تثبيت
...
257. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 157,818 تثبيت ⭐
...
258. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 156,978 تثبيت
...
259. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 153,973 تثبيت ⭐
...
260. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 153,396 تثبيت ⭐
...
261. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 152,577 تثبيت ⭐
...
262. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 149,821 تثبيت
...
263. **improve-animations** — `emilkowalski/skills/improve-animations` · 149,802 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill improve-animations`

264. **sentry-cli** — `sentry/dev/sentry-cli` · 148,171 تثبيت
...
265. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 147,676 تثبيت
...
266. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 145,082 تثبيت
...
267. **implement-spec** — `mattpocock/skills/implement-spec` · 143,970 تثبيت
   You have been provided a spec. This spec should have tickets associated with it, describing how to implement the spec.
   `npx skills add https://github.com/mattpocock/skills --skill implement-spec`

268. **neon** — `neondatabase/agent-skills/neon` · 141,606 تثبيت ⭐
...
269. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 137,161 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

270. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 136,358 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

271. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 135,921 تثبيت
...
272. **ui-radar** — `uizze.com/ui-radar` · 135,613 تثبيت
   Don't let your AI agents design blind.
   `npx skills add https://uizze.com/`

273. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 132,355 تثبيت
...
274. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 131,995 تثبيت ⭐
...
275. **retro** — `mattpocock/skills/retro` · 130,793 تثبيت
   The user has asked for a retrospective. You are suggesting improvements to the coding agent's environment to improve future runs.
   `npx skills add https://github.com/mattpocock/skills --skill retro`

276. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 130,560 تثبيت
...
277. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 130,436 تثبيت
...
278. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 129,450 تثبيت
...
279. **lark-meeting** — `open.feishu.cn/lark-meeting` · 124,962 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

280. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 121,786 تثبيت ⭐
...
281. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 120,236 تثبيت
...
282. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 119,942 تثبيت
...
283. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 119,406 تثبيت ⭐
...
284. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 118,438 تثبيت ⭐
...
285. **mcp-builder** — `anthropics/skills/mcp-builder` · 118,301 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

286. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 118,120 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill pick-ui-library`

287. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 117,581 تثبيت ⭐
...
288. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 117,478 تثبيت ⭐
...
289. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 116,370 تثبيت
...
290. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 115,298 تثبيت ⭐
...
291. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 114,506 تثبيت ⭐
...
292. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 113,830 تثبيت ⭐
...
293. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 112,509 تثبيت
...
294. **canvas-design** — `anthropics/skills/canvas-design` · 110,713 تثبيت ⭐
...
295. **archify** — `tt-a1i/archify/archify` · 109,832 تثبيت
...
296. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 108,498 تثبيت
...
297. **browser-act** — `browser-act/skills/browser-act` · 108,107 تثبيت
...
298. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 107,600 تثبيت ⭐
...
299. **prototype** — `emilkowalski/skills/prototype` · 106,991 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill prototype`

300. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 106,783 تثبيت
...
301. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 105,873 تثبيت
...
302. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 105,508 تثبيت
...
303. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 104,968 تثبيت ⭐
...
304. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 103,599 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

305. **firecrawl** — `firecrawl/cli/firecrawl` · 101,816 تثبيت ⭐
...
306. **revops** — `coreyhaines31/marketingskills/revops` · 101,073 تثبيت
...
307. **cloudflare** — `cloudflare/skills/cloudflare` · 99,456 تثبيت ⭐
...
308. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 98,958 تثبيت
...
309. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 98,929 تثبيت
...
310. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 98,718 تثبيت
...
311. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 98,614 تثبيت
...
312. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,337 تثبيت ⭐
...
313. **remotion-render** — `remotion-dev/skills/remotion-render` · 97,068 تثبيت ⭐
   General rendering strategy
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-render`

314. **convex** — `get-convex/agent-skills/convex` · 96,822 تثبيت
...
315. **remotion-create** — `remotion-dev/skills/remotion-create` · 96,747 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

316. **wrangler** — `cloudflare/skills/wrangler` · 96,610 تثبيت ⭐
...
317. **animate** — `emilkowalski/skills/animate` · 96,002 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill animate`

318. **gsap** — `heygen-com/hyperframes/gsap` · 95,804 تثبيت
...
319. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 95,782 تثبيت ⭐
...
320. **browser-use** — `browser-use/browser-use/browser-use` · 95,586 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

321. **review** — `mattpocock/skills/review` · 94,602 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

322. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,541 تثبيت
...
323. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 94,535 تثبيت ⭐
...
324. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,106 تثبيت
...
325. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,105 تثبيت
...
326. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 92,940 تثبيت
...
327. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 91,505 تثبيت ⭐
...
328. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 89,602 تثبيت ⭐
...
329. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 89,301 تثبيت ⭐
...
330. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 88,592 تثبيت ⭐
...
334. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 87,218 تثبيت
...
335. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 87,215 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

336. **theme-factory** — `anthropics/skills/theme-factory` · 87,050 تثبيت ⭐
...
337. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 86,273 تثبيت ⭐
...
338. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 86,178 تثبيت
...
339. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 85,149 تثبيت ⭐
...
340. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,118 تثبيت
...
341. **critique** — `pbakaus/impeccable/critique` · 84,752 تثبيت
...
342. **audit** — `pbakaus/impeccable/audit` · 83,968 تثبيت
...
343. **animate** — `pbakaus/impeccable/animate` · 83,820 تثبيت
...
344. **adapt** — `pbakaus/impeccable/adapt` · 83,812 تثبيت
...
345. **clarify** — `pbakaus/impeccable/clarify` · 83,303 تثبيت
...
346. **optimize** — `pbakaus/impeccable/optimize` · 83,158 تثبيت
...
347. **colorize** — `pbakaus/impeccable/colorize` · 82,963 تثبيت
...
348. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 82,683 تثبيت ⭐
...
349. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 82,533 تثبيت ⭐
...
350. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 82,347 تثبيت ⭐
...
351. **bolder** — `pbakaus/impeccable/bolder` · 82,084 تثبيت
...
352. **durable-objects** — `cloudflare/skills/durable-objects` · 81,928 تثبيت ⭐
...
353. **delight** — `pbakaus/impeccable/delight` · 81,914 تثبيت
...
354. **distill** — `pbakaus/impeccable/distill` · 81,523 تثبيت
...
355. **web-perf** — `cloudflare/skills/web-perf` · 81,431 تثبيت ⭐
...
356. **quieter** — `pbakaus/impeccable/quieter` · 80,689 تثبيت
...
357. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 80,684 تثبيت ⭐
...
358. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 79,947 تثبيت ⭐
...
359. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 79,934 تثبيت ⭐
...
360. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 79,627 تثبيت
...
361. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 79,480 تثبيت ⭐
...
362. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 79,158 تثبيت ⭐
...
363. **review-loop** — `2dmurali/review-loop-skill/review-loop` · 79,028 تثبيت
...
364. **agents-sdk** — `cloudflare/skills/agents-sdk` · 78,965 تثبيت ⭐
...
365. **notion-api** — `intellectronica/agent-skills/notion-api` · 78,809 تثبيت
...
366. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 78,737 تثبيت
...
367. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 78,058 تثبيت ⭐
...
368. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,869 تثبيت
...
369. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 77,265 تثبيت ⭐
...
370. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 76,331 تثبيت
...
371. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 75,968 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill ask-sonner`

372. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 75,836 تثبيت
...
373. **turborepo** — `vercel/turborepo/turborepo` · 75,724 تثبيت ⭐
...
374. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 75,578 تثبيت ⭐
...
375. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 75,136 تثبيت
...
376. **web-search** — `skills-101/superpowers/web-search` · 74,752 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill web-search`

377. **wonda-cli** — `degausai/wonda/wonda-cli` · 74,605 تثبيت
...
378. **css-animations** — `heygen-com/hyperframes/css-animations` · 74,582 تثبيت
...
379. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 74,495 تثبيت ⭐
...
381. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 74,407 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

382. **python-executor** — `skills-101/superpowers/python-executor` · 74,371 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

383. **internal-comms** — `anthropics/skills/internal-comms` · 74,188 تثبيت ⭐
...
384. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 73,074 تثبيت
...
385. **image** — `coreyhaines31/marketingskills/image` · 73,028 تثبيت
...
386. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,741 تثبيت
...
387. **video** — `coreyhaines31/marketingskills/video` · 72,517 تثبيت
...
388. **animejs** — `heygen-com/hyperframes/animejs` · 72,188 تثبيت
...
389. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 71,918 تثبيت ⭐
...
390. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 71,907 تثبيت ⭐
...
391. **cro** — `coreyhaines31/marketingskills/cro` · 71,902 تثبيت
   Conversion Rate Optimization (CRO)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill cro`

392. **audit-website** — `squirrelscan/skills/audit-website` · 71,807 تثبيت
...
393. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 71,795 تثبيت
...
394. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 71,525 تثبيت ⭐
...
395. **three** — `heygen-com/hyperframes/three` · 71,466 تثبيت
...
396. **lottie** — `heygen-com/hyperframes/lottie` · 71,193 تثبيت
...
397. **waapi** — `heygen-com/hyperframes/waapi` · 70,818 تثبيت
...
398. **gws-drive** — `googleworkspace/cli/gws-drive` · 70,371 تثبيت ⭐
...
399. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 70,316 تثبيت
...
400. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 70,159 تثبيت
...
401. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 69,928 تثبيت ⭐
...
402. **defuddle** — `kepano/obsidian-skills/defuddle` · 69,824 تثبيت
...
403. **caveman-optimize** — `juliusbrussee/caveman/caveman-optimize` · 69,629 تثبيت
   Evaluate an optimization observation
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-optimize`

404. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 69,589 تثبيت
...
405. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 69,258 تثبيت
...
406. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 69,248 تثبيت
...
407. **gpt-image-2** — `prime-skills/runcomfy-agent-skills/gpt-image-2` · 69,180 تثبيت
   GPT Image 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill gpt-image-2`

408. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 69,065 تثبيت
...
409. **typesafe-ai** — `typesafe-ai/skills/typesafe-ai` · 69,064 تثبيت
...
410. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 68,911 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

411. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 68,872 تثبيت
...
412. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 68,709 تثبيت
...
413. **lean-build** — `juliusbrussee/caveman/lean-build` · 68,630 تثبيت
...
414. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 68,614 تثبيت
...
415. **caveman-manage** — `juliusbrussee/caveman/caveman-manage` · 68,522 تثبيت
   Manage eval-gated experiments
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-manage`

416. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 68,323 تثبيت
...
417. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 68,314 تثبيت
...
418. **migration** — `juliusbrussee/caveman/migration` · 68,258 تثبيت
...
419. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 67,988 تثبيت ⭐
   Choose a target API version
   `npx skills add https://github.com/stripe/ai --skill upgrade-stripe`

420. **analytics** — `coreyhaines31/marketingskills/analytics` · 67,866 تثبيت
...
421. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 67,846 تثبيت
...
422. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,806 تثبيت
...
423. **social** — `coreyhaines31/marketingskills/social` · 67,357 تثبيت
...
424. **claude-api** — `anthropics/skills/claude-api` · 66,912 تثبيت ⭐
...
425. **template-skill** — `anthropics/skills/template-skill` · 66,593 تثبيت ⭐
   Replace with description of the skill and when Claude should use it.
   `npx skills add https://github.com/anthropics/skills --skill template-skill`

426. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 66,535 تثبيت
...
427. **typeset** — `pbakaus/impeccable/typeset` · 66,311 تثبيت
...
428. **ads** — `coreyhaines31/marketingskills/ads` · 66,253 تثبيت
...
429. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 65,909 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

430. **tailwind-design-system** — `wshobson/agents/tailwind-design-system` · 65,571 تثبيت
   CSS-first design system framework for Tailwind v4 with tokens, components, and responsive patterns.
   `npx skills add https://github.com/wshobson/agents --skill tailwind-design-system`

431. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 65,544 تثبيت ⭐
...
432. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 65,429 تثبيت
...
433. **higgsfield-youtube-thumbnail** — `higgsfield-ai/skills/higgsfield-youtube-thumbnail` · 65,398 تثبيت
   Higgsfield YouTube Thumbnail
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-youtube-thumbnail`

434. **stripe-projects** — `stripe/ai/stripe-projects` · 65,299 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

435. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 64,896 تثبيت
...
436. **pricing** — `coreyhaines31/marketingskills/pricing` · 64,882 تثبيت
...
437. **ponytail** — `dietrichgebert/ponytail/ponytail` · 64,881 تثبيت
   You are a lazy senior developer. Lazy means efficient, not careless. You have
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail`

438. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 64,736 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

439. **batch-grill-me** — `mattpocock/skills/batch-grill-me` · 64,677 تثبيت
   Interview the user relentlessly until you reach a shared understanding. Map this as a design tree: every decision branches into the decisions that han
   `npx skills add https://github.com/mattpocock/skills --skill batch-grill-me`

440. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 64,667 تثبيت
...
441. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 64,637 تثبيت
...
442. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 64,627 تثبيت
...
443. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 64,618 تثبيت
...
444. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 64,603 تثبيت
...
445. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 64,587 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

446. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 64,531 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

447. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 64,421 تثبيت ⭐
...
448. **overdrive** — `pbakaus/impeccable/overdrive` · 64,382 تثبيت
   ──────────── ⚡ OVERDRIVE ─────────────
   `npx skills add https://github.com/pbakaus/impeccable --skill overdrive`

449. **competitors** — `coreyhaines31/marketingskills/competitors` · 64,314 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

450. **animate-expo** — `emilkowalski/skills/animate-expo` · 64,044 تثبيت
   Building Animations in Expo
   `npx skills add https://github.com/emilkowalski/skills --skill animate-expo`

451. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 63,399 تثبيت ⭐
...
452. **schema** — `coreyhaines31/marketingskills/schema` · 63,369 تثبيت
...
453. **emails** — `coreyhaines31/marketingskills/emails` · 63,243 تثبيت
...
454. **launch** — `coreyhaines31/marketingskills/launch` · 63,185 تثبيت
...
455. **ab-testing** — `coreyhaines31/marketingskills/ab-testing` · 62,648 تثبيت
   You are an expert in experimentation and A/B testing. Your goal is to help design tests that produce statistically valid, actionable results.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill ab-testing`

456. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,595 تثبيت
   Cross-Border E-Commerce ✈️
   `npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill cross-border-ecommerce`

457. **developing-genkit-js** — `firebase/agent-skills/developing-genkit-js` · 62,592 تثبيت ⭐
...
458. **design-md** — `google-labs-code/stitch-skills/design-md` · 62,534 تثبيت ⭐
...
459. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 62,401 تثبيت ⭐
...
460. **developing-genkit-dart** — `firebase/agent-skills/developing-genkit-dart` · 62,276 تثبيت ⭐
...
461. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,953 تثبيت
...
462. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,952 تثبيت
...
463. **gws-shared** — `googleworkspace/cli/gws-shared` · 61,900 تثبيت ⭐
...
464. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 61,572 تثبيت
...
465. **expo-dev-client** — `expo/skills/expo-dev-client` · 61,541 تثبيت ⭐
...
466. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 61,507 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

467. **aso** — `coreyhaines31/marketingskills/aso` · 61,324 تثبيت
...
468. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 61,077 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill motion-doctrine`

469. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 60,995 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill captions-overlay`

470. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 60,966 تثبيت
...
471. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 60,788 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

472. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 60,637 تثبيت ⭐
...
473. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 60,568 تثبيت ⭐
...
474. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 60,503 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill seam-craft`

475. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 60,453 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill changelog-video`

476. **oversized-cursor** — `heygen-com/hyperframes/oversized-cursor` · 60,400 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill oversized-cursor`

477. **agently-mail** — `agent.qq.com/agently-mail` · 60,388 تثبيت
   通过 agently-cli 命令行工具操作邮件，通过管理端 (agent.qq.com) 进行后台管理。
   `npx skills add https://agent.qq.com/`

478. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 60,271 تثبيت ⭐
...
479. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 60,225 تثبيت ⭐
...
480. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 60,146 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

481. **referrals** — `coreyhaines31/marketingskills/referrals` · 59,479 تثبيت
   Referral & Affiliate Programs
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill referrals`

482. **signup** — `coreyhaines31/marketingskills/signup` · 59,415 تثبيت
...
483. **gsap-core** — `greensock/gsap-skills/gsap-core` · 59,293 تثبيت
...
484. **building-native-ui** — `expo/skills/building-native-ui` · 59,260 تثبيت ⭐
...
485. **popups** — `coreyhaines31/marketingskills/popups` · 58,787 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

486. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 58,743 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

487. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 58,603 تثبيت
...
488. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,556 تثبيت
...
489. **ai-sdk** — `vercel/ai/ai-sdk` · 58,514 تثبيت ⭐
...
490. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,201 تثبيت
...
491. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,187 تثبيت
...
492. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 58,110 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

493. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,693 تثبيت
...
494. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 57,686 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

495. **mastra** — `mastra-ai/skills/mastra` · 57,284 تثبيت ⭐
...
496. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 57,283 تثبيت ⭐
...
497. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 57,081 تثبيت
...
498. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,837 تثبيت
...
499. **hallmark** — `nutlope/hallmark/hallmark` · 56,773 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

500. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,767 تثبيت
...
501. **hyperframes-studio** — `heygen-com/hyperframes/hyperframes-studio` · 56,697 تثبيت
   HyperFrames Studio conventions
   `npx skills add https://github.com/heygen-com/hyperframes --skill hyperframes-studio`

502. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 56,620 تثبيت ⭐
...
503. **write-swift** — `emilkowalski/skills/write-swift` · 56,494 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/emilkowalski/skills --skill write-swift`

504. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,458 تثبيت
...
505. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 56,414 تثبيت
...
506. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,205 تثبيت
...
507. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 55,972 تثبيت
...
508. **normalize** — `pbakaus/impeccable/normalize` · 55,898 تثبيت
...
509. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,814 تثبيت
...
510. **opentui** — `msmps/opentui-skill/opentui` · 55,581 تثبيت
...
511. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,361 تثبيت
...
512. **nia** — `nozomio-labs/nia-skill/nia` · 55,328 تثبيت
...
513. **herdr** — `herdrdev/herdr/herdr` · 55,207 تثبيت
...
514. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 54,994 تثبيت
...
515. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,858 تثبيت
...
516. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 54,851 تثبيت ⭐
...
517. **extract** — `pbakaus/impeccable/extract` · 54,814 تثبيت
...
518. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 54,768 تثبيت
...
519. **onboard** — `pbakaus/impeccable/onboard` · 54,652 تثبيت
...
520. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 54,649 تثبيت ⭐
...
521. **harden** — `pbakaus/impeccable/harden` · 54,578 تثبيت
...
522. **momentic-test** — `momentic-ai/skills/momentic-test` · 54,562 تثبيت
...
523. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 54,540 تثبيت
...
524. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 54,450 تثبيت ⭐
...
525. **gws-docs** — `googleworkspace/cli/gws-docs` · 54,350 تثبيت ⭐
...
526. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,330 تثبيت
...
527. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 53,768 تثبيت
...
528. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 53,484 تثبيت
...
529. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,243 تثبيت
...
530. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 53,004 تثبيت
...
531. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,946 تثبيت
...
532. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,765 تثبيت
...
533. **gsap-react** — `greensock/gsap-skills/gsap-react` · 52,577 تثبيت
...
534. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,502 تثبيت
...
535. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 52,485 تثبيت
...
536. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 52,380 تثبيت
...
537. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 52,356 تثبيت
...
538. **sms** — `coreyhaines31/marketingskills/sms` · 52,328 تثبيت
...
539. **typegpu** — `heygen-com/hyperframes/typegpu` · 52,214 تثبيت
...
540. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,094 تثبيت
...
541. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 51,896 تثبيت ⭐
...
542. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,761 تثبيت
...
543. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,536 تثبيت
...
544. **react:components** — `google-labs-code/stitch-skills/react:components` · 50,714 تثبيت ⭐
   Stitch to React Components
   `npx skills add https://github.com/google-labs-code/stitch-skills --skill react:components`

545. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 50,340 تثبيت ⭐
...
546. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 50,299 تثبيت
...
547. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 50,161 تثبيت
...
548. **marketing-mindset** — `axelfreeman/marketing-mindset/marketing-mindset` · 50,119 تثبيت
...
549. **developing-genkit-go** — `firebase/agent-skills/developing-genkit-go` · 49,547 تثبيت ⭐
...
550. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 49,033 تثبيت
...
551. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 48,965 تثبيت
...
552. **clerk-setup** — `clerk/skills/clerk-setup` · 48,833 تثبيت ⭐
...
553. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 47,545 تثبيت ⭐
...
554. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 47,313 تثبيت
...
555. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,299 تثبيت ⭐
...
556. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 47,235 تثبيت ⭐
...
557. **seo** — `addyosmani/web-quality-skills/seo` · 47,218 تثبيت
...
558. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 47,179 تثبيت
...
559. **insforge** — `insforge/insforge-skills/insforge` · 47,078 تثبيت
   InsForge App Integration Skill
   `npx skills add https://github.com/insforge/insforge-skills --skill insforge`

560. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 46,969 تثبيت
...
561. **compress** — `juliusbrussee/caveman/compress` · 46,876 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

562. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 46,826 تثبيت ⭐
...
563. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 46,671 تثبيت ⭐
...
564. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 46,245 تثبيت ⭐
...
565. **clerk-backend-api** — `clerk/skills/clerk-backend-api` · 46,238 تثبيت ⭐
   CRITICAL: Mandatory checks before EVERY write request
   `npx skills add https://github.com/clerk/skills --skill clerk-backend-api`

566. **byted-web-search** — `skills.volces.com/byted-web-search` · 46,176 تثبيت
...
567. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 46,076 تثبيت
...
568. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 45,941 تثبيت ⭐
...
569. **git-commit** — `github/awesome-copilot/git-commit` · 45,740 تثبيت ⭐
...
570. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 45,331 تثبيت ⭐
...
571. **weread-skills** — `tencent/wechatreading/weread-skills` · 45,125 تثبيت
   通过 Agent API Gateway 调用微信读书接口，提供搜索、书架、笔记、书评等能力。
   `npx skills add https://github.com/tencent/wechatreading --skill weread-skills`

572. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 45,051 تثبيت ⭐
...
573. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,957 تثبيت
...
574. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 44,942 تثبيت
...
575. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 44,559 تثبيت
...
576. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 44,539 تثبيت
...
577. **gws-gmail-triage** — `googleworkspace/cli/gws-gmail-triage` · 43,458 تثبيت ⭐
...
578. **clerk-orgs** — `clerk/skills/clerk-orgs` · 43,450 تثبيت ⭐
...
579. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 43,335 تثبيت ⭐
...
580. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 43,220 تثبيت
...
581. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 43,202 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

582. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 43,186 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

583. **upgrading-expo** — `expo/skills/upgrading-expo` · 43,167 تثبيت ⭐
...
584. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 43,121 تثبيت
...
585. **offers** — `coreyhaines31/marketingskills/offers` · 43,108 تثبيت
...
586. **last30days** — `mvanhorn/last30days-skill/last30days` · 42,558 تثبيت
...
587. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 42,481 تثبيت
...
588. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 42,430 تثبيت
...
589. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 42,428 تثبيت
...
590. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 41,770 تثبيت
...
591. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 41,719 تثبيت
...
592. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 41,717 تثبيت
...
593. **sandbox-stable** — `cloudflare/skills/sandbox-stable` · 41,704 تثبيت ⭐
   Sandbox SDK — stable package
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-stable`

594. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 41,516 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

595. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 41,497 تثبيت ⭐
...
596. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 41,337 تثبيت
...
597. **sandbox-next** — `cloudflare/skills/sandbox-next` · 41,303 تثبيت ⭐
   Sandbox SDK — @next (1.0 preview)
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-next`

598. **sandbox-migrate-to-next** — `cloudflare/skills/sandbox-migrate-to-next` · 41,235 تثبيت ⭐
...
599. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 41,139 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

600. **expo-deployment** — `expo/skills/expo-deployment` · 41,048 تثبيت ⭐
...
601. **clerk-testing** — `clerk/skills/clerk-testing` · 40,879 تثبيت ⭐
   https://clerk.com/docs/guides/development/testing/overview
   `npx skills add https://github.com/clerk/skills --skill clerk-testing`

602. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 40,839 تثبيت
...
603. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 40,771 تثبيت
...
604. **golang-security** — `samber/cc-skills-golang/golang-security` · 40,734 تثبيت
...
605. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 40,619 تثبيت
...
606. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 40,352 تثبيت
...
607. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 40,337 تثبيت ⭐
...
608. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 40,288 تثبيت
...
609. **arrange** — `pbakaus/impeccable/arrange` · 40,243 تثبيت
...
610. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 40,228 تثبيت
...
611. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 40,125 تثبيت
...
612. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 40,022 تثبيت ⭐
...
613. **remotion** — `google-labs-code/stitch-skills/remotion` · 39,916 تثبيت ⭐
...
614. **golang-context** — `samber/cc-skills-golang/golang-context` · 39,711 تثبيت
...
615. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 39,653 تثبيت
...
616. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 39,625 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

617. **wind-find-finance-skill** — `wind-alice/alicemarket/wind-find-finance-skill` · 39,610 تثبيت
...
618. **golang-database** — `samber/cc-skills-golang/golang-database` · 39,592 تثبيت
...
619. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 39,439 تثبيت
...
620. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 39,404 تثبيت
...
621. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 39,379 تثبيت
...
622. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 39,319 تثبيت
...
623. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 39,293 تثبيت
...
624. **gws-slides** — `googleworkspace/cli/gws-slides` · 39,278 تثبيت ⭐
...
625. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 39,183 تثبيت
...
626. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 38,990 تثبيت
...
627. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 38,961 تثبيت
...
628. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 38,911 تثبيت
...
629. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 38,841 تثبيت
...
630. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 38,809 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

631. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 38,769 تثبيت
...
632. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 38,738 تثبيت ⭐
...
633. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 38,668 تثبيت
...
634. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 38,656 تثبيت
...
635. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 38,638 تثبيت
...
636. **angular-developer** — `angular/skills/angular-developer` · 38,610 تثبيت
...
637. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 38,575 تثبيت
...
638. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 38,566 تثبيت
...
639. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 38,550 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

640. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 38,523 تثبيت
...
641. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 38,451 تثبيت
...
642. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 38,406 تثبيت
...
643. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 38,220 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

644. **gws-forms** — `googleworkspace/cli/gws-forms` · 38,124 تثبيت ⭐
...
645. **expo-module** — `expo/skills/expo-module` · 38,041 تثبيت ⭐
...
646. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 37,993 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

647. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,991 تثبيت
...
648. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,958 تثبيت ⭐
...
649. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 37,911 تثبيت
...
650. **karpathy-guidelines** — `multica-ai/andrej-karpathy-skills/karpathy-guidelines` · 37,895 تثبيت
   Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   `npx skills add https://github.com/multica-ai/andrej-karpathy-skills --skill karpathy-guidelines`

651. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 37,841 تثبيت
...
652. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 37,790 تثبيت
...
653. **gws-meet** — `googleworkspace/cli/gws-meet` · 37,715 تثبيت ⭐
...
654. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 37,713 تثبيت
...
655. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 37,672 تثبيت
...
656. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 37,644 تثبيت
...
657. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 37,599 تثبيت
...
658. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 37,578 تثبيت
...
659. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 37,569 تثبيت
...
660. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 37,546 تثبيت
...
661. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 37,544 تثبيت
...
662. **vitest** — `antfu/skills/vitest` · 37,483 تثبيت
...
663. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 37,472 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

664. **product-photography** — `skills-101/superpowers/product-photography` · 37,454 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

665. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 37,401 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

666. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 37,392 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

667. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 37,388 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

668. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 37,380 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

669. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 37,378 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

670. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 37,377 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

671. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 37,376 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

672. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 37,275 تثبيت ⭐
...
673. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 37,273 تثبيت
...
674. **firebase-firestore-standard** — `firebase/agent-skills/firebase-firestore-standard` · 37,122 تثبيت ⭐
...
675. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 36,928 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

676. **performance** — `addyosmani/web-quality-skills/performance` · 36,743 تثبيت
...
677. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 36,465 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

678. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 36,413 تثبيت
...
679. **vite** — `antfu/skills/vite` · 36,366 تثبيت
...
680. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 36,338 تثبيت
...
681. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 36,328 تثبيت
...
682. **interview-me** — `addyosmani/agent-skills/interview-me` · 36,191 تثبيت
...
683. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 36,174 تثبيت
...
684. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 36,155 تثبيت
...
685. **firebase-firestore-enterprise-native-mode** — `firebase/agent-skills/firebase-firestore-enterprise-native-mode` · 36,059 تثبيت ⭐
...
686. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 36,023 تثبيت
...
687. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 35,975 تثبيت
...
688. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 35,745 تثبيت
...
689. **replicas-agent** — `replicas-group/skill/replicas-agent` · 35,691 تثبيت
...
690. **value** — `hugmouse/skills/value` · 35,530 تثبيت
   This skill does absolutely nothing.
   `npx skills add https://github.com/hugmouse/skills --skill value`

691. **gws-keep** — `googleworkspace/cli/gws-keep` · 35,518 تثبيت ⭐
...
692. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 35,427 تثبيت
...
693. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 35,217 تثبيت ⭐
...
694. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 34,683 تثبيت ⭐
...
695. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 34,637 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

696. **firebase-ai-logic** — `firebase/agent-skills/firebase-ai-logic` · 34,584 تثبيت ⭐
...
697. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 34,418 تثبيت
...
698. **vue** — `antfu/skills/vue` · 34,283 تثبيت
...
699. **improve** — `shadcn/improve/improve` · 34,223 تثبيت
...
700. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 34,000 تثبيت
...
701. **self-improving-agent** — `zhaono1/agent-playbook/self-improving-agent` · 33,987 تثبيت
...
702. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 33,860 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

703. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 33,651 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

704. **sandbox-sdk** — `cloudflare/skills/sandbox-sdk` · 33,649 تثبيت ⭐
   Build secure, isolated code execution environments on Cloudflare Workers.
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-sdk`

705. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,645 تثبيت ⭐
...
706. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 33,612 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

707. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 33,466 تثبيت ⭐
...
708. **tavily-search** — `tavily-ai/skills/tavily-search` · 33,462 تثبيت ⭐
...
709. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 33,372 تثبيت
...
710. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 33,187 تثبيت ⭐
...
711. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 33,110 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

712. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 33,105 تثبيت ⭐
...
713. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,959 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

714. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 32,915 تثبيت
...
715. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,883 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

716. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 32,877 تثبيت ⭐
...
717. **swiftui-expert-skill** — `avdlee/swiftui-agent-skill/swiftui-expert-skill` · 32,867 تثبيت
   Expert SwiftUI code review, refactoring, and implementation guidance with iOS 26+ and macOS support.
   `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill swiftui-expert-skill`

718. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 32,782 تثبيت
...
719. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,584 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

720. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 32,540 تثبيت ⭐
...
721. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,518 تثبيت
...
722. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 32,282 تثبيت ⭐
...
723. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 32,173 تثبيت ⭐
...
724. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 32,155 تثبيت ⭐
...
725. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 32,131 تثبيت ⭐
...
726. **baoyu-infographic** — `jimliu/baoyu-skills/baoyu-infographic` · 32,105 تثبيت
...
727. **ckm:brand** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:brand` · 32,085 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

728. **ckm:banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:banner-design` · 32,057 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

729. **ckm:slides** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:slides` · 31,967 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

730. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 31,961 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

731. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,915 تثبيت ⭐
...
732. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 31,903 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

733. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 31,771 تثبيت
...
734. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 31,744 تثبيت ⭐
...
735. **design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/design-system` · 31,610 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

736. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,592 تثبيت ⭐
...
737. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 31,585 تثبيت
...
738. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 31,542 تثبيت ⭐
...
739. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 31,526 تثبيت ⭐
...
740. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 31,479 تثبيت ⭐
...
741. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 31,442 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

742. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 31,431 تثبيت ⭐
...
743. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 31,413 تثبيت ⭐
...
744. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 31,389 تثبيت ⭐
...
745. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 31,388 تثبيت ⭐
...
746. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 31,375 تثبيت
...
747. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 31,362 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

748. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 31,341 تثبيت ⭐
...
749. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 31,314 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

750. **eas-update-insights** — `expo/skills/eas-update-insights` · 31,221 تثبيت ⭐
...
751. **gws-chat** — `googleworkspace/cli/gws-chat` · 31,196 تثبيت ⭐
...
752. **use-dom** — `expo/skills/use-dom` · 31,014 تثبيت ⭐
...
753. **gws-people** — `googleworkspace/cli/gws-people` · 30,994 تثبيت ⭐
...
754. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 30,987 تثبيت ⭐
...
755. **shape** — `pbakaus/impeccable/shape` · 30,869 تثبيت
...
756. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 30,853 تثبيت
...
757. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 30,688 تثبيت
...
758. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 30,679 تثبيت ⭐
...
759. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 30,646 تثبيت ⭐
...
760. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 30,547 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

761. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 30,537 تثبيت
...
762. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 30,522 تثبيت
...
763. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 30,310 تثبيت ⭐
...
764. **gws-chat-send** — `googleworkspace/cli/gws-chat-send` · 30,052 تثبيت ⭐
   Send plain-text messages to Google Chat spaces.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-chat-send`

765. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 30,038 تثبيت ⭐
...
766. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 29,958 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

767. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,922 تثبيت ⭐
...
768. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 29,885 تثبيت
...
769. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,874 تثبيت
...
770. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 29,856 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

771. **recipe-draft-email-from-doc** — `googleworkspace/cli/recipe-draft-email-from-doc` · 29,847 تثبيت ⭐
...
772. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 29,837 تثبيت ⭐
...
773. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 29,789 تثبيت ⭐
...
774. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 29,774 تثبيت ⭐
...
775. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 29,734 تثبيت ⭐
...
776. **gws-events** — `googleworkspace/cli/gws-events` · 29,644 تثبيت ⭐
...
777. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 29,567 تثبيت ⭐
...
778. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 29,419 تثبيت ⭐
...
779. **baoyu-comic** — `jimliu/baoyu-skills/baoyu-comic` · 29,350 تثبيت
...
780. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 29,333 تثبيت ⭐
...
781. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 29,311 تثبيت ⭐
...
782. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 29,251 تثبيت ⭐
...
783. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 29,244 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

784. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 29,193 تثبيت ⭐
...
785. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 29,135 تثبيت ⭐
...
786. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 29,058 تثبيت ⭐
...
787. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 29,033 تثبيت ⭐
...
788. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 29,023 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

789. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 29,006 تثبيت ⭐
...
790. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 29,004 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

791. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 28,992 تثبيت ⭐
...
792. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 28,987 تثبيت ⭐
...
793. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 28,985 تثبيت ⭐
...
794. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 28,956 تثبيت ⭐
...
795. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 28,910 تثبيت ⭐
...
796. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 28,886 تثبيت ⭐
...
797. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 28,857 تثبيت ⭐
...
798. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 28,852 تثبيت
...
799. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 28,791 تثبيت ⭐
...
800. **api-design-principles** — `wshobson/agents/api-design-principles` · 28,783 تثبيت
...
801. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 28,740 تثبيت
   niche-signal-discovery (renamed to deepline-scoring)
   `npx skills add https://code.deepline.com/`

802. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 28,685 تثبيت ⭐
...
803. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 28,678 تثبيت ⭐
...
804. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 28,658 تثبيت ⭐
...
805. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 28,645 تثبيت ⭐
...
806. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 28,614 تثبيت ⭐
...
807. **build-tam** — `code.deepline.com/build-tam` · 28,612 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

808. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 28,606 تثبيت ⭐
...
809. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 28,605 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

810. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 28,596 تثبيت ⭐
...
811. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 28,528 تثبيت
...
812. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 28,523 تثبيت ⭐
...
813. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 28,521 تثبيت
...
814. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 28,513 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

815. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 28,505 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

816. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 28,503 تثبيت ⭐
...
817. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 28,496 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

818. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 28,496 تثبيت ⭐
...
819. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 28,477 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

820. **pr** — `mattpocock/skills/pr` · 28,453 تثبيت
   Use this template for writing the PR body:
   `npx skills add https://github.com/mattpocock/skills --skill pr`

821. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 28,449 تثبيت ⭐
...
822. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 28,427 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

823. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 28,405 تثبيت ⭐
...
824. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 28,387 تثبيت ⭐
...
825. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 28,381 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

826. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 28,361 تثبيت ⭐
...
827. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 28,332 تثبيت ⭐
...
828. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 28,298 تثبيت
...
829. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 28,292 تثبيت ⭐
...
830. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 28,280 تثبيت ⭐
...
831. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 28,279 تثبيت ⭐
...
832. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 28,275 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

833. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 28,272 تثبيت ⭐
...
834. **clerk-cli** — `clerk/skills/clerk-cli` · 28,271 تثبيت ⭐
...
835. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 28,262 تثبيت ⭐
...
836. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 28,255 تثبيت ⭐
...
837. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 28,241 تثبيت ⭐
...
838. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 28,206 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

839. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 28,200 تثبيت ⭐
...
840. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 28,174 تثبيت ⭐
...
841. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 28,164 تثبيت ⭐
...
842. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 28,125 تثبيت ⭐
...
843. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 28,065 تثبيت ⭐
...
844. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 28,061 تثبيت ⭐
...
845. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 28,033 تثبيت
...
846. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 27,985 تثبيت ⭐
...
847. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 27,907 تثبيت ⭐
...
848. **clerk** — `clerk/skills/clerk` · 27,895 تثبيت ⭐
...
849. **azure-postgres** — `microsoft/azure-skills/azure-postgres` · 27,855 تثبيت ⭐
   No SKILL.md available for this skill.
   `npx skills add https://github.com/microsoft/azure-skills --skill azure-postgres`

850. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 27,855 تثبيت ⭐
...
851. **ponytail-review** — `dietrichgebert/ponytail/ponytail-review` · 27,841 تثبيت
   Review diffs for unnecessary complexity. One line per finding: location, what
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-review`

852. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 27,815 تثبيت ⭐
...
853. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 27,793 تثبيت
...
854. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 27,775 تثبيت ⭐
...
855. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 27,760 تثبيت ⭐
...
856. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 27,686 تثبيت
...
857. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 27,669 تثبيت ⭐
...
858. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 27,657 تثبيت
...
859. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 27,583 تثبيت
...
860. **interface-design** — `dammyjay93/interface-design/interface-design` · 27,514 تثبيت
...
861. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 27,429 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

862. **stripe-directory** — `docs.stripe.com/stripe-directory` · 27,423 تثبيت
...
863. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 27,260 تثبيت ⭐
...
864. **layout** — `pbakaus/impeccable/layout` · 27,056 تثبيت
...
865. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 27,022 تثبيت
...
866. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 26,925 تثبيت ⭐
...
867. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 26,886 تثبيت ⭐
...
868. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 26,716 تثبيت ⭐
...
869. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,708 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

870. **better-ui** — `jakubkrehel/skills/better-ui` · 26,662 تثبيت
...
871. **golang-linter** — `samber/cc-skills-golang/golang-linter` · 26,543 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/samber/cc-skills-golang --skill golang-linter`

872. **review-pr** — `warpdotdev/common-skills/review-pr` · 26,508 تثبيت
...
873. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 26,365 تثبيت
...
874. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 26,357 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

875. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 26,295 تثبيت
...
876. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 26,222 تثبيت
...
877. **dbs** — `dontbesilent2025/dbskill/dbs` · 26,204 تثبيت
   你是 dontbesilent 商业工具箱的公开入口。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs`

878. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 26,182 تثبيت
...
879. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 26,150 تثبيت
...
880. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 26,148 تثبيت
...
881. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 26,128 تثبيت
...
882. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,100 تثبيت
...
883. **create-pr** — `warpdotdev/common-skills/create-pr` · 26,099 تثبيت
...
884. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 26,086 تثبيت
...
885. **update-skill** — `warpdotdev/common-skills/update-skill` · 26,060 تثبيت
...
886. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 26,049 تثبيت
...
887. **ponytail-audit** — `dietrichgebert/ponytail/ponytail-audit` · 25,927 تثبيت
   ponytail-review, repo-wide. Scan the whole tree instead of a diff. Rank
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-audit`

888. **brandalf** — `warpdotdev/common-skills/brandalf` · 25,786 تثبيت
...
889. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 25,736 تثبيت
...
890. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 25,581 تثبيت
...
891. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,498 تثبيت ⭐
...
892. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 25,469 تثبيت
...
893. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 25,407 تثبيت
...
894. **convex-auth** — `get-convex/agent-skills/convex-auth` · 25,356 تثبيت
...
895. **convex-expert** — `get-convex/agent-skills/convex-expert` · 25,342 تثبيت
...
896. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 25,324 تثبيت
...
900. **convex-authz** — `get-convex/agent-skills/convex-authz` · 25,255 تثبيت
   Convex Authz Auditor/Hardener
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-authz`

901. **convex-reviewer** — `get-convex/agent-skills/convex-reviewer` · 25,236 تثبيت
...
905. **convex-deploy-guard** — `get-convex/agent-skills/convex-deploy-guard` · 25,190 تثبيت
...
906. **convex-env** — `get-convex/agent-skills/convex-env` · 25,181 تثبيت
...
907. **convex-crons** — `get-convex/agent-skills/convex-crons` · 25,176 تثبيت
   Add scheduled jobs (crons)
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-crons`

908. **convex-advisor** — `get-convex/agent-skills/convex-advisor` · 25,162 تثبيت
...
909. **convex-add** — `get-convex/agent-skills/convex-add` · 25,143 تثبيت
...
910. **convex-agent** — `get-convex/agent-skills/convex-agent` · 25,139 تثبيت
   Add an AI agent / RAG backend
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-agent`

911. **convex-migrate-rehearse** — `get-convex/agent-skills/convex-migrate-rehearse` · 25,128 تثبيت
...
916. **convex-test** — `get-convex/agent-skills/convex-test` · 25,117 تثبيت
...
917. **convex-launch-readiness** — `get-convex/agent-skills/convex-launch-readiness` · 25,110 تثبيت
...
918. **convex-domains** — `get-convex/agent-skills/convex-domains` · 25,108 تثبيت
...
919. **convex-billing** — `get-convex/agent-skills/convex-billing` · 25,100 تثبيت
...
920. **convex-monitor** — `get-convex/agent-skills/convex-monitor` · 25,097 تثبيت
   Watch for the next thing to react to
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-monitor`

921. **convex-seed** — `get-convex/agent-skills/convex-seed` · 25,081 تثبيت
...
922. **convex-verify** — `get-convex/agent-skills/convex-verify` · 25,079 تثبيت
   Prove a feature works — seed, drive, assert
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-verify`

923. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 25,078 تثبيت
...
924. **convex-improve-convex-plugin** — `get-convex/agent-skills/convex-improve-convex-plugin` · 25,076 تثبيت
...
925. **convex-suggest** — `get-convex/agent-skills/convex-suggest` · 25,065 تثبيت
...
926. **convex-self-heal** — `get-convex/agent-skills/convex-self-heal` · 25,060 تثبيت
   Gated production self-healing loop
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-self-heal`

927. **convex-sentinel** — `get-convex/agent-skills/convex-sentinel` · 25,016 تثبيت
...
928. **release-skills** — `jimliu/baoyu-skills/release-skills` · 25,000 تثبيت
...
929. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 24,995 تثبيت
...
930. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 24,751 تثبيت
...
931. **influencer-marketing** — `coreyhaines31/marketingskills/influencer-marketing` · 24,707 تثبيت
   Influencer & Creator Marketing
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill influencer-marketing`

932. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 24,604 تثبيت
...
933. **check-impl-against-spec** — `warpdotdev/common-skills/check-impl-against-spec` · 24,476 تثبيت
   Check implementation against spec
   `npx skills add https://github.com/warpdotdev/common-skills --skill check-impl-against-spec`

934. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 24,383 تثبيت
...
935. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 24,244 تثبيت
...
936. **gws-script** — `googleworkspace/cli/gws-script` · 24,146 تثبيت ⭐
...
937. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 23,851 تثبيت ⭐
...
938. **attribution** — `coreyhaines31/marketingskills/attribution` · 23,561 تثبيت
...
939. **prd** — `github/awesome-copilot/prd` · 23,309 تثبيت ⭐
...
940. **gstack** — `garrytan/gstack/gstack` · 23,252 تثبيت
...
941. **ponytail-help** — `dietrichgebert/ponytail/ponytail-help` · 23,087 تثبيت
   Display this reference card when invoked. One-shot, do NOT change mode,
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-help`

942. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 23,053 تثبيت
...
943. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 23,017 تثبيت
...
944. **ponytail-debt** — `dietrichgebert/ponytail/ponytail-debt` · 22,997 تثبيت
   Every deliberate ponytail shortcut is marked with a ponytail: comment naming
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-debt`

945. **expo-ui** — `expo/skills/expo-ui` · 22,946 تثبيت ⭐
...
946. **nuxt** — `antfu/skills/nuxt` · 22,944 تثبيت
...
947. **modern-web-guidance** — `googlechrome/modern-web-guidance/modern-web-guidance` · 22,929 تثبيت
   A skill to search for specific web development use cases and retrieve their corresponding best practice guides.
   `npx skills add https://github.com/googlechrome/modern-web-guidance --skill modern-web-guidance`

948. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 22,797 تثبيت
...
949. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 22,763 تثبيت
...
950. **summarize** — `openclaw/openclaw/summarize` · 22,705 تثبيت
   Fast CLI to summarize URLs, local files, and YouTube links.
   `npx skills add https://github.com/openclaw/openclaw --skill summarize`

951. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 22,337 تثبيت
...
952. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 22,297 تثبيت
...
953. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 22,294 تثبيت
...
954. **validate-changes-match-specs** — `warpdotdev/common-skills/validate-changes-match-specs` · 22,097 تثبيت
   Validate changes match specs
   `npx skills add https://github.com/warpdotdev/common-skills --skill validate-changes-match-specs`

955. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 22,050 تثبيت
...
956. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,937 تثبيت ⭐
...
961. **dbs-agent-migration** — `dontbesilent2025/dbskill/dbs-agent-migration` · 21,678 تثبيت
   dbs-agent-migration：Agent 工作台迁移
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-agent-migration`

962. **prompt-engineering-patterns** — `wshobson/agents/prompt-engineering-patterns` · 21,453 تثبيت
...
963. **vueuse-functions** — `antfu/skills/vueuse-functions` · 21,312 تثبيت
...
964. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 21,274 تثبيت ⭐
...
965. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 21,233 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

966. **error-handling-patterns** — `wshobson/agents/error-handling-patterns` · 21,158 تثبيت
...
967. **wecomcli-doc** — `wecomteam/wecom-cli/wecomcli-doc` · 20,999 تثبيت
...
968. **skill-vetter** — `useai-pro/openclaw-skills-security/skill-vetter` · 20,984 تثبيت
...
969. **mediabunny** — `remotion-dev/skills/mediabunny` · 20,928 تثبيت ⭐
   Mediabunny is a multimedia library for dealing with audio and video in the browser.
   `npx skills add https://github.com/remotion-dev/skills --skill mediabunny`

970. **baoyu-post-to-weibo** — `jimliu/baoyu-skills/baoyu-post-to-weibo` · 20,903 تثبيت
...
971. **wecomcli-todo** — `wecomteam/wecom-cli/wecomcli-todo` · 20,608 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-todo`

972. **pnpm** — `antfu/skills/pnpm` · 20,582 تثبيت
...
973. **wecomcli-contact** — `wecomteam/wecom-cli/wecomcli-contact` · 20,559 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-contact`

974. **wecomcli-meeting** — `wecomteam/wecom-cli/wecomcli-meeting` · 20,517 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-meeting`

975. **gemini-api-dev** — `google-gemini/gemini-skills/gemini-api-dev` · 20,426 تثبيت ⭐
...
976. **firestore-security-rules-auditor** — `firebase/agent-skills/firestore-security-rules-auditor` · 20,414 تثبيت ⭐
...
977. **python-design-patterns** — `wshobson/agents/python-design-patterns` · 20,328 تثبيت
...
978. **baoyu-youtube-transcript** — `jimliu/baoyu-skills/baoyu-youtube-transcript` · 20,090 تثبيت
...
979. **dbs-report** — `dontbesilent2025/dbskill/dbs-report` · 20,082 تثبيت
...
980. **dbs-save** — `dontbesilent2025/dbskill/dbs-save` · 20,057 تثبيت
...
981. **dbs-restore** — `dontbesilent2025/dbskill/dbs-restore` · 20,047 تثبيت
...
982. **java-springboot** — `github/awesome-copilot/java-springboot` · 20,026 تثبيت ⭐
...
983. **dbs-goal** — `dontbesilent2025/dbskill/dbs-goal` · 19,879 تثبيت
...
984. **opencli-usage** — `jackwener/opencli/opencli-usage` · 19,632 تثبيت
...
985. **html-ppt** — `lewislulu/html-ppt-skill/html-ppt` · 19,423 تثبيت
   html-ppt — HTML PPT Studio
   `npx skills add https://github.com/lewislulu/html-ppt-skill --skill html-ppt`

986. **security-requirement-extraction** — `wshobson/agents/security-requirement-extraction` · 19,398 تثبيت
   Transform threat analysis into actionable security requirements.
   `npx skills add https://github.com/wshobson/agents --skill security-requirement-extraction`

987. **pricewin-hotel-deal-finder** — `price-win/pricewin-skills-hub/pricewin-hotel-deal-finder` · 19,389 تثبيت
   PriceWin Hotel Deal Finder
   `npx skills add https://github.com/price-win/pricewin-skills-hub --skill pricewin-hotel-deal-finder`

988. **dbs-slowisfast** — `dontbesilent2025/dbskill/dbs-slowisfast` · 19,325 تثبيت
...
989. **baseline-ui** — `ibelick/ui-skills/baseline-ui` · 19,283 تثبيت
...
990. **extension-email-calendar-events** — `caffeinelabs/skills/extension-email-calendar-events` · 19,219 تثبيت
...
991. **find-qualified-titles** — `code.deepline.com/find-qualified-titles` · 18,868 تثبيت
   Find Qualified Titles (company_titles -> ICP filter -> contacts)
   `npx skills add https://code.deepline.com/`

992. **modern-javascript-patterns** — `wshobson/agents/modern-javascript-patterns` · 18,806 تثبيت
...
993. **expo-brownfield** — `expo/skills/expo-brownfield` · 18,753 تثبيت ⭐
...
998. **extension-email-verification** — `caffeinelabs/skills/extension-email-verification` · 18,653 تثبيت
...
999. **extension-object-storage** — `caffeinelabs/skills/extension-object-storage` · 18,652 تثبيت
...
1000. **javascript-testing-patterns** — `wshobson/agents/javascript-testing-patterns` · 18,479 تثبيت
...
1001. **feature-sliced-design** — `feature-sliced/skills/feature-sliced-design` · 18,458 تثبيت
   Feature-Sliced Design (FSD) v2.1
   `npx skills add https://github.com/feature-sliced/skills --skill feature-sliced-design`

1002. **extension-email** — `caffeinelabs/skills/extension-email` · 18,415 تثبيت
   Email — Service/Transactional
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-email`

1003. **extension-http-outcalls** — `caffeinelabs/skills/extension-http-outcalls` · 18,411 تثبيت
   HTTP outcalls extension for Caffeine AI.
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-http-outcalls`

1004. **extension-authorization** — `caffeinelabs/skills/extension-authorization` · 18,411 تثبيت
...
1005. **opencli-browser** — `jackwener/opencli/opencli-browser` · 18,408 تثبيت
...
1006. **extension-invite-links** — `caffeinelabs/skills/extension-invite-links` · 18,408 تثبيت
...
1007. **extension-core-infrastructure** — `caffeinelabs/skills/extension-core-infrastructure` · 18,406 تثبيت
...
1008. **vue-router-best-practices** — `antfu/skills/vue-router-best-practices` · 18,329 تثبيت
...
1013. **extension-posting-to-x** — `caffeinelabs/skills/extension-posting-to-x` · 18,153 تثبيت
...
1014. **aso-audit** — `coreyhaines31/marketingskills/aso-audit` · 18,009 تثبيت
...
1015. **create-readme** — `github/awesome-copilot/create-readme` · 17,955 تثبيت ⭐
...
1016. **rust-async-patterns** — `wshobson/agents/rust-async-patterns` · 17,904 تثبيت
...
1017. **playwright-generate-test** — `github/awesome-copilot/playwright-generate-test` · 17,869 تثبيت ⭐
...
1018. **agent development** — `anthropics/claude-code/agent-development` · 17,722 تثبيت ⭐
   Agent Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Agent Development&#x27;`

1019. **skill development** — `anthropics/claude-code/skill-development` · 17,528 تثبيت ⭐
   Skill Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Skill Development&#x27;`

1020. **pinia** — `antfu/skills/pinia` · 17,407 تثبيت
...
1021. **sql-optimization-patterns** — `wshobson/agents/sql-optimization-patterns` · 17,389 تثبيت
...
1022. **planning-with-files-zh** — `othmanadi/planning-with-files/planning-with-files-zh` · 17,220 تثبيت
...
1023. **fixing-accessibility** — `ibelick/ui-skills/fixing-accessibility` · 17,204 تثبيت
...
1024. **the-news** — `sfkislev/the-news/the-news` · 17,165 تثبيت
...
1025. **golang-pro** — `jeffallan/claude-skills/golang-pro` · 17,124 تثبيت
