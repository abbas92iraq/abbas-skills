...
**آخر تحديث:** 2026-09-17 · **العدد:** 1,020 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,432,632 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 1,157,993 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 988,808 تثبيت
...
4. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 942,931 تثبيت
...
7. **agent-browser** — `vercel-labs/agent-browser/agent-browser` · 869,657 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/vercel-labs/agent-browser --skill agent-browser`

8. **setup-matt-pocock-skills** — `mattpocock/skills/setup-matt-pocock-skills` · 844,901 تثبيت
...
9. **handoff** — `mattpocock/skills/handoff` · 817,166 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 796,854 تثبيت
...
11. **prototype** — `mattpocock/skills/prototype` · 792,342 تثبيت
...
12. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 719,794 تثبيت ⭐
   React and Next.js performance optimization across 70 rules prioritized by impact.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-react-best-practices`

13. **grilling** — `mattpocock/skills/grilling` · 715,290 تثبيت
...
16. **lark-drive** — `open.feishu.cn/lark-drive` · 699,768 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

17. **lark-shared** — `open.feishu.cn/lark-shared` · 699,388 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/`

18. **lark-approval** — `open.feishu.cn/lark-approval` · 699,271 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

19. **lark-im** — `open.feishu.cn/lark-im` · 699,231 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

20. **lark-calendar** — `open.feishu.cn/lark-calendar` · 699,109 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

21. **lark-sheets** — `open.feishu.cn/lark-sheets` · 698,825 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/`

22. **lark-wiki** — `open.feishu.cn/lark-wiki` · 698,584 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

23. **lark-contact** — `open.feishu.cn/lark-contact` · 698,437 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/`

24. **lark-minutes** — `open.feishu.cn/lark-minutes` · 698,309 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

25. **lark-slides** — `open.feishu.cn/lark-slides` · 698,141 تثبيت
   本技能文档较长，务必使用 Read 工具阅读两次，必须阅读完整全文。
   `npx skills add https://open.feishu.cn/`

26. **lark-mail** — `open.feishu.cn/lark-mail` · 698,101 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

27. **lark-event** — `open.feishu.cn/lark-event` · 698,095 تثبيت
...
28. **lark-task** — `open.feishu.cn/lark-task` · 698,079 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

29. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 698,056 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/`

30. **lark-attendance** — `open.feishu.cn/lark-attendance` · 697,942 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

31. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 697,887 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

32. **lark-vc** — `open.feishu.cn/lark-vc` · 697,652 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

33. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 697,558 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/`

34. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 697,421 تثبيت
...
35. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 697,255 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`
...
37. **lark-okr** — `open.feishu.cn/lark-okr` · 678,678 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

38. **teach** — `mattpocock/skills/teach` · 665,081 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

39. **lark-markdown** — `open.feishu.cn/lark-markdown` · 664,059 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

40. **domain-modeling** — `mattpocock/skills/domain-modeling` · 647,123 تثبيت
...
41. **lark-vc-agent** — `open.feishu.cn/lark-vc-agent` · 642,230 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

42. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 640,945 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

43. **codebase-design** — `mattpocock/skills/codebase-design` · 626,771 تثبيت
...
44. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 615,012 تثبيت
   A discipline for hard bugs. Skip phases only when explicitly justified.
   `npx skills add https://github.com/mattpocock/skills --skill diagnosing-bugs`

45. **lark-apps** — `open.feishu.cn/lark-apps` · 608,569 تثبيت
...
46. **microsoft-foundry** — `microsoft/azure-skills/microsoft-foundry` · 594,919 تثبيت ⭐
   End-to-end deployment, evaluation, and management of AI agents on Microsoft Foundry.
   `npx skills add https://github.com/microsoft/azure-skills --skill microsoft-foundry`

47. **ai-video-generation** — `skills-101/superpowers/ai-video-generation` · 593,457 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-video-generation`

48. **ai-image-generation** — `skills-101/superpowers/ai-image-generation` · 592,739 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-image-generation`

49. **ai-avatar-video** — `skills-101/superpowers/ai-avatar-video` · 592,601 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
...
51. **azure-diagnostics** — `microsoft/azure-skills/azure-diagnostics` · 586,303 تثبيت ⭐
...
52. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 585,856 تثبيت ⭐
...
53. **azure-ai** — `microsoft/azure-skills/azure-ai` · 585,630 تثبيت ⭐
...
54. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 585,559 تثبيت ⭐
...
55. **azure-validate** — `microsoft/azure-skills/azure-validate` · 585,004 تثبيت ⭐
...
56. **azure-storage** — `microsoft/azure-skills/azure-storage` · 584,461 تثبيت ⭐
...
57. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 584,200 تثبيت ⭐
...
58. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 584,009 تثبيت ⭐
...
59. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 583,948 تثبيت ⭐
...
60. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 583,879 تثبيت ⭐
...
61. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 583,864 تثبيت ⭐
...
62. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 583,623 تثبيت ⭐
...
63. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 583,545 تثبيت ⭐
...
64. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 573,261 تثبيت ⭐
...
65. **hyperframes-cli** — `heygen-com/hyperframes/hyperframes-cli` · 571,348 تثبيت
...
70. **remotion-best-practices** — `remotion-dev/skills/remotion-best-practices` · 527,574 تثبيت ⭐
   Domain-specific knowledge base for building videos with Remotion and React.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices`

71. **azure-compute** — `microsoft/azure-skills/azure-compute` · 527,242 تثبيت ⭐
...
72. **video-edit** — `genmedia-labs/skills/video-edit` · 523,597 تثبيت
   Video Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/genmedia-labs/skills --skill video-edit`

73. **ai-music** — `genmedia-labs/skills/ai-music` · 522,872 تثبيت
...
74. **image-to-video** — `genmedia-labs/skills/image-to-video` · 522,319 تثبيت
   Image-to-Video — Pro Pack on RunComfy
   `npx skills add https://github.com/genmedia-labs/skills --skill image-to-video`

75. **wayfinder** — `mattpocock/skills/wayfinder` · 521,227 تثبيت
...
76. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 517,266 تثبيت ⭐
...
80. **to-tickets** — `mattpocock/skills/to-tickets` · 505,852 تثبيت
   Break a plan, spec, or conversation into a set of tickets: tracer-bullet vertical slices, each declaring the tickets that block it.
   `npx skills add https://github.com/mattpocock/skills --skill to-tickets`

81. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 496,255 تثبيت
...
82. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 494,918 تثبيت
...
83. **reddit-automation** — `flowkit-labs/skills/reddit-automation` · 491,207 تثبيت
   Built by the team at doany.ai.
   `npx skills add https://github.com/flowkit-labs/skills --skill reddit-automation`

84. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 490,826 تثبيت ⭐
...
85. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 486,386 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

86. **lark-note** — `open.feishu.cn/lark-note` · 482,074 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

87. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 453,382 تثبيت ⭐
...
88. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,899 تثبيت
...
89. **hyperframes-core** — `heygen-com/hyperframes/hyperframes-core` · 450,886 تثبيت
   Agent pitfalls (read first):
   `npx skills add https://github.com/heygen-com/hyperframes --skill hyperframes-core`

90. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,117 تثبيت
...
91. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 450,031 تثبيت
...
92. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 449,998 تثبيت
...
93. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 445,496 تثبيت ⭐
...
94. **media-use** — `heygen-com/hyperframes/media-use` · 445,342 تثبيت
   The media OS for HyperFrames: resolve · generate · operate · remember — every media type, one skill, zero context noise.
   `npx skills add https://github.com/heygen-com/hyperframes --skill media-use`

95. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 441,870 تثبيت ⭐
...
96. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 436,829 تثبيت
...
97. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 420,033 تثبيت ⭐
...
98. **nano-banana-2** — `prime-skills/runcomfy-agent-skills/nano-banana-2` · 418,814 تثبيت
   Nano Banana 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill nano-banana-2`

99. **image-edit** — `prime-skills/runcomfy-agent-skills/image-edit` · 418,424 تثبيت
   Image Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill image-edit`

100. **nano-banana-edit** — `prime-skills/runcomfy-agent-skills/nano-banana-edit` · 418,364 تثبيت
...
101. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 418,161 تثبيت
...
102. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 417,610 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

103. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 417,460 تثبيت
...
104. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 417,435 تثبيت
...
105. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 417,434 تثبيت
...
106. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 417,388 تثبيت
...
107. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 417,216 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

108. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 412,884 تثبيت ⭐
...
109. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 404,353 تثبيت ⭐
...
110. **kling-3-0** — `prime-skills/runcomfy-agent-skills/kling-3-0` · 394,387 تثبيت
   Kling 3.0 - Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill kling-3-0`

111. **azure-cost** — `microsoft/azure-skills/azure-cost` · 388,116 تثبيت ⭐
...
115. **to-prd** — `mattpocock/skills/to-prd` · 367,638 تثبيت
...
116. **git-guardrails-claude-code** — `mattpocock/skills/git-guardrails-claude-code` · 365,464 تثبيت
   Sets up a PreToolUse hook that intercepts and blocks dangerous git commands before Claude executes them.
   `npx skills add https://github.com/mattpocock/skills --skill git-guardrails-claude-code`

117. **brainstorming** — `obra/superpowers/brainstorming` · 365,222 تثبيت
   Structured design dialogue that validates ideas before implementation begins.
   `npx skills add https://github.com/obra/superpowers --skill brainstorming`

118. **caveman-commit** — `juliusbrussee/caveman/caveman-commit` · 361,589 تثبيت
...
119. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 361,331 تثبيت
...
120. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 361,013 تثبيت
...
121. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 359,589 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

122. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 359,373 تثبيت
...
123. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 358,884 تثبيت
...
124. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 358,663 تثبيت
...
125. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 358,629 تثبيت
...
126. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 358,226 تثبيت
...
127. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 358,082 تثبيت
...
128. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 358,019 تثبيت
...
129. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 357,974 تثبيت
...
130. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 357,945 تثبيت
...
131. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 357,859 تثبيت
...
132. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 357,764 تثبيت
...
133. **setup-pre-commit** — `mattpocock/skills/setup-pre-commit` · 357,718 تثبيت
   lint-staged running Prettier on all staged files
   `npx skills add https://github.com/mattpocock/skills --skill setup-pre-commit`

134. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 356,420 تثبيت
...
135. **to-issues** — `mattpocock/skills/to-issues` · 354,579 تثبيت
...
136. **redesign-existing-projects** — `leonxlnx/taste-skill/redesign-existing-projects` · 354,545 تثبيت
   Audit and upgrade existing websites to premium design standards without breaking functionality.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill redesign-existing-projects`

137. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 351,384 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

138. **writing-beats** — `mattpocock/skills/writing-beats` · 351,313 تثبيت
...
139. **writing-shape** — `mattpocock/skills/writing-shape` · 350,809 تثبيت
...
140. **writing-fragments** — `mattpocock/skills/writing-fragments` · 350,671 تثبيت
...
141. **ace-step** — `prime-skills/runcomfy-agent-skills/ace-step` · 349,649 تثبيت
   ACE Step — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ace-step`

142. **caveman-help** — `juliusbrussee/caveman/caveman-help` · 348,855 تثبيت
...
143. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 347,768 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

144. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 340,685 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

145. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 331,972 تثبيت ⭐
...
146. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 329,257 تثبيت
...
147. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 323,400 تثبيت
...
148. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 320,033 تثبيت
...
149. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 318,860 تثبيت
...
150. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 314,114 تثبيت
...
151. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,247 تثبيت
...
152. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 311,025 تثبيت
...
153. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,971 تثبيت
...
154. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,650 تثبيت
...
155. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,627 تثبيت
...
156. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,485 تثبيت
...
157. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,469 تثبيت
...
158. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 307,556 تثبيت
...
159. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 307,089 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

160. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 306,119 تثبيت
...
161. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 306,093 تثبيت ⭐
...
162. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 306,005 تثبيت
...
163. **loop-me** — `mattpocock/skills/loop-me` · 305,486 تثبيت
...
164. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 305,428 تثبيت
...
165. **brandkit** — `leonxlnx/taste-skill/brandkit` · 296,973 تثبيت
...
166. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 292,183 تثبيت
...
167. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 291,927 تثبيت ⭐
...
168. **prisma-client-api** — `prisma/skills/prisma-client-api` · 291,521 تثبيت ⭐
...
169. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 290,040 تثبيت
...
170. **prisma-cli** — `prisma/skills/prisma-cli` · 289,198 تثبيت ⭐
...
171. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 287,800 تثبيت
...
172. **prisma-postgres** — `prisma/skills/prisma-postgres` · 284,923 تثبيت ⭐
...
173. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 284,583 تثبيت
...
174. **general-video** — `heygen-com/hyperframes/general-video` · 283,622 تثبيت
   Before relying on this workflow, run:
   `npx skills add https://github.com/heygen-com/hyperframes --skill general-video`

175. **claude-handoff** — `mattpocock/skills/claude-handoff` · 282,075 تثبيت
...
176. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 280,105 تثبيت ⭐
...
177. **impeccable** — `pbakaus/impeccable/impeccable` · 280,005 تثبيت
   Frontend design and iteration for production-grade interfaces, from concept to ship.
   `npx skills add https://github.com/pbakaus/impeccable --skill impeccable`

178. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 279,847 تثبيت ⭐
...
179. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 279,235 تثبيت ⭐
...
180. **supabase** — `supabase/agent-skills/supabase` · 278,178 تثبيت ⭐
...
181. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 275,883 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

182. **prisma-compute** — `prisma/skills/prisma-compute` · 275,139 تثبيت ⭐
...
183. **prisma-mongodb-upgrade** — `prisma/skills/prisma-mongodb-upgrade` · 273,799 تثبيت ⭐
   Prisma MongoDB Upgrade Path
   `npx skills add https://github.com/prisma/skills --skill prisma-mongodb-upgrade`

184. **shadcn** — `shadcn/ui/shadcn` · 271,675 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

185. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 271,338 تثبيت
...
186. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 265,237 تثبيت ⭐
...
187. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 261,172 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

188. **wait-what** — `mattpocock/skills/wait-what` · 260,503 تثبيت
...
189. **design-mobile-apps** — `designed-by-ai/skills/design-mobile-apps` · 256,078 تثبيت
...
190. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 253,418 تثبيت
...
191. **writing-plans** — `obra/superpowers/writing-plans` · 250,382 تثبيت
   Comprehensive implementation plans for multi-step tasks, breaking down specs into bite-sized, testable steps.
   `npx skills add https://github.com/obra/superpowers --skill writing-plans`

192. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 249,861 تثبيت
...
193. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 248,974 تثبيت
...
194. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 248,608 تثبيت
...
195. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 248,574 تثبيت
...
196. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 248,525 تثبيت
...
197. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 248,522 تثبيت
...
198. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 248,495 تثبيت
...
199. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 248,359 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

200. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 246,830 تثبيت
...
201. **using-superpowers** — `obra/superpowers/using-superpowers` · 245,088 تثبيت
   IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST USE IT.
   `npx skills add https://github.com/obra/superpowers --skill using-superpowers`

202. **just-scrape** — `scrapegraphai/just-scrape/just-scrape` · 244,966 تثبيت
...
203. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 242,093 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

204. **diagnose** — `mattpocock/skills/diagnose` · 238,849 تثبيت
...
205. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 238,475 تثبيت
...
206. **orca-cli** — `stablyai/orca/orca-cli` · 234,198 تثبيت
   This discovery stub loads the version-matched guide from the Orca executable used for this session.
   `npx skills add https://github.com/stablyai/orca --skill orca-cli`

207. **write-a-skill** — `mattpocock/skills/write-a-skill` · 230,306 تثبيت
...
208. **requesting-code-review** — `obra/superpowers/requesting-code-review` · 229,916 تثبيت
   Dispatch code review subagents with focused context to catch issues before they compound.
   `npx skills add https://github.com/obra/superpowers --skill requesting-code-review`

209. **zoom-out** — `mattpocock/skills/zoom-out` · 229,761 تثبيت
...
210. **test-driven-development** — `obra/superpowers/test-driven-development` · 228,124 تثبيت
   Write tests first, watch them fail, then implement minimal code to pass.
   `npx skills add https://github.com/obra/superpowers --skill test-driven-development`

211. **embedded-captions** — `heygen-com/hyperframes/embedded-captions` · 226,977 تثبيت
...
212. **pptx** — `anthropics/skills/pptx` · 222,144 تثبيت ⭐
...
213. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 221,898 تثبيت
...
214. **design-an-interface** — `mattpocock/skills/design-an-interface` · 216,496 تثبيت
...
215. **orchestration** — `stablyai/orca/orchestration` · 215,288 تثبيت
...
216. **executing-plans** — `obra/superpowers/executing-plans` · 213,435 تثبيت
...
217. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 212,912 تثبيت ⭐
...
218. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 212,591 تثبيت
...
219. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 209,830 تثبيت
...
220. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,567 تثبيت ⭐
...
221. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 208,583 تثبيت
...
222. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 206,435 تثبيت
...
223. **qa** — `mattpocock/skills/qa` · 205,740 تثبيت
...
224. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 204,398 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

225. **obsidian-vault** — `mattpocock/skills/obsidian-vault` · 202,151 تثبيت
   /mnt/d/Obsidian Vault/AI Research/
   `npx skills add https://github.com/mattpocock/skills --skill obsidian-vault`

226. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 201,941 تثبيت
...
227. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 200,865 تثبيت
...
228. **edit-article** — `mattpocock/skills/edit-article` · 198,460 تثبيت
...
231. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 194,850 تثبيت
...
232. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 192,354 تثبيت
...
233. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 191,788 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

234. **writing-skills** — `obra/superpowers/writing-skills` · 191,616 تثبيت
...
235. **wan-3-0-prime-reference-to-video** — `genmedia-labs/skills/wan-3-0-prime-reference-to-video` · 189,596 تثبيت
...
236. **seedance-2-5-image-to-video** — `genmedia-labs/skills/seedance-2-5-image-to-video` · 189,321 تثبيت
   Seedance 2.5 Image to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-image-to-video`

237. **docx** — `anthropics/skills/docx` · 189,004 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

238. **seedance-2-5-reference-to-video** — `genmedia-labs/skills/seedance-2-5-reference-to-video` · 188,950 تثبيت
   Seedance 2.5 Reference to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-reference-to-video`

239. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 188,411 تثبيت
...
240. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 188,254 تثبيت ⭐
...
241. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 186,282 تثبيت
...
242. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 172,169 تثبيت
...
243. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 169,753 تثبيت
...
244. **xlsx** — `anthropics/skills/xlsx` · 169,421 تثبيت ⭐
   Create, edit, and analyze Excel spreadsheets with formulas, formatting, and error-free calculations.
   `npx skills add https://github.com/anthropics/skills --skill xlsx`

245. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 167,406 تثبيت ⭐
...
246. **review-animations** — `emilkowalski/skills/review-animations` · 161,346 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill review-animations`

247. **wind-mcp-skill** — `wind-alice/alicemarket/wind-mcp-skill` · 160,756 تثبيت
...
252. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 152,676 تثبيت ⭐
...
253. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 149,814 تثبيت
...
254. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 149,378 تثبيت
...
255. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 149,038 تثبيت ⭐
...
256. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 148,745 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill animation-vocabulary`

257. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 148,697 تثبيت
...
258. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 148,510 تثبيت ⭐
...
259. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 147,677 تثبيت ⭐
...
260. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 147,125 تثبيت
...
261. **apple-design** — `emilkowalski/skills/apple-design` · 144,298 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill apple-design`

262. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 143,977 تثبيت
...
263. **sentry-cli** — `sentry/dev/sentry-cli` · 143,181 تثبيت
...
264. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 141,100 تثبيت
...
266. **improve-animations** — `emilkowalski/skills/improve-animations` · 133,320 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill improve-animations`

267. **figma** — `heygen-com/hyperframes/figma` · 133,024 تثبيت
...
268. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 132,714 تثبيت
...
269. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 129,181 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

270. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 129,144 تثبيت
...
271. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 128,936 تثبيت
...
272. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 126,543 تثبيت
...
273. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 126,296 تثبيت
...
274. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 122,993 تثبيت ⭐
...
275. **neon** — `neondatabase/agent-skills/neon` · 121,227 تثبيت ⭐
...
276. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 120,259 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

277. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 117,176 تثبيت
...
278. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 116,821 تثبيت
...
279. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 116,657 تثبيت ⭐
...
280. **mcp-builder** — `anthropics/skills/mcp-builder` · 115,299 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

281. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 114,424 تثبيت ⭐
...
282. **implement-spec** — `mattpocock/skills/implement-spec` · 113,383 تثبيت
   You have been provided a spec. This spec should have tickets associated with it, describing how to implement the spec.
   `npx skills add https://github.com/mattpocock/skills --skill implement-spec`

283. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 113,300 تثبيت ⭐
...
284. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 112,694 تثبيت
...
285. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 110,364 تثبيت ⭐
...
286. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 110,326 تثبيت ⭐
...
287. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 109,600 تثبيت ⭐
...
288. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 109,149 تثبيت
...
289. **canvas-design** — `anthropics/skills/canvas-design` · 108,312 تثبيت ⭐
...
290. **browser-act** — `browser-act/skills/browser-act` · 108,028 تثبيت
...
291. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 105,450 تثبيت
...
292. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 105,378 تثبيت
...
293. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 103,519 تثبيت
...
294. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 102,999 تثبيت
...
295. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 102,648 تثبيت
...
296. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 102,490 تثبيت ⭐
...
297. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 102,392 تثبيت ⭐
...
298. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 101,311 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

299. **firecrawl** — `firecrawl/cli/firecrawl` · 101,158 تثبيت ⭐
...
300. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 100,399 تثبيت ⭐
...
301. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 100,020 تثبيت ⭐
...
302. **retro** — `mattpocock/skills/retro` · 99,670 تثبيت
   The user has asked for a retrospective. You are suggesting improvements to the coding agent's environment to improve future runs.
   `npx skills add https://github.com/mattpocock/skills --skill retro`

303. **revops** — `coreyhaines31/marketingskills/revops` · 98,335 تثبيت
...
304. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,324 تثبيت ⭐
...
305. **lark-meeting** — `open.feishu.cn/lark-meeting` · 97,281 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

306. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 95,727 تثبيت
...
307. **gsap** — `heygen-com/hyperframes/gsap` · 95,517 تثبيت
...
308. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 94,987 تثبيت
...
309. **browser-use** — `browser-use/browser-use/browser-use` · 94,836 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

310. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,515 تثبيت
...
311. **review** — `mattpocock/skills/review` · 94,434 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

312. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,079 تثبيت
...
313. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,078 تثبيت
...
314. **convex** — `get-convex/agent-skills/convex` · 93,611 تثبيت
...
315. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 92,663 تثبيت
...
316. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 92,270 تثبيت ⭐
...
317. **prototype** — `emilkowalski/skills/prototype` · 91,781 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill prototype`

318. **cloudflare** — `cloudflare/skills/cloudflare` · 91,187 تثبيت ⭐
...
319. **archify** — `tt-a1i/archify/archify` · 89,159 تثبيت
...
320. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 89,120 تثبيت
...
321. **wrangler** — `cloudflare/skills/wrangler` · 88,551 تثبيت ⭐
...
322. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 88,158 تثبيت
...
323. **polish** — `pbakaus/impeccable/polish` · 87,284 تثبيت
...
324. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 85,835 تثبيت
...
325. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 85,781 تثبيت ⭐
...
326. **theme-factory** — `anthropics/skills/theme-factory` · 85,141 تثبيت ⭐
...
327. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,092 تثبيت
...
328. **remotion-render** — `remotion-dev/skills/remotion-render` · 84,809 تثبيت ⭐
   General rendering strategy
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-render`

329. **critique** — `pbakaus/impeccable/critique` · 84,679 تثبيت
...
330. **remotion-create** — `remotion-dev/skills/remotion-create` · 84,590 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

331. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 84,472 تثبيت ⭐
...
332. **audit** — `pbakaus/impeccable/audit` · 83,896 تثبيت
...
333. **animate** — `pbakaus/impeccable/animate` · 83,750 تثبيت
...
334. **adapt** — `pbakaus/impeccable/adapt` · 83,740 تثبيت
...
335. **clarify** — `pbakaus/impeccable/clarify` · 83,232 تثبيت
...
336. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 83,161 تثبيت
...
337. **optimize** — `pbakaus/impeccable/optimize` · 83,086 تثبيت
...
338. **colorize** — `pbakaus/impeccable/colorize` · 82,892 تثبيت
...
339. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 82,440 تثبيت ⭐
...
340. **bolder** — `pbakaus/impeccable/bolder` · 82,013 تثبيت
...
341. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 82,011 تثبيت ⭐
...
342. **delight** — `pbakaus/impeccable/delight` · 81,844 تثبيت
...
343. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 81,696 تثبيت ⭐
...
344. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 81,679 تثبيت ⭐
...
345. **distill** — `pbakaus/impeccable/distill` · 81,453 تثبيت
...
346. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 80,913 تثبيت ⭐
...
347. **quieter** — `pbakaus/impeccable/quieter` · 80,620 تثبيت
...
348. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 79,647 تثبيت ⭐
...
349. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 79,499 تثبيت ⭐
...
350. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 79,442 تثبيت ⭐
...
351. **animate** — `emilkowalski/skills/animate` · 79,359 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill animate`

352. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 79,059 تثبيت ⭐
...
353. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 78,744 تثبيت ⭐
...
354. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,808 تثبيت
...
355. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 77,741 تثبيت ⭐
...
356. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 77,388 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

357. **remotion-saas** — `remotion-dev/skills/remotion-saas` · 76,167 تثبيت ⭐
   One can build apps with Remotion.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-saas`

358. **notion-api** — `intellectronica/agent-skills/notion-api` · 76,154 تثبيت
...
359. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 76,076 تثبيت ⭐
...
360. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 76,042 تثبيت
...
361. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 75,267 تثبيت
...
362. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 75,117 تثبيت
...
365. **durable-objects** — `cloudflare/skills/durable-objects` · 74,479 تثبيت ⭐
...
366. **css-animations** — `heygen-com/hyperframes/css-animations` · 74,434 تثبيت
...
367. **agent-tools** — `skills-101/superpowers/agent-tools` · 74,420 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill agent-tools`

368. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 74,407 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

369. **python-executor** — `skills-101/superpowers/python-executor` · 74,371 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

370. **web-perf** — `cloudflare/skills/web-perf` · 74,202 تثبيت ⭐
...
371. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 73,937 تثبيت
...
372. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 73,322 تثبيت ⭐
...
373. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 73,316 تثبيت ⭐
...
374. **turborepo** — `vercel/turborepo/turborepo` · 72,942 تثبيت ⭐
...
375. **internal-comms** — `anthropics/skills/internal-comms` · 72,678 تثبيت ⭐
...
376. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,599 تثبيت
...
377. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 72,573 تثبيت
...
378. **animejs** — `heygen-com/hyperframes/animejs` · 72,043 تثبيت
...
379. **agents-sdk** — `cloudflare/skills/agents-sdk` · 71,844 تثبيت ⭐
...
380. **three** — `heygen-com/hyperframes/three` · 71,324 تثبيت
...
381. **audit-website** — `squirrelscan/skills/audit-website` · 71,245 تثبيت
...
382. **lottie** — `heygen-com/hyperframes/lottie` · 71,056 تثبيت
...
383. **waapi** — `heygen-com/hyperframes/waapi` · 70,683 تثبيت
...
384. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 70,483 تثبيت ⭐
...
385. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 70,033 تثبيت
...
386. **image** — `coreyhaines31/marketingskills/image` · 69,780 تثبيت
...
387. **video** — `coreyhaines31/marketingskills/video` · 69,656 تثبيت
...
388. **gws-drive** — `googleworkspace/cli/gws-drive` · 69,109 تثبيت ⭐
...
389. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 69,063 تثبيت
...
390. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 68,674 تثبيت
...
391. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 68,529 تثبيت ⭐
...
392. **defuddle** — `kepano/obsidian-skills/defuddle` · 68,499 تثبيت
...
393. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 68,042 تثبيت ⭐
...
394. **cro** — `coreyhaines31/marketingskills/cro` · 68,011 تثبيت
   Conversion Rate Optimization (CRO)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill cro`

395. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,775 تثبيت
...
396. **review-loop** — `2dmurali/review-loop-skill/review-loop` · 67,698 تثبيت
...
397. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 67,278 تثبيت ⭐
...
398. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 66,541 تثبيت ⭐
...
399. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 66,328 تثبيت ⭐
...
400. **typeset** — `pbakaus/impeccable/typeset` · 66,256 تثبيت
...
401. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 65,510 تثبيت
...
405. **batch-grill-me** — `mattpocock/skills/batch-grill-me` · 64,543 تثبيت
   Interview the user relentlessly until you reach a shared understanding. Map this as a design tree: every decision branches into the decisions that han
   `npx skills add https://github.com/mattpocock/skills --skill batch-grill-me`

406. **overdrive** — `pbakaus/impeccable/overdrive` · 64,329 تثبيت
   ──────────── ⚡ OVERDRIVE ─────────────
   `npx skills add https://github.com/pbakaus/impeccable --skill overdrive`

407. **tailwind-design-system** — `wshobson/agents/tailwind-design-system` · 64,304 تثبيت
   CSS-first design system framework for Tailwind v4 with tokens, components, and responsive patterns.
   `npx skills add https://github.com/wshobson/agents --skill tailwind-design-system`

408. **analytics** — `coreyhaines31/marketingskills/analytics` · 64,266 تثبيت
...
409. **social** — `coreyhaines31/marketingskills/social` · 64,156 تثبيت
...
410. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 64,024 تثبيت ⭐
...
411. **stripe-projects** — `stripe/ai/stripe-projects` · 63,780 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

412. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 63,340 تثبيت
...
413. **ads** — `coreyhaines31/marketingskills/ads` · 62,760 تثبيت
...
414. **developing-genkit-js** — `firebase/agent-skills/developing-genkit-js` · 62,588 تثبيت ⭐
...
415. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,513 تثبيت
...
417. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,924 تثبيت
...
418. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,923 تثبيت
...
419. **design-md** — `google-labs-code/stitch-skills/design-md` · 61,819 تثبيت ⭐
...
420. **pricing** — `coreyhaines31/marketingskills/pricing` · 61,723 تثبيت
...
421. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 61,581 تثبيت
...
422. **competitors** — `coreyhaines31/marketingskills/competitors` · 60,984 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

423. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 60,704 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill motion-doctrine`

424. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 60,632 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill captions-overlay`

425. **gws-shared** — `googleworkspace/cli/gws-shared` · 60,572 تثبيت ⭐
...
426. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 60,426 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

427. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 60,422 تثبيت ⭐
...
428. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 60,270 تثبيت ⭐
...
429. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 60,207 تثبيت ⭐
...
430. **schema** — `coreyhaines31/marketingskills/schema` · 60,204 تثبيت
...
431. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 60,148 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill seam-craft`

432. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 60,125 تثبيت ⭐
...
433. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 60,090 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill changelog-video`

434. **oversized-cursor** — `heygen-com/hyperframes/oversized-cursor` · 60,043 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill oversized-cursor`

435. **emails** — `coreyhaines31/marketingskills/emails` · 59,923 تثبيت
...
436. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 59,911 تثبيت ⭐
...
437. **launch** — `coreyhaines31/marketingskills/launch` · 59,908 تثبيت
...
438. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 59,793 تثبيت ⭐
...
439. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 59,610 تثبيت
...
444. **expo-dev-client** — `expo/skills/expo-dev-client` · 59,147 تثبيت ⭐
...
445. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 58,611 تثبيت ⭐
...
446. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,529 تثبيت
...
447. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,168 تثبيت
...
448. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,160 تثبيت
...
449. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 58,094 تثبيت
...
450. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 58,081 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

451. **aso** — `coreyhaines31/marketingskills/aso` · 58,064 تثبيت
...
452. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 57,833 تثبيت
...
453. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 57,805 تثبيت
...
454. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,665 تثبيت
...
455. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 56,946 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

456. **gsap-core** — `greensock/gsap-skills/gsap-core` · 56,805 تثبيت
...
457. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,750 تثبيت
...
458. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,740 تثبيت
...
459. **referrals** — `coreyhaines31/marketingskills/referrals` · 56,697 تثبيت
   Referral & Affiliate Programs
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill referrals`

460. **signup** — `coreyhaines31/marketingskills/signup` · 56,599 تثبيت
...
461. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 56,594 تثبيت
...
462. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,427 تثبيت
...
463. **ai-sdk** — `vercel/ai/ai-sdk` · 56,305 تثبيت ⭐
...
464. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 56,257 تثبيت ⭐
...
465. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,176 تثبيت
...
466. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 56,133 تثبيت ⭐
...
467. **popups** — `coreyhaines31/marketingskills/popups` · 56,086 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

468. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 56,027 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

469. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 56,021 تثبيت ⭐
...
470. **normalize** — `pbakaus/impeccable/normalize` · 55,836 تثبيت
...
471. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,784 تثبيت
...
472. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 55,596 تثبيت
...
473. **higgsfield-youtube-thumbnail** — `higgsfield-ai/skills/higgsfield-youtube-thumbnail` · 55,550 تثبيت
   Higgsfield YouTube Thumbnail
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-youtube-thumbnail`

474. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 55,519 تثبيت ⭐
...
475. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 55,502 تثبيت
...
476. **opentui** — `msmps/opentui-skill/opentui` · 55,465 تثبيت
...
477. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,334 تثبيت
...
478. **nia** — `nozomio-labs/nia-skill/nia` · 55,247 تثبيت
...
479. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 55,216 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

480. **caveman-optimize** — `juliusbrussee/caveman/caveman-optimize` · 54,949 تثبيت
   Evaluate an optimization observation
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-optimize`

481. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 54,904 تثبيت
...
482. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,833 تثبيت
...
483. **extract** — `pbakaus/impeccable/extract` · 54,753 تثبيت
...
484. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 54,681 تثبيت
...
485. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 54,616 تثبيت
...
486. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 54,603 تثبيت
...
487. **onboard** — `pbakaus/impeccable/onboard` · 54,590 تثبيت
...
488. **harden** — `pbakaus/impeccable/harden` · 54,517 تثبيت
...
489. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 54,461 تثبيت
...
490. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 54,373 تثبيت ⭐
...
491. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 54,368 تثبيت
...
492. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 54,342 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

493. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,304 تثبيت
...
494. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 54,247 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

495. **hallmark** — `nutlope/hallmark/hallmark` · 54,194 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

496. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 54,193 تثبيت
...
497. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 54,168 تثبيت
...
498. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 54,155 تثبيت
...
499. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 54,140 تثبيت
...
500. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 54,118 تثبيت
...
501. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 54,110 تثبيت ⭐
...
502. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 54,110 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

503. **lean-build** — `juliusbrussee/caveman/lean-build` · 54,108 تثبيت
...
504. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 54,088 تثبيت
...
505. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 54,081 تثبيت
...
506. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 54,061 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

507. **caveman-manage** — `juliusbrussee/caveman/caveman-manage` · 54,052 تثبيت
   Manage eval-gated experiments
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-manage`

508. **migration** — `juliusbrussee/caveman/migration` · 53,833 تثبيت
...
509. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 53,630 تثبيت ⭐
...
510. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 53,452 تثبيت
...
511. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 53,399 تثبيت
...
512. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,217 تثبيت
...
513. **gws-docs** — `googleworkspace/cli/gws-docs` · 53,106 تثبيت ⭐
...
514. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 52,978 تثبيت
...
515. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,919 تثبيت
...
516. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,741 تثبيت
...
517. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 52,678 تثبيت
...
518. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,476 تثبيت
...
519. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 52,460 تثبيت
...
520. **typegpu** — `heygen-com/hyperframes/typegpu` · 52,133 تثبيت
...
521. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,067 تثبيت
...
522. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 51,930 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

523. **momentic-test** — `momentic-ai/skills/momentic-test` · 51,742 تثبيت
...
524. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,734 تثبيت
...
525. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 51,720 تثبيت
...
526. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,479 تثبيت
...
527. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 51,306 تثبيت ⭐
...
528. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 51,296 تثبيت
...
529. **mastra** — `mastra-ai/skills/mastra` · 50,744 تثبيت ⭐
...
530. **react:components** — `google-labs-code/stitch-skills/react:components` · 50,690 تثبيت ⭐
   Stitch to React Components
   `npx skills add https://github.com/google-labs-code/stitch-skills --skill react:components`

531. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 50,653 تثبيت
...
532. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 50,609 تثبيت
...
533. **gsap-react** — `greensock/gsap-skills/gsap-react` · 50,362 تثبيت
...
534. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 50,241 تثبيت
...
535. **marketing-mindset** — `axelfreeman/marketing-mindset/marketing-mindset` · 49,978 تثبيت
...
536. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 49,962 تثبيت ⭐
...
537. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 49,724 تثبيت
...
538. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 49,666 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

539. **sms** — `coreyhaines31/marketingskills/sms` · 49,662 تثبيت
...
540. **developing-genkit-go** — `firebase/agent-skills/developing-genkit-go` · 49,544 تثبيت ⭐
...
541. **animate-expo** — `emilkowalski/skills/animate-expo` · 49,533 تثبيت
   Building Animations in Expo
   `npx skills add https://github.com/emilkowalski/skills --skill animate-expo`

542. **herdr** — `herdrdev/herdr/herdr` · 49,463 تثبيت
...
543. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 48,835 تثبيت
...
544. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 48,117 تثبيت
...
545. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 47,543 تثبيت
...
546. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,255 تثبيت ⭐
...
547. **compress** — `juliusbrussee/caveman/compress` · 46,842 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

548. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 46,651 تثبيت
...
549. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 46,544 تثبيت
...
550. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 46,140 تثبيت ⭐
...
551. **clerk-setup** — `clerk/skills/clerk-setup` · 45,921 تثبيت ⭐
...
552. **seo** — `addyosmani/web-quality-skills/seo` · 45,854 تثبيت
...
553. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 45,776 تثبيت
...
554. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 45,562 تثبيت ⭐
...
555. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 45,386 تثبيت
...
556. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 45,187 تثبيت ⭐
...
557. **git-commit** — `github/awesome-copilot/git-commit` · 45,128 تثبيت ⭐
...
558. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,872 تثبيت
...
559. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 44,859 تثبيت ⭐
...
560. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 44,621 تثبيت ⭐
...
561. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 44,327 تثبيت ⭐
...
562. **byted-web-search** — `skills.volces.com/byted-web-search` · 44,318 تثبيت
...
563. **insforge** — `insforge/insforge-skills/insforge` · 44,030 تثبيت
   InsForge App Integration Skill
   `npx skills add https://github.com/insforge/insforge-skills --skill insforge`

564. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 44,025 تثبيت ⭐
...
565. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 43,921 تثبيت
...
566. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 43,732 تثبيت
...
567. **clerk-backend-api** — `clerk/skills/clerk-backend-api` · 43,372 تثبيت ⭐
   CRITICAL: Mandatory checks before EVERY write request
   `npx skills add https://github.com/clerk/skills --skill clerk-backend-api`

568. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 43,309 تثبيت
...
569. **upgrading-expo** — `expo/skills/upgrading-expo` · 43,116 تثبيت ⭐
...
570. **weread-skills** — `tencent/wechatreading/weread-skills` · 43,110 تثبيت
   通过 Agent API Gateway 调用微信读书接口，提供搜索、书架、笔记、书评等能力。
   `npx skills add https://github.com/tencent/wechatreading --skill weread-skills`

571. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 42,530 تثبيت ⭐
...
572. **write-swift** — `emilkowalski/skills/write-swift` · 42,418 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/emilkowalski/skills --skill write-swift`

573. **gws-gmail-triage** — `googleworkspace/cli/gws-gmail-triage` · 42,397 تثبيت ⭐
...
574. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 42,253 تثبيت ⭐
...
575. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 41,342 تثبيت
...
576. **expo-deployment** — `expo/skills/expo-deployment` · 41,010 تثبيت ⭐
...
577. **last30days** — `mvanhorn/last30days-skill/last30days` · 40,825 تثبيت
...
578. **clerk-orgs** — `clerk/skills/clerk-orgs` · 40,665 تثبيت ⭐
...
579. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 40,651 تثبيت
...
580. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 40,640 تثبيت
...
581. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 40,509 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

582. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 40,466 تثبيت ⭐
...
583. **arrange** — `pbakaus/impeccable/arrange` · 40,196 تثبيت
...
584. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 40,196 تثبيت
...
585. **offers** — `coreyhaines31/marketingskills/offers` · 40,075 تثبيت
...
586. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 39,987 تثبيت ⭐
...
587. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 39,982 تثبيت
...
588. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 39,856 تثبيت
...
589. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 39,799 تثبيت
...
590. **golang-security** — `samber/cc-skills-golang/golang-security` · 39,734 تثبيت
...
591. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 39,457 تثبيت
...
592. **remotion** — `google-labs-code/stitch-skills/remotion` · 39,430 تثبيت ⭐
...
593. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 39,284 تثبيت
...
594. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 39,098 تثبيت
...
595. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 39,008 تثبيت
...
596. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 38,945 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

597. **golang-context** — `samber/cc-skills-golang/golang-context` · 38,739 تثبيت
...
598. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 38,705 تثبيت
...
599. **golang-database** — `samber/cc-skills-golang/golang-database` · 38,636 تثبيت
...
600. **clerk-testing** — `clerk/skills/clerk-testing` · 38,612 تثبيت ⭐
   https://clerk.com/docs/guides/development/testing/overview
   `npx skills add https://github.com/clerk/skills --skill clerk-testing`

601. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 38,521 تثبيت
...
602. **gws-slides** — `googleworkspace/cli/gws-slides` · 38,509 تثبيت ⭐
...
603. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 38,455 تثبيت
...
604. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 38,453 تثبيت
...
605. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 38,396 تثبيت
...
606. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 38,373 تثبيت
...
607. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 38,336 تثبيت
...
608. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 38,262 تثبيت
...
609. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 38,081 تثبيت
...
610. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 38,063 تثبيت
...
611. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 38,040 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

612. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 38,035 تثبيت ⭐
...
613. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 37,993 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

614. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 37,950 تثبيت
...
615. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,927 تثبيت ⭐
...
616. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 37,897 تثبيت
...
617. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 37,868 تثبيت
...
618. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 37,812 تثبيت
...
619. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 37,776 تثبيت
...
620. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 37,750 تثبيت
...
621. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,747 تثبيت
...
622. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 37,685 تثبيت
...
623. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 37,653 تثبيت
...
624. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 37,560 تثبيت
...
625. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 37,537 تثبيت
...
626. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 37,529 تثبيت
...
627. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 37,472 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

628. **product-photography** — `skills-101/superpowers/product-photography` · 37,454 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

629. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 37,401 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

630. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 37,388 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

631. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 37,380 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

632. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 37,378 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

633. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 37,377 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

634. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 37,376 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

635. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 37,177 تثبيت
...
636. **gws-forms** — `googleworkspace/cli/gws-forms` · 37,125 تثبيت ⭐
...
637. **firebase-firestore-standard** — `firebase/agent-skills/firebase-firestore-standard` · 37,121 تثبيت ⭐
...
638. **wind-find-finance-skill** — `wind-alice/alicemarket/wind-find-finance-skill` · 37,103 تثبيت
...
639. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 37,008 تثبيت
...
640. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 36,950 تثبيت
...
641. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 36,840 تثبيت
...
642. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 36,815 تثبيت
...
643. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 36,772 تثبيت
...
644. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 36,748 تثبيت
...
645. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 36,742 تثبيت
...
646. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 36,720 تثبيت
...
647. **gws-meet** — `googleworkspace/cli/gws-meet` · 36,629 تثبيت ⭐
...
648. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 36,571 تثبيت
...
649. **karpathy-guidelines** — `multica-ai/andrej-karpathy-skills/karpathy-guidelines` · 36,539 تثبيت
   Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   `npx skills add https://github.com/multica-ai/andrej-karpathy-skills --skill karpathy-guidelines`

650. **angular-developer** — `angular/skills/angular-developer` · 36,442 تثبيت
...
651. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 36,314 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

652. **vitest** — `antfu/skills/vitest` · 36,238 تثبيت
...
653. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 36,222 تثبيت
...
654. **firebase-firestore-enterprise-native-mode** — `firebase/agent-skills/firebase-firestore-enterprise-native-mode` · 36,058 تثبيت ⭐
...
655. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 36,045 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

656. **expo-module** — `expo/skills/expo-module` · 35,978 تثبيت ⭐
...
657. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 35,738 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

658. **vite** — `antfu/skills/vite` · 35,653 تثبيت
...
659. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 35,576 تثبيت
...
660. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 35,542 تثبيت ⭐
...
661. **value** — `hugmouse/skills/value` · 35,529 تثبيت
   This skill does absolutely nothing.
   `npx skills add https://github.com/hugmouse/skills --skill value`

662. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 35,491 تثبيت
...
663. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 35,482 تثبيت ⭐
...
664. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 35,480 تثبيت
...
665. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 35,441 تثبيت
...
666. **replicas-agent** — `replicas-group/skill/replicas-agent` · 35,389 تثبيت
...
667. **performance** — `addyosmani/web-quality-skills/performance` · 35,370 تثبيت
...
668. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 35,335 تثبيت
...
669. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 35,332 تثبيت
...
670. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 35,198 تثبيت
...
671. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 35,147 تثبيت
...
672. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 35,048 تثبيت
...
673. **sandbox-stable** — `cloudflare/skills/sandbox-stable` · 34,920 تثبيت ⭐
   Sandbox SDK — stable package
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-stable`

674. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 34,773 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

675. **firebase-ai-logic** — `firebase/agent-skills/firebase-ai-logic` · 34,583 تثبيت ⭐
...
676. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 34,560 تثبيت ⭐
...
677. **gws-keep** — `googleworkspace/cli/gws-keep` · 34,544 تثبيت ⭐
...
678. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 34,529 تثبيت
...
679. **sandbox-next** — `cloudflare/skills/sandbox-next` · 34,529 تثبيت ⭐
   Sandbox SDK — @next (1.0 preview)
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-next`

680. **sandbox-migrate-to-next** — `cloudflare/skills/sandbox-migrate-to-next` · 34,470 تثبيت ⭐
...
681. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 34,226 تثبيت ⭐
...
682. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 34,037 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

683. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 33,964 تثبيت
...
684. **vue** — `antfu/skills/vue` · 33,851 تثبيت
...
685. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 33,804 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

686. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 33,785 تثبيت
...
687. **self-improving-agent** — `zhaono1/agent-playbook/self-improving-agent` · 33,752 تثبيت
...
688. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 33,646 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

689. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,642 تثبيت ⭐
...
690. **sandbox-sdk** — `cloudflare/skills/sandbox-sdk` · 33,587 تثبيت ⭐
   Build secure, isolated code execution environments on Cloudflare Workers.
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-sdk`

691. **improve** — `shadcn/improve/improve` · 33,351 تثبيت
...
692. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 33,312 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

693. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 33,153 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

694. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 33,114 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

695. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 33,046 تثبيت
...
696. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 33,015 تثبيت ⭐
...
697. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,871 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

698. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,779 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

699. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 32,747 تثبيت
...
700. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 32,690 تثبيت
...
701. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 32,658 تثبيت
...
702. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 32,645 تثبيت
...
703. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,572 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

704. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 32,547 تثبيت ⭐
...
705. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,506 تثبيت
...
706. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 32,443 تثبيت ⭐
...
707. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 32,413 تثبيت
...
708. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 32,379 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

709. **tavily-search** — `tavily-ai/skills/tavily-search` · 32,327 تثبيت ⭐
...
710. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 32,190 تثبيت ⭐
...
711. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 32,135 تثبيت ⭐
...
717. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 31,809 تثبيت ⭐
...
718. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 31,793 تثبيت ⭐
...
719. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,779 تثبيت ⭐
...
720. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 31,687 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

721. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 31,561 تثبيت
...
722. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 31,489 تثبيت ⭐
...
723. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 31,486 تثبيت
...
724. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,471 تثبيت ⭐
...
725. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 31,367 تثبيت ⭐
...
726. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 31,351 تثبيت
...
727. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 31,319 تثبيت ⭐
...
728. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 31,304 تثبيت ⭐
...
729. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 31,286 تثبيت ⭐
...
730. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 31,284 تثبيت ⭐
...
731. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 31,252 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

732. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 31,229 تثبيت ⭐
...
733. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 31,205 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

734. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 31,148 تثبيت
...
735. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 31,106 تثبيت ⭐
...
736. **interview-me** — `addyosmani/agent-skills/interview-me` · 31,009 تثبيت
...
737. **use-dom** — `expo/skills/use-dom` · 30,983 تثبيت ⭐
...
738. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 30,889 تثبيت ⭐
...
739. **shape** — `pbakaus/impeccable/shape` · 30,850 تثبيت
...
740. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 30,801 تثبيت
...
741. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 30,751 تثبيت ⭐
...
742. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 30,654 تثبيت
...
743. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 30,647 تثبيت ⭐
...
744. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 30,584 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

745. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 30,544 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

746. **gws-chat** — `googleworkspace/cli/gws-chat` · 30,539 تثبيت ⭐
...
747. **gws-people** — `googleworkspace/cli/gws-people` · 30,369 تثبيت ⭐
...
748. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 30,351 تثبيت ⭐
...
749. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 30,298 تثبيت
...
750. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 30,100 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

751. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 30,053 تثبيت ⭐
...
752. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 30,029 تثبيت ⭐
...
753. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 30,024 تثبيت
...
754. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 30,023 تثبيت
...
755. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,904 تثبيت ⭐
...
756. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,822 تثبيت
...
757. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 29,744 تثبيت
...
758. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 29,706 تثبيت ⭐
...
759. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 29,676 تثبيت
...
760. **eas-update-insights** — `expo/skills/eas-update-insights` · 29,555 تثبيت ⭐
...
761. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 29,414 تثبيت ⭐
...
762. **gws-chat-send** — `googleworkspace/cli/gws-chat-send` · 29,413 تثبيت ⭐
   Send plain-text messages to Google Chat spaces.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-chat-send`

763. **recipe-draft-email-from-doc** — `googleworkspace/cli/recipe-draft-email-from-doc` · 29,252 تثبيت ⭐
...
764. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 29,228 تثبيت ⭐
...
765. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 29,166 تثبيت ⭐
...
766. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 29,154 تثبيت ⭐
...
767. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 29,139 تثبيت ⭐
...
768. **baoyu-comic** — `jimliu/baoyu-skills/baoyu-comic` · 29,136 تثبيت
...
769. **design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/design-system` · 29,089 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

770. **gws-events** — `googleworkspace/cli/gws-events` · 29,043 تثبيت ⭐
...
771. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 29,007 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

772. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 28,967 تثبيت ⭐
...
773. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 28,805 تثبيت ⭐
...
774. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 28,739 تثبيت ⭐
...
775. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 28,699 تثبيت ⭐
...
776. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 28,656 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

777. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 28,655 تثبيت ⭐
...
778. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 28,595 تثبيت ⭐
...
779. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 28,530 تثبيت ⭐
...
780. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 28,449 تثبيت ⭐
...
781. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 28,438 تثبيت
...
782. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 28,427 تثبيت ⭐
...
783. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 28,409 تثبيت ⭐
...
784. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 28,402 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

785. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 28,395 تثبيت ⭐
...
786. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 28,388 تثبيت ⭐
...
787. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 28,385 تثبيت ⭐
...
788. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 28,367 تثبيت ⭐
...
789. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 28,346 تثبيت
...
790. **api-design-principles** — `wshobson/agents/api-design-principles` · 28,332 تثبيت
...
791. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 28,303 تثبيت ⭐
...
792. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 28,253 تثبيت ⭐
...
793. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 28,193 تثبيت ⭐
...
794. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 28,139 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

795. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 28,092 تثبيت ⭐
...
796. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 28,083 تثبيت ⭐
...
797. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 28,059 تثبيت ⭐
...
798. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 28,041 تثبيت ⭐
...
799. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 28,024 تثبيت ⭐
...
800. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 28,012 تثبيت ⭐
...
801. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 27,997 تثبيت ⭐
...
802. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 27,929 تثبيت ⭐
...
803. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 27,912 تثبيت ⭐
...
804. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 27,907 تثبيت ⭐
...
805. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 27,902 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

806. **azure-postgres** — `microsoft/azure-skills/azure-postgres` · 27,852 تثبيت ⭐
   No SKILL.md available for this skill.
   `npx skills add https://github.com/microsoft/azure-skills --skill azure-postgres`

807. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 27,845 تثبيت ⭐
...
808. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 27,832 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

809. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 27,811 تثبيت ⭐
...
810. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 27,789 تثبيت ⭐
...
811. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 27,781 تثبيت ⭐
...
812. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 27,762 تثبيت ⭐
...
813. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 27,734 تثبيت ⭐
...
814. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 27,695 تثبيت ⭐
...
815. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 27,687 تثبيت ⭐
...
816. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 27,678 تثبيت ⭐
...
817. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 27,669 تثبيت ⭐
...
818. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 27,662 تثبيت ⭐
...
819. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 27,647 تثبيت ⭐
...
820. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 27,642 تثبيت
...
821. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 27,620 تثبيت ⭐
...
822. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 27,606 تثبيت ⭐
...
823. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 27,605 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

824. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 27,601 تثبيت
...
825. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 27,580 تثبيت ⭐
...
826. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 27,573 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

827. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 27,568 تثبيت ⭐
...
828. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 27,535 تثبيت ⭐
...
829. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 27,483 تثبيت
...
830. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 27,482 تثبيت
...
831. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 27,468 تثبيت ⭐
...
832. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 27,468 تثبيت ⭐
...
833. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 27,404 تثبيت
...
834. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 27,395 تثبيت ⭐
...
835. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 27,319 تثبيت ⭐
...
836. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 27,259 تثبيت ⭐
...
837. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 27,226 تثبيت ⭐
...
838. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 27,180 تثبيت ⭐
...
839. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 27,160 تثبيت ⭐
...
840. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 27,094 تثبيت
...
841. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 27,081 تثبيت ⭐
...
842. **layout** — `pbakaus/impeccable/layout` · 27,044 تثبيت
...
843. **build-tam** — `code.deepline.com/build-tam` · 26,965 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

844. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 26,926 تثبيت
...
845. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 26,924 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

846. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 26,910 تثبيت
...
847. **clerk** — `clerk/skills/clerk` · 26,901 تثبيت ⭐
...
848. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 26,875 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

849. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 26,865 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

850. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 26,858 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

851. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 26,831 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

852. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 26,793 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

853. **interface-design** — `dammyjay93/interface-design/interface-design` · 26,751 تثبيت
...
854. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 26,732 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

855. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,702 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

856. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 26,628 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

857. **golang-linter** — `samber/cc-skills-golang/golang-linter` · 26,543 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/samber/cc-skills-golang --skill golang-linter`

858. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 26,538 تثبيت ⭐
...
859. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 26,412 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

860. **stripe-directory** — `docs.stripe.com/stripe-directory` · 26,233 تثبيت
...
861. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 26,186 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

862. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,098 تثبيت
...
863. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 26,001 تثبيت ⭐
...
864. **clerk-cli** — `clerk/skills/clerk-cli` · 25,919 تثبيت ⭐
...
865. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 25,916 تثبيت
...
866. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 25,889 تثبيت
...
867. **review-pr** — `warpdotdev/common-skills/review-pr` · 25,739 تثبيت
...
868. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 25,703 تثبيت ⭐
...
869. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 25,612 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

870. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 25,602 تثبيت
...
871. **dbs** — `dontbesilent2025/dbskill/dbs` · 25,563 تثبيت
   你是 dontbesilent 商业工具箱的公开入口。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs`

872. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 25,551 تثبيت
...
873. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,485 تثبيت ⭐
...
874. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 25,481 تثبيت
...
875. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 25,442 تثبيت
...
876. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 25,415 تثبيت
...
877. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 25,389 تثبيت
...
878. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 25,368 تثبيت ⭐
...
879. **create-pr** — `warpdotdev/common-skills/create-pr` · 25,358 تثبيت
...
880. **update-skill** — `warpdotdev/common-skills/update-skill` · 25,329 تثبيت
...
881. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 25,315 تثبيت
...
882. **brandalf** — `warpdotdev/common-skills/brandalf` · 25,058 تثبيت
...
883. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 24,994 تثبيت
...
884. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 24,956 تثبيت
...
885. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 24,846 تثبيت
...
886. **release-skills** — `jimliu/baoyu-skills/release-skills` · 24,792 تثبيت
...
887. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 24,782 تثبيت
...
888. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 24,753 تثبيت
...
889. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 24,743 تثبيت
...
890. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 24,704 تثبيت
...
891. **ponytail-review** — `dietrichgebert/ponytail/ponytail-review` · 24,702 تثبيت
   Review diffs for unnecessary complexity. One line per finding: location, what
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-review`

892. **council** — `warpdotdev/common-skills/council` · 24,496 تثبيت
...
893. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 24,298 تثبيت
...
894. **best-practices** — `addyosmani/web-quality-skills/best-practices` · 24,233 تثبيت
   Modern web development standards based on Lighthouse best practices audits. Covers security, browser compatibility, and code quality patterns.
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill best-practices`

895. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 24,124 تثبيت
...
896. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 23,919 تثبيت
...
897. **check-impl-against-spec** — `warpdotdev/common-skills/check-impl-against-spec` · 23,855 تثبيت
   Check implementation against spec
   `npx skills add https://github.com/warpdotdev/common-skills --skill check-impl-against-spec`

898. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 23,707 تثبيت
...
899. **gws-script** — `googleworkspace/cli/gws-script` · 23,707 تثبيت ⭐
...
900. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 23,415 تثبيت ⭐
...
901. **prd** — `github/awesome-copilot/prd` · 23,171 تثبيت ⭐
...
902. **gstack** — `garrytan/gstack/gstack` · 23,069 تثبيت
...
903. **ponytail-audit** — `dietrichgebert/ponytail/ponytail-audit` · 23,057 تثبيت
   ponytail-review, repo-wide. Scan the whole tree instead of a diff. Rank
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-audit`

904. **better-ui** — `jakubkrehel/skills/better-ui` · 22,892 تثبيت
...
905. **nuxt** — `antfu/skills/nuxt` · 22,732 تثبيت
...
906. **summarize** — `openclaw/openclaw/summarize` · 22,705 تثبيت
   Fast CLI to summarize URLs, local files, and YouTube links.
   `npx skills add https://github.com/openclaw/openclaw --skill summarize`

907. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 22,627 تثبيت
...
908. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 22,605 تثبيت
...
909. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 22,575 تثبيت
...
910. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 22,520 تثبيت
...
911. **convex-auth** — `get-convex/agent-skills/convex-auth` · 22,322 تثبيت
...
912. **convex-expert** — `get-convex/agent-skills/convex-expert` · 22,296 تثبيت
...
918. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 22,197 تثبيت
...
919. **convex-design** — `get-convex/agent-skills/convex-design` · 22,196 تثبيت
...
920. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 22,172 تثبيت
...
921. **convex-deploy-guard** — `get-convex/agent-skills/convex-deploy-guard` · 22,167 تثبيت
...
922. **convex-env** — `get-convex/agent-skills/convex-env` · 22,160 تثبيت
...
923. **convex-crons** — `get-convex/agent-skills/convex-crons` · 22,155 تثبيت
   Add scheduled jobs (crons)
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-crons`

924. **convex-advisor** — `get-convex/agent-skills/convex-advisor` · 22,149 تثبيت
...
925. **convex-add** — `get-convex/agent-skills/convex-add` · 22,134 تثبيت
...
926. **convex-agent** — `get-convex/agent-skills/convex-agent` · 22,130 تثبيت
   Add an AI agent / RAG backend
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-agent`

927. **convex-migrate-rehearse** — `get-convex/agent-skills/convex-migrate-rehearse` · 22,120 تثبيت
...
932. **convex-launch-readiness** — `get-convex/agent-skills/convex-launch-readiness` · 22,105 تثبيت
...
933. **convex-domains** — `get-convex/agent-skills/convex-domains` · 22,099 تثبيت
...
934. **convex-test** — `get-convex/agent-skills/convex-test` · 22,095 تثبيت
...
935. **convex-billing** — `get-convex/agent-skills/convex-billing` · 22,095 تثبيت
...
936. **convex-monitor** — `get-convex/agent-skills/convex-monitor` · 22,095 تثبيت
   Watch for the next thing to react to
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-monitor`

937. **convex-seed** — `get-convex/agent-skills/convex-seed` · 22,075 تثبيت
...
938. **convex-improve-convex-plugin** — `get-convex/agent-skills/convex-improve-convex-plugin` · 22,074 تثبيت
...
939. **convex-verify** — `get-convex/agent-skills/convex-verify` · 22,069 تثبيت
   Prove a feature works — seed, drive, assert
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-verify`

940. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 22,061 تثبيت
...
941. **convex-self-heal** — `get-convex/agent-skills/convex-self-heal` · 22,056 تثبيت
   Gated production self-healing loop
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-self-heal`

942. **convex-suggest** — `get-convex/agent-skills/convex-suggest` · 22,055 تثبيت
...
943. **convex-sentinel** — `get-convex/agent-skills/convex-sentinel` · 22,012 تثبيت
...
944. **validate-changes-match-specs** — `warpdotdev/common-skills/validate-changes-match-specs` · 22,003 تثبيت
   Validate changes match specs
   `npx skills add https://github.com/warpdotdev/common-skills --skill validate-changes-match-specs`

945. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 21,999 تثبيت
...
946. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,937 تثبيت ⭐
...
951. **dbs-agent-migration** — `dontbesilent2025/dbskill/dbs-agent-migration` · 21,678 تثبيت
   dbs-agent-migration：Agent 工作台迁移
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-agent-migration`

952. **expo-ui** — `expo/skills/expo-ui` · 21,668 تثبيت ⭐
...
953. **influencer-marketing** — `coreyhaines31/marketingskills/influencer-marketing` · 21,650 تثبيت
   Influencer & Creator Marketing
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill influencer-marketing`

954. **modern-web-guidance** — `googlechrome/modern-web-guidance/modern-web-guidance` · 21,572 تثبيت
   A skill to search for specific web development use cases and retrieve their corresponding best practice guides.
   `npx skills add https://github.com/googlechrome/modern-web-guidance --skill modern-web-guidance`

955. **ponytail-help** — `dietrichgebert/ponytail/ponytail-help` · 21,552 تثبيت
   Display this reference card when invoked. One-shot, do NOT change mode,
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-help`

956. **prompt-engineering-patterns** — `wshobson/agents/prompt-engineering-patterns` · 21,453 تثبيت
...
957. **vueuse-functions** — `antfu/skills/vueuse-functions` · 21,312 تثبيت
...
958. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 21,274 تثبيت ⭐
...
959. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 21,233 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`
