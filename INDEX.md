...
**آخر تحديث:** 2026-09-06 · **العدد:** 966 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,271,794 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 1,068,549 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 911,452 تثبيت
...
4. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 874,171 تثبيت
...
5. **frontend-design** — `anthropics/skills/frontend-design` · 858,083 تثبيت ⭐
...
9. **handoff** — `mattpocock/skills/handoff` · 747,739 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 736,027 تثبيت
...
11. **prototype** — `mattpocock/skills/prototype` · 727,982 تثبيت
...
12. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 691,783 تثبيت ⭐
...
16. **lark-drive** — `open.feishu.cn/lark-drive` · 660,141 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

17. **lark-approval** — `open.feishu.cn/lark-approval` · 659,866 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

18. **lark-shared** — `open.feishu.cn/lark-shared` · 659,753 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

19. **lark-im** — `open.feishu.cn/lark-im` · 659,702 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

20. **lark-calendar** — `open.feishu.cn/lark-calendar` · 659,639 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/`

21. **lark-sheets** — `open.feishu.cn/lark-sheets` · 659,326 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

22. **lark-contact** — `open.feishu.cn/lark-contact` · 659,123 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

23. **lark-wiki** — `open.feishu.cn/lark-wiki` · 659,095 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

24. **lark-minutes** — `open.feishu.cn/lark-minutes` · 659,048 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

25. **lark-event** — `open.feishu.cn/lark-event` · 658,805 تثبيت
...
26. **lark-task** — `open.feishu.cn/lark-task` · 658,749 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

27. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 658,737 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

28. **lark-slides** — `open.feishu.cn/lark-slides` · 658,713 تثبيت
   本技能文档较长，务必使用 Read 工具阅读两次，必须阅读完整全文。
   `npx skills add https://open.feishu.cn/`

29. **lark-mail** — `open.feishu.cn/lark-mail` · 658,706 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/`

30. **lark-attendance** — `open.feishu.cn/lark-attendance` · 658,693 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

31. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 658,625 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

32. **lark-vc** — `open.feishu.cn/lark-vc` · 658,431 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

33. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 658,322 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

34. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 658,185 تثبيت
...
35. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 658,059 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

36. **lark-okr** — `open.feishu.cn/lark-okr` · 639,355 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

37. **grilling** — `mattpocock/skills/grilling` · 632,578 تثبيت
...
38. **lark-markdown** — `open.feishu.cn/lark-markdown` · 624,671 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

39. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 610,293 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

40. **lark-vc-agent** — `open.feishu.cn/lark-vc-agent` · 603,027 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

41. **teach** — `mattpocock/skills/teach` · 601,815 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

42. **ai-video-generation** — `skills-101/superpowers/ai-video-generation` · 593,457 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-video-generation`

43. **ai-image-generation** — `skills-101/superpowers/ai-image-generation` · 592,739 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-image-generation`

44. **ai-avatar-video** — `skills-101/superpowers/ai-avatar-video` · 592,601 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-avatar-video`

45. **twitter-automation** — `skills-101/superpowers/twitter-automation` · 592,485 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill twitter-automation`

46. **domain-modeling** — `mattpocock/skills/domain-modeling` · 575,155 تثبيت
...
47. **microsoft-foundry** — `microsoft/azure-skills/microsoft-foundry` · 573,160 تثبيت ⭐
   End-to-end deployment, evaluation, and management of AI agents on Microsoft Foundry.
   `npx skills add https://github.com/microsoft/azure-skills --skill microsoft-foundry`

48. **lark-apps** — `open.feishu.cn/lark-apps` · 569,013 تثبيت
...
49. **azure-diagnostics** — `microsoft/azure-skills/azure-diagnostics` · 565,683 تثبيت ⭐
...
50. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 565,078 تثبيت ⭐
...
51. **azure-ai** — `microsoft/azure-skills/azure-ai` · 564,994 تثبيت ⭐
...
52. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 564,960 تثبيت ⭐
...
53. **azure-validate** — `microsoft/azure-skills/azure-validate` · 564,427 تثبيت ⭐
...
54. **azure-storage** — `microsoft/azure-skills/azure-storage` · 563,878 تثبيت ⭐
...
55. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 563,615 تثبيت ⭐
...
56. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 563,363 تثبيت ⭐
...
57. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 563,297 تثبيت ⭐
...
58. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 563,278 تثبيت ⭐
...
59. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 563,240 تثبيت ⭐
...
60. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 563,057 تثبيت ⭐
...
61. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 562,981 تثبيت ⭐
...
62. **codebase-design** — `mattpocock/skills/codebase-design` · 557,885 تثبيت
...
63. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 552,706 تثبيت ⭐
...
64. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 548,476 تثبيت
   A discipline for hard bugs. Skip phases only when explicitly justified.
   `npx skills add https://github.com/mattpocock/skills --skill diagnosing-bugs`

65. **remotion-best-practices** — `remotion-dev/skills/remotion-best-practices` · 511,574 تثبيت ⭐
   Domain-specific knowledge base for building videos with Remotion and React.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices`

66. **ask-matt** — `mattpocock/skills/ask-matt` · 508,384 تثبيت
   You don't remember every skill, so ask.
   `npx skills add https://github.com/mattpocock/skills --skill ask-matt`

67. **azure-compute** — `microsoft/azure-skills/azure-compute` · 506,723 تثبيت ⭐
...
68. **implement** — `mattpocock/skills/implement` · 501,515 تثبيت
   Implement the work described by the user in the spec or tickets.
   `npx skills add https://github.com/mattpocock/skills --skill implement`

69. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 496,742 تثبيت ⭐
...
70. **code-review** — `mattpocock/skills/code-review` · 493,164 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill code-review`

71. **hyperframes-cli** — `heygen-com/hyperframes/hyperframes-cli` · 489,324 تثبيت
...
72. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 488,388 تثبيت ⭐
...
73. **caveman** — `juliusbrussee/caveman/caveman` · 484,458 تثبيت
   Ultra-compressed communication mode cutting token usage ~75% while preserving technical accuracy.
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman`

74. **hyperframes** — `heygen-com/hyperframes/hyperframes` · 467,528 تثبيت
...
75. **wayfinder** — `mattpocock/skills/wayfinder` · 458,229 تثبيت
...
76. **research** — `mattpocock/skills/research` · 451,120 تثبيت
   Spin up a background agent to do the research, so you keep working while it reads.
   `npx skills add https://github.com/mattpocock/skills --skill research`

77. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,810 تثبيت
...
78. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,062 تثبيت
...
79. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 449,977 تثبيت
...
80. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 449,951 تثبيت
...
81. **to-spec** — `mattpocock/skills/to-spec` · 448,139 تثبيت
...
82. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 447,370 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

83. **lark-note** — `open.feishu.cn/lark-note` · 442,851 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

84. **to-tickets** — `mattpocock/skills/to-tickets` · 440,295 تثبيت
   Break a plan, spec, or conversation into a set of tickets: tracer-bullet vertical slices, each declaring the tickets that block it.
   `npx skills add https://github.com/mattpocock/skills --skill to-tickets`

85. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 439,905 تثبيت ⭐
...
86. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 433,265 تثبيت
...
87. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 432,921 تثبيت ⭐
...
88. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 425,896 تثبيت
...
89. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 425,045 تثبيت ⭐
...
90. **video-edit** — `prime-skills/runcomfy-agent-skills/video-edit` · 414,965 تثبيت
   Video Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill video-edit`

91. **image-to-video** — `prime-skills/runcomfy-agent-skills/image-to-video` · 413,368 تثبيت
...
92. **nano-banana-2** — `prime-skills/runcomfy-agent-skills/nano-banana-2` · 413,057 تثبيت
   Nano Banana 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill nano-banana-2`

93. **nano-banana-edit** — `prime-skills/runcomfy-agent-skills/nano-banana-edit` · 412,649 تثبيت
...
94. **image-edit** — `prime-skills/runcomfy-agent-skills/image-edit` · 412,639 تثبيت
   Image Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill image-edit`

95. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 412,434 تثبيت
...
96. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 411,892 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

97. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 411,720 تثبيت
...
98. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 411,713 تثبيت
...
99. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 411,673 تثبيت
...
100. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 411,503 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

101. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 399,550 تثبيت ⭐
...
102. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 392,415 تثبيت ⭐
...
103. **kling-3-0** — `prime-skills/runcomfy-agent-skills/kling-3-0` · 388,648 تثبيت
   Kling 3.0 - Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill kling-3-0`

104. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 387,872 تثبيت ⭐
...
108. **azure-cost** — `microsoft/azure-skills/azure-cost` · 367,642 تثبيت ⭐
...
109. **to-prd** — `mattpocock/skills/to-prd` · 366,753 تثبيت
...
110. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 365,361 تثبيت
...
111. **media-use** — `heygen-com/hyperframes/media-use` · 363,879 تثبيت
   The media OS for HyperFrames: resolve · generate · operate · remember — every media type, one skill, zero context noise.
   `npx skills add https://github.com/heygen-com/hyperframes --skill media-use`

112. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 355,591 تثبيت
...
113. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 355,285 تثبيت
...
114. **to-issues** — `mattpocock/skills/to-issues` · 353,758 تثبيت
...
115. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 353,640 تثبيت
...
116. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 353,152 تثبيت
...
117. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 352,945 تثبيت
...
118. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 352,903 تثبيت
...
119. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 352,500 تثبيت
...
120. **brainstorming** — `obra/superpowers/brainstorming` · 352,444 تثبيت
   Structured design dialogue that validates ideas before implementation begins.
   `npx skills add https://github.com/obra/superpowers --skill brainstorming`

121. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 352,357 تثبيت
...
122. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 352,222 تثبيت
...
123. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 352,144 تثبيت
...
124. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 352,042 تثبيت
...
125. **ai-music** — `genmedia-labs/skills/ai-music` · 350,205 تثبيت
...
126. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 345,923 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

127. **ace-step** — `prime-skills/runcomfy-agent-skills/ace-step` · 343,934 تثبيت
   ACE Step — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ace-step`

128. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 342,459 تثبيت
...
129. **caveman-commit** — `juliusbrussee/caveman/caveman-commit` · 339,425 تثبيت
...
130. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 336,245 تثبيت
...
131. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 334,477 تثبيت
...
132. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 331,073 تثبيت
...
133. **caveman-help** — `juliusbrussee/caveman/caveman-help` · 327,497 تثبيت
...
134. **redesign-existing-projects** — `leonxlnx/taste-skill/redesign-existing-projects` · 327,422 تثبيت
   Audit and upgrade existing websites to premium design standards without breaking functionality.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill redesign-existing-projects`

135. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 322,671 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

136. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 322,066 تثبيت
...
141. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 311,575 تثبيت ⭐
...
142. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,151 تثبيت
...
143. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 310,956 تثبيت
...
144. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,890 تثبيت
...
145. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,602 تثبيت
...
146. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,558 تثبيت
...
147. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,447 تثبيت
...
148. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,433 تثبيت
...
149. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 307,681 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

150. **writing-beats** — `mattpocock/skills/writing-beats` · 307,172 تثبيت
...
151. **writing-shape** — `mattpocock/skills/writing-shape` · 306,711 تثبيت
...
152. **writing-fragments** — `mattpocock/skills/writing-fragments` · 306,565 تثبيت
...
153. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 304,240 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

154. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 303,892 تثبيت
...
155. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 289,795 تثبيت
...
156. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 285,717 تثبيت ⭐
...
157. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 285,265 تثبيت
...
158. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 284,341 تثبيت
...
159. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 283,421 تثبيت
...
160. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 282,127 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

161. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 281,943 تثبيت
...
162. **brandkit** — `leonxlnx/taste-skill/brandkit` · 272,149 تثبيت
...
163. **shadcn** — `shadcn/ui/shadcn` · 271,675 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

164. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 269,056 تثبيت
...
165. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 267,188 تثبيت
...
166. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 265,647 تثبيت
...
167. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 263,800 تثبيت ⭐
...
168. **impeccable** — `pbakaus/impeccable/impeccable` · 263,672 تثبيت
   Frontend design and iteration for production-grade interfaces, from concept to ship.
   `npx skills add https://github.com/pbakaus/impeccable --skill impeccable`

169. **prisma-client-api** — `prisma/skills/prisma-client-api` · 263,320 تثبيت ⭐
...
170. **prisma-cli** — `prisma/skills/prisma-cli` · 261,071 تثبيت ⭐
...
171. **loop-me** — `mattpocock/skills/loop-me` · 260,382 تثبيت
...
172. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 260,372 تثبيت
...
173. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 260,212 تثبيت
...
174. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 260,146 تثبيت
...
175. **supabase** — `supabase/agent-skills/supabase` · 258,604 تثبيت ⭐
...
176. **prisma-postgres** — `prisma/skills/prisma-postgres` · 257,077 تثبيت ⭐
...
177. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 252,471 تثبيت ⭐
...
178. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 252,256 تثبيت ⭐
...
179. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 251,984 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

180. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 251,450 تثبيت ⭐
...
181. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 249,030 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

182. **prisma-compute** — `prisma/skills/prisma-compute` · 247,581 تثبيت ⭐
...
183. **prisma-mongodb-upgrade** — `prisma/skills/prisma-mongodb-upgrade` · 246,289 تثبيت ⭐
   Prisma MongoDB Upgrade Path
   `npx skills add https://github.com/prisma/skills --skill prisma-mongodb-upgrade`

184. **just-scrape** — `scrapegraphai/just-scrape/just-scrape` · 244,956 تثبيت
...
185. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 244,879 تثبيت ⭐
...
188. **claude-handoff** — `mattpocock/skills/claude-handoff` · 236,950 تثبيت
...
189. **using-superpowers** — `obra/superpowers/using-superpowers` · 236,213 تثبيت
   IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST USE IT.
   `npx skills add https://github.com/obra/superpowers --skill using-superpowers`

190. **general-video** — `heygen-com/hyperframes/general-video` · 233,045 تثبيت
   Before relying on this workflow, run:
   `npx skills add https://github.com/heygen-com/hyperframes --skill general-video`

191. **write-a-skill** — `mattpocock/skills/write-a-skill` · 229,813 تثبيت
...
192. **zoom-out** — `mattpocock/skills/zoom-out` · 229,245 تثبيت
...
193. **requesting-code-review** — `obra/superpowers/requesting-code-review` · 220,298 تثبيت
   Dispatch code review subagents with focused context to catch issues before they compound.
   `npx skills add https://github.com/obra/superpowers --skill requesting-code-review`

194. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 218,363 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

195. **test-driven-development** — `obra/superpowers/test-driven-development` · 218,025 تثبيت
   Write tests first, watch them fail, then implement minimal code to pass.
   `npx skills add https://github.com/obra/superpowers --skill test-driven-development`

196. **design-an-interface** — `mattpocock/skills/design-an-interface` · 215,929 تثبيت
...
197. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 215,513 تثبيت
...
198. **pptx** — `anthropics/skills/pptx` · 215,440 تثبيت ⭐
...
199. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 215,381 تثبيت
...
200. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 211,696 تثبيت
...
201. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,414 تثبيت ⭐
...
202. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 209,310 تثبيت
...
203. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 208,552 تثبيت
...
206. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 203,898 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

207. **executing-plans** — `obra/superpowers/executing-plans` · 203,857 تثبيت
...
208. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 203,697 تثبيت ⭐
...
209. **obsidian-vault** — `mattpocock/skills/obsidian-vault` · 201,652 تثبيت
   /mnt/d/Obsidian Vault/AI Research/
   `npx skills add https://github.com/mattpocock/skills --skill obsidian-vault`

210. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 201,430 تثبيت
...
211. **wait-what** — `mattpocock/skills/wait-what` · 201,324 تثبيت
...
212. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 201,204 تثبيت
...
213. **edit-article** — `mattpocock/skills/edit-article` · 197,965 تثبيت
...
214. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 196,792 تثبيت
...
215. **embedded-captions** — `heygen-com/hyperframes/embedded-captions` · 195,020 تثبيت
...
216. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 194,882 تثبيت
...
217. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 193,966 تثبيت
...
218. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 192,333 تثبيت
...
219. **pdf** — `anthropics/skills/pdf` · 191,199 تثبيت ⭐
   Comprehensive PDF processing with text extraction, merging, splitting, form filling, and OCR capabilities.
   `npx skills add https://github.com/anthropics/skills --skill pdf`

220. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 185,778 تثبيت
...
221. **docx** — `anthropics/skills/docx` · 183,323 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

222. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 183,221 تثبيت
...
223. **writing-skills** — `obra/superpowers/writing-skills` · 182,898 تثبيت
...
224. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 182,673 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

225. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 179,358 تثبيت
...
226. **orchestration** — `stablyai/orca/orchestration` · 174,815 تثبيت
...
227. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 172,001 تثبيت
...
228. **slideshow** — `heygen-com/hyperframes/slideshow` · 169,195 تثبيت
...
229. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 168,027 تثبيت ⭐
...
230. **xlsx** — `anthropics/skills/xlsx` · 163,930 تثبيت ⭐
   Create, edit, and analyze Excel spreadsheets with formulas, formatting, and error-free calculations.
   `npx skills add https://github.com/anthropics/skills --skill xlsx`

231. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 155,561 تثبيت
...
232. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 152,769 تثبيت
...
233. **webapp-testing** — `anthropics/skills/webapp-testing` · 150,678 تثبيت ⭐
   Native Python Playwright scripts for testing local web applications with server lifecycle management.
   `npx skills add https://github.com/anthropics/skills --skill webapp-testing`

234. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 148,696 تثبيت
...
235. **firebase-basics** — `firebase/agent-skills/firebase-basics` · 146,433 تثبيت ⭐
...
236. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 145,380 تثبيت ⭐
...
237. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 145,200 تثبيت
...
238. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 144,862 تثبيت
...
239. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 144,836 تثبيت
...
240. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 144,771 تثبيت
...
241. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 144,760 تثبيت
...
242. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 144,757 تثبيت
...
243. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 144,636 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

244. **playwright-cli** — `microsoft/playwright-cli/playwright-cli` · 143,495 تثبيت ⭐
   Browser automation with 40+ commands for navigation, interaction, form filling, and web testing.
   `npx skills add https://github.com/microsoft/playwright-cli --skill playwright-cli`

245. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 141,866 تثبيت ⭐
...
246. **review-animations** — `emilkowalski/skills/review-animations` · 141,524 تثبيت
...
247. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 141,361 تثبيت ⭐
...
248. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 140,557 تثبيت ⭐
...
249. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 140,208 تثبيت ⭐
...
250. **wind-mcp-skill** — `wind-information-co-ltd/wind-skills/wind-mcp-skill` · 139,352 تثبيت
...
251. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 138,661 تثبيت
...
252. **sentry-cli** — `sentry/dev/sentry-cli` · 138,283 تثبيت
...
253. **ui-radar** — `uizze.com/ui-radar` · 135,613 تثبيت
   Don't let your AI agents design blind.
   `npx skills add https://uizze.com/`

254. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 135,414 تثبيت
...
255. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 133,285 تثبيت
...
256. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 132,183 تثبيت
...
257. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 130,685 تثبيت
...
258. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 129,304 تثبيت
...
259. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 128,557 تثبيت
...
260. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 127,995 تثبيت
...
261. **computer-use** — `stablyai/orca/computer-use` · 127,486 تثبيت
...
262. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 124,179 تثبيت
...
263. **apple-design** — `emilkowalski/skills/apple-design` · 122,855 تثبيت
...
264. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 121,151 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

265. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 121,025 تثبيت
...
266. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 120,134 تثبيت
...
267. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 114,198 تثبيت ⭐
...
268. **improve-animations** — `emilkowalski/skills/improve-animations` · 113,776 تثبيت
...
269. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 112,296 تثبيت
...
270. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 111,891 تثبيت
...
271. **mcp-builder** — `anthropics/skills/mcp-builder` · 111,383 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

272. **figma** — `heygen-com/hyperframes/figma` · 110,698 تثبيت
...
273. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 109,369 تثبيت
...
274. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 109,334 تثبيت ⭐
...
275. **browser-act** — `browser-act/skills/browser-act` · 107,928 تثبيت
...
276. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 107,369 تثبيت
...
277. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 107,293 تثبيت ⭐
...
278. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 105,917 تثبيت ⭐
...
279. **canvas-design** — `anthropics/skills/canvas-design` · 105,115 تثبيت ⭐
...
280. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 104,889 تثبيت ⭐
...
281. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 104,766 تثبيت
...
282. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 104,257 تثبيت
...
283. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 103,181 تثبيت ⭐
...
284. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 102,448 تثبيت ⭐
...
285. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 101,214 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

286. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 100,918 تثبيت
...
287. **firecrawl** — `firecrawl/cli/firecrawl` · 100,346 تثبيت ⭐
...
288. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 98,855 تثبيت
...
289. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 98,427 تثبيت
...
290. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 98,328 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

291. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,309 تثبيت ⭐
...
292. **gsap** — `heygen-com/hyperframes/gsap` · 95,091 تثبيت
...
293. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,484 تثبيت
...
294. **neon** — `neondatabase/agent-skills/neon` · 94,453 تثبيت ⭐
...
295. **revops** — `coreyhaines31/marketingskills/revops` · 94,278 تثبيت
...
296. **review** — `mattpocock/skills/review` · 94,214 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

297. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,052 تثبيت
...
298. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,046 تثبيت
...
299. **browser-use** — `browser-use/browser-use/browser-use` · 93,725 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

300. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 93,427 تثبيت ⭐
...
301. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 92,885 تثبيت ⭐
...
302. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 92,254 تثبيت
...
303. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 91,280 تثبيت
...
304. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 89,775 تثبيت
...
305. **convex** — `get-convex/agent-skills/convex` · 88,604 تثبيت
...
306. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 87,589 تثبيت ⭐
...
307. **polish** — `pbakaus/impeccable/polish` · 87,205 تثبيت
...
308. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 85,074 تثبيت
...
309. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,068 تثبيت
...
310. **critique** — `pbakaus/impeccable/critique` · 84,601 تثبيت
...
311. **audit** — `pbakaus/impeccable/audit` · 83,820 تثبيت
...
312. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 83,802 تثبيت
...
313. **animate** — `pbakaus/impeccable/animate` · 83,676 تثبيت
...
314. **adapt** — `pbakaus/impeccable/adapt` · 83,664 تثبيت
...
315. **clarify** — `pbakaus/impeccable/clarify` · 83,156 تثبيت
...
316. **optimize** — `pbakaus/impeccable/optimize` · 83,011 تثبيت
...
317. **colorize** — `pbakaus/impeccable/colorize` · 82,819 تثبيت
...
318. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 82,600 تثبيت ⭐
...
319. **theme-factory** — `anthropics/skills/theme-factory` · 82,541 تثبيت ⭐
...
320. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 82,505 تثبيت ⭐
...
321. **bolder** — `pbakaus/impeccable/bolder` · 81,936 تثبيت
...
322. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 81,931 تثبيت ⭐
...
323. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 81,903 تثبيت ⭐
...
324. **delight** — `pbakaus/impeccable/delight` · 81,770 تثبيت
...
325. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 81,410 تثبيت ⭐
...
326. **distill** — `pbakaus/impeccable/distill` · 81,381 تثبيت
...
327. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 81,093 تثبيت ⭐
...
328. **quieter** — `pbakaus/impeccable/quieter` · 80,547 تثبيت
...
329. **cloudflare** — `cloudflare/skills/cloudflare` · 79,604 تثبيت ⭐
...
330. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 79,494 تثبيت
...
331. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 78,967 تثبيت ⭐
...
332. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 78,921 تثبيت ⭐
...
333. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 78,801 تثبيت ⭐
...
334. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 78,542 تثبيت ⭐
...
335. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 78,232 تثبيت ⭐
...
336. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,699 تثبيت
...
337. **wrangler** — `cloudflare/skills/wrangler` · 77,035 تثبيت ⭐
...
338. **web-search** — `skills-101/superpowers/web-search` · 74,752 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill web-search`

339. **wonda-cli** — `degausai/wonda/wonda-cli` · 74,605 تثبيت
...
340. **agent-tools** — `skills-101/superpowers/agent-tools` · 74,420 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill agent-tools`

341. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 74,407 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

342. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 74,376 تثبيت ⭐
...
343. **remotion-render** — `skills-101/superpowers/remotion-render` · 74,374 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill remotion-render`

344. **python-executor** — `skills-101/superpowers/python-executor` · 74,371 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

345. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 74,270 تثبيت
...
346. **css-animations** — `heygen-com/hyperframes/css-animations` · 74,186 تثبيت
...
347. **prototype** — `emilkowalski/skills/prototype` · 73,878 تثبيت
...
348. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 73,344 تثبيت
...
349. **notion-api** — `intellectronica/agent-skills/notion-api` · 72,865 تثبيت
...
350. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 72,648 تثبيت
...
351. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,357 تثبيت
...
352. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 72,276 تثبيت
...
353. **animejs** — `heygen-com/hyperframes/animejs` · 71,810 تثبيت
...
354. **remotion-create** — `remotion-dev/skills/remotion-create` · 71,539 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

355. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 71,223 تثبيت
...
356. **three** — `heygen-com/hyperframes/three` · 71,091 تثبيت
...
357. **lottie** — `heygen-com/hyperframes/lottie` · 70,824 تثبيت
...
358. **internal-comms** — `anthropics/skills/internal-comms` · 70,662 تثبيت ⭐
...
359. **waapi** — `heygen-com/hyperframes/waapi` · 70,451 تثبيت
...
360. **audit-website** — `squirrelscan/skills/audit-website` · 70,404 تثبيت
...
361. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 70,322 تثبيت
...
362. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 70,161 تثبيت ⭐
...
363. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 69,573 تثبيت ⭐
...
364. **implement-spec** — `mattpocock/skills/implement-spec` · 69,492 تثبيت
   You have been provided a spec. This spec should have tickets associated with it, describing how to implement the spec.
   `npx skills add https://github.com/mattpocock/skills --skill implement-spec`

365. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 69,258 تثبيت ⭐
...
366. **turborepo** — `vercel/turborepo/turborepo` · 68,567 تثبيت ⭐
...
367. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 67,812 تثبيت
...
368. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,742 تثبيت
...
369. **gws-drive** — `googleworkspace/cli/gws-drive` · 67,624 تثبيت ⭐
...
370. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 67,464 تثبيت
...
371. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 67,204 تثبيت ⭐
...
372. **defuddle** — `kepano/obsidian-skills/defuddle` · 66,828 تثبيت
...
373. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 66,660 تثبيت ⭐
...
374. **typeset** — `pbakaus/impeccable/typeset` · 66,197 تثبيت
...
375. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 65,638 تثبيت ⭐
...
376. **video** — `coreyhaines31/marketingskills/video` · 65,456 تثبيت
...
377. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 65,455 تثبيت ⭐
...
378. **image** — `coreyhaines31/marketingskills/image` · 65,368 تثبيت
...
379. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 65,209 تثبيت
...
380. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 64,426 تثبيت ⭐
...
381. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 64,363 تثبيت
...
386. **template-skill** — `anthropics/skills/template-skill` · 63,574 تثبيت ⭐
   Replace with description of the skill and when Claude should use it.
   `npx skills add https://github.com/anthropics/skills --skill template-skill`

387. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 63,562 تثبيت ⭐
...
388. **durable-objects** — `cloudflare/skills/durable-objects` · 63,560 تثبيت ⭐
...
389. **claude-api** — `anthropics/skills/claude-api` · 62,918 تثبيت ⭐
...
390. **tailwind-design-system** — `wshobson/agents/tailwind-design-system` · 62,647 تثبيت
   CSS-first design system framework for Tailwind v4 with tokens, components, and responsive patterns.
   `npx skills add https://github.com/wshobson/agents --skill tailwind-design-system`

391. **developing-genkit-js** — `firebase/agent-skills/developing-genkit-js` · 62,580 تثبيت ⭐
...
392. **cro** — `coreyhaines31/marketingskills/cro` · 62,515 تثبيت
   Conversion Rate Optimization (CRO)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill cro`

393. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,411 تثبيت
   Cross-Border E-Commerce ✈️
   `npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill cross-border-ecommerce`

394. **developing-genkit-dart** — `firebase/agent-skills/developing-genkit-dart` · 62,265 تثبيت ⭐
...
395. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,891 تثبيت
...
396. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,889 تثبيت
...
397. **stripe-projects** — `stripe/ai/stripe-projects` · 61,810 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

398. **agents-sdk** — `cloudflare/skills/agents-sdk` · 61,309 تثبيت ⭐
...
399. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 60,988 تثبيت ⭐
...
400. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 60,961 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

401. **design-md** — `google-labs-code/stitch-skills/design-md` · 60,871 تثبيت ⭐
...
402. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 60,602 تثبيت
...
403. **animate** — `emilkowalski/skills/animate` · 60,004 تثبيت
...
404. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 59,858 تثبيت ⭐
...
405. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 59,745 تثبيت ⭐
...
406. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 59,681 تثبيت ⭐
...
407. **gpt-image-2** — `prime-skills/runcomfy-agent-skills/gpt-image-2` · 59,642 تثبيت
   GPT Image 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill gpt-image-2`

408. **social** — `coreyhaines31/marketingskills/social` · 59,530 تثبيت
...
409. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 59,374 تثبيت ⭐
...
410. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 59,275 تثبيت ⭐
...
411. **analytics** — `coreyhaines31/marketingskills/analytics` · 59,157 تثبيت
...
412. **building-native-ui** — `expo/skills/building-native-ui` · 59,129 تثبيت ⭐
...
413. **gws-shared** — `googleworkspace/cli/gws-shared` · 59,056 تثبيت ⭐
...
414. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 58,705 تثبيت
...
415. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,501 تثبيت
...
416. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,137 تثبيت
...
417. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,120 تثبيت
...
418. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 58,046 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

419. **lark-meeting** — `open.feishu.cn/lark-meeting` · 57,914 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

420. **ads** — `coreyhaines31/marketingskills/ads` · 57,756 تثبيت
...
421. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,629 تثبيت
...
422. **agently-mail** — `agent.qq.com/agently-mail` · 57,308 تثبيت
   通过 agently-cli 命令行工具操作邮件，通过管理端 (agent.qq.com) 进行后台管理。
   `npx skills add https://agent.qq.com/`

423. **pricing** — `coreyhaines31/marketingskills/pricing` · 57,213 تثبيت
...
424. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 57,021 تثبيت
...
425. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 56,846 تثبيت ⭐
...
426. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,709 تثبيت
...
427. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,602 تثبيت
...
428. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,382 تثبيت
...
429. **competitors** — `coreyhaines31/marketingskills/competitors` · 56,247 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

430. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,148 تثبيت
...
431. **expo-dev-client** — `expo/skills/expo-dev-client` · 55,924 تثبيت ⭐
...
432. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 55,793 تثبيت
...
433. **normalize** — `pbakaus/impeccable/normalize` · 55,775 تثبيت
...
434. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 55,753 تثبيت
...
435. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,752 تثبيت
...
436. **retro** — `mattpocock/skills/retro` · 55,708 تثبيت
   The user has asked for a retrospective. You are suggesting improvements to the coding agent's environment to improve future runs.
   `npx skills add https://github.com/mattpocock/skills --skill retro`

437. **schema** — `coreyhaines31/marketingskills/schema` · 55,597 تثبيت
...
438. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 55,549 تثبيت
   Cut the Curve — the technique catalog
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

439. **emails** — `coreyhaines31/marketingskills/emails` · 55,423 تثبيت
...
440. **launch** — `coreyhaines31/marketingskills/launch` · 55,367 تثبيت
...
441. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,308 تثبيت
...
442. **opentui** — `msmps/opentui-skill/opentui` · 55,292 تثبيت
...
443. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 55,289 تثبيت
...
444. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 55,226 تثبيت
...
445. **oversized-cursor** — `heygen-com/hyperframes/oversized-cursor` · 55,192 تثبيت
   Oversized Cursor — the eye-carrier
   `npx skills add https://github.com/heygen-com/hyperframes --skill oversized-cursor`

446. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 55,167 تثبيت ⭐
...
447. **nia** — `nozomio-labs/nia-skill/nia` · 55,078 تثبيت
...
448. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,803 تثبيت
...
449. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 54,758 تثبيت ⭐
...
450. **extract** — `pbakaus/impeccable/extract` · 54,693 تثبيت
...
451. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 54,632 تثبيت ⭐
...
452. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 54,615 تثبيت
...
453. **ab-testing** — `coreyhaines31/marketingskills/ab-testing` · 54,578 تثبيت
   You are an expert in experimentation and A/B testing. Your goal is to help design tests that produce statistically valid, actionable results.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill ab-testing`

454. **onboard** — `pbakaus/impeccable/onboard` · 54,529 تثبيت
...
455. **harden** — `pbakaus/impeccable/harden` · 54,458 تثبيت
...
456. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,278 تثبيت
...
457. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 54,214 تثبيت ⭐
...
458. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 53,895 تثبيت
...
459. **review-loop** — `2dmurali/review-loop-skill/review-loop` · 53,667 تثبيت
...
460. **gsap-core** — `greensock/gsap-skills/gsap-core` · 53,519 تثبيت
...
461. **aso** — `coreyhaines31/marketingskills/aso` · 53,414 تثبيت
...
462. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 53,347 تثبيت ⭐
...
463. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,192 تثبيت
...
464. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 52,953 تثبيت
...
465. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,893 تثبيت
...
466. **ai-sdk** — `vercel/ai/ai-sdk` · 52,776 تثبيت ⭐
...
467. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,715 تثبيت
...
468. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 52,581 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

469. **referrals** — `coreyhaines31/marketingskills/referrals` · 52,561 تثبيت
   Referral & Affiliate Programs
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill referrals`

470. **signup** — `coreyhaines31/marketingskills/signup` · 52,512 تثبيت
...
471. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,450 تثبيت
...
472. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 52,151 تثبيت ⭐
...
473. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,042 تثبيت
...
474. **popups** — `coreyhaines31/marketingskills/popups` · 52,024 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

475. **typegpu** — `heygen-com/hyperframes/typegpu` · 52,002 تثبيت
...
476. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 51,978 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

477. **archify** — `tt-a1i/archify/archify` · 51,731 تثبيت
...
478. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,708 تثبيت
...
479. **ponytail** — `dietrichgebert/ponytail/ponytail` · 51,689 تثبيت
   You are a lazy senior developer. Lazy means efficient, not careless. You have
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail`

480. **gws-docs** — `googleworkspace/cli/gws-docs` · 51,652 تثبيت ⭐
...
481. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 51,488 تثبيت
...
482. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,422 تثبيت
...
483. **hallmark** — `nutlope/hallmark/hallmark` · 50,812 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

484. **react:components** — `google-labs-code/stitch-skills/react:components` · 50,661 تثبيت ⭐
   Stitch to React Components
   `npx skills add https://github.com/google-labs-code/stitch-skills --skill react:components`

485. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 50,488 تثبيت
...
486. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 50,486 تثبيت ⭐
...
487. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 49,591 تثبيت
...
488. **developing-genkit-go** — `firebase/agent-skills/developing-genkit-go` · 49,537 تثبيت ⭐
...
489. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 49,496 تثبيت ⭐
...
490. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 49,372 تثبيت
...
491. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 48,574 تثبيت ⭐
...
492. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 48,469 تثبيت ⭐
...
493. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 48,364 تثبيت
...
494. **momentic-test** — `momentic-ai/skills/momentic-test` · 48,191 تثبيت
...
495. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 48,171 تثبيت
...
496. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 47,557 تثبيت ⭐
...
497. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 47,384 تثبيت
...
498. **gsap-react** — `greensock/gsap-skills/gsap-react` · 47,313 تثبيت
...
499. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,188 تثبيت ⭐
...
500. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 47,157 تثبيت
...
501. **compress** — `juliusbrussee/caveman/compress` · 46,778 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

502. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 46,257 تثبيت ⭐
...
503. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 46,214 تثبيت
...
504. **sms** — `coreyhaines31/marketingskills/sms` · 45,707 تثبيت
...
505. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 45,609 تثبيت ⭐
...
506. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 45,566 تثبيت
...
507. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 45,522 تثبيت
...
508. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 45,517 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

509. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 45,505 تثبيت
...
510. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 45,329 تثبيت
...
511. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 44,846 تثبيت ⭐
...
512. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,755 تثبيت
...
513. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 44,548 تثبيت
...
514. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 44,529 تثبيت
...
515. **git-commit** — `github/awesome-copilot/git-commit` · 44,273 تثبيت ⭐
...
516. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 44,264 تثبيت ⭐
...
517. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 44,157 تثبيت
...
518. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 43,971 تثبيت
...
519. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 43,950 تثبيت ⭐
...
520. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 43,940 تثبيت
...
521. **seo** — `addyosmani/web-quality-skills/seo` · 43,757 تثبيت
...
522. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 43,596 تثبيت ⭐
...
523. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 43,312 تثبيت
...
524. **mastra** — `mastra-ai/skills/mastra` · 43,247 تثبيت ⭐
...
525. **upgrading-expo** — `expo/skills/upgrading-expo` · 43,045 تثبيت ⭐
...
526. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 42,821 تثبيت ⭐
...
527. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 42,580 تثبيت
...
528. **byted-web-search** — `skills.volces.com/byted-web-search` · 41,789 تثبيت
...
529. **clerk-setup** — `clerk/skills/clerk-setup` · 41,572 تثبيت ⭐
...
530. **gws-gmail-triage** — `googleworkspace/cli/gws-gmail-triage` · 41,156 تثبيت ⭐
...
531. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 41,081 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

532. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 40,974 تثبيت ⭐
...
533. **expo-deployment** — `expo/skills/expo-deployment` · 40,945 تثبيت ⭐
...
534. **herdr** — `herdrdev/herdr/herdr` · 40,738 تثبيت
...
535. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 40,612 تثبيت ⭐
...
536. **weread-skills** — `tencent/wechatreading/weread-skills` · 40,532 تثبيت
   通过 Agent API Gateway 调用微信读书接口，提供搜索、书架、笔记、书评等能力。
   `npx skills add https://github.com/tencent/wechatreading --skill weread-skills`

537. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 40,455 تثبيت
...
538. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 40,373 تثبيت
...
539. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 40,371 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

540. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 40,353 تثبيت ⭐
...
541. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 40,339 تثبيت
...
542. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 40,315 تثبيت
...
543. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 40,311 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

544. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 40,295 تثبيت
...
545. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 40,277 تثبيت
...
546. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 40,249 تثبيت
...
547. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 40,218 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

548. **arrange** — `pbakaus/impeccable/arrange` · 40,151 تثبيت
...
549. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 39,956 تثبيت
...
550. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 39,926 تثبيت ⭐
...
551. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 39,806 تثبيت
...
552. **insforge** — `insforge/insforge-skills/insforge` · 39,571 تثبيت
   InsForge App Integration Skill
   `npx skills add https://github.com/insforge/insforge-skills --skill insforge`

553. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 39,464 تثبيت
...
554. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 39,297 تثبيت
...
555. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 39,264 تثبيت ⭐
...
556. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 39,262 تثبيت
...
557. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 39,173 تثبيت
...
561. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 38,591 تثبيت
...
562. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 38,539 تثبيت
...
563. **golang-security** — `samber/cc-skills-golang/golang-security` · 38,463 تثبيت
...
564. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 38,396 تثبيت ⭐
...
565. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 38,145 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

566. **last30days** — `mvanhorn/last30days-skill/last30days` · 38,096 تثبيت
...
567. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 38,057 تثبيت
...
568. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 37,993 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

569. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 37,978 تثبيت
...
570. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,867 تثبيت ⭐
...
571. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 37,513 تثبيت
...
572. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 37,501 تثبيت
...
573. **golang-context** — `samber/cc-skills-golang/golang-context` · 37,500 تثبيت
...
574. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 37,472 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

575. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,471 تثبيت
...
576. **product-photography** — `skills-101/superpowers/product-photography` · 37,454 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

577. **gws-slides** — `googleworkspace/cli/gws-slides` · 37,451 تثبيت ⭐
...
578. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 37,401 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

579. **golang-database** — `samber/cc-skills-golang/golang-database` · 37,395 تثبيت
...
580. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 37,388 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

581. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 37,380 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

582. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 37,378 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

583. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 37,377 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

584. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 37,376 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

585. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 37,359 تثبيت
...
586. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 37,294 تثبيت
...
587. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 37,262 تثبيت
...
588. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 37,240 تثبيت
...
589. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 37,175 تثبيت
...
590. **firebase-firestore-standard** — `firebase/agent-skills/firebase-firestore-standard` · 37,116 تثبيت ⭐
...
591. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 37,076 تثبيت
...
592. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 37,044 تثبيت ⭐
...
593. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 36,997 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

594. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 36,932 تثبيت
...
595. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 36,918 تثبيت
...
596. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 36,794 تثبيت
...
597. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 36,743 تثبيت
...
598. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 36,723 تثبيت
...
599. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 36,643 تثبيت
...
600. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 36,617 تثبيت
...
601. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 36,557 تثبيت
...
602. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 36,552 تثبيت
...
603. **clerk-orgs** — `clerk/skills/clerk-orgs` · 36,513 تثبيت ⭐
...
604. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 36,459 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

605. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 36,458 تثبيت
...
606. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 36,446 تثبيت
...
607. **design-mobile-apps** — `designed-by-ai/skills/design-mobile-apps` · 36,375 تثبيت
...
608. **firebase-firestore-enterprise-native-mode** — `firebase/agent-skills/firebase-firestore-enterprise-native-mode` · 36,053 تثبيت ⭐
...
609. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 35,960 تثبيت
...
610. **gws-forms** — `googleworkspace/cli/gws-forms` · 35,953 تثبيت ⭐
...
611. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 35,897 تثبيت
...
612. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 35,794 تثبيت
...
613. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 35,768 تثبيت
...
614. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 35,754 تثبيت
...
615. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 35,726 تثبيت
...
616. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 35,709 تثبيت
...
617. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 35,696 تثبيت
...
618. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 35,676 تثبيت
...
619. **offers** — `coreyhaines31/marketingskills/offers` · 35,641 تثبيت
...
620. **value** — `hugmouse/skills/value` · 35,526 تثبيت
   This skill does absolutely nothing.
   `npx skills add https://github.com/hugmouse/skills --skill value`

621. **gws-meet** — `googleworkspace/cli/gws-meet` · 35,421 تثبيت ⭐
...
622. **clerk-testing** — `clerk/skills/clerk-testing` · 35,195 تثبيت ⭐
   https://clerk.com/docs/guides/development/testing/overview
   `npx skills add https://github.com/clerk/skills --skill clerk-testing`

623. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 35,016 تثبيت
...
624. **replicas-agent** — `replicas-group/skill/replicas-agent` · 35,002 تثبيت
...
625. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 34,937 تثبيت
...
626. **karpathy-guidelines** — `multica-ai/andrej-karpathy-skills/karpathy-guidelines` · 34,936 تثبيت
   Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   `npx skills add https://github.com/multica-ai/andrej-karpathy-skills --skill karpathy-guidelines`

627. **vitest** — `antfu/skills/vitest` · 34,737 تثبيت
...
628. **vite** — `antfu/skills/vite` · 34,655 تثبيت
...
629. **caveman-optimize** — `juliusbrussee/caveman/caveman-optimize` · 34,593 تثبيت
   Evaluate an optimization observation
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-optimize`

630. **firebase-ai-logic** — `firebase/agent-skills/firebase-ai-logic` · 34,579 تثبيت ⭐
...
631. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 34,541 تثبيت
...
632. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 34,507 تثبيت
...
633. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 34,430 تثبيت
...
634. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 34,422 تثبيت
...
635. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 34,335 تثبيت
...
636. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 34,323 تثبيت
...
637. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 34,277 تثبيت
...
638. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 34,260 تثبيت
...
639. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 34,228 تثبيت
...
640. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 34,165 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

641. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 34,163 تثبيت
...
642. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 34,110 تثبيت
...
643. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 34,107 تثبيت
...
644. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 34,041 تثبيت
...
645. **lean-build** — `juliusbrussee/caveman/lean-build` · 34,010 تثبيت
...
646. **caveman-manage** — `juliusbrussee/caveman/caveman-manage` · 34,005 تثبيت
   Manage eval-gated experiments
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-manage`

647. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 33,970 تثبيت
...
648. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 33,943 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

649. **angular-developer** — `angular/skills/angular-developer` · 33,937 تثبيت
...
650. **migration** — `juliusbrussee/caveman/migration` · 33,840 تثبيت
...
651. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 33,670 تثبيت ⭐
...
652. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,636 تثبيت ⭐
...
653. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 33,618 تثبيت ⭐
...
654. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 33,611 تثبيت
...
655. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 33,599 تثبيت
...
656. **sandbox-sdk** — `cloudflare/skills/sandbox-sdk` · 33,494 تثبيت ⭐
   Build secure, isolated code execution environments on Cloudflare Workers.
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-sdk`

657. **self-improving-agent** — `zhaono1/agent-playbook/self-improving-agent` · 33,452 تثبيت
...
658. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 33,430 تثبيت
...
659. **gws-keep** — `googleworkspace/cli/gws-keep` · 33,416 تثبيت ⭐
...
660. **wind-find-finance-skill** — `wind-information-co-ltd/wind-skills/wind-find-finance-skill` · 33,381 تثبيت
...
661. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 33,314 تثبيت
...
662. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 33,291 تثبيت
...
663. **performance** — `addyosmani/web-quality-skills/performance` · 33,283 تثبيت
...
664. **expo-module** — `expo/skills/expo-module` · 33,250 تثبيت ⭐
...
665. **vue** — `antfu/skills/vue` · 33,167 تثبيت
...
666. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 33,130 تثبيت ⭐
...
667. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 32,935 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

668. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 32,928 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

669. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,854 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

670. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 32,724 تثبيت ⭐
...
671. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,555 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

672. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 32,513 تثبيت
...
673. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 32,512 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

674. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,509 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

675. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,489 تثبيت
...
676. **animate-expo** — `emilkowalski/skills/animate-expo` · 32,308 تثبيت
   Building Animations in Expo
   `npx skills add https://github.com/emilkowalski/skills --skill animate-expo`

677. **improve** — `shadcn/improve/improve` · 32,092 تثبيت
...
678. **ckm:brand** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:brand` · 32,055 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

679. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 32,046 تثبيت
...
680. **ckm:banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:banner-design` · 32,027 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

681. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 31,980 تثبيت
...
682. **ckm:slides** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:slides` · 31,938 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

683. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 31,910 تثبيت ⭐
...
684. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 31,798 تثبيت
...
685. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 31,743 تثبيت ⭐
...
686. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,563 تثبيت ⭐
...
687. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 31,514 تثبيت ⭐
...
688. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 31,495 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

689. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 31,381 تثبيت ⭐
...
690. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 31,358 تثبيت ⭐
...
691. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 31,294 تثبيت
...
692. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,282 تثبيت ⭐
...
693. **baoyu-infographic** — `jimliu/baoyu-skills/baoyu-infographic` · 31,270 تثبيت
...
694. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 31,247 تثبيت ⭐
...
695. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 31,194 تثبيت ⭐
...
696. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 31,164 تثبيت
...
697. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 31,148 تثبيت ⭐
...
698. **tavily-search** — `tavily-ai/skills/tavily-search` · 31,148 تثبيت ⭐
...
699. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 31,132 تثبيت ⭐
...
700. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 31,122 تثبيت ⭐
...
701. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 31,117 تثبيت ⭐
...
702. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 31,080 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

703. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 31,064 تثبيت
...
704. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 31,048 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

705. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 31,048 تثبيت ⭐
...
706. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 31,031 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

707. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 30,928 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

708. **use-dom** — `expo/skills/use-dom` · 30,928 تثبيت ⭐
...
709. **shape** — `pbakaus/impeccable/shape` · 30,828 تثبيت
...
710. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 30,816 تثبيت
...
711. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 30,749 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

712. **swiftui-expert-skill** — `avdlee/swiftui-agent-skill/swiftui-expert-skill` · 30,727 تثبيت
   Expert SwiftUI code review, refactoring, and implementation guidance with iOS 26+ and macOS support.
   `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill swiftui-expert-skill`

713. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 30,622 تثبيت
...
714. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 30,198 تثبيت ⭐
...
715. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 30,150 تثبيت
...
716. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 30,132 تثبيت
...
717. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 30,126 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

718. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 29,989 تثبيت ⭐
...
719. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 29,976 تثبيت ⭐
...
720. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 29,926 تثبيت
...
721. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,878 تثبيت ⭐
...
722. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 29,776 تثبيت
...
723. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,754 تثبيت
...
724. **gws-chat** — `googleworkspace/cli/gws-chat` · 29,625 تثبيت ⭐
...
725. **gws-people** — `googleworkspace/cli/gws-people` · 29,484 تثبيت ⭐
...
726. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 29,450 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

727. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 29,447 تثبيت ⭐
...
728. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 29,392 تثبيت ⭐
...
729. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 29,366 تثبيت
...
730. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 29,249 تثبيت ⭐
...
731. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 29,189 تثبيت ⭐
...
732. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 29,159 تثبيت
...
733. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 29,143 تثبيت ⭐
...
734. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 29,090 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

735. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 29,080 تثبيت
...
736. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 29,051 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

737. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 28,998 تثبيت
...
738. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 28,902 تثبيت ⭐
...
739. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 28,868 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

740. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 28,747 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

741. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 28,649 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

742. **baoyu-comic** — `jimliu/baoyu-skills/baoyu-comic` · 28,647 تثبيت
...
743. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 28,552 تثبيت ⭐
...
744. **gws-chat-send** — `googleworkspace/cli/gws-chat-send` · 28,517 تثبيت ⭐
   Send plain-text messages to Google Chat spaces.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-chat-send`

745. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 28,498 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

746. **recipe-draft-email-from-doc** — `googleworkspace/cli/recipe-draft-email-from-doc` · 28,417 تثبيت ⭐
...
747. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 28,402 تثبيت ⭐
...
748. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 28,353 تثبيت ⭐
...
749. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 28,305 تثبيت ⭐
...
750. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 28,304 تثبيت ⭐
...
751. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 28,298 تثبيت ⭐
...
752. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 28,272 تثبيت
...
753. **gws-events** — `googleworkspace/cli/gws-events` · 28,192 تثبيت ⭐
...
754. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 28,128 تثبيت ⭐
...
755. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 27,951 تثبيت ⭐
...
756. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 27,928 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

757. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 27,906 تثبيت
...
758. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 27,901 تثبيت ⭐
...
759. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 27,882 تثبيت
...
760. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 27,851 تثبيت ⭐
...
761. **azure-postgres** — `microsoft/azure-skills/azure-postgres` · 27,850 تثبيت ⭐
   No SKILL.md available for this skill.
   `npx skills add https://github.com/microsoft/azure-skills --skill azure-postgres`

762. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 27,821 تثبيت ⭐
...
763. **api-design-principles** — `wshobson/agents/api-design-principles` · 27,791 تثبيت
...
764. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 27,782 تثبيت
...
765. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 27,755 تثبيت ⭐
...
766. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 27,698 تثبيت
...
767. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 27,690 تثبيت ⭐
...
768. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 27,611 تثبيت ⭐
...
769. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 27,579 تثبيت ⭐
...
770. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 27,575 تثبيت
...
771. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 27,564 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

772. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 27,559 تثبيت ⭐
...
773. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 27,559 تثبيت ⭐
...
774. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 27,545 تثبيت ⭐
...
775. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 27,545 تثبيت ⭐
...
776. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 27,543 تثبيت ⭐
...
777. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 27,517 تثبيت ⭐
...
778. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 27,454 تثبيت ⭐
...
779. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 27,403 تثبيت ⭐
...
780. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 27,361 تثبيت ⭐
...
781. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 27,281 تثبيت
...
782. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 27,256 تثبيت ⭐
...
783. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 27,255 تثبيت ⭐
...
784. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 27,225 تثبيت ⭐
...
785. **eas-update-insights** — `expo/skills/eas-update-insights` · 27,210 تثبيت ⭐
...
786. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 27,203 تثبيت ⭐
...
787. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 27,194 تثبيت ⭐
...
788. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 27,179 تثبيت ⭐
...
789. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 27,166 تثبيت ⭐
...
790. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 27,130 تثبيت
...
791. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 27,099 تثبيت ⭐
...
792. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 27,084 تثبيت ⭐
...
793. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 27,078 تثبيت ⭐
...
794. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 27,073 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

795. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 27,035 تثبيت
...
796. **layout** — `pbakaus/impeccable/layout` · 27,024 تثبيت
...
797. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 27,008 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

798. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 27,008 تثبيت ⭐
...
799. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 27,006 تثبيت
...
800. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 26,978 تثبيت ⭐
...
801. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 26,963 تثبيت ⭐
...
802. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 26,949 تثبيت
...
803. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 26,937 تثبيت ⭐
...
804. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 26,902 تثبيت ⭐
...
805. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 26,869 تثبيت ⭐
...
806. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 26,846 تثبيت ⭐
...
807. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 26,844 تثبيت ⭐
...
808. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 26,834 تثبيت ⭐
...
809. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 26,834 تثبيت ⭐
...
810. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 26,816 تثبيت ⭐
...
811. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 26,790 تثبيت
...
812. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 26,778 تثبيت ⭐
...
813. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 26,774 تثبيت
...
814. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 26,766 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

815. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 26,756 تثبيت ⭐
...
816. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 26,754 تثبيت ⭐
...
817. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 26,745 تثبيت ⭐
...
818. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 26,709 تثبيت ⭐
...
819. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,691 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

820. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 26,638 تثبيت ⭐
...
821. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 26,628 تثبيت ⭐
...
822. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 26,569 تثبيت ⭐
...
823. **golang-linter** — `samber/cc-skills-golang/golang-linter` · 26,543 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/samber/cc-skills-golang --skill golang-linter`

824. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 26,495 تثبيت ⭐
...
825. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 26,419 تثبيت ⭐
...
826. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 26,404 تثبيت ⭐
...
827. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 26,341 تثبيت ⭐
...
828. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 26,312 تثبيت ⭐
...
829. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 26,260 تثبيت ⭐
...
830. **interview-me** — `addyosmani/agent-skills/interview-me` · 26,111 تثبيت
...
831. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,096 تثبيت
...
832. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 26,005 تثبيت ⭐
...
833. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 25,854 تثبيت
...
834. **write-swift** — `emilkowalski/skills/write-swift` · 25,723 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/emilkowalski/skills --skill write-swift`

835. **interface-design** — `dammyjay93/interface-design/interface-design` · 25,721 تثبيت
...
836. **design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/design-system` · 25,708 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

837. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 25,626 تثبيت
...
838. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,471 تثبيت ⭐
...
839. **clerk** — `clerk/skills/clerk` · 25,467 تثبيت ⭐
...
840. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 25,456 تثبيت
...
841. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 25,310 تثبيت
...
842. **build-tam** — `code.deepline.com/build-tam` · 25,182 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

843. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 25,156 تثبيت
...
844. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 25,140 تثبيت
...
845. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 25,092 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

846. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 25,083 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

847. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 25,075 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

848. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 25,048 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

849. **sandbox-stable** — `cloudflare/skills/sandbox-stable` · 24,972 تثبيت ⭐
   Sandbox SDK — stable package
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-stable`

850. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 24,944 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

851. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 24,923 تثبيت
...
852. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 24,890 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

853. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 24,845 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

854. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 24,835 تثبيت ⭐
...
855. **sandbox-next** — `cloudflare/skills/sandbox-next` · 24,743 تثبيت ⭐
   Sandbox SDK — @next (1.0 preview)
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-next`

856. **stripe-directory** — `docs.stripe.com/stripe-directory` · 24,738 تثبيت
...
857. **sandbox-migrate-to-next** — `cloudflare/skills/sandbox-migrate-to-next` · 24,703 تثبيت ⭐
...
858. **review-pr** — `warpdotdev/common-skills/review-pr` · 24,521 تثبيت
...
859. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 24,449 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

860. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 24,430 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

861. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 24,360 تثبيت
...
862. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 24,347 تثبيت
...
863. **release-skills** — `jimliu/baoyu-skills/release-skills` · 24,343 تثبيت
...
864. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 24,311 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

865. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 24,292 تثبيت
...
866. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 24,258 تثبيت
...
867. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 24,246 تثبيت
...
868. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 24,213 تثبيت
...
869. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 24,196 تثبيت
...
870. **create-pr** — `warpdotdev/common-skills/create-pr` · 24,187 تثبيت
...
871. **update-skill** — `warpdotdev/common-skills/update-skill` · 24,162 تثبيت
...
872. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 24,147 تثبيت
...
873. **dbs** — `dontbesilent2025/dbskill/dbs` · 24,121 تثبيت
   你是 dontbesilent 商业工具箱的公开入口。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs`

874. **brandalf** — `warpdotdev/common-skills/brandalf` · 23,893 تثبيت
...
875. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 23,858 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

876. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 23,824 تثبيت
...
877. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 23,819 تثبيت
...
878. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 23,780 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

879. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 23,652 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

880. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 23,580 تثبيت ⭐
...
881. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 23,539 تثبيت
...
882. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 23,435 تثبيت
...
883. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 23,415 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

884. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 23,373 تثبيت
...
885. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 23,300 تثبيت
...
886. **council** — `warpdotdev/common-skills/council` · 23,279 تثبيت
...
887. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 22,942 تثبيت ⭐
...
888. **gws-script** — `googleworkspace/cli/gws-script` · 22,811 تثبيت ⭐
...
889. **prd** — `github/awesome-copilot/prd` · 22,798 تثبيت ⭐
...
890. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 22,714 تثبيت
...
895. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 22,537 تثبيت
...
896. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 22,535 تثبيت ⭐
...
897. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 22,512 تثبيت
...
898. **clerk-cli** — `clerk/skills/clerk-cli` · 22,426 تثبيت ⭐
...
899. **nuxt** — `antfu/skills/nuxt` · 22,222 تثبيت
...
900. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 22,087 تثبيت
...
901. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 21,924 تثبيت
...
902. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,907 تثبيت ⭐
...
903. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 21,705 تثبيت
...
904. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 21,670 تثبيت
...
905. **refactor** — `github/awesome-copilot/refactor` · 21,528 تثبيت ⭐
   Surgical code refactoring to improve maintainability without changing behavior.
   `npx skills add https://github.com/github/awesome-copilot --skill refactor`

906. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 21,455 تثبيت
...
907. **laravel-specialist** — `jeffallan/claude-skills/laravel-specialist` · 21,343 تثبيت
...
908. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 21,220 تثبيت
...
909. **prompt-engineering-patterns** — `wshobson/agents/prompt-engineering-patterns` · 20,964 تثبيت
...
910. **vueuse-functions** — `antfu/skills/vueuse-functions` · 20,951 تثبيت
...
911. **skill-vetter** — `useai-pro/openclaw-skills-security/skill-vetter` · 20,930 تثبيت
...
912. **mediabunny** — `remotion-dev/skills/mediabunny` · 20,923 تثبيت ⭐
   Mediabunny is a multimedia library for dealing with audio and video in the browser.
   `npx skills add https://github.com/remotion-dev/skills --skill mediabunny`

913. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 20,894 تثبيت
...
914. **validate-changes-match-specs** — `warpdotdev/common-skills/validate-changes-match-specs` · 20,826 تثبيت
   Validate changes match specs
   `npx skills add https://github.com/warpdotdev/common-skills --skill validate-changes-match-specs`

915. **error-handling-patterns** — `wshobson/agents/error-handling-patterns` · 20,774 تثبيت
...
916. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 20,761 تثبيت
...
917. **baoyu-post-to-weibo** — `jimliu/baoyu-skills/baoyu-post-to-weibo` · 20,609 تثبيت
...
918. **dbs-chatroom** — `dontbesilent2025/dbskill/dbs-chatroom` · 20,501 تثبيت
   你是定向聊天室的主持人。根据话题推荐或接受用户指定的专家，模拟多角色对话。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-chatroom`

919. **ponytail-review** — `dietrichgebert/ponytail/ponytail-review` · 20,490 تثبيت
   Review diffs for unnecessary complexity. One line per finding: location, what
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-review`

920. **firestore-security-rules-auditor** — `firebase/agent-skills/firestore-security-rules-auditor` · 20,413 تثبيت ⭐
...
921. **dbs-chatroom-austrian** — `dontbesilent2025/dbskill/dbs-chatroom-austrian` · 20,408 تثبيت
   dbs-chatroom-austrian：奥派经济聊天室
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-chatroom-austrian`

922. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 20,335 تثبيت ⭐
...
923. **dbs-agent-migration** — `dontbesilent2025/dbskill/dbs-agent-migration` · 20,276 تثبيت
   dbs-agent-migration：Agent 工作台迁移
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-agent-migration`

924. **pnpm** — `antfu/skills/pnpm` · 20,254 تثبيت
...
925. **marketing-mindset** — `axelfreeman/marketing-mindset/marketing-mindset` · 20,007 تثبيت
...
926. **wecomcli-doc** — `wecomteam/wecom-cli/wecomcli-doc` · 19,989 تثبيت
...
927. **python-design-patterns** — `wshobson/agents/python-design-patterns` · 19,934 تثبيت
...
928. **gemini-api-dev** — `google-gemini/gemini-skills/gemini-api-dev` · 19,926 تثبيت ⭐
...
929. **java-springboot** — `github/awesome-copilot/java-springboot` · 19,870 تثبيت ⭐
...
930. **baoyu-youtube-transcript** — `jimliu/baoyu-skills/baoyu-youtube-transcript` · 19,849 تثبيت
...
931. **wecomcli-todo** — `wecomteam/wecom-cli/wecomcli-todo` · 19,798 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-todo`

932. **wecomcli-contact** — `wecomteam/wecom-cli/wecomcli-contact` · 19,756 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-contact`

933. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 19,715 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

934. **wecomcli-meeting** — `wecomteam/wecom-cli/wecomcli-meeting` · 19,707 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-meeting`

935. **opencli-usage** — `jackwener/opencli/opencli-usage` · 19,482 تثبيت
...
936. **pricewin-hotel-deal-finder** — `price-win/pricewin-skills-hub/pricewin-hotel-deal-finder` · 19,386 تثبيت
   PriceWin Hotel Deal Finder
   `npx skills add https://github.com/price-win/pricewin-skills-hub --skill pricewin-hotel-deal-finder`

937. **dbs-slowisfast** — `dontbesilent2025/dbskill/dbs-slowisfast` · 19,311 تثبيت
...
938. **html-ppt** — `lewislulu/html-ppt-skill/html-ppt` · 19,235 تثبيت
   html-ppt — HTML PPT Studio
   `npx skills add https://github.com/lewislulu/html-ppt-skill --skill html-ppt`

939. **dbs-report** — `dontbesilent2025/dbskill/dbs-report` · 19,181 تثبيت
...
940. **dbs-save** — `dontbesilent2025/dbskill/dbs-save` · 19,159 تثبيت
...
941. **dbs-restore** — `dontbesilent2025/dbskill/dbs-restore` · 19,150 تثبيت
...
942. **ponytail-audit** — `dietrichgebert/ponytail/ponytail-audit` · 19,104 تثبيت
   ponytail-review, repo-wide. Scan the whole tree instead of a diff. Rank
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-audit`

943. **security-requirement-extraction** — `wshobson/agents/security-requirement-extraction` · 19,066 تثبيت
   Transform threat analysis into actionable security requirements.
   `npx skills add https://github.com/wshobson/agents --skill security-requirement-extraction`

944. **baseline-ui** — `ibelick/ui-skills/baseline-ui` · 19,019 تثبيت
...
945. **dbs-goal** — `dontbesilent2025/dbskill/dbs-goal` · 18,976 تثبيت
...
946. **modern-web-guidance** — `googlechrome/modern-web-guidance/modern-web-guidance` · 18,921 تثبيت
   A skill to search for specific web development use cases and retrieve their corresponding best practice guides.
   `npx skills add https://github.com/googlechrome/modern-web-guidance --skill modern-web-guidance`

947. **expo-ui** — `expo/skills/expo-ui` · 18,711 تثبيت ⭐
...
948. **modern-javascript-patterns** — `wshobson/agents/modern-javascript-patterns` · 18,700 تثبيت
...
949. **find-qualified-titles** — `code.deepline.com/find-qualified-titles` · 18,518 تثبيت
   Find Qualified Titles (company_titles -> ICP filter -> contacts)
   `npx skills add https://code.deepline.com/`

950. **javascript-testing-patterns** — `wshobson/agents/javascript-testing-patterns` · 18,422 تثبيت
...
951. **feature-sliced-design** — `feature-sliced/skills/feature-sliced-design` · 18,395 تثبيت
   Feature-Sliced Design (FSD) v2.1
   `npx skills add https://github.com/feature-sliced/skills --skill feature-sliced-design`

952. **opencli-browser** — `jackwener/opencli/opencli-browser` · 18,314 تثبيت
...
953. **vue-router-best-practices** — `antfu/skills/vue-router-best-practices` · 18,282 تثبيت
...
954. **aso-audit** — `coreyhaines31/marketingskills/aso-audit` · 18,009 تثبيت
...
955. **create-readme** — `github/awesome-copilot/create-readme` · 17,955 تثبيت ⭐
...
956. **rust-async-patterns** — `wshobson/agents/rust-async-patterns` · 17,904 تثبيت
...
957. **playwright-generate-test** — `github/awesome-copilot/playwright-generate-test` · 17,869 تثبيت ⭐
...
958. **responsive-design** — `wshobson/agents/responsive-design` · 17,779 تثبيت
...
959. **agent development** — `anthropics/claude-code/agent-development` · 17,722 تثبيت ⭐
   Agent Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Agent Development&#x27;`

960. **skill development** — `anthropics/claude-code/skill-development` · 17,528 تثبيت ⭐
   Skill Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Skill Development&#x27;`

961. **pinia** — `antfu/skills/pinia` · 17,407 تثبيت
...
962. **sql-optimization-patterns** — `wshobson/agents/sql-optimization-patterns` · 17,389 تثبيت
...
963. **planning-with-files-zh** — `othmanadi/planning-with-files/planning-with-files-zh` · 17,220 تثبيت
...
964. **fixing-accessibility** — `ibelick/ui-skills/fixing-accessibility` · 17,204 تثبيت
...
965. **the-news** — `sfkislev/the-news/the-news` · 17,165 تثبيت
...
966. **golang-pro** — `jeffallan/claude-skills/golang-pro` · 17,124 تثبيت
