...
**آخر تحديث:** 2026-09-14 · **العدد:** 1,017 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,385,326 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 1,132,800 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 966,833 تثبيت
...
4. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 923,844 تثبيت
...
7. **agent-browser** — `vercel-labs/agent-browser/agent-browser` · 845,130 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/vercel-labs/agent-browser --skill agent-browser`

8. **setup-matt-pocock-skills** — `mattpocock/skills/setup-matt-pocock-skills` · 827,162 تثبيت
...
9. **handoff** — `mattpocock/skills/handoff` · 797,429 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 779,931 تثبيت
...
11. **prototype** — `mattpocock/skills/prototype` · 773,995 تثبيت
...
12. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 710,096 تثبيت ⭐
   React and Next.js performance optimization across 70 rules prioritized by impact.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-react-best-practices`

13. **grilling** — `mattpocock/skills/grilling` · 691,619 تثبيت
...
14. **anti-ui-slop** — `uizze.com/anti-ui-slop` · 691,327 تثبيت
   Stop AI coding agents from shipping generic UI.
   `npx skills add https://uizze.com/`

15. **lark-doc** — `open.feishu.cn/lark-doc` · 688,515 تثبيت
...
16. **lark-base** — `open.feishu.cn/lark-base` · 688,355 تثبيت
...
17. **lark-drive** — `open.feishu.cn/lark-drive` · 688,177 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

18. **lark-shared** — `open.feishu.cn/lark-shared` · 687,779 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/`

19. **lark-approval** — `open.feishu.cn/lark-approval` · 687,729 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

20. **lark-im** — `open.feishu.cn/lark-im` · 687,667 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

21. **lark-calendar** — `open.feishu.cn/lark-calendar` · 687,568 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/`

22. **lark-sheets** — `open.feishu.cn/lark-sheets` · 687,260 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

23. **lark-wiki** — `open.feishu.cn/lark-wiki` · 687,018 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

24. **lark-contact** — `open.feishu.cn/lark-contact` · 686,933 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

25. **lark-minutes** — `open.feishu.cn/lark-minutes` · 686,832 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

26. **lark-slides** — `open.feishu.cn/lark-slides` · 686,602 تثبيت
   本技能文档较长，务必使用 Read 工具阅读两次，必须阅读完整全文。
   `npx skills add https://open.feishu.cn/`

27. **lark-event** — `open.feishu.cn/lark-event` · 686,596 تثبيت
...
28. **lark-mail** — `open.feishu.cn/lark-mail` · 686,573 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/`

29. **lark-task** — `open.feishu.cn/lark-task` · 686,565 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

30. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 686,545 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

31. **lark-attendance** — `open.feishu.cn/lark-attendance` · 686,453 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

32. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 686,394 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/`

33. **lark-vc** — `open.feishu.cn/lark-vc` · 686,188 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

34. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 686,066 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/`

35. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 685,932 تثبيت
...
36. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 685,780 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

37. **lark-okr** — `open.feishu.cn/lark-okr` · 667,168 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

38. **lark-markdown** — `open.feishu.cn/lark-markdown` · 652,527 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

39. **teach** — `mattpocock/skills/teach` · 647,466 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

40. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 630,925 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

41. **lark-vc-agent** — `open.feishu.cn/lark-vc-agent` · 630,772 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

42. **domain-modeling** — `mattpocock/skills/domain-modeling` · 626,638 تثبيت
...
43. **codebase-design** — `mattpocock/skills/codebase-design` · 607,420 تثبيت
...
44. **lark-apps** — `open.feishu.cn/lark-apps` · 597,003 تثبيت
...
45. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 596,164 تثبيت
...
50. **microsoft-foundry** — `microsoft/azure-skills/microsoft-foundry` · 587,439 تثبيت ⭐
   End-to-end deployment, evaluation, and management of AI agents on Microsoft Foundry.
   `npx skills add https://github.com/microsoft/azure-skills --skill microsoft-foundry`

51. **azure-diagnostics** — `microsoft/azure-skills/azure-diagnostics` · 579,265 تثبيت ⭐
...
52. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 578,783 تثبيت ⭐
...
53. **azure-ai** — `microsoft/azure-skills/azure-ai` · 578,580 تثبيت ⭐
...
54. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 578,525 تثبيت ⭐
...
55. **azure-validate** — `microsoft/azure-skills/azure-validate` · 577,976 تثبيت ⭐
...
56. **azure-storage** — `microsoft/azure-skills/azure-storage` · 577,429 تثبيت ⭐
...
57. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 577,171 تثبيت ⭐
...
58. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 576,937 تثبيت ⭐
...
59. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 576,914 تثبيت ⭐
...
60. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 576,852 تثبيت ⭐
...
61. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 576,830 تثبيت ⭐
...
62. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 576,601 تثبيت ⭐
...
63. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 576,523 تثبيت ⭐
...
64. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 566,242 تثبيت ⭐
...
65. **ask-matt** — `mattpocock/skills/ask-matt` · 552,663 تثبيت
   You don't remember every skill, so ask.
   `npx skills add https://github.com/mattpocock/skills --skill ask-matt`

66. **implement** — `mattpocock/skills/implement` · 548,658 تثبيت
   Implement the work described by the user in the spec or tickets.
   `npx skills add https://github.com/mattpocock/skills --skill implement`

67. **code-review** — `mattpocock/skills/code-review` · 544,528 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill code-review`

68. **hyperframes-cli** — `heygen-com/hyperframes/hyperframes-cli` · 542,305 تثبيت
...
69. **remotion-best-practices** — `remotion-dev/skills/remotion-best-practices` · 523,144 تثبيت ⭐
   Domain-specific knowledge base for building videos with Remotion and React.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices`

70. **azure-compute** — `microsoft/azure-skills/azure-compute` · 520,233 تثبيت ⭐
...
71. **hyperframes** — `heygen-com/hyperframes/hyperframes` · 518,254 تثبيت
...
72. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 510,256 تثبيت ⭐
...
73. **caveman** — `juliusbrussee/caveman/caveman` · 505,440 تثبيت
   Ultra-compressed communication mode cutting token usage ~75% while preserving technical accuracy.
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman`

74. **wayfinder** — `mattpocock/skills/wayfinder` · 503,795 تثبيت
...
75. **research** — `mattpocock/skills/research` · 497,523 تثبيت
   Spin up a background agent to do the research, so you keep working while it reads.
   `npx skills add https://github.com/mattpocock/skills --skill research`

76. **to-spec** — `mattpocock/skills/to-spec` · 496,236 تثبيت
...
77. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 490,062 تثبيت ⭐
...
78. **to-tickets** — `mattpocock/skills/to-tickets` · 487,533 تثبيت
   Break a plan, spec, or conversation into a set of tickets: tracer-bullet vertical slices, each declaring the tickets that block it.
   `npx skills add https://github.com/mattpocock/skills --skill to-tickets`

79. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 477,395 تثبيت
...
80. **video-edit** — `genmedia-labs/skills/video-edit` · 476,253 تثبيت
   Video Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/genmedia-labs/skills --skill video-edit`

81. **ai-music** — `genmedia-labs/skills/ai-music` · 475,681 تثبيت
...
82. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 475,453 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

83. **image-to-video** — `genmedia-labs/skills/image-to-video` · 475,119 تثبيت
   Image-to-Video — Pro Pack on RunComfy
   `npx skills add https://github.com/genmedia-labs/skills --skill image-to-video`

84. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 473,501 تثبيت
...
85. **lark-note** — `open.feishu.cn/lark-note` · 470,612 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

86. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,878 تثبيت
...
87. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,105 تثبيت
...
88. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 450,020 تثبيت
...
89. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 449,986 تثبيت
...
90. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 446,392 تثبيت ⭐
...
91. **reddit-automation** — `flowkit-labs/skills/reddit-automation` · 443,963 تثبيت
   Built by the team at doany.ai.
   `npx skills add https://github.com/flowkit-labs/skills --skill reddit-automation`

92. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 441,249 تثبيت ⭐
...
93. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 438,507 تثبيت ⭐
...
94. **hyperframes-core** — `heygen-com/hyperframes/hyperframes-core` · 423,751 تثبيت
...
99. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 416,624 تثبيت
...
100. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 416,076 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

101. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 415,903 تثبيت
...
102. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 415,901 تثبيت
...
103. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 415,855 تثبيت
...
104. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 415,684 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

105. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 413,036 تثبيت ⭐
...
106. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 411,264 تثبيت
...
107. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 405,888 تثبيت ⭐
...
108. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 399,477 تثبيت ⭐
...
109. **kling-3-0** — `prime-skills/runcomfy-agent-skills/kling-3-0` · 392,846 تثبيت
   Kling 3.0 - Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill kling-3-0`

110. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 390,388 تثبيت
...
111. **codex-pet** — `prime-skills/runcomfy-agent-skills/codex-pet` · 381,244 تثبيت
   Codex Pet — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill codex-pet`

112. **azure-cost** — `microsoft/azure-skills/azure-cost` · 381,118 تثبيت ⭐
...
113. **skill-creator** — `anthropics/skills/skill-creator` · 380,161 تثبيت ⭐
   Create, test, and iteratively improve AI agent skills with structured evaluation and benchmarking.
   `npx skills add https://github.com/anthropics/skills --skill skill-creator`

114. **to-prd** — `mattpocock/skills/to-prd` · 367,397 تثبيت
...
115. **brainstorming** — `obra/superpowers/brainstorming` · 361,375 تثبيت
   Structured design dialogue that validates ideas before implementation begins.
   `npx skills add https://github.com/obra/superpowers --skill brainstorming`

116. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 359,792 تثبيت
...
117. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 359,478 تثبيت
...
118. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 357,834 تثبيت
...
119. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 357,351 تثبيت
...
120. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 357,131 تثبيت
...
121. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 357,092 تثبيت
...
122. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 356,690 تثبيت
...
123. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 356,546 تثبيت
...
124. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 356,411 تثبيت
...
125. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 356,327 تثبيت
...
126. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 356,231 تثبيت
...
127. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 355,839 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

128. **caveman-commit** — `juliusbrussee/caveman/caveman-commit` · 354,527 تثبيت
...
129. **wizard** — `mattpocock/skills/wizard` · 354,502 تثبيت
...
130. **to-issues** — `mattpocock/skills/to-issues` · 354,356 تثبيت
...
131. **git-guardrails-claude-code** — `mattpocock/skills/git-guardrails-claude-code` · 353,024 تثبيت
   Sets up a PreToolUse hook that intercepts and blocks dangerous git commands before Claude executes them.
   `npx skills add https://github.com/mattpocock/skills --skill git-guardrails-claude-code`

132. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 351,015 تثبيت
...
133. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 350,581 تثبيت
...
134. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 349,377 تثبيت
...
139. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 339,282 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

140. **writing-beats** — `mattpocock/skills/writing-beats` · 339,088 تثبيت
...
141. **writing-shape** — `mattpocock/skills/writing-shape` · 338,585 تثبيت
...
142. **writing-fragments** — `mattpocock/skills/writing-fragments` · 338,450 تثبيت
...
143. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 335,717 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

144. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 334,091 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

145. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 325,001 تثبيت ⭐
...
146. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 323,048 تثبيت
...
147. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 322,291 تثبيت
...
148. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,228 تثبيت
...
149. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 311,014 تثبيت
...
150. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,958 تثبيت
...
151. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,639 تثبيت
...
152. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,613 تثبيت
...
153. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,479 تثبيت
...
154. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,464 تثبيت
...
155. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 307,395 تثبيت
...
156. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 302,199 تثبيت
...
157. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 301,113 تثبيت
...
158. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 300,899 تثبيت
...
159. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 300,210 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

160. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 299,485 تثبيت
...
161. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 299,382 تثبيت
...
162. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 299,126 تثبيت ⭐
...
163. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 298,621 تثبيت
...
164. **loop-me** — `mattpocock/skills/loop-me` · 292,991 تثبيت
...
165. **brandkit** — `leonxlnx/taste-skill/brandkit` · 290,115 تثبيت
...
166. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 285,286 تثبيت
...
167. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 283,331 تثبيت ⭐
...
168. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 283,323 تثبيت
...
169. **prisma-client-api** — `prisma/skills/prisma-client-api` · 282,894 تثبيت ⭐
...
170. **prisma-cli** — `prisma/skills/prisma-cli` · 280,605 تثبيت ⭐
...
171. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 277,923 تثبيت
...
172. **prisma-postgres** — `prisma/skills/prisma-postgres` · 276,416 تثبيت ⭐
...
173. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 276,147 تثبيت
...
174. **impeccable** — `pbakaus/impeccable/impeccable` · 275,254 تثبيت
   Frontend design and iteration for production-grade interfaces, from concept to ship.
   `npx skills add https://github.com/pbakaus/impeccable --skill impeccable`

175. **supabase** — `supabase/agent-skills/supabase` · 272,712 تثبيت ⭐
...
176. **shadcn** — `shadcn/ui/shadcn` · 271,675 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

177. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 271,656 تثبيت ⭐
...
178. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 271,407 تثبيت ⭐
...
179. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 270,741 تثبيت ⭐
...
180. **claude-handoff** — `mattpocock/skills/claude-handoff` · 269,663 تثبيت
...
181. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 266,993 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

182. **prisma-compute** — `prisma/skills/prisma-compute` · 266,710 تثبيت ⭐
...
183. **prisma-mongodb-upgrade** — `prisma/skills/prisma-mongodb-upgrade` · 265,386 تثبيت ⭐
   Prisma MongoDB Upgrade Path
   `npx skills add https://github.com/prisma/skills --skill prisma-mongodb-upgrade`

184. **general-video** — `heygen-com/hyperframes/general-video` · 264,036 تثبيت
   Before relying on this workflow, run:
   `npx skills add https://github.com/heygen-com/hyperframes --skill general-video`

185. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 258,272 تثبيت ⭐
...
186. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 257,587 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

187. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 253,680 تثبيت
...
188. **writing-plans** — `obra/superpowers/writing-plans` · 247,294 تثبيت
   Comprehensive implementation plans for multi-step tasks, breaking down specs into bite-sized, testable steps.
   `npx skills add https://github.com/obra/superpowers --skill writing-plans`

189. **just-scrape** — `scrapegraphai/just-scrape/just-scrape` · 244,963 تثبيت
...
190. **wait-what** — `mattpocock/skills/wait-what` · 244,132 تثبيت
...
191. **using-superpowers** — `obra/superpowers/using-superpowers` · 242,440 تثبيت
   IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST USE IT.
   `npx skills add https://github.com/obra/superpowers --skill using-superpowers`

192. **diagnose** — `mattpocock/skills/diagnose` · 238,697 تثبيت
...
193. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 238,537 تثبيت
...
194. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 235,546 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

195. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 235,525 تثبيت
...
196. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 231,646 تثبيت
...
197. **write-a-skill** — `mattpocock/skills/write-a-skill` · 230,177 تثبيت
...
198. **zoom-out** — `mattpocock/skills/zoom-out` · 229,614 تثبيت
...
199. **requesting-code-review** — `obra/superpowers/requesting-code-review` · 227,042 تثبيت
   Dispatch code review subagents with focused context to catch issues before they compound.
   `npx skills add https://github.com/obra/superpowers --skill requesting-code-review`

200. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 226,442 تثبيت
...
204. **design-an-interface** — `mattpocock/skills/design-an-interface` · 216,338 تثبيت
...
205. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 214,593 تثبيت
...
206. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 214,241 تثبيت
...
207. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 214,203 تثبيت
...
208. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 214,160 تثبيت
...
209. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 214,158 تثبيت
...
210. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 214,129 تثبيت
...
211. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 213,998 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

212. **embedded-captions** — `heygen-com/hyperframes/embedded-captions` · 213,725 تثبيت
...
213. **executing-plans** — `obra/superpowers/executing-plans` · 210,599 تثبيت
...
214. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 209,675 تثبيت
...
215. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,519 تثبيت ⭐
...
216. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 209,498 تثبيت
...
217. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 209,245 تثبيت
...
218. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 209,224 تثبيت ⭐
...
219. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 206,609 تثبيت
...
220. **qa** — `mattpocock/skills/qa` · 205,581 تثبيت
...
221. **orchestration** — `stablyai/orca/orchestration` · 205,152 تثبيت
...
222. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 204,249 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

223. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 203,578 تثبيت
...
224. **obsidian-vault** — `mattpocock/skills/obsidian-vault` · 202,006 تثبيت
   /mnt/d/Obsidian Vault/AI Research/
   `npx skills add https://github.com/mattpocock/skills --skill obsidian-vault`

225. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 199,735 تثبيت
...
226. **edit-article** — `mattpocock/skills/edit-article` · 198,318 تثبيت
...
227. **pdf** — `anthropics/skills/pdf` · 195,356 تثبيت ⭐
   Comprehensive PDF processing with text extraction, merging, splitting, form filling, and OCR capabilities.
   `npx skills add https://github.com/anthropics/skills --skill pdf`

228. **design-mobile-apps** — `designed-by-ai/skills/design-mobile-apps` · 194,274 تثبيت
...
229. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 192,133 تثبيت
...
230. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 189,625 تثبيت
...
231. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 189,065 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

232. **writing-skills** — `obra/superpowers/writing-skills` · 188,944 تثبيت
...
233. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 187,992 تثبيت
...
234. **docx** — `anthropics/skills/docx` · 187,231 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

235. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 185,708 تثبيت
...
236. **slideshow** — `heygen-com/hyperframes/slideshow` · 184,294 تثبيت
...
237. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 181,338 تثبيت ⭐
...
238. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 172,731 تثبيت
...
239. **xlsx** — `anthropics/skills/xlsx` · 167,660 تثبيت ⭐
   Create, edit, and analyze Excel spreadsheets with formulas, formatting, and error-free calculations.
   `npx skills add https://github.com/anthropics/skills --skill xlsx`

240. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 165,090 تثبيت
...
241. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 160,020 تثبيت ⭐
...
242. **webapp-testing** — `anthropics/skills/webapp-testing` · 155,971 تثبيت ⭐
   Native Python Playwright scripts for testing local web applications with server lifecycle management.
   `npx skills add https://github.com/anthropics/skills --skill webapp-testing`

243. **review-animations** — `emilkowalski/skills/review-animations` · 154,973 تثبيت
...
244. **wind-mcp-skill** — `wind-alice/alicemarket/wind-mcp-skill` · 154,608 تثبيت
...
245. **playwright-cli** — `microsoft/playwright-cli/playwright-cli` · 152,488 تثبيت ⭐
   Browser automation with 40+ commands for navigation, interaction, form filling, and web testing.
   `npx skills add https://github.com/microsoft/playwright-cli --skill playwright-cli`

246. **firebase-basics** — `firebase/agent-skills/firebase-basics` · 151,830 تثبيت ⭐
...
247. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 150,768 تثبيت ⭐
...
248. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 149,223 تثبيت
...
249. **computer-use** — `stablyai/orca/computer-use` · 148,861 تثبيت
   This discovery stub loads the version-matched guide from the Orca executable used for this session.
   `npx skills add https://github.com/stablyai/orca --skill computer-use`

250. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 147,917 تثبيت
...
251. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 147,159 تثبيت ⭐
...
252. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 146,637 تثبيت ⭐
...
253. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 145,813 تثبيت ⭐
...
254. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 145,285 تثبيت
...
255. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 144,169 تثبيت
...
256. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 142,625 تثبيت
...
257. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 142,620 تثبيت
...
258. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 142,462 تثبيت
...
259. **wan-3-0-prime-reference-to-video** — `genmedia-labs/skills/wan-3-0-prime-reference-to-video` · 142,315 تثبيت
...
260. **sentry-cli** — `sentry/dev/sentry-cli` · 141,958 تثبيت
...
261. **seedance-2-5-image-to-video** — `genmedia-labs/skills/seedance-2-5-image-to-video` · 141,826 تثبيت
   Seedance 2.5 Image to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-image-to-video`

262. **seedance-2-5-reference-to-video** — `genmedia-labs/skills/seedance-2-5-reference-to-video` · 141,500 تثبيت
   Seedance 2.5 Reference to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-reference-to-video`

263. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 139,552 تثبيت
...
264. **apple-design** — `emilkowalski/skills/apple-design` · 137,576 تثبيت
...
266. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 131,398 تثبيت
...
267. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 128,954 تثبيت
...
268. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 127,593 تثبيت
...
269. **improve-animations** — `emilkowalski/skills/improve-animations` · 127,109 تثبيت
...
270. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 125,832 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

271. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 125,025 تثبيت
...
272. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 124,613 تثبيت
...
273. **figma** — `heygen-com/hyperframes/figma` · 122,954 تثبيت
...
274. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 119,402 تثبيت ⭐
...
275. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 115,917 تثبيت
...
276. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 115,551 تثبيت
...
277. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 114,747 تثبيت ⭐
...
278. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 114,193 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

279. **mcp-builder** — `anthropics/skills/mcp-builder` · 114,071 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

280. **neon** — `neondatabase/agent-skills/neon` · 113,973 تثبيت ⭐
...
281. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 112,559 تثبيت ⭐
...
282. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 111,356 تثبيت ⭐
...
283. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 111,223 تثبيت
...
284. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 108,597 تثبيت ⭐
...
285. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 108,456 تثبيت ⭐
...
286. **browser-act** — `browser-act/skills/browser-act` · 107,994 تثبيت
...
287. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 107,809 تثبيت
...
288. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 107,703 تثبيت ⭐
...
289. **canvas-design** — `anthropics/skills/canvas-design` · 107,333 تثبيت ⭐
...
290. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 105,299 تثبيت
...
291. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 104,138 تثبيت
...
292. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 102,260 تثبيت
...
293. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 101,458 تثبيت
...
294. **implement-spec** — `mattpocock/skills/implement-spec` · 101,252 تثبيت
   You have been provided a spec. This spec should have tickets associated with it, describing how to implement the spec.
   `npx skills add https://github.com/mattpocock/skills --skill implement-spec`

295. **firecrawl** — `firecrawl/cli/firecrawl` · 100,932 تثبيت ⭐
...
296. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 100,270 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

297. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,320 تثبيت ⭐
...
298. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 98,154 تثبيت ⭐
...
299. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 97,371 تثبيت ⭐
...
300. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 97,324 تثبيت
...
301. **revops** — `coreyhaines31/marketingskills/revops` · 97,188 تثبيت
...
302. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 95,676 تثبيت ⭐
...
303. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 95,578 تثبيت ⭐
...
304. **gsap** — `heygen-com/hyperframes/gsap` · 95,412 تثبيت
...
305. **browser-use** — `browser-use/browser-use/browser-use` · 94,528 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

306. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,509 تثبيت
...
307. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 94,456 تثبيت
...
308. **review** — `mattpocock/skills/review` · 94,367 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

309. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,074 تثبيت
...
310. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,071 تثبيت
...
311. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 93,569 تثبيت
...
312. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 92,563 تثبيت
...
313. **convex** — `get-convex/agent-skills/convex` · 92,296 تثبيت
...
314. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 90,970 تثبيت ⭐
...
315. **cloudflare** — `cloudflare/skills/cloudflare` · 88,168 تثبيت ⭐
...
316. **polish** — `pbakaus/impeccable/polish` · 87,264 تثبيت
...
317. **retro** — `mattpocock/skills/retro` · 87,218 تثبيت
   The user has asked for a retrospective. You are suggesting improvements to the coding agent's environment to improve future runs.
   `npx skills add https://github.com/mattpocock/skills --skill retro`

318. **prototype** — `emilkowalski/skills/prototype` · 86,106 تثبيت
...
319. **lark-meeting** — `open.feishu.cn/lark-meeting` · 85,762 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/`

320. **wrangler** — `cloudflare/skills/wrangler` · 85,595 تثبيت ⭐
...
321. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 85,290 تثبيت
...
322. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,084 تثبيت
...
323. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 84,741 تثبيت ⭐
...
324. **critique** — `pbakaus/impeccable/critique` · 84,659 تثبيت
...
325. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 84,606 تثبيت
...
326. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 84,439 تثبيت
...
327. **theme-factory** — `anthropics/skills/theme-factory` · 84,352 تثبيت ⭐
...
328. **audit** — `pbakaus/impeccable/audit` · 83,876 تثبيت
...
329. **animate** — `pbakaus/impeccable/animate` · 83,732 تثبيت
...
330. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 83,727 تثبيت ⭐
...
331. **adapt** — `pbakaus/impeccable/adapt` · 83,719 تثبيت
...
332. **clarify** — `pbakaus/impeccable/clarify` · 83,212 تثبيت
...
333. **optimize** — `pbakaus/impeccable/optimize` · 83,066 تثبيت
...
334. **colorize** — `pbakaus/impeccable/colorize` · 82,872 تثبيت
...
335. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 82,052 تثبيت
...
336. **bolder** — `pbakaus/impeccable/bolder` · 81,993 تثبيت
...
337. **delight** — `pbakaus/impeccable/delight` · 81,824 تثبيت
...
338. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 81,800 تثبيت ⭐
...
339. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 81,514 تثبيت ⭐
...
340. **distill** — `pbakaus/impeccable/distill` · 81,433 تثبيت
...
341. **remotion-render** — `remotion-dev/skills/remotion-render` · 81,066 تثبيت ⭐
   General rendering strategy
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-render`

342. **remotion-create** — `remotion-dev/skills/remotion-create` · 80,860 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

343. **quieter** — `pbakaus/impeccable/quieter` · 80,600 تثبيت
...
344. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 80,280 تثبيت ⭐
...
345. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 79,345 تثبيت ⭐
...
346. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 79,294 تثبيت ⭐
...
347. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 78,908 تثبيت ⭐
...
348. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 78,774 تثبيت ⭐
...
349. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 78,695 تثبيت ⭐
...
350. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 78,596 تثبيت ⭐
...
351. **archify** — `tt-a1i/archify/archify` · 78,288 تثبيت
...
352. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,777 تثبيت
...
353. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 76,077 تثبيت ⭐
...
354. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 75,583 تثبيت ⭐
...
355. **notion-api** — `intellectronica/agent-skills/notion-api` · 75,329 تثبيت
...
356. **web-search** — `skills-101/superpowers/web-search` · 74,752 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill web-search`

357. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 74,662 تثبيت
...
358. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 74,643 تثبيت
...
359. **wonda-cli** — `degausai/wonda/wonda-cli` · 74,605 تثبيت
...
360. **agent-tools** — `skills-101/superpowers/agent-tools` · 74,420 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill agent-tools`

361. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 74,407 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

362. **css-animations** — `heygen-com/hyperframes/css-animations` · 74,375 تثبيت
...
363. **python-executor** — `skills-101/superpowers/python-executor` · 74,371 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

364. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 74,242 تثبيت ⭐
...
365. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 73,930 تثبيت
...
366. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 73,480 تثبيت
...
367. **animate** — `emilkowalski/skills/animate` · 73,225 تثبيت
...
368. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 72,876 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

369. **remotion-saas** — `remotion-dev/skills/remotion-saas` · 72,711 تثبيت ⭐
   One can build apps with Remotion.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-saas`

370. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,544 تثبيت
...
371. **internal-comms** — `anthropics/skills/internal-comms` · 72,064 تثبيت ⭐
...
372. **animejs** — `heygen-com/hyperframes/animejs` · 71,992 تثبيت
...
373. **durable-objects** — `cloudflare/skills/durable-objects` · 71,638 تثبيت ⭐
...
374. **turborepo** — `vercel/turborepo/turborepo` · 71,481 تثبيت ⭐
...
375. **web-perf** — `cloudflare/skills/web-perf` · 71,406 تثبيت ⭐
...
376. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 71,294 تثبيت
...
377. **three** — `heygen-com/hyperframes/three` · 71,273 تثبيت
...
378. **lottie** — `heygen-com/hyperframes/lottie` · 71,006 تثبيت
...
379. **audit-website** — `squirrelscan/skills/audit-website` · 70,976 تثبيت
...
380. **waapi** — `heygen-com/hyperframes/waapi` · 70,632 تثبيت
...
381. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 70,152 تثبيت ⭐
...
382. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 70,119 تثبيت ⭐
...
383. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 69,761 تثبيت ⭐
...
384. **agents-sdk** — `cloudflare/skills/agents-sdk` · 69,136 تثبيت ⭐
...
385. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 68,740 تثبيت
...
386. **gws-drive** — `googleworkspace/cli/gws-drive` · 68,674 تثبيت ⭐
...
387. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 68,630 تثبيت
...
388. **image** — `coreyhaines31/marketingskills/image` · 68,511 تثبيت
...
389. **video** — `coreyhaines31/marketingskills/video` · 68,477 تثبيت
...
390. **defuddle** — `kepano/obsidian-skills/defuddle` · 67,985 تثبيت
...
391. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 67,965 تثبيت ⭐
...
392. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,764 تثبيت
...
393. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 67,450 تثبيت
...
394. **cro** — `coreyhaines31/marketingskills/cro` · 66,501 تثبيت
   Conversion Rate Optimization (CRO)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill cro`

395. **typeset** — `pbakaus/impeccable/typeset` · 66,242 تثبيت
...
396. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 65,830 تثبيت ⭐
...
397. **template-skill** — `anthropics/skills/template-skill` · 64,771 تثبيت ⭐
   Replace with description of the skill and when Claude should use it.
   `npx skills add https://github.com/anthropics/skills --skill template-skill`

398. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 64,760 تثبيت ⭐
...
399. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 64,539 تثبيت ⭐
...
400. **claude-api** — `anthropics/skills/claude-api` · 64,535 تثبيت ⭐
...
401. **batch-grill-me** — `mattpocock/skills/batch-grill-me` · 64,486 تثبيت
   Interview the user relentlessly until you reach a shared understanding. Map this as a design tree: every decision branches into the decisions that han
   `npx skills add https://github.com/mattpocock/skills --skill batch-grill-me`

402. **overdrive** — `pbakaus/impeccable/overdrive` · 64,314 تثبيت
   ──────────── ⚡ OVERDRIVE ─────────────
   `npx skills add https://github.com/pbakaus/impeccable --skill overdrive`

403. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 64,131 تثبيت
...
404. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 63,919 تثبيت ⭐
...
408. **stripe-projects** — `stripe/ai/stripe-projects` · 63,288 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

409. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 63,080 تثبيت ⭐
...
410. **analytics** — `coreyhaines31/marketingskills/analytics` · 62,861 تثبيت
...
411. **social** — `coreyhaines31/marketingskills/social` · 62,856 تثبيت
...
413. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,485 تثبيت
   Cross-Border E-Commerce ✈️
   `npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill cross-border-ecommerce`

414. **developing-genkit-dart** — `firebase/agent-skills/developing-genkit-dart` · 62,272 تثبيت ⭐
...
415. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 62,100 تثبيت
...
416. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,914 تثبيت
...
417. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,912 تثبيت
...
418. **design-md** — `google-labs-code/stitch-skills/design-md` · 61,563 تثبيت ⭐
...
419. **ads** — `coreyhaines31/marketingskills/ads` · 61,396 تثبيت
...
420. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 60,556 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill motion-doctrine`

421. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 60,489 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill captions-overlay`

422. **pricing** — `coreyhaines31/marketingskills/pricing` · 60,476 تثبيت
...
423. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 60,289 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

424. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 60,136 تثبيت ⭐
...
425. **gws-shared** — `googleworkspace/cli/gws-shared` · 60,120 تثبيت ⭐
...
426. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 60,071 تثبيت ⭐
...
427. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 60,012 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill seam-craft`

428. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 59,946 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill changelog-video`

429. **oversized-cursor** — `heygen-com/hyperframes/oversized-cursor` · 59,906 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill oversized-cursor`

430. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 59,776 تثبيت ⭐
...
431. **competitors** — `coreyhaines31/marketingskills/competitors` · 59,713 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

432. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 59,661 تثبيت ⭐
...
433. **building-native-ui** — `expo/skills/building-native-ui` · 59,188 تثبيت ⭐
...
434. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 58,924 تثبيت
...
435. **schema** — `coreyhaines31/marketingskills/schema` · 58,887 تثبيت
...
436. **agently-mail** — `agent.qq.com/agently-mail` · 58,718 تثبيت
   通过 agently-cli 命令行工具操作邮件，通过管理端 (agent.qq.com) 进行后台管理。
   `npx skills add https://agent.qq.com/`

437. **emails** — `coreyhaines31/marketingskills/emails` · 58,640 تثبيت
...
438. **launch** — `coreyhaines31/marketingskills/launch` · 58,627 تثبيت
...
439. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,520 تثبيت
...
440. **expo-dev-client** — `expo/skills/expo-dev-client` · 58,197 تثبيت ⭐
...
441. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,158 تثبيت
...
442. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,146 تثبيت
...
443. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 58,066 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

444. **ab-testing** — `coreyhaines31/marketingskills/ab-testing` · 58,054 تثبيت
   You are an expert in experimentation and A/B testing. Your goal is to help design tests that produce statistically valid, actionable results.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill ab-testing`

445. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,651 تثبيت
...
446. **ponytail** — `dietrichgebert/ponytail/ponytail` · 57,163 تثبيت
   You are a lazy senior developer. Lazy means efficient, not careless. You have
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail`

447. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 56,951 تثبيت ⭐
...
448. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 56,925 تثبيت
...
449. **aso** — `coreyhaines31/marketingskills/aso` · 56,828 تثبيت
...
450. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,730 تثبيت
...
451. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,716 تثبيت
...
452. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 56,521 تثبيت ⭐
...
453. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,411 تثبيت
...
454. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 56,214 تثبيت
...
455. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,167 تثبيت
...
456. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 55,974 تثبيت ⭐
...
457. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 55,956 تثبيت
...
458. **gsap-core** — `greensock/gsap-skills/gsap-core` · 55,890 تثبيت
...
459. **normalize** — `pbakaus/impeccable/normalize` · 55,821 تثبيت
...
460. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 55,793 تثبيت ⭐
...
461. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,774 تثبيت
...
462. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 55,735 تثبيت ⭐
...
463. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 55,705 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

464. **referrals** — `coreyhaines31/marketingskills/referrals` · 55,549 تثبيت
   Referral & Affiliate Programs
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill referrals`

465. **signup** — `coreyhaines31/marketingskills/signup` · 55,456 تثبيت
...
466. **opentui** — `msmps/opentui-skill/opentui` · 55,421 تثبيت
...
467. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,325 تثبيت
...
468. **nia** — `nozomio-labs/nia-skill/nia` · 55,200 تثبيت
...
469. **ai-sdk** — `vercel/ai/ai-sdk` · 55,104 تثبيت ⭐
...
470. **popups** — `coreyhaines31/marketingskills/popups` · 54,958 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

471. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 54,891 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

472. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,823 تثبيت
...
473. **extract** — `pbakaus/impeccable/extract` · 54,737 تثبيت
...
474. **onboard** — `pbakaus/impeccable/onboard` · 54,575 تثبيت
...
475. **harden** — `pbakaus/impeccable/harden` · 54,503 تثبيت
...
476. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 54,327 تثبيت ⭐
...
477. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,296 تثبيت
...
478. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 54,116 تثبيت
...
479. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 54,091 تثبيت
...
480. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 53,905 تثبيت ⭐
...
481. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 53,783 تثبيت
...
482. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 53,629 تثبيت ⭐
...
483. **hallmark** — `nutlope/hallmark/hallmark` · 53,327 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

484. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,209 تثبيت
...
485. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 53,191 تثبيت ⭐
...
486. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 52,969 تثبيت
...
487. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 52,919 تثبيت ⭐
...
488. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,910 تثبيت
...
489. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,733 تثبيت
...
490. **gws-docs** — `googleworkspace/cli/gws-docs` · 52,683 تثبيت ⭐
...
491. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 52,661 تثبيت
...
492. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,468 تثبيت
...
493. **typegpu** — `heygen-com/hyperframes/typegpu` · 52,104 تثبيت
...
494. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,059 تثبيت
...
495. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 51,820 تثبيت
...
496. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,726 تثبيت
...
497. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 51,596 تثبيت
...
498. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,465 تثبيت
...
499. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 51,432 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

500. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 51,087 تثبيت ⭐
...
501. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 51,076 تثبيت
...
502. **higgsfield-youtube-thumbnail** — `higgsfield-ai/skills/higgsfield-youtube-thumbnail` · 51,054 تثبيت
   Higgsfield YouTube Thumbnail
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-youtube-thumbnail`

503. **momentic-test** — `momentic-ai/skills/momentic-test` · 50,865 تثبيت
...
504. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 50,844 تثبيت
...
505. **react:components** — `google-labs-code/stitch-skills/react:components` · 50,680 تثبيت ⭐
   Stitch to React Components
   `npx skills add https://github.com/google-labs-code/stitch-skills --skill react:components`

506. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 50,641 تثبيت
...
507. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 50,502 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

508. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 50,477 تثبيت
...
509. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 50,458 تثبيت
...
510. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 50,450 تثبيت
...
511. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 50,449 تثبيت
...
512. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 50,411 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

513. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 50,401 تثبيت
...
514. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 50,376 تثبيت
...
515. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 50,350 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

516. **marketing-mindset** — `axelfreeman/marketing-mindset/marketing-mindset` · 49,893 تثبيت
...
517. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 49,834 تثبيت ⭐
...
518. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 49,573 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

519. **developing-genkit-go** — `firebase/agent-skills/developing-genkit-go` · 49,543 تثبيت ⭐
...
520. **gsap-react** — `greensock/gsap-skills/gsap-react` · 49,511 تثبيت
...
521. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 49,453 تثبيت
...
522. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 49,406 تثبيت
...
523. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 48,940 تثبيت
...
524. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 48,552 تثبيت
...
525. **sms** — `coreyhaines31/marketingskills/sms` · 48,550 تثبيت
...
526. **caveman-optimize** — `juliusbrussee/caveman/caveman-optimize` · 48,467 تثبيت
   Evaluate an optimization observation
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-optimize`

527. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 48,423 تثبيت
...
528. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 48,338 تثبيت
...
529. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 48,256 تثبيت
...
530. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 48,164 تثبيت
...
531. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 48,133 تثبيت
...
532. **mastra** — `mastra-ai/skills/mastra` · 48,082 تثبيت ⭐
...
533. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 48,018 تثبيت
...
534. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 47,921 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

535. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 47,777 تثبيت
...
536. **lean-build** — `juliusbrussee/caveman/lean-build` · 47,693 تثبيت
...
537. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 47,664 تثبيت
...
538. **caveman-manage** — `juliusbrussee/caveman/caveman-manage` · 47,658 تثبيت
   Manage eval-gated experiments
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-manage`

539. **migration** — `juliusbrussee/caveman/migration` · 47,461 تثبيت
...
540. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 47,352 تثبيت
...
541. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,234 تثبيت ⭐
...
542. **herdr** — `herdrdev/herdr/herdr` · 47,059 تثبيت
...
543. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 47,039 تثبيت
...
544. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 46,961 تثبيت
...
545. **compress** — `juliusbrussee/caveman/compress` · 46,824 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

546. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 46,207 تثبيت
...
547. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 46,035 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

548. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 45,758 تثبيت ⭐
...
549. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 45,405 تثبيت
...
550. **seo** — `addyosmani/web-quality-skills/seo` · 45,282 تثبيت
...
551. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 45,182 تثبيت ⭐
...
552. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 45,148 تثبيت
...
553. **git-commit** — `github/awesome-copilot/git-commit` · 44,871 تثبيت ⭐
...
554. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,841 تثبيت
...
555. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 44,823 تثبيت ⭐
...
556. **clerk-setup** — `clerk/skills/clerk-setup` · 44,747 تثبيت ⭐
...
557. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 44,489 تثبيت ⭐
...
558. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 44,334 تثبيت
...
559. **animate-expo** — `emilkowalski/skills/animate-expo` · 44,097 تثبيت
   Building Animations in Expo
   `npx skills add https://github.com/emilkowalski/skills --skill animate-expo`

560. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 43,670 تثبيت ⭐
...
561. **byted-web-search** — `skills.volces.com/byted-web-search` · 43,525 تثبيت
...
562. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 43,447 تثبيت ⭐
...
563. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 43,392 تثبيت
...
564. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 43,292 تثبيت ⭐
...
565. **upgrading-expo** — `expo/skills/upgrading-expo` · 43,096 تثبيت ⭐
...
566. **insforge** — `insforge/insforge-skills/insforge` · 43,089 تثبيت
   InsForge App Integration Skill
   `npx skills add https://github.com/insforge/insforge-skills --skill insforge`

567. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 42,980 تثبيت
...
571. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 41,878 تثبيت ⭐
...
572. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 41,521 تثبيت
...
573. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 41,400 تثبيت ⭐
...
574. **expo-deployment** — `expo/skills/expo-deployment` · 40,990 تثبيت ⭐
...
575. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 40,920 تثبيت
...
576. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 40,247 تثبيت
...
577. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 40,229 تثبيت
...
578. **arrange** — `pbakaus/impeccable/arrange` · 40,186 تثبيت
...
579. **last30days** — `mvanhorn/last30days-skill/last30days` · 40,145 تثبيت
...
580. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 40,108 تثبيت ⭐
...
581. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 39,968 تثبيت ⭐
...
582. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 39,946 تثبيت
...
583. **clerk-orgs** — `clerk/skills/clerk-orgs` · 39,520 تثبيت ⭐
...
584. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 39,474 تثبيت
...
585. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 39,414 تثبيت
...
586. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 39,384 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

587. **golang-security** — `samber/cc-skills-golang/golang-security` · 39,350 تثبيت
...
588. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 39,261 تثبيت
...
589. **remotion** — `google-labs-code/stitch-skills/remotion` · 39,236 تثبيت ⭐
...
590. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 38,900 تثبيت
...
591. **offers** — `coreyhaines31/marketingskills/offers` · 38,825 تثبيت
...
592. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 38,725 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

593. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 38,522 تثبيت
...
594. **golang-context** — `samber/cc-skills-golang/golang-context` · 38,371 تثبيت
...
595. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 38,348 تثبيت
...
596. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 38,256 تثبيت
...
597. **golang-database** — `samber/cc-skills-golang/golang-database` · 38,255 تثبيت
...
598. **gws-slides** — `googleworkspace/cli/gws-slides` · 38,217 تثبيت ⭐
...
599. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 38,165 تثبيت
...
600. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 38,101 تثبيت
...
601. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 38,096 تثبيت
...
602. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 38,050 تثبيت
...
603. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 38,003 تثبيت
...
604. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 37,993 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

605. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,906 تثبيت ⭐
...
606. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 37,903 تثبيت
...
607. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 37,761 تثبيت ⭐
...
608. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 37,729 تثبيت
...
609. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 37,723 تثبيت
...
610. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,690 تثبيت
...
611. **clerk-testing** — `clerk/skills/clerk-testing` · 37,668 تثبيت ⭐
   https://clerk.com/docs/guides/development/testing/overview
   `npx skills add https://github.com/clerk/skills --skill clerk-testing`

612. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 37,594 تثبيت
...
613. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 37,533 تثبيت
...
614. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 37,484 تثبيت
...
615. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 37,472 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

616. **product-photography** — `skills-101/superpowers/product-photography` · 37,454 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

617. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 37,426 تثبيت
...
618. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 37,408 تثبيت
...
619. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 37,401 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

620. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 37,399 تثبيت
...
621. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 37,388 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

622. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 37,380 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

623. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 37,378 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

624. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 37,377 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

625. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 37,376 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

626. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 37,363 تثبيت
...
627. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 37,329 تثبيت
...
628. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 37,328 تثبيت
...
629. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 37,228 تثبيت
...
630. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 37,213 تثبيت
...
631. **write-swift** — `emilkowalski/skills/write-swift` · 37,168 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
...
633. **gws-forms** — `googleworkspace/cli/gws-forms` · 36,783 تثبيت ⭐
...
634. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 36,690 تثبيت
...
635. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 36,652 تثبيت
...
636. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 36,634 تثبيت
...
637. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 36,524 تثبيت
...
638. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 36,498 تثبيت
...
639. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 36,467 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

640. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 36,456 تثبيت
...
641. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 36,434 تثبيت
...
642. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 36,427 تثبيت
...
643. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 36,405 تثبيت
...
644. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 36,270 تثبيت
...
645. **gws-meet** — `googleworkspace/cli/gws-meet` · 36,264 تثبيت ⭐
...
646. **wind-find-finance-skill** — `wind-alice/alicemarket/wind-find-finance-skill` · 36,086 تثبيت
...
647. **firebase-firestore-enterprise-native-mode** — `firebase/agent-skills/firebase-firestore-enterprise-native-mode` · 36,057 تثبيت ⭐
...
648. **karpathy-guidelines** — `multica-ai/andrej-karpathy-skills/karpathy-guidelines` · 36,049 تثبيت
   Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   `npx skills add https://github.com/multica-ai/andrej-karpathy-skills --skill karpathy-guidelines`

649. **vitest** — `antfu/skills/vitest` · 35,772 تثبيت
...
650. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 35,591 تثبيت
...
651. **angular-developer** — `angular/skills/angular-developer` · 35,549 تثبيت
...
654. **replicas-agent** — `replicas-group/skill/replicas-agent` · 35,304 تثبيت
...
655. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 35,256 تثبيت
...
656. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 35,198 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

657. **expo-module** — `expo/skills/expo-module` · 35,172 تثبيت ⭐
...
658. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 35,164 تثبيت
...
659. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 35,163 تثبيت
...
660. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 35,006 تثبيت
...
661. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 35,002 تثبيت
...
662. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 34,987 تثبيت
...
663. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 34,887 تثبيت
...
664. **performance** — `addyosmani/web-quality-skills/performance` · 34,825 تثبيت
...
665. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 34,824 تثبيت
...
666. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 34,773 تثبيت ⭐
...
667. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 34,741 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

668. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 34,674 تثبيت
...
669. **firebase-ai-logic** — `firebase/agent-skills/firebase-ai-logic` · 34,583 تثبيت ⭐
...
670. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 34,498 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

671. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 34,306 تثبيت ⭐
...
672. **gws-keep** — `googleworkspace/cli/gws-keep` · 34,205 تثبيت ⭐
...
673. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 34,196 تثبيت
...
674. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 34,172 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

675. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 34,056 تثبيت ⭐
...
676. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 33,839 تثبيت
...
677. **vue** — `antfu/skills/vue` · 33,684 تثبيت
...
678. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,641 تثبيت ⭐
...
679. **self-improving-agent** — `zhaono1/agent-playbook/self-improving-agent` · 33,637 تثبيت
...
680. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 33,631 تثبيت ⭐
...
681. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 33,616 تثبيت
...
682. **sandbox-sdk** — `cloudflare/skills/sandbox-sdk` · 33,558 تثبيت ⭐
   Build secure, isolated code execution environments on Cloudflare Workers.
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-sdk`

683. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 33,486 تثبيت
...
684. **improve** — `shadcn/improve/improve` · 32,939 تثبيت
...
685. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 32,937 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

686. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 32,920 تثبيت ⭐
...
687. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,866 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

688. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,707 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

689. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 32,630 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

690. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,567 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

691. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 32,505 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

692. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,501 تثبيت
...
693. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 32,468 تثبيت
...
694. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 32,453 تثبيت
...
695. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 32,415 تثبيت
...
696. **sandbox-stable** — `cloudflare/skills/sandbox-stable` · 32,319 تثبيت ⭐
   Sandbox SDK — stable package
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-stable`

697. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 32,275 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

698. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 32,186 تثبيت ⭐
...
699. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 32,175 تثبيت ⭐
...
700. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 32,167 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

701. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 32,079 تثبيت ⭐
...
702. **ckm:brand** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:brand` · 32,067 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

703. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 32,063 تثبيت ⭐
...
704. **ckm:banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:banner-design` · 32,040 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

705. **tavily-search** — `tavily-ai/skills/tavily-search` · 32,002 تثبيت ⭐
...
706. **sandbox-next** — `cloudflare/skills/sandbox-next` · 31,959 تثبيت ⭐
   Sandbox SDK — @next (1.0 preview)
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-next`

707. **ckm:slides** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:slides` · 31,950 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

708. **sandbox-migrate-to-next** — `cloudflare/skills/sandbox-migrate-to-next` · 31,904 تثبيت ⭐
...
709. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 31,876 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

710. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 31,814 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

711. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,729 تثبيت ⭐
...
712. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 31,680 تثبيت ⭐
...
713. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 31,656 تثبيت ⭐
...
714. **baoyu-infographic** — `jimliu/baoyu-skills/baoyu-infographic` · 31,652 تثبيت
...
715. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 31,560 تثبيت
...
716. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,425 تثبيت ⭐
...
717. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 31,393 تثبيت
...
718. **swiftui-expert-skill** — `avdlee/swiftui-agent-skill/swiftui-expert-skill` · 31,374 تثبيت
   Expert SwiftUI code review, refactoring, and implementation guidance with iOS 26+ and macOS support.
   `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill swiftui-expert-skill`

719. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 31,324 تثبيت ⭐
...
720. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 31,279 تثبيت ⭐
...
721. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 31,259 تثبيت ⭐
...
722. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 31,246 تثبيت ⭐
...
723. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 31,244 تثبيت ⭐
...
724. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 31,241 تثبيت
...
725. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 31,211 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

726. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 31,204 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

727. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 31,185 تثبيت ⭐
...
728. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 31,172 تثبيت
...
729. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 31,169 تثبيت
...
730. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 31,165 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

731. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 31,010 تثبيت ⭐
...
732. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 30,967 تثبيت
...
733. **use-dom** — `expo/skills/use-dom` · 30,964 تثبيت ⭐
...
734. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 30,928 تثبيت
...
735. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 30,855 تثبيت ⭐
...
736. **shape** — `pbakaus/impeccable/shape` · 30,843 تثبيت
...
737. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 30,640 تثبيت ⭐
...
738. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 30,478 تثبيت
...
739. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 30,301 تثبيت
...
740. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 30,296 تثبيت ⭐
...
741. **gws-chat** — `googleworkspace/cli/gws-chat` · 30,292 تثبيت ⭐
...
742. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 30,277 تثبيت ⭐
...
743. **gws-people** — `googleworkspace/cli/gws-people` · 30,129 تثبيت ⭐
...
744. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 30,119 تثبيت
...
745. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 30,118 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

746. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 30,100 تثبيت ⭐
...
747. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 30,072 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

748. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,894 تثبيت ⭐
...
749. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 29,842 تثبيت
...
750. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 29,813 تثبيت ⭐
...
751. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,801 تثبيت
...
752. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 29,790 تثبيت ⭐
...
753. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 29,754 تثبيت
...
754. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 29,639 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

755. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 29,504 تثبيت
...
756. **interview-me** — `addyosmani/agent-skills/interview-me` · 29,486 تثبيت
...
757. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 29,418 تثبيت ⭐
...
758. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 29,306 تثبيت
...
759. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 29,175 تثبيت ⭐
...
760. **gws-chat-send** — `googleworkspace/cli/gws-chat-send` · 29,168 تثبيت ⭐
   Send plain-text messages to Google Chat spaces.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-chat-send`

761. **recipe-draft-email-from-doc** — `googleworkspace/cli/recipe-draft-email-from-doc` · 29,023 تثبيت ⭐
...
762. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 28,986 تثبيت ⭐
...
763. **baoyu-comic** — `jimliu/baoyu-skills/baoyu-comic` · 28,964 تثبيت
...
764. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 28,925 تثبيت ⭐
...
765. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 28,916 تثبيت ⭐
...
766. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 28,911 تثبيت ⭐
...
767. **eas-update-insights** — `expo/skills/eas-update-insights` · 28,904 تثبيت ⭐
...
768. **gws-events** — `googleworkspace/cli/gws-events` · 28,810 تثبيت ⭐
...
769. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 28,740 تثبيت ⭐
...
770. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 28,628 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

771. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 28,563 تثبيت ⭐
...
772. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 28,524 تثبيت
...
773. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 28,507 تثبيت ⭐
...
774. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 28,466 تثبيت ⭐
...
775. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 28,428 تثبيت ⭐
...
776. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 28,365 تثبيت ⭐
...
777. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 28,299 تثبيت ⭐
...
778. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 28,292 تثبيت
...
779. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 28,219 تثبيت ⭐
...
780. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 28,193 تثبيت ⭐
...
781. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 28,188 تثبيت
...
782. **design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/design-system` · 28,180 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

783. **api-design-principles** — `wshobson/agents/api-design-principles` · 28,179 تثبيت
...
784. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 28,176 تثبيت ⭐
...
785. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 28,173 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

786. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 28,162 تثبيت ⭐
...
787. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 28,162 تثبيت ⭐
...
788. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 28,156 تثبيت ⭐
...
789. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 28,141 تثبيت ⭐
...
790. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 28,066 تثبيت ⭐
...
791. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 28,020 تثبيت ⭐
...
792. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 27,964 تثبيت ⭐
...
793. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 27,865 تثبيت ⭐
...
794. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 27,857 تثبيت ⭐
...
795. **azure-postgres** — `microsoft/azure-skills/azure-postgres` · 27,852 تثبيت ⭐
   No SKILL.md available for this skill.
   `npx skills add https://github.com/microsoft/azure-skills --skill azure-postgres`

796. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 27,830 تثبيت ⭐
...
797. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 27,811 تثبيت ⭐
...
798. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 27,798 تثبيت ⭐
...
799. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 27,786 تثبيت ⭐
...
800. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 27,771 تثبيت ⭐
...
801. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 27,716 تثبيت ⭐
...
802. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 27,702 تثبيت ⭐
...
803. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 27,684 تثبيت ⭐
...
804. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 27,679 تثبيت ⭐
...
805. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 27,675 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

806. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 27,614 تثبيت ⭐
...
807. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 27,606 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

808. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 27,583 تثبيت ⭐
...
809. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 27,563 تثبيت ⭐
...
810. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 27,536 تثبيت ⭐
...
811. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 27,506 تثبيت ⭐
...
812. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 27,469 تثبيت ⭐
...
813. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 27,459 تثبيت ⭐
...
814. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 27,450 تثبيت ⭐
...
815. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 27,442 تثبيت ⭐
...
816. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 27,438 تثبيت
...
817. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 27,435 تثبيت ⭐
...
818. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 27,419 تثبيت ⭐
...
819. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 27,381 تثبيت ⭐
...
820. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 27,381 تثبيت
...
821. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 27,380 تثبيت ⭐
...
822. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 27,375 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

823. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 27,354 تثبيت ⭐
...
824. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 27,342 تثبيت ⭐
...
825. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 27,330 تثبيت
...
826. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 27,318 تثبيت
...
827. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 27,307 تثبيت ⭐
...
828. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 27,250 تثبيت
...
829. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 27,240 تثبيت ⭐
...
830. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 27,239 تثبيت ⭐
...
831. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 27,230 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

832. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 27,169 تثبيت ⭐
...
833. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 27,149 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

834. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 27,093 تثبيت ⭐
...
835. **layout** — `pbakaus/impeccable/layout` · 27,038 تثبيت
...
836. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 27,030 تثبيت ⭐
...
837. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 27,001 تثبيت ⭐
...
838. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 26,952 تثبيت ⭐
...
839. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 26,928 تثبيت ⭐
...
840. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 26,867 تثبيت
...
841. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 26,855 تثبيت ⭐
...
842. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 26,728 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

843. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,697 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

844. **golang-linter** — `samber/cc-skills-golang/golang-linter` · 26,543 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/samber/cc-skills-golang --skill golang-linter`

845. **clerk** — `clerk/skills/clerk` · 26,497 تثبيت ⭐
...
846. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 26,463 تثبيت
...
847. **interface-design** — `dammyjay93/interface-design/interface-design` · 26,450 تثبيت
...
848. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 26,401 تثبيت ⭐
...
849. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 26,351 تثبيت
...
850. **build-tam** — `code.deepline.com/build-tam` · 26,223 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

851. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 26,133 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

852. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 26,123 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

853. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 26,116 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

854. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,098 تثبيت
...
855. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 26,089 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

856. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 26,069 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

857. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 25,987 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

858. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 25,971 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

859. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 25,886 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

860. **stripe-directory** — `docs.stripe.com/stripe-directory` · 25,850 تثبيت
...
861. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 25,844 تثبيت
...
862. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 25,688 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

863. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 25,680 تثبيت
...
864. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 25,621 تثبيت ⭐
...
865. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 25,593 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

866. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,479 تثبيت ⭐
...
867. **review-pr** — `warpdotdev/common-skills/review-pr` · 25,441 تثبيت
...
868. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 25,392 تثبيت
...
869. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 25,321 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

870. **dbs** — `dontbesilent2025/dbskill/dbs` · 25,301 تثبيت
   你是 dontbesilent 商业工具箱的公开入口。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs`

871. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 25,262 تثبيت
...
872. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 25,191 تثبيت
...
873. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 25,153 تثبيت
...
874. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 25,129 تثبيت
...
875. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 25,101 تثبيت
...
876. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 25,085 تثبيت ⭐
...
877. **create-pr** — `warpdotdev/common-skills/create-pr` · 25,071 تثبيت
...
878. **update-skill** — `warpdotdev/common-skills/update-skill` · 25,044 تثبيت
...
879. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 25,031 تثبيت
...
880. **clerk-cli** — `clerk/skills/clerk-cli` · 24,957 تثبيت ⭐
...
881. **brandalf** — `warpdotdev/common-skills/brandalf` · 24,774 تثبيت
...
882. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 24,710 تثبيت
...
883. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 24,697 تثبيت
...
884. **release-skills** — `jimliu/baoyu-skills/release-skills` · 24,638 تثبيت
...
885. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 24,617 تثبيت
...
886. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 24,590 تثبيت
...
887. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 24,568 تثبيت
...
888. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 24,526 تثبيت ⭐
...
889. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 24,525 تثبيت
...
890. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 24,450 تثبيت
...
891. **council** — `warpdotdev/common-skills/council` · 24,202 تثبيت
...
892. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 24,158 تثبيت
...
893. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 23,869 تثبيت
...
894. **best-practices** — `addyosmani/web-quality-skills/best-practices` · 23,787 تثبيت
   Modern web development standards based on Lighthouse best practices audits. Covers security, browser compatibility, and code quality patterns.
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill best-practices`

895. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 23,663 تثبيت
...
896. **check-impl-against-spec** — `warpdotdev/common-skills/check-impl-against-spec` · 23,570 تثبيت
   Check implementation against spec
   `npx skills add https://github.com/warpdotdev/common-skills --skill check-impl-against-spec`

897. **gws-script** — `googleworkspace/cli/gws-script` · 23,464 تثبيت ⭐
...
898. **ponytail-review** — `dietrichgebert/ponytail/ponytail-review` · 23,461 تثبيت
   Review diffs for unnecessary complexity. One line per finding: location, what
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-review`

899. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 23,423 تثبيت
...
900. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 23,175 تثبيت ⭐
...
901. **prd** — `github/awesome-copilot/prd` · 23,065 تثبيت ⭐
...
902. **gstack** — `garrytan/gstack/gstack` · 22,931 تثبيت
...
904. **nuxt** — `antfu/skills/nuxt` · 22,603 تثبيت
...
905. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 22,454 تثبيت
...
906. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 22,369 تثبيت
...
907. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 22,355 تثبيت
...
908. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 22,253 تثبيت
...
909. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 22,061 تثبيت
...
910. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,928 تثبيت ⭐
...
911. **ponytail-audit** — `dietrichgebert/ponytail/ponytail-audit` · 21,919 تثبيت
   ponytail-review, repo-wide. Scan the whole tree instead of a diff. Rank
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-audit`

912. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 21,914 تثبيت
...
913. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 21,838 تثبيت
...
914. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 21,777 تثبيت
...
919. **dbs-chatroom-austrian** — `dontbesilent2025/dbskill/dbs-chatroom-austrian` · 21,557 تثبيت
   dbs-chatroom-austrian：奥派经济聊天室
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-chatroom-austrian`

920. **dbs-agent-migration** — `dontbesilent2025/dbskill/dbs-agent-migration` · 21,422 تثبيت
   dbs-agent-migration：Agent 工作台迁移
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-agent-migration`

921. **prompt-engineering-patterns** — `wshobson/agents/prompt-engineering-patterns` · 21,349 تثبيت
...
922. **vueuse-functions** — `antfu/skills/vueuse-functions` · 21,253 تثبيت
...
923. **error-handling-patterns** — `wshobson/agents/error-handling-patterns` · 21,117 تثبيت
...
924. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 21,096 تثبيت ⭐
...
925. **convex-auth** — `get-convex/agent-skills/convex-auth` · 21,075 تثبيت
...
926. **convex-expert** — `get-convex/agent-skills/convex-expert` · 21,046 تثبيت
...
933. **convex-design** — `get-convex/agent-skills/convex-design` · 20,953 تثبيت
...
934. **mediabunny** — `remotion-dev/skills/mediabunny` · 20,928 تثبيت ⭐
   Mediabunny is a multimedia library for dealing with audio and video in the browser.
   `npx skills add https://github.com/remotion-dev/skills --skill mediabunny`

935. **convex-deploy-guard** — `get-convex/agent-skills/convex-deploy-guard` · 20,926 تثبيت
...
936. **convex-env** — `get-convex/agent-skills/convex-env` · 20,920 تثبيت
...
937. **convex-crons** — `get-convex/agent-skills/convex-crons` · 20,912 تثبيت
   Add scheduled jobs (crons)
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-crons`

938. **convex-advisor** — `get-convex/agent-skills/convex-advisor` · 20,909 تثبيت
...
939. **baoyu-post-to-weibo** — `jimliu/baoyu-skills/baoyu-post-to-weibo` · 20,903 تثبيت
...
940. **convex-add** — `get-convex/agent-skills/convex-add` · 20,895 تثبيت
...
941. **convex-agent** — `get-convex/agent-skills/convex-agent` · 20,892 تثبيت
   Add an AI agent / RAG backend
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-agent`

942. **convex-migrate-rehearse** — `get-convex/agent-skills/convex-migrate-rehearse` · 20,887 تثبيت
...
946. **convex-explain-app** — `get-convex/agent-skills/convex-explain-app` · 20,871 تثبيت
...
947. **convex-backup** — `get-convex/agent-skills/convex-backup` · 20,870 تثبيت
   Back up — and prove the restore works
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-backup`

948. **convex-launch-readiness** — `get-convex/agent-skills/convex-launch-readiness` · 20,868 تثبيت
...
949. **convex-domains** — `get-convex/agent-skills/convex-domains` · 20,861 تثبيت
...
950. **convex-monitor** — `get-convex/agent-skills/convex-monitor` · 20,860 تثبيت
   Watch for the next thing to react to
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-monitor`

951. **convex-test** — `get-convex/agent-skills/convex-test` · 20,860 تثبيت
...
952. **convex-billing** — `get-convex/agent-skills/convex-billing` · 20,857 تثبيت
...
953. **convex-seed** — `get-convex/agent-skills/convex-seed` · 20,839 تثبيت
...
954. **convex-verify** — `get-convex/agent-skills/convex-verify` · 20,839 تثبيت
   Prove a feature works — seed, drive, assert
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-verify`

955. **convex-improve-convex-plugin** — `get-convex/agent-skills/convex-improve-convex-plugin` · 20,838 تثبيت
...
956. **convex-self-heal** — `get-convex/agent-skills/convex-self-heal` · 20,822 تثبيت
   Gated production self-healing loop
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-self-heal`

957. **convex-suggest** — `get-convex/agent-skills/convex-suggest` · 20,820 تثبيت
...
958. **modern-web-guidance** — `googlechrome/modern-web-guidance/modern-web-guidance` · 20,817 تثبيت
   A skill to search for specific web development use cases and retrieve their corresponding best practice guides.
   `npx skills add https://github.com/googlechrome/modern-web-guidance --skill modern-web-guidance`

959. **expo-ui** — `expo/skills/expo-ui` · 20,800 تثبيت ⭐
...
960. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 20,662 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

961. **wecomcli-todo** — `wecomteam/wecom-cli/wecomcli-todo` · 20,608 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-todo`

962. **pnpm** — `antfu/skills/pnpm` · 20,582 تثبيت
...
963. **wecomcli-contact** — `wecomteam/wecom-cli/wecomcli-contact` · 20,559 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-contact`

964. **wecomcli-meeting** — `wecomteam/wecom-cli/wecomcli-meeting` · 20,517 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-meeting`

965. **gemini-api-dev** — `google-gemini/gemini-skills/gemini-api-dev` · 20,426 تثبيت ⭐
...
966. **firestore-security-rules-auditor** — `firebase/agent-skills/firestore-security-rules-auditor` · 20,414 تثبيت ⭐
...
967. **python-design-patterns** — `wshobson/agents/python-design-patterns` · 20,328 تثبيت
...
968. **baoyu-youtube-transcript** — `jimliu/baoyu-skills/baoyu-youtube-transcript` · 20,090 تثبيت
...
969. **dbs-report** — `dontbesilent2025/dbskill/dbs-report` · 20,082 تثبيت
...
970. **dbs-save** — `dontbesilent2025/dbskill/dbs-save` · 20,057 تثبيت
...
971. **dbs-restore** — `dontbesilent2025/dbskill/dbs-restore` · 20,047 تثبيت
...
972. **java-springboot** — `github/awesome-copilot/java-springboot` · 20,026 تثبيت ⭐
...
973. **dbs-goal** — `dontbesilent2025/dbskill/dbs-goal` · 19,879 تثبيت
...
974. **opencli-usage** — `jackwener/opencli/opencli-usage` · 19,632 تثبيت
...
975. **html-ppt** — `lewislulu/html-ppt-skill/html-ppt` · 19,423 تثبيت
   html-ppt — HTML PPT Studio
   `npx skills add https://github.com/lewislulu/html-ppt-skill --skill html-ppt`

976. **security-requirement-extraction** — `wshobson/agents/security-requirement-extraction` · 19,398 تثبيت
   Transform threat analysis into actionable security requirements.
   `npx skills add https://github.com/wshobson/agents --skill security-requirement-extraction`

977. **pricewin-hotel-deal-finder** — `price-win/pricewin-skills-hub/pricewin-hotel-deal-finder` · 19,389 تثبيت
   PriceWin Hotel Deal Finder
   `npx skills add https://github.com/price-win/pricewin-skills-hub --skill pricewin-hotel-deal-finder`

978. **dbs-slowisfast** — `dontbesilent2025/dbskill/dbs-slowisfast` · 19,325 تثبيت
...
979. **baseline-ui** — `ibelick/ui-skills/baseline-ui` · 19,283 تثبيت
...
980. **ponytail-help** — `dietrichgebert/ponytail/ponytail-help` · 19,248 تثبيت
   Display this reference card when invoked. One-shot, do NOT change mode,
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-help`

981. **extension-email-calendar-events** — `caffeinelabs/skills/extension-email-calendar-events` · 19,219 تثبيت
...
982. **ponytail-debt** — `dietrichgebert/ponytail/ponytail-debt` · 19,196 تثبيت
   Every deliberate ponytail shortcut is marked with a ponytail: comment naming
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-debt`

983. **find-qualified-titles** — `code.deepline.com/find-qualified-titles` · 18,868 تثبيت
   Find Qualified Titles (company_titles -> ICP filter -> contacts)
   `npx skills add https://code.deepline.com/`

984. **modern-javascript-patterns** — `wshobson/agents/modern-javascript-patterns` · 18,806 تثبيت
...
985. **expo-brownfield** — `expo/skills/expo-brownfield` · 18,753 تثبيت ⭐
...
990. **extension-email-verification** — `caffeinelabs/skills/extension-email-verification` · 18,653 تثبيت
...
991. **extension-object-storage** — `caffeinelabs/skills/extension-object-storage` · 18,652 تثبيت
...
992. **javascript-testing-patterns** — `wshobson/agents/javascript-testing-patterns` · 18,479 تثبيت
...
993. **feature-sliced-design** — `feature-sliced/skills/feature-sliced-design` · 18,458 تثبيت
   Feature-Sliced Design (FSD) v2.1
   `npx skills add https://github.com/feature-sliced/skills --skill feature-sliced-design`

994. **extension-email** — `caffeinelabs/skills/extension-email` · 18,415 تثبيت
   Email — Service/Transactional
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-email`

995. **extension-http-outcalls** — `caffeinelabs/skills/extension-http-outcalls` · 18,411 تثبيت
   HTTP outcalls extension for Caffeine AI.
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-http-outcalls`

996. **extension-authorization** — `caffeinelabs/skills/extension-authorization` · 18,411 تثبيت
...
997. **opencli-browser** — `jackwener/opencli/opencli-browser` · 18,408 تثبيت
...
998. **extension-invite-links** — `caffeinelabs/skills/extension-invite-links` · 18,408 تثبيت
...
999. **extension-core-infrastructure** — `caffeinelabs/skills/extension-core-infrastructure` · 18,406 تثبيت
...
1000. **vue-router-best-practices** — `antfu/skills/vue-router-best-practices` · 18,329 تثبيت
...
1005. **extension-posting-to-x** — `caffeinelabs/skills/extension-posting-to-x` · 18,153 تثبيت
...
1006. **aso-audit** — `coreyhaines31/marketingskills/aso-audit` · 18,009 تثبيت
...
1007. **create-readme** — `github/awesome-copilot/create-readme` · 17,955 تثبيت ⭐
...
1008. **rust-async-patterns** — `wshobson/agents/rust-async-patterns` · 17,904 تثبيت
...
1009. **playwright-generate-test** — `github/awesome-copilot/playwright-generate-test` · 17,869 تثبيت ⭐
...
1010. **agent development** — `anthropics/claude-code/agent-development` · 17,722 تثبيت ⭐
   Agent Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Agent Development&#x27;`

1011. **skill development** — `anthropics/claude-code/skill-development` · 17,528 تثبيت ⭐
   Skill Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Skill Development&#x27;`

1012. **pinia** — `antfu/skills/pinia` · 17,407 تثبيت
...
1013. **sql-optimization-patterns** — `wshobson/agents/sql-optimization-patterns` · 17,389 تثبيت
...
1014. **planning-with-files-zh** — `othmanadi/planning-with-files/planning-with-files-zh` · 17,220 تثبيت
...
1015. **fixing-accessibility** — `ibelick/ui-skills/fixing-accessibility` · 17,204 تثبيت
...
1016. **the-news** — `sfkislev/the-news/the-news` · 17,165 تثبيت
...
1017. **golang-pro** — `jeffallan/claude-skills/golang-pro` · 17,124 تثبيت
