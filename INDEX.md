...
**آخر تحديث:** 2026-09-11 · **العدد:** 1,006 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,348,155 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 1,113,169 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 949,631 تثبيت
...
4. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 908,551 تثبيت
...
7. **agent-browser** — `vercel-labs/agent-browser/agent-browser` · 828,030 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/vercel-labs/agent-browser --skill agent-browser`

8. **setup-matt-pocock-skills** — `mattpocock/skills/setup-matt-pocock-skills` · 812,737 تثبيت
...
9. **handoff** — `mattpocock/skills/handoff` · 781,825 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 766,413 تثبيت
...
11. **prototype** — `mattpocock/skills/prototype` · 759,516 تثبيت
...
12. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 704,268 تثبيت ⭐
   React and Next.js performance optimization across 70 rules prioritized by impact.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-react-best-practices`

13. **anti-ui-slop** — `uizze.com/anti-ui-slop` · 691,327 تثبيت
   Stop AI coding agents from shipping generic UI.
   `npx skills add https://uizze.com/`

14. **lark-doc** — `open.feishu.cn/lark-doc` · 680,645 تثبيت
...
15. **lark-base** — `open.feishu.cn/lark-base` · 680,498 تثبيت
...
16. **lark-drive** — `open.feishu.cn/lark-drive` · 680,325 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

17. **lark-approval** — `open.feishu.cn/lark-approval` · 679,938 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

18. **lark-shared** — `open.feishu.cn/lark-shared` · 679,908 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

19. **lark-im** — `open.feishu.cn/lark-im` · 679,834 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

20. **lark-calendar** — `open.feishu.cn/lark-calendar` · 679,745 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/`

21. **lark-sheets** — `open.feishu.cn/lark-sheets` · 679,420 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/`

22. **lark-wiki** — `open.feishu.cn/lark-wiki` · 679,182 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

23. **lark-contact** — `open.feishu.cn/lark-contact` · 679,153 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

24. **lark-minutes** — `open.feishu.cn/lark-minutes` · 679,063 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

25. **lark-event** — `open.feishu.cn/lark-event` · 678,829 تثبيت
...
26. **lark-slides** — `open.feishu.cn/lark-slides` · 678,790 تثبيت
   本技能文档较长，务必使用 Read 工具阅读两次，必须阅读完整全文。
   `npx skills add https://open.feishu.cn/`

27. **lark-task** — `open.feishu.cn/lark-task` · 678,789 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

28. **lark-mail** — `open.feishu.cn/lark-mail` · 678,785 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

29. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 678,766 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/`

30. **lark-attendance** — `open.feishu.cn/lark-attendance` · 678,693 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

31. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 678,629 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

32. **lark-vc** — `open.feishu.cn/lark-vc` · 678,430 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

33. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 678,318 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/`

34. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 678,180 تثبيت
...
35. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 678,034 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

36. **grilling** — `mattpocock/skills/grilling` · 673,416 تثبيت
...
37. **lark-okr** — `open.feishu.cn/lark-okr` · 659,392 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

38. **lark-markdown** — `open.feishu.cn/lark-markdown` · 644,737 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

39. **teach** — `mattpocock/skills/teach` · 633,273 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

40. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 624,104 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

41. **lark-vc-agent** — `open.feishu.cn/lark-vc-agent` · 623,016 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

42. **domain-modeling** — `mattpocock/skills/domain-modeling` · 610,592 تثبيت
...
43. **ai-video-generation** — `skills-101/superpowers/ai-video-generation` · 593,457 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-video-generation`

44. **ai-image-generation** — `skills-101/superpowers/ai-image-generation` · 592,739 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-image-generation`

45. **ai-avatar-video** — `skills-101/superpowers/ai-avatar-video` · 592,601 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-avatar-video`

46. **twitter-automation** — `skills-101/superpowers/twitter-automation` · 592,485 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill twitter-automation`

47. **codebase-design** — `mattpocock/skills/codebase-design` · 591,938 تثبيت
...
48. **lark-apps** — `open.feishu.cn/lark-apps` · 589,167 تثبيت
...
49. **microsoft-foundry** — `microsoft/azure-skills/microsoft-foundry` · 583,151 تثبيت ⭐
   End-to-end deployment, evaluation, and management of AI agents on Microsoft Foundry.
   `npx skills add https://github.com/microsoft/azure-skills --skill microsoft-foundry`

50. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 581,089 تثبيت
   A discipline for hard bugs. Skip phases only when explicitly justified.
   `npx skills add https://github.com/mattpocock/skills --skill diagnosing-bugs`

51. **azure-diagnostics** — `microsoft/azure-skills/azure-diagnostics` · 575,231 تثبيت ⭐
...
52. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 574,699 تثبيت ⭐
...
53. **azure-ai** — `microsoft/azure-skills/azure-ai` · 574,544 تثبيت ⭐
...
54. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 574,494 تثبيت ⭐
...
55. **azure-validate** — `microsoft/azure-skills/azure-validate` · 573,947 تثبيت ⭐
...
56. **azure-storage** — `microsoft/azure-skills/azure-storage` · 573,401 تثبيت ⭐
...
57. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 573,141 تثبيت ⭐
...
58. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 572,883 تثبيت ⭐
...
59. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 572,850 تثبيت ⭐
...
60. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 572,823 تثبيت ⭐
...
61. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 572,803 تثبيت ⭐
...
62. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 572,573 تثبيت ⭐
...
63. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 572,496 تثبيت ⭐
...
64. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 562,217 تثبيت ⭐
...
65. **ask-matt** — `mattpocock/skills/ask-matt` · 538,998 تثبيت
   You don't remember every skill, so ask.
   `npx skills add https://github.com/mattpocock/skills --skill ask-matt`

66. **implement** — `mattpocock/skills/implement` · 533,926 تثبيت
   Implement the work described by the user in the spec or tickets.
   `npx skills add https://github.com/mattpocock/skills --skill implement`

67. **code-review** — `mattpocock/skills/code-review` · 528,560 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill code-review`

68. **hyperframes-cli** — `heygen-com/hyperframes/hyperframes-cli` · 524,077 تثبيت
...
69. **remotion-best-practices** — `remotion-dev/skills/remotion-best-practices` · 519,123 تثبيت ⭐
   Domain-specific knowledge base for building videos with Remotion and React.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices`

70. **azure-compute** — `microsoft/azure-skills/azure-compute` · 516,216 تثبيت ⭐
...
71. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 506,241 تثبيت ⭐
...
72. **hyperframes** — `heygen-com/hyperframes/hyperframes` · 502,380 تثبيت
...
73. **caveman** — `juliusbrussee/caveman/caveman` · 498,633 تثبيت
   Ultra-compressed communication mode cutting token usage ~75% while preserving technical accuracy.
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman`

74. **wayfinder** — `mattpocock/skills/wayfinder` · 489,763 تثبيت
...
75. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 489,621 تثبيت ⭐
...
76. **research** — `mattpocock/skills/research` · 483,149 تثبيت
   Spin up a background agent to do the research, so you keep working while it reads.
   `npx skills add https://github.com/mattpocock/skills --skill research`

77. **to-spec** — `mattpocock/skills/to-spec` · 481,242 تثبيت
...
78. **to-tickets** — `mattpocock/skills/to-tickets` · 472,873 تثبيت
   Break a plan, spec, or conversation into a set of tickets: tracer-bullet vertical slices, each declaring the tickets that block it.
   `npx skills add https://github.com/mattpocock/skills --skill to-tickets`

79. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 465,737 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

80. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 463,519 تثبيت
...
81. **lark-note** — `open.feishu.cn/lark-note` · 462,858 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

82. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 458,047 تثبيت
...
83. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,854 تثبيت
...
84. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,095 تثبيت
...
85. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 450,007 تثبيت
...
86. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 449,977 تثبيت
...
87. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 442,383 تثبيت ⭐
...
88. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 440,893 تثبيت ⭐
...
89. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 434,499 تثبيت ⭐
...
90. **video-edit** — `genmedia-labs/skills/video-edit` · 427,241 تثبيت
   Video Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/genmedia-labs/skills --skill video-edit`

91. **ai-music** — `genmedia-labs/skills/ai-music` · 426,867 تثبيت
...
96. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 415,152 تثبيت
...
97. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 414,609 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

98. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 414,436 تثبيت
...
99. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 414,432 تثبيت
...
100. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 414,388 تثبيت
...
101. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 414,217 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

102. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 409,025 تثبيت ⭐
...
103. **hyperframes-core** — `heygen-com/hyperframes/hyperframes-core` · 404,868 تثبيت
...
104. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 401,881 تثبيت ⭐
...
105. **media-use** — `heygen-com/hyperframes/media-use` · 401,212 تثبيت
   The media OS for HyperFrames: resolve · generate · operate · remember — every media type, one skill, zero context noise.
   `npx skills add https://github.com/heygen-com/hyperframes --skill media-use`

106. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 395,507 تثبيت ⭐
...
107. **reddit-automation** — `flowkit-labs/skills/reddit-automation` · 395,060 تثبيت
   Built by the team at doany.ai.
   `npx skills add https://github.com/flowkit-labs/skills --skill reddit-automation`

108. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 394,800 تثبيت
...
113. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 375,911 تثبيت
...
114. **to-prd** — `mattpocock/skills/to-prd` · 367,215 تثبيت
...
115. **brainstorming** — `obra/superpowers/brainstorming` · 358,467 تثبيت
   Structured design dialogue that validates ideas before implementation begins.
   `npx skills add https://github.com/obra/superpowers --skill brainstorming`

116. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 358,315 تثبيت
...
117. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 358,006 تثبيت
...
118. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 356,366 تثبيت
...
119. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 355,880 تثبيت
...
120. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 355,664 تثبيت
...
121. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 355,624 تثبيت
...
122. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 355,220 تثبيت
...
123. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 355,077 تثبيت
...
124. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 354,943 تثبيت
...
125. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 354,860 تثبيت
...
126. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 354,763 تثبيت
...
127. **to-issues** — `mattpocock/skills/to-issues` · 354,182 تثبيت
...
128. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 352,661 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

129. **caveman-commit** — `juliusbrussee/caveman/caveman-commit` · 349,581 تثبيت
...
130. **ace-step** — `prime-skills/runcomfy-agent-skills/ace-step` · 346,650 تثبيت
   ACE Step — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ace-step`

131. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 346,177 تثبيت
...
132. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 344,544 تثبيت
...
133. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 343,818 تثبيت
...
134. **git-guardrails-claude-code** — `mattpocock/skills/git-guardrails-claude-code` · 342,923 تثبيت
   Sets up a PreToolUse hook that intercepts and blocks dangerous git commands before Claude executes them.
   `npx skills add https://github.com/mattpocock/skills --skill git-guardrails-claude-code`

135. **wizard** — `mattpocock/skills/wizard` · 341,533 تثبيت
...
136. **redesign-existing-projects** — `leonxlnx/taste-skill/redesign-existing-projects` · 340,174 تثبيت
   Audit and upgrade existing websites to premium design standards without breaking functionality.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill redesign-existing-projects`

137. **caveman-help** — `juliusbrussee/caveman/caveman-help` · 337,173 تثبيت
...
138. **setup-pre-commit** — `mattpocock/skills/setup-pre-commit` · 335,443 تثبيت
   lint-staged running Prettier on all staged files
   `npx skills add https://github.com/mattpocock/skills --skill setup-pre-commit`

139. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 330,548 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

140. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 329,453 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

141. **writing-beats** — `mattpocock/skills/writing-beats` · 329,174 تثبيت
...
142. **writing-shape** — `mattpocock/skills/writing-shape` · 328,679 تثبيت
...
143. **writing-fragments** — `mattpocock/skills/writing-fragments` · 328,552 تثبيت
...
144. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 325,915 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

145. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 322,768 تثبيت
...
146. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 321,004 تثبيت ⭐
...
147. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 315,860 تثبيت
...
148. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,207 تثبيت
...
149. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 311,001 تثبيت
...
150. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,942 تثبيت
...
151. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,627 تثبيت
...
152. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,597 تثبيت
...
153. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,469 تثبيت
...
154. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,454 تثبيت
...
155. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 301,242 تثبيت
...
156. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 295,135 تثبيت ⭐
...
157. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 294,801 تثبيت
...
158. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 294,788 تثبيت
...
159. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 293,933 تثبيت
...
160. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 293,898 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

161. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 293,285 تثبيت
...
162. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 290,720 تثبيت
...
163. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 288,904 تثبيت
...
164. **brandkit** — `leonxlnx/taste-skill/brandkit` · 283,836 تثبيت
...
165. **loop-me** — `mattpocock/skills/loop-me` · 282,802 تثبيت
...
166. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 279,009 تثبيت
...
167. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 277,168 تثبيت
...
168. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 276,173 تثبيت ⭐
...
169. **prisma-client-api** — `prisma/skills/prisma-client-api` · 275,720 تثبيت ⭐
...
170. **prisma-cli** — `prisma/skills/prisma-cli` · 273,443 تثبيت ⭐
...
171. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 271,790 تثبيت
...
172. **shadcn** — `shadcn/ui/shadcn` · 271,675 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

173. **impeccable** — `pbakaus/impeccable/impeccable` · 270,971 تثبيت
   Frontend design and iteration for production-grade interfaces, from concept to ship.
   `npx skills add https://github.com/pbakaus/impeccable --skill impeccable`

174. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 270,475 تثبيت
...
175. **prisma-postgres** — `prisma/skills/prisma-postgres` · 269,319 تثبيت ⭐
...
176. **supabase** — `supabase/agent-skills/supabase` · 267,698 تثبيت ⭐
...
177. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 264,627 تثبيت ⭐
...
178. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 264,388 تثبيت ⭐
...
179. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 263,657 تثبيت ⭐
...
180. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 260,931 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

181. **prisma-compute** — `prisma/skills/prisma-compute` · 259,695 تثبيت ⭐
...
182. **claude-handoff** — `mattpocock/skills/claude-handoff` · 259,521 تثبيت
...
183. **prisma-mongodb-upgrade** — `prisma/skills/prisma-mongodb-upgrade` · 258,385 تثبيت ⭐
   Prisma MongoDB Upgrade Path
   `npx skills add https://github.com/prisma/skills --skill prisma-mongodb-upgrade`

184. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 254,974 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

185. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 254,286 تثبيت ⭐
...
189. **using-superpowers** — `obra/superpowers/using-superpowers` · 240,409 تثبيت
   IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST USE IT.
   `npx skills add https://github.com/obra/superpowers --skill using-superpowers`

190. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 239,528 تثبيت
...
191. **diagnose** — `mattpocock/skills/diagnose` · 238,582 تثبيت
...
192. **wait-what** — `mattpocock/skills/wait-what` · 230,871 تثبيت
...
193. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 230,244 تثبيت
...
194. **write-a-skill** — `mattpocock/skills/write-a-skill` · 230,069 تثبيت
...
195. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 229,541 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

196. **zoom-out** — `mattpocock/skills/zoom-out` · 229,503 تثبيت
...
197. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 227,447 تثبيت
...
198. **requesting-code-review** — `obra/superpowers/requesting-code-review` · 224,954 تثبيت
   Dispatch code review subagents with focused context to catch issues before they compound.
   `npx skills add https://github.com/obra/superpowers --skill requesting-code-review`

199. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 224,167 تثبيت
...
203. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 216,631 تثبيت
...
204. **design-an-interface** — `mattpocock/skills/design-an-interface` · 216,223 تثبيت
...
205. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 209,579 تثبيت
...
206. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,490 تثبيت ⭐
...
207. **executing-plans** — `obra/superpowers/executing-plans` · 208,511 تثبيت
...
208. **embedded-captions** — `heygen-com/hyperframes/embedded-captions` · 207,763 تثبيت
...
209. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 207,334 تثبيت ⭐
...
210. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 206,823 تثبيت
...
211. **qa** — `mattpocock/skills/qa` · 205,484 تثبيت
...
212. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 204,863 تثبيت
...
213. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 204,154 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

214. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 203,395 تثبيت
...
215. **obsidian-vault** — `mattpocock/skills/obsidian-vault` · 201,908 تثبيت
   /mnt/d/Obsidian Vault/AI Research/
   `npx skills add https://github.com/mattpocock/skills --skill obsidian-vault`

216. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 201,486 تثبيت
...
217. **edit-article** — `mattpocock/skills/edit-article` · 198,220 تثبيت
...
218. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 197,830 تثبيت
...
219. **orchestration** — `stablyai/orca/orchestration` · 196,900 تثبيت
...
220. **pdf** — `anthropics/skills/pdf` · 194,049 تثبيت ⭐
   Comprehensive PDF processing with text extraction, merging, splitting, form filling, and OCR capabilities.
   `npx skills add https://github.com/anthropics/skills --skill pdf`

221. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 190,180 تثبيت
...
222. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 187,649 تثبيت
...
223. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 187,105 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

224. **writing-skills** — `obra/superpowers/writing-skills` · 187,000 تثبيت
...
225. **docx** — `anthropics/skills/docx` · 186,044 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

226. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 183,746 تثبيت
...
227. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 182,287 تثبيت
...
228. **slideshow** — `heygen-com/hyperframes/slideshow` · 178,911 تثبيت
...
229. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 178,492 تثبيت
...
230. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 178,142 تثبيت
...
231. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 178,107 تثبيت
...
232. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 178,052 تثبيت
...
233. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 178,050 تثبيت
...
234. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 178,031 تثبيت
...
235. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 177,901 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

236. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 177,372 تثبيت ⭐
...
237. **xlsx** — `anthropics/skills/xlsx` · 166,531 تثبيت ⭐
   Create, edit, and analyze Excel spreadsheets with formulas, formatting, and error-free calculations.
   `npx skills add https://github.com/anthropics/skills --skill xlsx`

238. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 166,520 تثبيت
...
239. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 160,724 تثبيت
...
240. **webapp-testing** — `anthropics/skills/webapp-testing` · 153,990 تثبيت ⭐
   Native Python Playwright scripts for testing local web applications with server lifecycle management.
   `npx skills add https://github.com/anthropics/skills --skill webapp-testing`

241. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 152,999 تثبيت ⭐
...
242. **wind-mcp-skill** — `wind-alice/alicemarket/wind-mcp-skill` · 150,605 تثبيت
...
243. **firebase-basics** — `firebase/agent-skills/firebase-basics` · 149,703 تثبيت ⭐
...
244. **review-animations** — `emilkowalski/skills/review-animations` · 149,630 تثبيت
...
245. **playwright-cli** — `microsoft/playwright-cli/playwright-cli` · 149,384 تثبيت ⭐
   Browser automation with 40+ commands for navigation, interaction, form filling, and web testing.
   `npx skills add https://github.com/microsoft/playwright-cli --skill playwright-cli`

246. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 149,068 تثبيت
...
247. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 148,646 تثبيت ⭐
...
248. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 145,066 تثبيت ⭐
...
249. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 144,555 تثبيت ⭐
...
250. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 143,733 تثبيت ⭐
...
251. **computer-use** — `stablyai/orca/computer-use` · 143,152 تثبيت
   This discovery stub loads the version-matched guide from the Orca executable used for this session.
   `npx skills add https://github.com/stablyai/orca --skill computer-use`

252. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 141,152 تثبيت
...
253. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 141,097 تثبيت
...
254. **sentry-cli** — `sentry/dev/sentry-cli` · 140,811 تثبيت
...
255. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 139,980 تثبيت
...
256. **design-mobile-apps** — `designed-by-ai/skills/design-mobile-apps` · 139,899 تثبيت
...
257. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 138,457 تثبيت
...
258. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 138,226 تثبيت
...
259. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 137,417 تثبيت
...
260. **ui-radar** — `uizze.com/ui-radar` · 135,613 تثبيت
   Don't let your AI agents design blind.
   `npx skills add https://uizze.com/`

261. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 131,878 تثبيت
...
262. **apple-design** — `emilkowalski/skills/apple-design` · 131,739 تثبيت
...
263. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 130,252 تثبيت
...
264. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 128,814 تثبيت
...
265. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 126,434 تثبيت
...
266. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 124,181 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

267. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 123,710 تثبيت
...
268. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 123,182 تثبيت
...
269. **improve-animations** — `emilkowalski/skills/improve-animations` · 121,825 تثبيت
...
270. **figma** — `heygen-com/hyperframes/figma` · 119,126 تثبيت
...
271. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 117,582 تثبيت ⭐
...
272. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 114,778 تثبيت
...
273. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 114,400 تثبيت
...
274. **mcp-builder** — `anthropics/skills/mcp-builder` · 113,179 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

275. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 112,629 تثبيت ⭐
...
276. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 110,481 تثبيت ⭐
...
277. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 109,975 تثبيت
...
278. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 109,217 تثبيت ⭐
...
279. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 109,018 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

280. **browser-act** — `browser-act/skills/browser-act` · 107,972 تثبيت
...
281. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 107,274 تثبيت ⭐
...
282. **neon** — `neondatabase/agent-skills/neon` · 107,057 تثبيت ⭐
...
283. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 106,660 تثبيت
...
284. **canvas-design** — `anthropics/skills/canvas-design` · 106,590 تثبيت ⭐
...
285. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 106,373 تثبيت ⭐
...
286. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 105,627 تثبيت ⭐
...
287. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 105,133 تثبيت
...
288. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 103,069 تثبيت
...
289. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 101,150 تثبيت
...
290. **firecrawl** — `firecrawl/cli/firecrawl` · 100,724 تثبيت ⭐
...
291. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 100,442 تثبيت
...
292. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 99,613 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

293. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,318 تثبيت ⭐
...
294. **revops** — `coreyhaines31/marketingskills/revops` · 96,211 تثبيت
...
295. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 96,070 تثبيت ⭐
...
296. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 95,992 تثبيت ⭐
...
297. **gsap** — `heygen-com/hyperframes/gsap` · 95,304 تثبيت
...
298. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,501 تثبيت
...
299. **review** — `mattpocock/skills/review` · 94,325 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

300. **browser-use** — `browser-use/browser-use/browser-use` · 94,272 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

301. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,067 تثبيت
...
302. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,063 تثبيت
...
303. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 93,362 تثبيت
...
304. **wan-3-0-prime-reference-to-video** — `genmedia-labs/skills/wan-3-0-prime-reference-to-video` · 93,300 تثبيت
...
305. **seedance-2-5-image-to-video** — `genmedia-labs/skills/seedance-2-5-image-to-video` · 93,092 تثبيت
   Seedance 2.5 Image to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-image-to-video`

306. **seedance-2-5-reference-to-video** — `genmedia-labs/skills/seedance-2-5-reference-to-video` · 92,959 تثبيت
   Seedance 2.5 Reference to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-reference-to-video`

307. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 92,460 تثبيت
...
308. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 92,415 تثبيت
...
309. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 92,351 تثبيت
...
310. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 91,774 تثبيت ⭐
...
311. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 91,676 تثبيت ⭐
...
312. **implement-spec** — `mattpocock/skills/implement-spec` · 91,372 تثبيت
   You have been provided a spec. This spec should have tickets associated with it, describing how to implement the spec.
   `npx skills add https://github.com/mattpocock/skills --skill implement-spec`

313. **convex** — `get-convex/agent-skills/convex` · 91,130 تثبيت
...
314. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 89,634 تثبيت ⭐
...
315. **polish** — `pbakaus/impeccable/polish` · 87,250 تثبيت
...
316. **cloudflare** — `cloudflare/skills/cloudflare` · 85,173 تثبيت ⭐
...
317. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,079 تثبيت
...
318. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 84,801 تثبيت
...
319. **critique** — `pbakaus/impeccable/critique` · 84,644 تثبيت
...
320. **audit** — `pbakaus/impeccable/audit` · 83,863 تثبيت
...
321. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 83,798 تثبيت ⭐
...
322. **theme-factory** — `anthropics/skills/theme-factory` · 83,730 تثبيت ⭐
...
323. **animate** — `pbakaus/impeccable/animate` · 83,718 تثبيت
...
324. **adapt** — `pbakaus/impeccable/adapt` · 83,706 تثبيت
...
325. **clarify** — `pbakaus/impeccable/clarify` · 83,197 تثبيت
...
326. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 83,150 تثبيت ⭐
...
327. **optimize** — `pbakaus/impeccable/optimize` · 83,053 تثبيت
...
328. **colorize** — `pbakaus/impeccable/colorize` · 82,859 تثبيت
...
329. **wrangler** — `cloudflare/skills/wrangler` · 82,627 تثبيت ⭐
...
330. **bolder** — `pbakaus/impeccable/bolder` · 81,979 تثبيت
...
331. **delight** — `pbakaus/impeccable/delight` · 81,811 تثبيت
...
332. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 81,661 تثبيت ⭐
...
333. **distill** — `pbakaus/impeccable/distill` · 81,420 تثبيت
...
334. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 81,363 تثبيت ⭐
...
335. **prototype** — `emilkowalski/skills/prototype` · 81,208 تثبيت
...
336. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 81,141 تثبيت
...
337. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 80,618 تثبيت
...
338. **quieter** — `pbakaus/impeccable/quieter` · 80,587 تثبيت
...
339. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 80,444 تثبيت
...
340. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 79,791 تثبيت ⭐
...
341. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 79,209 تثبيت ⭐
...
342. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 79,157 تثبيت ⭐
...
343. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 78,774 تثبيت ⭐
...
344. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 78,463 تثبيت ⭐
...
345. **lark-meeting** — `open.feishu.cn/lark-meeting` · 77,985 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

346. **remotion-render** — `remotion-dev/skills/remotion-render` · 77,757 تثبيت ⭐
   General rendering strategy
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-render`

347. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,747 تثبيت
...
348. **remotion-create** — `remotion-dev/skills/remotion-create` · 77,619 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

349. **retro** — `mattpocock/skills/retro` · 77,397 تثبيت
   The user has asked for a retrospective. You are suggesting improvements to the coding agent's environment to improve future runs.
   `npx skills add https://github.com/mattpocock/skills --skill retro`

350. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 75,725 تثبيت ⭐
...
351. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 75,548 تثبيت ⭐
...
352. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 75,156 تثبيت ⭐
...
353. **web-search** — `skills-101/superpowers/web-search` · 74,752 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill web-search`

354. **wonda-cli** — `degausai/wonda/wonda-cli` · 74,605 تثبيت
...
355. **notion-api** — `intellectronica/agent-skills/notion-api` · 74,541 تثبيت
...
356. **agent-tools** — `skills-101/superpowers/agent-tools` · 74,420 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill agent-tools`

357. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 74,407 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

358. **python-executor** — `skills-101/superpowers/python-executor` · 74,371 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

359. **css-animations** — `heygen-com/hyperframes/css-animations` · 74,314 تثبيت
...
360. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 74,221 تثبيت
...
361. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 73,363 تثبيت
...
362. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 73,080 تثبيت
...
363. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 72,993 تثبيت ⭐
...
364. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 72,779 تثبيت
...
365. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,483 تثبيت
...
366. **animejs** — `heygen-com/hyperframes/animejs` · 71,933 تثبيت
...
367. **internal-comms** — `anthropics/skills/internal-comms` · 71,598 تثبيت ⭐
...
368. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 71,242 تثبيت ⭐
...
369. **three** — `heygen-com/hyperframes/three` · 71,214 تثبيت
...
370. **lottie** — `heygen-com/hyperframes/lottie` · 70,948 تثبيت
...
371. **archify** — `tt-a1i/archify/archify` · 70,882 تثبيت
...
372. **audit-website** — `squirrelscan/skills/audit-website` · 70,768 تثبيت
...
373. **waapi** — `heygen-com/hyperframes/waapi` · 70,575 تثبيت
...
374. **turborepo** — `vercel/turborepo/turborepo` · 70,452 تثبيت ⭐
...
375. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 70,183 تثبيت
...
376. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 69,860 تثبيت ⭐
...
377. **remotion-saas** — `remotion-dev/skills/remotion-saas` · 69,779 تثبيت ⭐
   One can build apps with Remotion.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-saas`

378. **durable-objects** — `cloudflare/skills/durable-objects` · 68,787 تثبيت ⭐
...
379. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 68,731 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

380. **web-perf** — `cloudflare/skills/web-perf` · 68,650 تثبيت ⭐
...
381. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 68,628 تثبيت ⭐
...
382. **gws-drive** — `googleworkspace/cli/gws-drive` · 68,371 تثبيت ⭐
...
383. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 68,247 تثبيت
...
384. **animate** — `emilkowalski/skills/animate` · 67,956 تثبيت
...
385. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,759 تثبيت
...
386. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 67,661 تثبيت
...
387. **defuddle** — `kepano/obsidian-skills/defuddle` · 67,599 تثبيت
...
388. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 67,529 تثبيت ⭐
...
389. **video** — `coreyhaines31/marketingskills/video` · 67,466 تثبيت
...
390. **image** — `coreyhaines31/marketingskills/image` · 67,417 تثبيت
...
391. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 66,711 تثبيت ⭐
...
392. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 66,378 تثبيت
...
393. **agents-sdk** — `cloudflare/skills/agents-sdk` · 66,361 تثبيت ⭐
...
394. **typeset** — `pbakaus/impeccable/typeset` · 66,230 تثبيت
...
395. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 65,417 تثبيت ⭐
...
401. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 63,792 تثبيت ⭐
...
402. **tailwind-design-system** — `wshobson/agents/tailwind-design-system` · 63,360 تثبيت
   CSS-first design system framework for Tailwind v4 with tokens, components, and responsive patterns.
   `npx skills add https://github.com/wshobson/agents --skill tailwind-design-system`

403. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 63,176 تثبيت ⭐
...
404. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 62,968 تثبيت
...
405. **stripe-projects** — `stripe/ai/stripe-projects` · 62,849 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

406. **developing-genkit-js** — `firebase/agent-skills/developing-genkit-js` · 62,585 تثبيت ⭐
...
407. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,456 تثبيت
   Cross-Border E-Commerce ✈️
   `npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill cross-border-ecommerce`

408. **gpt-image-2** — `prime-skills/runcomfy-agent-skills/gpt-image-2` · 62,393 تثبيت
   GPT Image 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill gpt-image-2`

409. **developing-genkit-dart** — `firebase/agent-skills/developing-genkit-dart` · 62,270 تثبيت ⭐
...
410. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,907 تثبيت
...
411. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,905 تثبيت
...
412. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 61,772 تثبيت ⭐
...
413. **social** — `coreyhaines31/marketingskills/social` · 61,739 تثبيت
...
414. **analytics** — `coreyhaines31/marketingskills/analytics` · 61,664 تثبيت
...
415. **design-md** — `google-labs-code/stitch-skills/design-md` · 61,329 تثبيت ⭐
...
416. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 61,016 تثبيت
...
417. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 60,434 تثبيت
...
418. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 60,374 تثبيت
...
419. **ads** — `coreyhaines31/marketingskills/ads` · 60,222 تثبيت
...
420. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 60,171 تثبيت
   Cut the Curve — the technique catalog
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

421. **review-loop** — `2dmurali/review-loop-skill/review-loop` · 60,154 تثبيت
...
422. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 60,137 تثبيت ⭐
...
423. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 60,016 تثبيت ⭐
...
424. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 59,948 تثبيت ⭐
...
425. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 59,902 تثبيت
...
426. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 59,833 تثبيت
...
427. **gws-shared** — `googleworkspace/cli/gws-shared` · 59,822 تثبيت ⭐
...
428. **oversized-cursor** — `heygen-com/hyperframes/oversized-cursor` · 59,794 تثبيت
   Oversized Cursor — the eye-carrier
   `npx skills add https://github.com/heygen-com/hyperframes --skill oversized-cursor`

429. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 59,646 تثبيت ⭐
...
430. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 59,539 تثبيت ⭐
...
431. **pricing** — `coreyhaines31/marketingskills/pricing` · 59,384 تثبيت
...
432. **building-native-ui** — `expo/skills/building-native-ui` · 59,171 تثبيت ⭐
...
433. **competitors** — `coreyhaines31/marketingskills/competitors` · 58,594 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

434. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,515 تثبيت
...
435. **agently-mail** — `agent.qq.com/agently-mail` · 58,244 تثبيت
   通过 agently-cli 命令行工具操作邮件，通过管理端 (agent.qq.com) 进行后台管理。
   `npx skills add https://agent.qq.com/`

436. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 58,217 تثبيت
...
437. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,153 تثبيت
...
438. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,139 تثبيت
...
439. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 58,059 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

440. **schema** — `coreyhaines31/marketingskills/schema` · 57,798 تثبيت
...
441. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,643 تثبيت
...
442. **emails** — `coreyhaines31/marketingskills/emails` · 57,518 تثبيت
...
443. **launch** — `coreyhaines31/marketingskills/launch` · 57,507 تثبيت
...
444. **expo-dev-client** — `expo/skills/expo-dev-client` · 57,409 تثبيت ⭐
...
445. **ab-testing** — `coreyhaines31/marketingskills/ab-testing` · 56,927 تثبيت
   You are an expert in experimentation and A/B testing. Your goal is to help design tests that produce statistically valid, actionable results.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill ab-testing`

446. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,723 تثبيت
...
447. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,679 تثبيت
...
448. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,402 تثبيت
...
449. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,163 تثبيت
...
450. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 55,911 تثبيت
...
451. **normalize** — `pbakaus/impeccable/normalize` · 55,810 تثبيت
...
452. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,768 تثبيت
...
453. **aso** — `coreyhaines31/marketingskills/aso` · 55,729 تثبيت
...
454. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 55,588 تثبيت ⭐
...
455. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 55,446 تثبيت ⭐
...
456. **ponytail** — `dietrichgebert/ponytail/ponytail` · 55,439 تثبيت
   You are a lazy senior developer. Lazy means efficient, not careless. You have
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail`

457. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 55,371 تثبيت
...
458. **opentui** — `msmps/opentui-skill/opentui` · 55,368 تثبيت
...
459. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,321 تثبيت
...
460. **gsap-core** — `greensock/gsap-skills/gsap-core` · 55,176 تثبيت
...
461. **nia** — `nozomio-labs/nia-skill/nia` · 55,175 تثبيت
...
462. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,816 تثبيت
...
463. **extract** — `pbakaus/impeccable/extract` · 54,728 تثبيت
...
464. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 54,623 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

465. **onboard** — `pbakaus/impeccable/onboard` · 54,565 تثبيت
...
466. **referrals** — `coreyhaines31/marketingskills/referrals` · 54,550 تثبيت
   Referral & Affiliate Programs
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill referrals`

467. **harden** — `pbakaus/impeccable/harden` · 54,493 تثبيت
...
468. **signup** — `coreyhaines31/marketingskills/signup` · 54,470 تثبيت
...
469. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,292 تثبيت
...
470. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 54,292 تثبيت ⭐
...
471. **ai-sdk** — `vercel/ai/ai-sdk` · 54,235 تثبيت ⭐
...
472. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 54,005 تثبيت ⭐
...
473. **popups** — `coreyhaines31/marketingskills/popups` · 53,967 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

474. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 53,909 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

475. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 53,721 تثبيت ⭐
...
476. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 53,384 تثبيت ⭐
...
477. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 53,305 تثبيت ⭐
...
478. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,206 تثبيت
...
479. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 53,106 تثبيت
...
480. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 52,966 تثبيت
...
481. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,906 تثبيت
...
482. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 52,890 تثبيت ⭐
...
483. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,729 تثبيت
...
484. **hallmark** — `nutlope/hallmark/hallmark` · 52,545 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

485. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,464 تثبيت
...
486. **gws-docs** — `googleworkspace/cli/gws-docs` · 52,386 تثبيت ⭐
...
487. **typegpu** — `heygen-com/hyperframes/typegpu` · 52,073 تثبيت
...
488. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,056 تثبيت
...
489. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 51,919 تثبيت
...
490. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,722 تثبيت
...
491. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 51,549 تثبيت
...
492. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,455 تثبيت
...
493. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 51,145 تثبيت
...
494. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 50,969 تثبيت ⭐
...
495. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 50,917 تثبيت
...
496. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 50,889 تثبيت ⭐
...
497. **react:components** — `google-labs-code/stitch-skills/react:components` · 50,672 تثبيت ⭐
   Stitch to React Components
   `npx skills add https://github.com/google-labs-code/stitch-skills --skill react:components`

498. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 50,322 تثبيت
...
499. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 50,277 تثبيت ⭐
...
500. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 50,272 تثبيت
...
501. **momentic-test** — `momentic-ai/skills/momentic-test` · 50,176 تثبيت
...
502. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 50,155 تثبيت
...
503. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 49,844 تثبيت
...
504. **marketing-mindset** — `axelfreeman/marketing-mindset/marketing-mindset` · 49,813 تثبيت
...
505. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 49,706 تثبيت ⭐
...
506. **developing-genkit-go** — `firebase/agent-skills/developing-genkit-go` · 49,541 تثبيت ⭐
...
507. **gsap-react** — `greensock/gsap-skills/gsap-react` · 48,841 تثبيت
...
508. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 48,831 تثبيت
...
509. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 48,709 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

510. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 48,336 تثبيت
...
511. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 47,916 تثبيت
...
512. **sms** — `coreyhaines31/marketingskills/sms` · 47,598 تثبيت
...
513. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 47,589 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

514. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 47,548 تثبيت
...
515. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 47,387 تثبيت
...
516. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,220 تثبيت ⭐
...
517. **mastra** — `mastra-ai/skills/mastra` · 46,966 تثبيت ⭐
...
518. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 46,938 تثبيت
...
519. **higgsfield-youtube-thumbnail** — `higgsfield-ai/skills/higgsfield-youtube-thumbnail` · 46,917 تثبيت
   Higgsfield YouTube Thumbnail
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-youtube-thumbnail`

520. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 46,818 تثبيت
...
521. **compress** — `juliusbrussee/caveman/compress` · 46,813 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

522. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 46,744 تثبيت
...
523. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 46,691 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

524. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 46,662 تثبيت
...
525. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 46,656 تثبيت
...
526. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 46,655 تثبيت
...
527. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 46,621 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

528. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 46,596 تثبيت
...
529. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 46,579 تثبيت
...
530. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 46,533 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

531. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 46,453 تثبيت
...
532. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 45,989 تثبيت
...
533. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 45,494 تثبيت ⭐
...
534. **herdr** — `herdrdev/herdr/herdr` · 45,075 تثبيت
...
535. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 44,926 تثبيت ⭐
...
536. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 44,911 تثبيت
...
537. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,819 تثبيت
...
538. **seo** — `addyosmani/web-quality-skills/seo` · 44,722 تثبيت
...
539. **git-commit** — `github/awesome-copilot/git-commit` · 44,685 تثبيت ⭐
...
540. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 44,599 تثبيت
...
541. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 44,569 تثبيت ⭐
...
542. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 44,317 تثبيت
...
543. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 44,231 تثبيت ⭐
...
544. **caveman-optimize** — `juliusbrussee/caveman/caveman-optimize` · 43,892 تثبيت
   Evaluate an optimization observation
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-optimize`

545. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 43,853 تثبيت
...
546. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 43,590 تثبيت
...
547. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 43,571 تثبيت
...
548. **clerk-setup** — `clerk/skills/clerk-setup` · 43,564 تثبيت ⭐
...
549. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 43,514 تثبيت
...
550. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 43,457 تثبيت
...
551. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 43,422 تثبيت ⭐
...
552. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 43,371 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

553. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 43,258 تثبيت
...
554. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 43,160 تثبيت
...
555. **lean-build** — `juliusbrussee/caveman/lean-build` · 43,160 تثبيت
...
556. **caveman-manage** — `juliusbrussee/caveman/caveman-manage` · 43,145 تثبيت
   Manage eval-gated experiments
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-manage`

557. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 43,121 تثبيت
...
558. **upgrading-expo** — `expo/skills/upgrading-expo` · 43,081 تثبيت ⭐
...
559. **byted-web-search** — `skills.volces.com/byted-web-search` · 42,976 تثبيت
...
560. **migration** — `juliusbrussee/caveman/migration` · 42,959 تثبيت
...
561. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 42,865 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

562. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 42,580 تثبيت
...
563. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 42,304 تثبيت ⭐
...
564. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 42,299 تثبيت ⭐
...
565. **insforge** — `insforge/insforge-skills/insforge` · 41,784 تثبيت
   InsForge App Integration Skill
   `npx skills add https://github.com/insforge/insforge-skills --skill insforge`

566. **gws-gmail-triage** — `googleworkspace/cli/gws-gmail-triage` · 41,774 تثبيت ⭐
...
567. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 41,675 تثبيت
...
568. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 41,620 تثبيت ⭐
...
572. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 40,602 تثبيت
...
573. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 40,278 تثبيت ⭐
...
574. **arrange** — `pbakaus/impeccable/arrange` · 40,177 تثبيت
...
575. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 40,105 تثبيت
...
576. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 39,956 تثبيت ⭐
...
577. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 39,932 تثبيت
...
578. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 39,905 تثبيت
...
579. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 39,897 تثبيت
...
580. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 39,863 تثبيت ⭐
...
581. **last30days** — `mvanhorn/last30days-skill/last30days` · 39,542 تثبيت
...
582. **animate-expo** — `emilkowalski/skills/animate-expo` · 39,389 تثبيت
   Building Animations in Expo
   `npx skills add https://github.com/emilkowalski/skills --skill animate-expo`

583. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 39,191 تثبيت
...
584. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 39,132 تثبيت
...
585. **remotion** — `google-labs-code/stitch-skills/remotion` · 39,069 تثبيت ⭐
...
586. **golang-security** — `samber/cc-skills-golang/golang-security` · 39,065 تثبيت
...
587. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 38,599 تثبيت
...
588. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 38,527 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

589. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 38,414 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

590. **clerk-orgs** — `clerk/skills/clerk-orgs` · 38,397 تثبيت ⭐
...
591. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 38,178 تثبيت
...
592. **golang-context** — `samber/cc-skills-golang/golang-context` · 38,087 تثبيت
...
593. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 38,082 تثبيت
...
594. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 37,993 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

595. **gws-slides** — `googleworkspace/cli/gws-slides` · 37,990 تثبيت ⭐
...
596. **golang-database** — `samber/cc-skills-golang/golang-database` · 37,983 تثبيت
...
597. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 37,956 تثبيت
...
598. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 37,912 تثبيت
...
599. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,896 تثبيت ⭐
...
600. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 37,845 تثبيت
...
601. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 37,827 تثبيت
...
602. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 37,793 تثبيت
...
603. **offers** — `coreyhaines31/marketingskills/offers` · 37,758 تثبيت
...
604. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 37,735 تثبيت
...
605. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 37,633 تثبيت
...
606. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,630 تثبيت
...
607. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 37,530 تثبيت ⭐
...
608. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 37,474 تثبيت
...
609. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 37,472 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

610. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 37,462 تثبيت
...
611. **product-photography** — `skills-101/superpowers/product-photography` · 37,454 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

612. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 37,401 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

613. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 37,388 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

614. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 37,380 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

615. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 37,378 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

616. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 37,377 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

617. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 37,376 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

618. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 37,342 تثبيت
...
619. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 37,277 تثبيت
...
620. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 37,244 تثبيت
...
621. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 37,218 تثبيت
...
622. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 37,175 تثبيت
...
623. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 37,150 تثبيت
...
624. **firebase-firestore-standard** — `firebase/agent-skills/firebase-firestore-standard` · 37,119 تثبيت ⭐
...
625. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 37,082 تثبيت
...
626. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 37,082 تثبيت
...
627. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 36,982 تثبيت
...
628. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 36,970 تثبيت
...
631. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 36,456 تثبيت
...
632. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 36,404 تثبيت
...
633. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 36,294 تثبيت
...
634. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 36,266 تثبيت
...
635. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 36,224 تثبيت
...
636. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 36,203 تثبيت
...
637. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 36,196 تثبيت
...
638. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 36,173 تثبيت
...
639. **firebase-firestore-enterprise-native-mode** — `firebase/agent-skills/firebase-firestore-enterprise-native-mode` · 36,056 تثبيت ⭐
...
640. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 36,044 تثبيت
...
641. **gws-meet** — `googleworkspace/cli/gws-meet` · 36,032 تثبيت ⭐
...
642. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 35,993 تثبيت
...
643. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 35,960 تثبيت
...
647. **wind-find-finance-skill** — `wind-alice/alicemarket/wind-find-finance-skill` · 35,362 تثبيت
...
648. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 35,223 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

649. **replicas-agent** — `replicas-group/skill/replicas-agent` · 35,214 تثبيت
...
650. **vite** — `antfu/skills/vite` · 35,149 تثبيت
...
651. **angular-developer** — `angular/skills/angular-developer` · 35,095 تثبيت
...
652. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 35,018 تثبيت
...
653. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 34,931 تثبيت
...
654. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 34,926 تثبيت
...
655. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 34,925 تثبيت
...
656. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 34,809 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

657. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 34,774 تثبيت
...
658. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 34,769 تثبيت
...
659. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 34,657 تثبيت
...
660. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 34,594 تثبيت
...
661. **firebase-ai-logic** — `firebase/agent-skills/firebase-ai-logic` · 34,582 تثبيت ⭐
...
662. **expo-module** — `expo/skills/expo-module` · 34,495 تثبيت ⭐
...
663. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 34,324 تثبيت
...
664. **performance** — `addyosmani/web-quality-skills/performance` · 34,277 تثبيت
...
665. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 34,201 تثبيت ⭐
...
666. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 34,094 تثبيت ⭐
...
667. **gws-keep** — `googleworkspace/cli/gws-keep` · 33,975 تثبيت ⭐
...
668. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 33,951 تثبيت
...
669. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 33,868 تثبيت ⭐
...
670. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 33,777 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

671. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 33,718 تثبيت
...
672. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,639 تثبيت ⭐
...
673. **self-improving-agent** — `zhaono1/agent-playbook/self-improving-agent` · 33,567 تثبيت
...
674. **sandbox-sdk** — `cloudflare/skills/sandbox-sdk` · 33,537 تثبيت ⭐
   Build secure, isolated code execution environments on Cloudflare Workers.
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-sdk`

675. **vue** — `antfu/skills/vue` · 33,514 تثبيت
...
676. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 33,460 تثبيت
...
677. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 33,443 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

678. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 33,437 تثبيت
...
679. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 33,250 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

680. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,862 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

681. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 32,837 تثبيت ⭐
...
682. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 32,774 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

683. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,626 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

684. **improve** — `shadcn/improve/improve` · 32,621 تثبيت
...
685. **write-swift** — `emilkowalski/skills/write-swift` · 32,577 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/emilkowalski/skills --skill write-swift`

686. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,563 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

687. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 32,529 تثبيت
...
688. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,497 تثبيت
...
689. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 32,274 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

690. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 32,247 تثبيت
...
691. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 32,229 تثبيت
...
692. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 32,198 تثبيت
...
693. **ckm:brand** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:brand` · 32,063 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

694. **ckm:banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:banner-design` · 32,036 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

695. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 32,019 تثبيت ⭐
...
696. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 31,969 تثبيت ⭐
...
697. **ckm:slides** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:slides` · 31,946 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

698. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 31,942 تثبيت ⭐
...
699. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 31,837 تثبيت ⭐
...
700. **tavily-search** — `tavily-ai/skills/tavily-search` · 31,712 تثبيت ⭐
...
701. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,666 تثبيت ⭐
...
702. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 31,561 تثبيت ⭐
...
703. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 31,518 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

704. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 31,511 تثبيت ⭐
...
705. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 31,497 تثبيت ⭐
...
706. **baoyu-infographic** — `jimliu/baoyu-skills/baoyu-infographic` · 31,480 تثبيت
...
707. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 31,381 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

708. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,363 تثبيت ⭐
...
709. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 31,269 تثبيت ⭐
...
710. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 31,265 تثبيت
...
711. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 31,236 تثبيت
...
712. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 31,226 تثبيت ⭐
...
713. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 31,202 تثبيت ⭐
...
714. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 31,197 تثبيت ⭐
...
715. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 31,191 تثبيت ⭐
...
716. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 31,156 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

717. **swiftui-expert-skill** — `avdlee/swiftui-agent-skill/swiftui-expert-skill` · 31,142 تثبيت
   Expert SwiftUI code review, refactoring, and implementation guidance with iOS 26+ and macOS support.
   `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill swiftui-expert-skill`

718. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 31,127 تثبيت ⭐
...
719. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 31,106 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

720. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 31,057 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

721. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 31,006 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

722. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 31,003 تثبيت
...
723. **use-dom** — `expo/skills/use-dom` · 30,952 تثبيت ⭐
...
724. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 30,867 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

725. **shape** — `pbakaus/impeccable/shape` · 30,838 تثبيت
...
726. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 30,802 تثبيت
...
727. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 30,687 تثبيت ⭐
...
728. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 30,647 تثبيت ⭐
...
729. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 30,641 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

730. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 30,438 تثبيت ⭐
...
731. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 30,405 تثبيت
...
732. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 30,319 تثبيت
...
733. **gws-chat** — `googleworkspace/cli/gws-chat` · 30,089 تثبيت ⭐
...
734. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 30,043 تثبيت
...
735. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 29,992 تثبيت
...
736. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 29,961 تثبيت ⭐
...
737. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 29,958 تثبيت ⭐
...
738. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 29,954 تثبيت
...
739. **gws-people** — `googleworkspace/cli/gws-people` · 29,926 تثبيت ⭐
...
740. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 29,895 تثبيت ⭐
...
741. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,888 تثبيت ⭐
...
742. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 29,804 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

743. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,782 تثبيت
...
744. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 29,765 تثبيت
...
745. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 29,753 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

746. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 29,678 تثبيت
...
747. **sandbox-stable** — `cloudflare/skills/sandbox-stable` · 29,669 تثبيت ⭐
   Sandbox SDK — stable package
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-stable`

748. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 29,616 تثبيت ⭐
...
749. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 29,593 تثبيت ⭐
...
750. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 29,509 تثبيت
...
751. **sandbox-next** — `cloudflare/skills/sandbox-next` · 29,341 تثبيت ⭐
   Sandbox SDK — @next (1.0 preview)
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-next`

752. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 29,334 تثبيت
...
753. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 29,333 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

754. **sandbox-migrate-to-next** — `cloudflare/skills/sandbox-migrate-to-next` · 29,292 تثبيت ⭐
...
755. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 29,280 تثبيت
...
756. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 29,268 تثبيت ⭐
...
757. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 28,978 تثبيت ⭐
...
758. **gws-chat-send** — `googleworkspace/cli/gws-chat-send` · 28,968 تثبيت ⭐
   Send plain-text messages to Google Chat spaces.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-chat-send`

759. **recipe-draft-email-from-doc** — `googleworkspace/cli/recipe-draft-email-from-doc` · 28,829 تثبيت ⭐
...
760. **baoyu-comic** — `jimliu/baoyu-skills/baoyu-comic` · 28,812 تثبيت
...
761. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 28,785 تثبيت ⭐
...
762. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 28,729 تثبيت ⭐
...
763. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 28,720 تثبيت ⭐
...
764. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 28,719 تثبيت ⭐
...
765. **gws-events** — `googleworkspace/cli/gws-events` · 28,616 تثبيت ⭐
...
766. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 28,547 تثبيت ⭐
...
767. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 28,370 تثبيت ⭐
...
768. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 28,347 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

769. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 28,315 تثبيت ⭐
...
770. **interview-me** — `addyosmani/agent-skills/interview-me` · 28,300 تثبيت
...
771. **eas-update-insights** — `expo/skills/eas-update-insights` · 28,293 تثبيت ⭐
...
772. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 28,273 تثبيت ⭐
...
773. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 28,237 تثبيت ⭐
...
774. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 28,170 تثبيت ⭐
...
775. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 28,139 تثبيت
...
776. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 28,104 تثبيت
...
777. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 28,103 تثبيت ⭐
...
778. **api-design-principles** — `wshobson/agents/api-design-principles` · 28,037 تثبيت
...
779. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 28,037 تثبيت
...
780. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 28,028 تثبيت ⭐
...
781. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 27,999 تثبيت ⭐
...
782. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 27,982 تثبيت ⭐
...
783. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 27,979 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

784. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 27,972 تثبيت ⭐
...
785. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 27,968 تثبيت ⭐
...
786. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 27,965 تثبيت ⭐
...
787. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 27,951 تثبيت ⭐
...
788. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 27,871 تثبيت ⭐
...
789. **azure-postgres** — `microsoft/azure-skills/azure-postgres` · 27,851 تثبيت ⭐
   No SKILL.md available for this skill.
   `npx skills add https://github.com/microsoft/azure-skills --skill azure-postgres`

790. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 27,827 تثبيت ⭐
...
791. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 27,771 تثبيت ⭐
...
792. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 27,674 تثبيت ⭐
...
793. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 27,665 تثبيت ⭐
...
794. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 27,638 تثبيت ⭐
...
795. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 27,619 تثبيت ⭐
...
796. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 27,618 تثبيت ⭐
...
797. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 27,607 تثبيت ⭐
...
798. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 27,594 تثبيت ⭐
...
799. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 27,581 تثبيت ⭐
...
800. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 27,510 تثبيت ⭐
...
801. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 27,494 تثبيت ⭐
...
802. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 27,488 تثبيت ⭐
...
803. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 27,484 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

804. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 27,472 تثبيت
...
805. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 27,422 تثبيت ⭐
...
806. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 27,417 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

807. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 27,392 تثبيت ⭐
...
808. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 27,374 تثبيت ⭐
...
809. **design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/design-system` · 27,365 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

810. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 27,346 تثبيت ⭐
...
811. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 27,315 تثبيت ⭐
...
812. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 27,289 تثبيت
...
813. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 27,279 تثبيت ⭐
...
814. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 27,268 تثبيت ⭐
...
815. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 27,258 تثبيت ⭐
...
816. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 27,247 تثبيت ⭐
...
817. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 27,244 تثبيت ⭐
...
818. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 27,228 تثبيت ⭐
...
819. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 27,190 تثبيت ⭐
...
820. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 27,190 تثبيت ⭐
...
821. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 27,185 تثبيت
...
822. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 27,184 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

823. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 27,170 تثبيت
...
824. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 27,166 تثبيت
...
825. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 27,165 تثبيت ⭐
...
826. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 27,153 تثبيت ⭐
...
827. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 27,116 تثبيت ⭐
...
828. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 27,103 تثبيت
...
829. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 27,050 تثبيت ⭐
...
830. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 27,048 تثبيت ⭐
...
831. **layout** — `pbakaus/impeccable/layout` · 27,034 تثبيت
...
832. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 26,978 تثبيت ⭐
...
833. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 26,903 تثبيت ⭐
...
834. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 26,838 تثبيت ⭐
...
835. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 26,833 تثبيت
...
836. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 26,811 تثبيت ⭐
...
837. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 26,760 تثبيت ⭐
...
838. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 26,735 تثبيت ⭐
...
839. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,693 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

840. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 26,666 تثبيت ⭐
...
841. **golang-linter** — `samber/cc-skills-golang/golang-linter` · 26,543 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/samber/cc-skills-golang --skill golang-linter`

842. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 26,471 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

843. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 26,301 تثبيت ⭐
...
844. **interface-design** — `dammyjay93/interface-design/interface-design` · 26,182 تثبيت
...
845. **clerk** — `clerk/skills/clerk` · 26,127 تثبيت ⭐
...
846. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,098 تثبيت
...
847. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 26,005 تثبيت
...
848. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 25,988 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

849. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 25,988 تثبيت
...
850. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 25,956 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

851. **build-tam** — `code.deepline.com/build-tam` · 25,877 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

852. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 25,787 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

853. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 25,777 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

854. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 25,770 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

855. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 25,748 تثبيت
...
856. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 25,743 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

857. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 25,641 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

858. **stripe-directory** — `docs.stripe.com/stripe-directory` · 25,543 تثبيت
...
859. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 25,540 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

860. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 25,518 تثبيت
...
861. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,475 تثبيت ⭐
...
862. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 25,366 تثبيت ⭐
...
863. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 25,346 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

864. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 25,257 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

865. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 25,226 تثبيت
...
866. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 25,193 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

867. **review-pr** — `warpdotdev/common-skills/review-pr` · 25,192 تثبيت
...
868. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 25,087 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

869. **dbs** — `dontbesilent2025/dbskill/dbs` · 25,050 تثبيت
   你是 dontbesilent 商业工具箱的公开入口。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs`

870. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 25,024 تثبيت
...
871. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 24,956 تثبيت
...
872. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 24,919 تثبيت
...
873. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 24,898 تثبيت
...
874. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 24,892 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

875. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 24,867 تثبيت
...
876. **create-pr** — `warpdotdev/common-skills/create-pr` · 24,839 تثبيت
...
877. **update-skill** — `warpdotdev/common-skills/update-skill` · 24,812 تثبيت
...
878. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 24,799 تثبيت
...
879. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 24,597 تثبيت ⭐
...
880. **brandalf** — `warpdotdev/common-skills/brandalf` · 24,543 تثبيت
...
881. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 24,534 تثبيت
...
882. **release-skills** — `jimliu/baoyu-skills/release-skills` · 24,495 تثبيت
...
883. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 24,478 تثبيت
...
884. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 24,448 تثبيت
...
885. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 24,399 تثبيت
...
886. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 24,344 تثبيت
...
887. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 24,278 تثبيت
...
888. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 24,206 تثبيت
...
889. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 24,036 تثبيت
...
890. **clerk-cli** — `clerk/skills/clerk-cli` · 24,011 تثبيت ⭐
...
891. **council** — `warpdotdev/common-skills/council` · 23,953 تثبيت
...
892. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 23,910 تثبيت ⭐
...
893. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 23,623 تثبيت
...
894. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 23,417 تثبيت
...
898. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 23,191 تثبيت
...
899. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 22,978 تثبيت ⭐
...
900. **prd** — `github/awesome-copilot/prd` · 22,974 تثبيت ⭐
...
901. **gstack** — `garrytan/gstack/gstack` · 22,812 تثبيت
...
905. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 22,323 تثبيت
...
906. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 22,199 تثبيت
...
907. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 22,123 تثبيت
...
908. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 21,995 تثبيت
...
909. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 21,932 تثبيت
...
910. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,922 تثبيت ⭐
...
911. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 21,700 تثبيت
...
912. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 21,667 تثبيت
...
913. **refactor** — `github/awesome-copilot/refactor` · 21,661 تثبيت ⭐
   Surgical code refactoring to improve maintainability without changing behavior.
   `npx skills add https://github.com/github/awesome-copilot --skill refactor`

914. **laravel-specialist** — `jeffallan/claude-skills/laravel-specialist` · 21,552 تثبيت
...
915. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 21,546 تثبيت
...
920. **dbs-agent-migration** — `dontbesilent2025/dbskill/dbs-agent-migration` · 21,178 تثبيت
   dbs-agent-migration：Agent 工作台迁移
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-agent-migration`

921. **vueuse-functions** — `antfu/skills/vueuse-functions` · 21,153 تثبيت
...
922. **ponytail-audit** — `dietrichgebert/ponytail/ponytail-audit` · 21,039 تثبيت
   ponytail-review, repo-wide. Scan the whole tree instead of a diff. Rank
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-audit`

923. **error-handling-patterns** — `wshobson/agents/error-handling-patterns` · 20,981 تثبيت
...
924. **skill-vetter** — `useai-pro/openclaw-skills-security/skill-vetter` · 20,965 تثبيت
...
925. **mediabunny** — `remotion-dev/skills/mediabunny` · 20,927 تثبيت ⭐
   Mediabunny is a multimedia library for dealing with audio and video in the browser.
   `npx skills add https://github.com/remotion-dev/skills --skill mediabunny`

926. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 20,838 تثبيت ⭐
...
927. **baoyu-post-to-weibo** — `jimliu/baoyu-skills/baoyu-post-to-weibo` · 20,759 تثبيت
...
928. **wecomcli-doc** — `wecomteam/wecom-cli/wecomcli-doc` · 20,643 تثبيت
...
929. **pnpm** — `antfu/skills/pnpm` · 20,504 تثبيت
...
930. **wecomcli-todo** — `wecomteam/wecom-cli/wecomcli-todo` · 20,443 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-todo`

931. **firestore-security-rules-auditor** — `firebase/agent-skills/firestore-security-rules-auditor` · 20,414 تثبيت ⭐
...
932. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 20,410 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

933. **wecomcli-contact** — `wecomteam/wecom-cli/wecomcli-contact` · 20,398 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-contact`

934. **wecomcli-meeting** — `wecomteam/wecom-cli/wecomcli-meeting` · 20,352 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-meeting`

935. **gemini-api-dev** — `google-gemini/gemini-skills/gemini-api-dev` · 20,315 تثبيت ⭐
...
936. **python-design-patterns** — `wshobson/agents/python-design-patterns` · 20,262 تثبيت
...
937. **modern-web-guidance** — `googlechrome/modern-web-guidance/modern-web-guidance` · 20,223 تثبيت
   A skill to search for specific web development use cases and retrieve their corresponding best practice guides.
   `npx skills add https://github.com/googlechrome/modern-web-guidance --skill modern-web-guidance`

938. **baoyu-youtube-transcript** — `jimliu/baoyu-skills/baoyu-youtube-transcript` · 20,090 تثبيت
...
939. **dbs-report** — `dontbesilent2025/dbskill/dbs-report` · 20,082 تثبيت
...
940. **expo-ui** — `expo/skills/expo-ui` · 20,069 تثبيت ⭐
...
941. **dbs-save** — `dontbesilent2025/dbskill/dbs-save` · 20,057 تثبيت
...
942. **dbs-restore** — `dontbesilent2025/dbskill/dbs-restore` · 20,047 تثبيت
...
943. **java-springboot** — `github/awesome-copilot/java-springboot` · 20,026 تثبيت ⭐
...
944. **convex-auth** — `get-convex/agent-skills/convex-auth` · 19,938 تثبيت
...
945. **convex-expert** — `get-convex/agent-skills/convex-expert` · 19,909 تثبيت
...
946. **dbs-goal** — `dontbesilent2025/dbskill/dbs-goal` · 19,879 تثبيت
...
952. **convex-design** — `get-convex/agent-skills/convex-design` · 19,816 تثبيت
...
953. **convex-deploy-guard** — `get-convex/agent-skills/convex-deploy-guard` · 19,793 تثبيت
...
954. **convex-env** — `get-convex/agent-skills/convex-env` · 19,786 تثبيت
...
955. **convex-advisor** — `get-convex/agent-skills/convex-advisor` · 19,777 تثبيت
...
956. **convex-crons** — `get-convex/agent-skills/convex-crons` · 19,776 تثبيت
   Add scheduled jobs (crons)
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-crons`

957. **convex-add** — `get-convex/agent-skills/convex-add` · 19,764 تثبيت
...
958. **convex-agent** — `get-convex/agent-skills/convex-agent` · 19,760 تثبيت
   Add an AI agent / RAG backend
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-agent`

959. **convex-migrate-rehearse** — `get-convex/agent-skills/convex-migrate-rehearse` · 19,757 تثبيت
...
963. **opencli-usage** — `jackwener/opencli/opencli-usage` · 19,632 تثبيت
...
964. **html-ppt** — `lewislulu/html-ppt-skill/html-ppt` · 19,423 تثبيت
   html-ppt — HTML PPT Studio
   `npx skills add https://github.com/lewislulu/html-ppt-skill --skill html-ppt`

965. **security-requirement-extraction** — `wshobson/agents/security-requirement-extraction` · 19,398 تثبيت
   Transform threat analysis into actionable security requirements.
   `npx skills add https://github.com/wshobson/agents --skill security-requirement-extraction`

966. **pricewin-hotel-deal-finder** — `price-win/pricewin-skills-hub/pricewin-hotel-deal-finder` · 19,389 تثبيت
   PriceWin Hotel Deal Finder
   `npx skills add https://github.com/price-win/pricewin-skills-hub --skill pricewin-hotel-deal-finder`

967. **dbs-slowisfast** — `dontbesilent2025/dbskill/dbs-slowisfast` · 19,325 تثبيت
...
968. **baseline-ui** — `ibelick/ui-skills/baseline-ui` · 19,283 تثبيت
...
969. **ponytail-help** — `dietrichgebert/ponytail/ponytail-help` · 19,248 تثبيت
   Display this reference card when invoked. One-shot, do NOT change mode,
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-help`

970. **extension-email-calendar-events** — `caffeinelabs/skills/extension-email-calendar-events` · 19,219 تثبيت
...
971. **ponytail-debt** — `dietrichgebert/ponytail/ponytail-debt` · 19,196 تثبيت
   Every deliberate ponytail shortcut is marked with a ponytail: comment naming
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-debt`

972. **find-qualified-titles** — `code.deepline.com/find-qualified-titles` · 18,868 تثبيت
   Find Qualified Titles (company_titles -> ICP filter -> contacts)
   `npx skills add https://code.deepline.com/`

973. **modern-javascript-patterns** — `wshobson/agents/modern-javascript-patterns` · 18,806 تثبيت
...
974. **expo-brownfield** — `expo/skills/expo-brownfield` · 18,753 تثبيت ⭐
...
979. **extension-email-verification** — `caffeinelabs/skills/extension-email-verification` · 18,653 تثبيت
...
980. **extension-object-storage** — `caffeinelabs/skills/extension-object-storage` · 18,652 تثبيت
...
981. **javascript-testing-patterns** — `wshobson/agents/javascript-testing-patterns` · 18,479 تثبيت
...
982. **feature-sliced-design** — `feature-sliced/skills/feature-sliced-design` · 18,458 تثبيت
   Feature-Sliced Design (FSD) v2.1
   `npx skills add https://github.com/feature-sliced/skills --skill feature-sliced-design`

983. **extension-email** — `caffeinelabs/skills/extension-email` · 18,415 تثبيت
   Email — Service/Transactional
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-email`

984. **extension-http-outcalls** — `caffeinelabs/skills/extension-http-outcalls` · 18,411 تثبيت
   HTTP outcalls extension for Caffeine AI.
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-http-outcalls`

985. **extension-authorization** — `caffeinelabs/skills/extension-authorization` · 18,411 تثبيت
...
986. **opencli-browser** — `jackwener/opencli/opencli-browser` · 18,408 تثبيت
...
987. **extension-invite-links** — `caffeinelabs/skills/extension-invite-links` · 18,408 تثبيت
...
988. **extension-core-infrastructure** — `caffeinelabs/skills/extension-core-infrastructure` · 18,406 تثبيت
...
989. **vue-router-best-practices** — `antfu/skills/vue-router-best-practices` · 18,329 تثبيت
...
994. **extension-posting-to-x** — `caffeinelabs/skills/extension-posting-to-x` · 18,153 تثبيت
...
995. **aso-audit** — `coreyhaines31/marketingskills/aso-audit` · 18,009 تثبيت
...
996. **create-readme** — `github/awesome-copilot/create-readme` · 17,955 تثبيت ⭐
...
997. **rust-async-patterns** — `wshobson/agents/rust-async-patterns` · 17,904 تثبيت
...
998. **playwright-generate-test** — `github/awesome-copilot/playwright-generate-test` · 17,869 تثبيت ⭐
...
999. **agent development** — `anthropics/claude-code/agent-development` · 17,722 تثبيت ⭐
   Agent Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Agent Development&#x27;`

1000. **skill development** — `anthropics/claude-code/skill-development` · 17,528 تثبيت ⭐
   Skill Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Skill Development&#x27;`

1001. **pinia** — `antfu/skills/pinia` · 17,407 تثبيت
...
1002. **sql-optimization-patterns** — `wshobson/agents/sql-optimization-patterns` · 17,389 تثبيت
...
1003. **planning-with-files-zh** — `othmanadi/planning-with-files/planning-with-files-zh` · 17,220 تثبيت
...
1004. **fixing-accessibility** — `ibelick/ui-skills/fixing-accessibility` · 17,204 تثبيت
...
1005. **the-news** — `sfkislev/the-news/the-news` · 17,165 تثبيت
...
1006. **golang-pro** — `jeffallan/claude-skills/golang-pro` · 17,124 تثبيت
