...
**آخر تحديث:** 2026-09-01 · **العدد:** 960 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,197,320 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 1,022,009 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 871,126 تثبيت
...
4. **frontend-design** — `anthropics/skills/frontend-design` · 840,294 تثبيت ⭐
...
5. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 837,397 تثبيت
...
9. **handoff** — `mattpocock/skills/handoff` · 712,256 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 703,677 تثبيت
...
11. **prototype** — `mattpocock/skills/prototype` · 694,468 تثبيت
...
12. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 679,641 تثبيت ⭐
   React and Next.js performance optimization across 70 rules prioritized by impact.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-react-best-practices`

13. **lark-doc** — `open.feishu.cn/lark-doc` · 640,047 تثبيت
...
14. **lark-base** — `open.feishu.cn/lark-base` · 639,940 تثبيت
...
15. **lark-drive** — `open.feishu.cn/lark-drive` · 639,760 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

16. **lark-approval** — `open.feishu.cn/lark-approval` · 639,624 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

17. **lark-shared** — `open.feishu.cn/lark-shared` · 639,482 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

18. **lark-im** — `open.feishu.cn/lark-im` · 639,353 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

19. **lark-calendar** — `open.feishu.cn/lark-calendar` · 639,296 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

20. **lark-sheets** — `open.feishu.cn/lark-sheets` · 638,981 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/`

21. **lark-contact** — `open.feishu.cn/lark-contact` · 638,936 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/`

22. **lark-minutes** — `open.feishu.cn/lark-minutes` · 638,878 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

23. **lark-wiki** — `open.feishu.cn/lark-wiki` · 638,864 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

24. **lark-event** — `open.feishu.cn/lark-event` · 638,639 تثبيت
...
25. **lark-task** — `open.feishu.cn/lark-task` · 638,554 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

26. **lark-attendance** — `open.feishu.cn/lark-attendance` · 638,551 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

27. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 638,550 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

28. **lark-slides** — `open.feishu.cn/lark-slides` · 638,508 تثبيت
   本技能文档较长，务必使用 Read 工具阅读两次，必须阅读完整全文。
   `npx skills add https://open.feishu.cn/`

29. **lark-mail** — `open.feishu.cn/lark-mail` · 638,492 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/`

30. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 638,472 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/`

31. **lark-vc** — `open.feishu.cn/lark-vc` · 638,280 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

32. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 638,197 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

33. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 638,039 تثبيت
...
34. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 637,943 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

35. **lark-okr** — `open.feishu.cn/lark-okr` · 619,084 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

36. **lark-markdown** — `open.feishu.cn/lark-markdown` · 604,451 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

37. **anti-ui-slop** — `uizze.com/anti-ui-slop` · 597,877 تثبيت
   Stop AI coding agents from shipping generic UI.
   `npx skills add https://uizze.com/`

38. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 595,933 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

39. **grilling** — `mattpocock/skills/grilling` · 590,536 تثبيت
...
40. **lark-vc-agent** — `open.feishu.cn/lark-vc-agent` · 582,888 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

41. **teach** — `mattpocock/skills/teach` · 568,786 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

42. **microsoft-foundry** — `microsoft/azure-skills/microsoft-foundry` · 563,151 تثبيت ⭐
   End-to-end deployment, evaluation, and management of AI agents on Microsoft Foundry.
   `npx skills add https://github.com/microsoft/azure-skills --skill microsoft-foundry`

43. **azure-diagnostics** — `microsoft/azure-skills/azure-diagnostics` · 556,353 تثبيت ⭐
...
44. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 555,765 تثبيت ⭐
...
45. **azure-ai** — `microsoft/azure-skills/azure-ai` · 555,679 تثبيت ⭐
...
46. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 555,650 تثبيت ⭐
...
47. **azure-validate** — `microsoft/azure-skills/azure-validate` · 555,133 تثبيت ⭐
...
48. **azure-storage** — `microsoft/azure-skills/azure-storage` · 554,583 تثبيت ⭐
...
49. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 554,320 تثبيت ⭐
...
50. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 554,069 تثبيت ⭐
...
51. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 553,992 تثبيت ⭐
...
52. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 553,989 تثبيت ⭐
...
53. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 553,947 تثبيت ⭐
...
54. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 553,772 تثبيت ⭐
...
55. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 553,696 تثبيت ⭐
...
56. **lark-apps** — `open.feishu.cn/lark-apps` · 548,652 تثبيت
...
57. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 543,428 تثبيت ⭐
...
58. **domain-modeling** — `mattpocock/skills/domain-modeling` · 538,313 تثبيت
...
59. **codebase-design** — `mattpocock/skills/codebase-design` · 522,236 تثبيت
...
60. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 514,075 تثبيت
   A discipline for hard bugs. Skip phases only when explicitly justified.
   `npx skills add https://github.com/mattpocock/skills --skill diagnosing-bugs`

61. **remotion-best-practices** — `remotion-dev/skills/remotion-best-practices` · 503,913 تثبيت ⭐
   Domain-specific knowledge base for building videos with Remotion and React.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices`

62. **azure-compute** — `microsoft/azure-skills/azure-compute` · 497,457 تثبيت ⭐
...
63. **ai-video-generation** — `skills-101/superpowers/ai-video-generation` · 496,406 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-video-generation`

64. **ai-image-generation** — `skills-101/superpowers/ai-image-generation` · 495,903 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-image-generation`

65. **ai-avatar-video** — `skills-101/superpowers/ai-avatar-video` · 495,791 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-avatar-video`

66. **twitter-automation** — `skills-101/superpowers/twitter-automation` · 495,680 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill twitter-automation`

67. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 487,462 تثبيت ⭐
...
68. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 487,020 تثبيت ⭐
...
73. **code-review** — `mattpocock/skills/code-review` · 456,317 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill code-review`

74. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,805 تثبيت
...
75. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,040 تثبيت
...
76. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 449,951 تثبيت
...
77. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 449,934 تثبيت
...
78. **hyperframes** — `heygen-com/hyperframes/hyperframes` · 447,978 تثبيت
...
79. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 438,795 تثبيت ⭐
...
80. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 428,026 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

81. **wayfinder** — `mattpocock/skills/wayfinder` · 424,665 تثبيت
...
82. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 423,681 تثبيت ⭐
...
83. **lark-note** — `open.feishu.cn/lark-note` · 422,708 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

84. **research** — `mattpocock/skills/research` · 417,134 تثبيت
   Spin up a background agent to do the research, so you keep working while it reads.
   `npx skills add https://github.com/mattpocock/skills --skill research`

85. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 415,813 تثبيت ⭐
...
86. **to-spec** — `mattpocock/skills/to-spec` · 413,432 تثبيت
...
87. **video-edit** — `prime-skills/runcomfy-agent-skills/video-edit` · 412,272 تثبيت
   Video Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill video-edit`

88. **image-to-video** — `prime-skills/runcomfy-agent-skills/image-to-video` · 410,710 تثبيت
...
89. **nano-banana-2** — `prime-skills/runcomfy-agent-skills/nano-banana-2` · 410,400 تثبيت
   Nano Banana 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill nano-banana-2`

90. **nano-banana-edit** — `prime-skills/runcomfy-agent-skills/nano-banana-edit` · 410,022 تثبيت
...
91. **image-edit** — `prime-skills/runcomfy-agent-skills/image-edit` · 409,979 تثبيت
   Image Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill image-edit`

92. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 409,806 تثبيت
...
93. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 409,267 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

94. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 409,096 تثبيت
...
95. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 409,086 تثبيت
...
96. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 409,049 تثبيت
...
97. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 408,880 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

98. **to-tickets** — `mattpocock/skills/to-tickets` · 406,286 تثبيت
   Break a plan, spec, or conversation into a set of tickets: tracer-bullet vertical slices, each declaring the tickets that block it.
   `npx skills add https://github.com/mattpocock/skills --skill to-tickets`

99. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 405,059 تثبيت
...
100. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 401,296 تثبيت
...
101. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 390,278 تثبيت ⭐
...
102. **kling-3-0** — `prime-skills/runcomfy-agent-skills/kling-3-0` · 386,010 تثبيت
   Kling 3.0 - Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill kling-3-0`

103. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 383,169 تثبيت ⭐
...
104. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 380,393 تثبيت ⭐
...
108. **azure-cost** — `microsoft/azure-skills/azure-cost` · 358,405 تثبيت ⭐
...
109. **to-issues** — `mattpocock/skills/to-issues` · 353,308 تثبيت
...
110. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 352,960 تثبيت
...
111. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 352,652 تثبيت
...
112. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 351,003 تثبيت
...
113. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 350,520 تثبيت
...
114. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 350,315 تثبيت
...
115. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 350,274 تثبيت
...
116. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 349,868 تثبيت
...
117. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 349,725 تثبيت
...
118. **hyperframes-core** — `heygen-com/hyperframes/hyperframes-core` · 349,715 تثبيت
...
119. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 349,594 تثبيت
...
120. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 349,519 تثبيت
...
121. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 349,414 تثبيت
...
122. **brainstorming** — `obra/superpowers/brainstorming` · 346,226 تثبيت
   Structured design dialogue that validates ideas before implementation begins.
   `npx skills add https://github.com/obra/superpowers --skill brainstorming`

123. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 345,826 تثبيت
...
124. **media-use** — `heygen-com/hyperframes/media-use` · 342,029 تثبيت
   The media OS for HyperFrames: resolve · generate · operate · remember — every media type, one skill, zero context noise.
   `npx skills add https://github.com/heygen-com/hyperframes --skill media-use`

125. **ai-music** — `prime-skills/runcomfy-agent-skills/ai-music` · 341,768 تثبيت
...
126. **ace-step** — `prime-skills/runcomfy-agent-skills/ace-step` · 341,305 تثبيت
   ACE Step — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ace-step`

127. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 338,619 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

128. **caveman-commit** — `juliusbrussee/caveman/caveman-commit` · 329,954 تثبيت
...
129. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 326,969 تثبيت
...
130. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 325,204 تثبيت
...
131. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 321,221 تثبيت
...
132. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 321,035 تثبيت
...
133. **caveman-help** — `juliusbrussee/caveman/caveman-help` · 318,490 تثبيت
...
134. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 317,648 تثبيت
...
135. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 315,111 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

136. **redesign-existing-projects** — `leonxlnx/taste-skill/redesign-existing-projects` · 313,975 تثبيت
   Audit and upgrade existing websites to premium design standards without breaking functionality.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill redesign-existing-projects`

137. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,101 تثبيت
...
138. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 310,920 تثبيت
...
139. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,855 تثبيت
...
140. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,580 تثبيت
...
141. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,526 تثبيت
...
142. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,430 تثبيت
...
143. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,417 تثبيت
...
144. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 302,375 تثبيت ⭐
...
145. **git-guardrails-claude-code** — `mattpocock/skills/git-guardrails-claude-code` · 297,292 تثبيت
   Sets up a PreToolUse hook that intercepts and blocks dangerous git commands before Claude executes them.
   `npx skills add https://github.com/mattpocock/skills --skill git-guardrails-claude-code`

146. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 291,337 تثبيت
...
147. **setup-pre-commit** — `mattpocock/skills/setup-pre-commit` · 290,282 تثبيت
   lint-staged running Prettier on all staged files
   `npx skills add https://github.com/mattpocock/skills --skill setup-pre-commit`

148. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 285,066 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

149. **writing-beats** — `mattpocock/skills/writing-beats` · 284,118 تثبيت
...
150. **writing-shape** — `mattpocock/skills/writing-shape` · 283,681 تثبيت
...
151. **writing-fragments** — `mattpocock/skills/writing-fragments` · 283,522 تثبيت
...
152. **wizard** — `mattpocock/skills/wizard` · 282,628 تثبيت
...
153. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 281,699 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

154. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 277,658 تثبيت
...
155. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 276,518 تثبيت ⭐
...
156. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 276,315 تثبيت
...
157. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 275,426 تثبيت
...
158. **shadcn** — `shadcn/ui/shadcn` · 271,675 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

159. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 271,455 تثبيت
...
160. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 270,027 تثبيت
...
161. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 269,746 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

162. **brandkit** — `leonxlnx/taste-skill/brandkit` · 259,786 تثبيت
...
163. **impeccable** — `pbakaus/impeccable/impeccable` · 255,989 تثبيت
   Frontend design and iteration for production-grade interfaces, from concept to ship.
   `npx skills add https://github.com/pbakaus/impeccable --skill impeccable`

164. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 254,629 تثبيت
...
165. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 253,498 تثبيت
...
166. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 252,804 تثبيت
...
167. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 251,412 تثبيت ⭐
...
168. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 251,370 تثبيت
...
169. **prisma-client-api** — `prisma/skills/prisma-client-api` · 250,873 تثبيت ⭐
...
170. **supabase** — `supabase/agent-skills/supabase` · 249,667 تثبيت ⭐
...
171. **prisma-cli** — `prisma/skills/prisma-cli` · 248,685 تثبيت ⭐
...
172. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 248,338 تثبيت
...
173. **just-scrape** — `scrapegraphai/just-scrape/just-scrape` · 244,949 تثبيت
...
174. **prisma-postgres** — `prisma/skills/prisma-postgres` · 244,781 تثبيت ⭐
...
175. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 243,256 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

176. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 241,269 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

177. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 240,264 تثبيت ⭐
...
178. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 240,072 تثبيت ⭐
...
179. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 239,157 تثبيت ⭐
...
180. **diagnose** — `mattpocock/skills/diagnose` · 238,026 تثبيت
...
181. **loop-me** — `mattpocock/skills/loop-me` · 236,959 تثبيت
...
182. **reddit-automation** — `flowkit-labs/skills/reddit-automation` · 236,788 تثبيت
   Built by the team at doany.ai.
   `npx skills add https://github.com/flowkit-labs/skills --skill reddit-automation`

183. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 235,700 تثبيت ⭐
...
184. **prisma-compute** — `prisma/skills/prisma-compute` · 235,430 تثبيت ⭐
...
185. **writing-plans** — `obra/superpowers/writing-plans` · 235,193 تثبيت
   Comprehensive implementation plans for multi-step tasks, breaking down specs into bite-sized, testable steps.
   `npx skills add https://github.com/obra/superpowers --skill writing-plans`

186. **prisma-mongodb-upgrade** — `prisma/skills/prisma-mongodb-upgrade` · 234,157 تثبيت ⭐
   Prisma MongoDB Upgrade Path
   `npx skills add https://github.com/prisma/skills --skill prisma-mongodb-upgrade`

187. **using-superpowers** — `obra/superpowers/using-superpowers` · 231,648 تثبيت
   IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST USE IT.
   `npx skills add https://github.com/obra/superpowers --skill using-superpowers`

188. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 230,133 تثبيت
...
189. **write-a-skill** — `mattpocock/skills/write-a-skill` · 229,555 تثبيت
...
190. **zoom-out** — `mattpocock/skills/zoom-out` · 228,982 تثبيت
...
191. **general-video** — `heygen-com/hyperframes/general-video` · 221,848 تثبيت
   Before relying on this workflow, run:
   `npx skills add https://github.com/heygen-com/hyperframes --skill general-video`

192. **design-an-interface** — `mattpocock/skills/design-an-interface` · 215,555 تثبيت
...
193. **requesting-code-review** — `obra/superpowers/requesting-code-review` · 215,159 تثبيت
   Dispatch code review subagents with focused context to catch issues before they compound.
   `npx skills add https://github.com/obra/superpowers --skill requesting-code-review`

194. **claude-handoff** — `mattpocock/skills/claude-handoff` · 213,100 تثبيت
...
195. **test-driven-development** — `obra/superpowers/test-driven-development` · 213,055 تثبيت
   Write tests first, watch them fail, then implement minimal code to pass.
   `npx skills add https://github.com/obra/superpowers --skill test-driven-development`

196. **pptx** — `anthropics/skills/pptx` · 212,212 تثبيت ⭐
...
197. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,346 تثبيت ⭐
...
198. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 208,960 تثبيت
...
199. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 206,755 تثبيت
...
200. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 206,569 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

201. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 206,392 تثبيت
...
202. **qa** — `mattpocock/skills/qa` · 204,888 تثبيت
...
203. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 203,554 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

204. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 202,737 تثبيت
...
205. **obsidian-vault** — `mattpocock/skills/obsidian-vault` · 201,336 تثبيت
   /mnt/d/Obsidian Vault/AI Research/
   `npx skills add https://github.com/mattpocock/skills --skill obsidian-vault`

206. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 199,857 تثبيت ⭐
...
207. **executing-plans** — `obra/superpowers/executing-plans` · 199,075 تثبيت
...
208. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 198,040 تثبيت
...
209. **edit-article** — `mattpocock/skills/edit-article` · 197,655 تثبيت
...
210. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 195,723 تثبيت
...
211. **orca-cli** — `stablyai/orca/orca-cli` · 193,019 تثبيت
   This file is a discovery stub, not the usage guide. The full, version-matched Orca CLI
   `npx skills add https://github.com/stablyai/orca --skill orca-cli`

212. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 192,002 تثبيت
...
213. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 189,840 تثبيت
...
214. **pdf** — `anthropics/skills/pdf` · 188,244 تثبيت ⭐
   Comprehensive PDF processing with text extraction, merging, splitting, form filling, and OCR capabilities.
   `npx skills add https://github.com/anthropics/skills --skill pdf`

215. **embedded-captions** — `heygen-com/hyperframes/embedded-captions` · 185,938 تثبيت
...
216. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 185,219 تثبيت
...
217. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 181,308 تثبيت
...
218. **docx** — `anthropics/skills/docx` · 180,549 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

219. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 178,681 تثبيت
...
220. **writing-skills** — `obra/superpowers/writing-skills` · 178,650 تثبيت
...
221. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 178,157 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

222. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 176,625 تثبيت
...
223. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 174,859 تثبيت
...
224. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 172,231 تثبيت
...
225. **wait-what** — `mattpocock/skills/wait-what` · 170,558 تثبيت
...
226. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 164,624 تثبيت
...
227. **slideshow** — `heygen-com/hyperframes/slideshow` · 162,307 تثبيت
...
228. **xlsx** — `anthropics/skills/xlsx` · 161,231 تثبيت ⭐
   Create, edit, and analyze Excel spreadsheets with formulas, formatting, and error-free calculations.
   `npx skills add https://github.com/anthropics/skills --skill xlsx`

229. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 158,932 تثبيت ⭐
...
230. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 148,382 تثبيت
...
231. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 147,681 تثبيت
...
232. **webapp-testing** — `anthropics/skills/webapp-testing` · 147,171 تثبيت ⭐
   Native Python Playwright scripts for testing local web applications with server lifecycle management.
   `npx skills add https://github.com/anthropics/skills --skill webapp-testing`

233. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 146,939 تثبيت
...
234. **firebase-basics** — `firebase/agent-skills/firebase-basics` · 142,866 تثبيت ⭐
...
235. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 141,831 تثبيت ⭐
...
236. **orchestration** — `stablyai/orca/orchestration` · 141,196 تثبيت
...
237. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 138,370 تثبيت ⭐
...
238. **playwright-cli** — `microsoft/playwright-cli/playwright-cli` · 138,051 تثبيت ⭐
   Browser automation with 40+ commands for navigation, interaction, form filling, and web testing.
   `npx skills add https://github.com/microsoft/playwright-cli --skill playwright-cli`

239. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 137,890 تثبيت ⭐
...
240. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 137,096 تثبيت ⭐
...
241. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 136,288 تثبيت
...
242. **sentry-cli** — `sentry/dev/sentry-cli` · 135,558 تثبيت
...
243. **ui-radar** — `uizze.com/ui-radar` · 134,505 تثبيت
   Don't let your AI agents design blind.
   `npx skills add https://uizze.com/`

244. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 132,461 تثبيت
...
245. **review-animations** — `emilkowalski/skills/review-animations` · 131,665 تثبيت
...
246. **wind-mcp-skill** — `wind-information-co-ltd/wind-skills/wind-mcp-skill` · 129,351 تثبيت
...
247. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 128,307 تثبيت
...
248. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 127,730 تثبيت ⭐
...
249. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 127,609 تثبيت
...
250. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 126,517 تثبيت
...
251. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 125,810 تثبيت
...
252. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 125,053 تثبيت
...
253. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 122,070 تثبيت
...
254. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 119,144 تثبيت
...
255. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 118,120 تثبيت
...
256. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 117,968 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

257. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 116,905 تثبيت
...
258. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 114,497 تثبيت
...
259. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 114,179 تثبيت
...
260. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 114,147 تثبيت
...
261. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 114,089 تثبيت
...
262. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 114,083 تثبيت
...
263. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 114,075 تثبيت
...
264. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 113,958 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

265. **apple-design** — `emilkowalski/skills/apple-design` · 112,451 تثبيت
...
266. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 110,431 تثبيت ⭐
...
267. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 109,725 تثبيت
...
268. **mcp-builder** — `anthropics/skills/mcp-builder` · 109,308 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

269. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 109,284 تثبيت
...
270. **browser-act** — `browser-act/skills/browser-act` · 107,862 تثبيت
...
271. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 105,748 تثبيت ⭐
...
272. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 104,635 تثبيت
...
273. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 104,459 تثبيت
...
274. **figma** — `heygen-com/hyperframes/figma` · 104,008 تثبيت
...
275. **improve-animations** — `emilkowalski/skills/improve-animations` · 103,999 تثبيت
...
276. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 103,830 تثبيت ⭐
...
277. **canvas-design** — `anthropics/skills/canvas-design` · 103,403 تثبيت ⭐
...
278. **computer-use** — `stablyai/orca/computer-use` · 102,950 تثبيت
...
279. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 102,896 تثبيت ⭐
...
280. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 102,346 تثبيت ⭐
...
281. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 101,660 تثبيت
...
282. **firecrawl** — `firecrawl/cli/firecrawl` · 100,001 تثبيت ⭐
...
283. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 99,709 تثبيت ⭐
...
284. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 98,984 تثبيت ⭐
...
285. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 98,899 تثبيت
...
286. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,306 تثبيت ⭐
...
287. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 96,861 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

288. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 96,531 تثبيت
...
289. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 96,371 تثبيت
...
290. **gsap** — `heygen-com/hyperframes/gsap` · 94,898 تثبيت
...
291. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,468 تثبيت
...
292. **review** — `mattpocock/skills/review` · 94,092 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

293. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,038 تثبيت
...
294. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,030 تثبيت
...
295. **browser-use** — `browser-use/browser-use/browser-use` · 93,109 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

296. **revops** — `coreyhaines31/marketingskills/revops` · 92,465 تثبيت
...
297. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 92,066 تثبيت
...
298. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 91,640 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

299. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 90,607 تثبيت ⭐
...
300. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 90,414 تثبيت
...
301. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 89,419 تثبيت ⭐
...
302. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 89,410 تثبيت
...
303. **polish** — `pbakaus/impeccable/polish` · 87,149 تثبيت
...
304. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 87,004 تثبيت
...
305. **convex** — `get-convex/agent-skills/convex` · 85,970 تثبيت
...
306. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 85,445 تثبيت ⭐
...
307. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,053 تثبيت
...
308. **critique** — `pbakaus/impeccable/critique` · 84,548 تثبيت
...
309. **audit** — `pbakaus/impeccable/audit` · 83,765 تثبيت
...
310. **animate** — `pbakaus/impeccable/animate` · 83,622 تثبيت
...
311. **adapt** — `pbakaus/impeccable/adapt` · 83,611 تثبيت
...
312. **clarify** — `pbakaus/impeccable/clarify` · 83,103 تثبيت
...
313. **optimize** — `pbakaus/impeccable/optimize` · 82,958 تثبيت
...
314. **colorize** — `pbakaus/impeccable/colorize` · 82,766 تثبيت
...
315. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 82,726 تثبيت
...
316. **neon** — `neondatabase/agent-skills/neon` · 82,175 تثبيت ⭐
...
317. **bolder** — `pbakaus/impeccable/bolder` · 81,882 تثبيت
...
318. **delight** — `pbakaus/impeccable/delight` · 81,720 تثبيت
...
319. **distill** — `pbakaus/impeccable/distill` · 81,329 تثبيت
...
320. **theme-factory** — `anthropics/skills/theme-factory` · 81,169 تثبيت ⭐
...
321. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 81,139 تثبيت ⭐
...
322. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 80,811 تثبيت ⭐
...
323. **quieter** — `pbakaus/impeccable/quieter` · 80,497 تثبيت
...
324. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 80,491 تثبيت ⭐
...
325. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 79,961 تثبيت ⭐
...
326. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 78,702 تثبيت ⭐
...
327. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 78,657 تثبيت ⭐
...
328. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 78,284 تثبيت ⭐
...
329. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 77,974 تثبيت ⭐
...
330. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 77,777 تثبيت
...
331. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,646 تثبيت
...
332. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 77,581 تثبيت ⭐
...
333. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 76,014 تثبيت
...
334. **wonda-cli** — `degausai/wonda/wonda-cli` · 74,605 تثبيت
...
335. **cloudflare** — `cloudflare/skills/cloudflare` · 74,121 تثبيت ⭐
...
336. **css-animations** — `heygen-com/hyperframes/css-animations` · 74,073 تثبيت
...
337. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 73,699 تثبيت ⭐
...
338. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 73,605 تثبيت ⭐
...
339. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 73,605 تثبيت ⭐
...
340. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 72,383 تثبيت
...
341. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,251 تثبيت
...
342. **wrangler** — `cloudflare/skills/wrangler` · 71,934 تثبيت ⭐
...
343. **animejs** — `heygen-com/hyperframes/animejs` · 71,699 تثبيت
...
344. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 71,371 تثبيت
...
345. **notion-api** — `intellectronica/agent-skills/notion-api` · 71,172 تثبيت
...
346. **three** — `heygen-com/hyperframes/three` · 70,982 تثبيت
...
347. **lottie** — `heygen-com/hyperframes/lottie` · 70,718 تثبيت
...
348. **waapi** — `heygen-com/hyperframes/waapi` · 70,344 تثبيت
...
349. **audit-website** — `squirrelscan/skills/audit-website` · 70,005 تثبيت
...
350. **internal-comms** — `anthropics/skills/internal-comms` · 69,550 تثبيت ⭐
...
351. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 69,353 تثبيت
...
352. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 68,703 تثبيت ⭐
...
353. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 68,218 تثبيت
...
354. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,727 تثبيت
...
355. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 67,690 تثبيت
...
356. **turborepo** — `vercel/turborepo/turborepo` · 67,269 تثبيت ⭐
...
357. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 67,027 تثبيت
...
358. **gws-drive** — `googleworkspace/cli/gws-drive` · 66,919 تثبيت ⭐
...
359. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 66,604 تثبيت
...
360. **typeset** — `pbakaus/impeccable/typeset` · 66,156 تثبيت
...
361. **defuddle** — `kepano/obsidian-skills/defuddle` · 65,941 تثبيت
...
362. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 65,639 تثبيت ⭐
...
363. **remotion-render** — `remotion-dev/skills/remotion-render` · 65,317 تثبيت ⭐
   General rendering strategy
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-render`

364. **remotion-create** — `remotion-dev/skills/remotion-create` · 65,312 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

365. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 65,288 تثبيت
...
366. **prototype** — `emilkowalski/skills/prototype` · 64,898 تثبيت
...
367. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 64,860 تثبيت ⭐
...
368. **overdrive** — `pbakaus/impeccable/overdrive` · 64,229 تثبيت
   ──────────── ⚡ OVERDRIVE ─────────────
   `npx skills add https://github.com/pbakaus/impeccable --skill overdrive`

369. **batch-grill-me** — `mattpocock/skills/batch-grill-me` · 64,178 تثبيت
   Interview the user relentlessly until you reach a shared understanding. Map this as a design tree: every decision branches into the decisions that han
   `npx skills add https://github.com/mattpocock/skills --skill batch-grill-me`

370. **video** — `coreyhaines31/marketingskills/video` · 63,556 تثبيت
...
371. **image** — `coreyhaines31/marketingskills/image` · 63,498 تثبيت
...
372. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 63,458 تثبيت ⭐
...
373. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 63,332 تثبيت ⭐
...
374. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 63,317 تثبيت ⭐
...
375. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 62,812 تثبيت
...
376. **template-skill** — `anthropics/skills/template-skill` · 62,628 تثبيت ⭐
   Replace with description of the skill and when Claude should use it.
   `npx skills add https://github.com/anthropics/skills --skill template-skill`

377. **web-search** — `skills-101/superpowers/web-search` · 62,576 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill web-search`

378. **developing-genkit-js** — `firebase/agent-skills/developing-genkit-js` · 62,576 تثبيت ⭐
...
379. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 62,534 تثبيت
...
380. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,358 تثبيت
   Cross-Border E-Commerce ✈️
   `npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill cross-border-ecommerce`

381. **agent-tools** — `skills-101/superpowers/agent-tools` · 62,327 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill agent-tools`

382. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 62,312 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

383. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 62,295 تثبيت ⭐
...
384. **python-executor** — `skills-101/superpowers/python-executor` · 62,276 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

385. **developing-genkit-dart** — `firebase/agent-skills/developing-genkit-dart` · 62,263 تثبيت ⭐
...
386. **tailwind-design-system** — `wshobson/agents/tailwind-design-system` · 61,892 تثبيت
   CSS-first design system framework for Tailwind v4 with tokens, components, and responsive patterns.
   `npx skills add https://github.com/wshobson/agents --skill tailwind-design-system`

387. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,874 تثبيت
...
388. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,873 تثبيت
...
389. **claude-api** — `anthropics/skills/claude-api` · 61,640 تثبيت ⭐
...
390. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 61,292 تثبيت ⭐
...
391. **stripe-projects** — `stripe/ai/stripe-projects` · 60,635 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

392. **design-md** — `google-labs-code/stitch-skills/design-md` · 60,448 تثبيت ⭐
...
393. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 59,897 تثبيت ⭐
...
394. **cro** — `coreyhaines31/marketingskills/cro` · 59,640 تثبيت
   Conversion Rate Optimization (CRO)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill cro`

395. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 59,472 تثبيت ⭐
...
396. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 59,408 تثبيت ⭐
...
397. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 59,094 تثبيت ⭐
...
398. **building-native-ui** — `expo/skills/building-native-ui` · 59,094 تثبيت ⭐
...
399. **web-perf** — `cloudflare/skills/web-perf` · 59,038 تثبيت ⭐
...
400. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 59,005 تثبيت ⭐
...
401. **remotion-saas** — `remotion-dev/skills/remotion-saas` · 58,622 تثبيت ⭐
   One can build apps with Remotion.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-saas`

402. **durable-objects** — `cloudflare/skills/durable-objects` · 58,587 تثبيت ⭐
...
403. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,487 تثبيت
...
404. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 58,372 تثبيت
...
405. **gws-shared** — `googleworkspace/cli/gws-shared` · 58,314 تثبيت ⭐
...
406. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,124 تثبيت
...
407. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,107 تثبيت
...
408. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 58,031 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

409. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,613 تثبيت
...
410. **social** — `coreyhaines31/marketingskills/social` · 57,477 تثبيت
...
411. **gpt-image-2** — `prime-skills/runcomfy-agent-skills/gpt-image-2` · 56,990 تثبيت
   GPT Image 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill gpt-image-2`

412. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,695 تثبيت
...
413. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,536 تثبيت
...
414. **analytics** — `coreyhaines31/marketingskills/analytics` · 56,516 تثبيت
...
415. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 56,515 تثبيت ⭐
...
416. **agents-sdk** — `cloudflare/skills/agents-sdk` · 56,468 تثبيت ⭐
...
417. **agently-mail** — `agent.qq.com/agently-mail` · 56,368 تثبيت
   通过 agently-cli 命令行工具操作邮件，通过管理端 (agent.qq.com) 进行后台管理。
   `npx skills add https://agent.qq.com/`

418. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,333 تثبيت
...
419. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 56,246 تثبيت
...
420. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,132 تثبيت
...
421. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 55,975 تثبيت
...
422. **normalize** — `pbakaus/impeccable/normalize` · 55,744 تثبيت
...
423. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,740 تثبيت
...
424. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 55,352 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

425. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,296 تثبيت
...
426. **opentui** — `msmps/opentui-skill/opentui` · 55,224 تثبيت
...
427. **pricing** — `coreyhaines31/marketingskills/pricing` · 55,193 تثبيت
...
428. **ads** — `coreyhaines31/marketingskills/ads` · 55,133 تثبيت
...
429. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 55,079 تثبيت ⭐
...
430. **nia** — `nozomio-labs/nia-skill/nia` · 55,037 تثبيت
...
431. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 54,810 تثبيت ⭐
...
432. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,791 تثبيت
...
433. **extract** — `pbakaus/impeccable/extract` · 54,662 تثبيت
...
434. **onboard** — `pbakaus/impeccable/onboard` · 54,501 تثبيت
...
435. **harden** — `pbakaus/impeccable/harden` · 54,427 تثبيت
...
436. **expo-dev-client** — `expo/skills/expo-dev-client` · 54,389 تثبيت ⭐
...
437. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,265 تثبيت
...
438. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 54,106 تثبيت ⭐
...
439. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 54,106 تثبيت ⭐
...
440. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 53,755 تثبيت
...
441. **competitors** — `coreyhaines31/marketingskills/competitors` · 53,743 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

442. **schema** — `coreyhaines31/marketingskills/schema` · 53,577 تثبيت
...
443. **emails** — `coreyhaines31/marketingskills/emails` · 53,537 تثبيت
...
444. **launch** — `coreyhaines31/marketingskills/launch` · 53,420 تثبيت
...
445. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,180 تثبيت
...
446. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 53,027 تثبيت ⭐
...
447. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 52,942 تثبيت
...
448. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,882 تثبيت
...
449. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,704 تثبيت
...
450. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,439 تثبيت
...
451. **ab-testing** — `coreyhaines31/marketingskills/ab-testing` · 52,070 تثبيت
   You are an expert in experimentation and A/B testing. Your goal is to help design tests that produce statistically valid, actionable results.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill ab-testing`

452. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 52,064 تثبيت ⭐
...
453. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,032 تثبيت
...
454. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 52,015 تثبيت
...
455. **typegpu** — `heygen-com/hyperframes/typegpu` · 51,947 تثبيت
...
456. **gsap-core** — `greensock/gsap-skills/gsap-core` · 51,744 تثبيت
...
457. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,697 تثبيت
...
458. **ai-sdk** — `vercel/ai/ai-sdk` · 51,600 تثبيت ⭐
...
459. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 51,439 تثبيت ⭐
...
460. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,394 تثبيت
...
461. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 51,216 تثبيت
...
462. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 51,206 تثبيت
...
463. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 51,008 تثبيت
   Cut the Curve — the technique catalog
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

464. **gws-docs** — `googleworkspace/cli/gws-docs` · 50,964 تثبيت ⭐
...
465. **aso** — `coreyhaines31/marketingskills/aso` · 50,920 تثبيت
...
466. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 50,764 تثبيت
...
467. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 50,735 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

468. **signup** — `coreyhaines31/marketingskills/signup` · 50,707 تثبيت
...
469. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 50,700 تثبيت
...
474. **popups** — `coreyhaines31/marketingskills/popups` · 50,229 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

475. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 50,184 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

476. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 50,124 تثبيت ⭐
...
477. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 49,732 تثبيت
...
478. **developing-genkit-go** — `firebase/agent-skills/developing-genkit-go` · 49,536 تثبيت ⭐
...
479. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 49,263 تثبيت ⭐
...
480. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 49,067 تثبيت
...
481. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 48,970 تثبيت ⭐
...
482. **hallmark** — `nutlope/hallmark/hallmark` · 48,830 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

483. **ponytail** — `dietrichgebert/ponytail/ponytail` · 48,155 تثبيت
   You are a lazy senior developer. Lazy means efficient, not careless. You have
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail`

484. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 47,910 تثبيت
...
485. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 47,697 تثبيت
...
486. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,159 تثبيت ⭐
...
487. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 46,749 تثبيت
...
488. **compress** — `juliusbrussee/caveman/compress` · 46,748 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

489. **momentic-test** — `momentic-ai/skills/momentic-test` · 46,662 تثبيت
...
490. **implement-spec** — `mattpocock/skills/implement-spec` · 46,653 تثبيت
   You have been provided a spec. This spec should have tickets associated with it, describing how to implement the spec.
   `npx skills add https://github.com/mattpocock/skills --skill implement-spec`

491. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 46,644 تثبيت
...
492. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 46,398 تثبيت
...
493. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 45,802 تثبيت
...
494. **gsap-react** — `greensock/gsap-skills/gsap-react` · 45,657 تثبيت
...
495. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 44,997 تثبيت
...
496. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,685 تثبيت
...
497. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 44,531 تثبيت
...
498. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 44,253 تثبيت ⭐
...
499. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 44,246 تثبيت
...
500. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 44,140 تثبيت ⭐
...
501. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 44,121 تثبيت
...
502. **sms** — `coreyhaines31/marketingskills/sms` · 43,945 تثبيت
...
503. **git-commit** — `github/awesome-copilot/git-commit` · 43,842 تثبيت ⭐
...
504. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 43,772 تثبيت
...
505. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 43,689 تثبيت
...
506. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 43,670 تثبيت ⭐
...
507. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 43,389 تثبيت ⭐
...
508. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 43,028 تثبيت ⭐
...
509. **upgrading-expo** — `expo/skills/upgrading-expo` · 43,013 تثبيت ⭐
...
510. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 42,817 تثبيت ⭐
...
511. **seo** — `addyosmani/web-quality-skills/seo` · 42,758 تثبيت
...
512. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 42,462 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

513. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 42,353 تثبيت
...
514. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 42,284 تثبيت ⭐
...
515. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 41,867 تثبيت
...
516. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 41,825 تثبيت ⭐
...
517. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 41,550 تثبيت ⭐
...
518. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 41,222 تثبيت ⭐
...
519. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 41,042 تثبيت
...
520. **review-loop** — `2dmurali/review-loop-skill/review-loop` · 40,924 تثبيت
...
521. **expo-deployment** — `expo/skills/expo-deployment` · 40,916 تثبيت ⭐
...
522. **byted-web-search** — `skills.volces.com/byted-web-search` · 40,646 تثبيت
...
523. **gws-gmail-triage** — `googleworkspace/cli/gws-gmail-triage` · 40,594 تثبيت ⭐
...
524. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 40,385 تثبيت ⭐
...
525. **arrange** — `pbakaus/impeccable/arrange` · 40,131 تثبيت
...
526. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 39,898 تثبيت ⭐
...
527. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 39,723 تثبيت
...
528. **mastra** — `mastra-ai/skills/mastra` · 39,671 تثبيت ⭐
...
529. **weread-skills** — `tencent/wechatreading/weread-skills` · 39,604 تثبيت
   通过 Agent API Gateway 调用微信读书接口，提供搜索、书架、笔记、书评等能力。
   `npx skills add https://github.com/tencent/wechatreading --skill weread-skills`

530. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 39,542 تثبيت
...
531. **clerk-setup** — `clerk/skills/clerk-setup` · 39,359 تثبيت ⭐
...
532. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 38,872 تثبيت
...
533. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 38,822 تثبيت
...
534. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 38,713 تثبيت ⭐
...
535. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 38,666 تثبيت ⭐
...
536. **remotion** — `google-labs-code/stitch-skills/remotion` · 38,441 تثبيت ⭐
...
537. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 38,187 تثبيت
...
538. **insforge** — `insforge/insforge-skills/insforge` · 38,178 تثبيت
   InsForge App Integration Skill
   `npx skills add https://github.com/insforge/insforge-skills --skill insforge`

539. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 38,174 تثبيت ⭐
...
540. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 38,138 تثبيت
...
541. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 38,071 تثبيت
...
542. **golang-security** — `samber/cc-skills-golang/golang-security` · 38,060 تثبيت
...
543. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 37,906 تثبيت
...
544. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 37,889 تثبيت
...
545. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,840 تثبيت ⭐
...
546. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 37,757 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

547. **lark-meeting** — `open.feishu.cn/lark-meeting` · 37,728 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

548. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 37,562 تثبيت
...
549. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 37,369 تثبيت
...
550. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 37,352 تثبيت
...
551. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,276 تثبيت
...
552. **herdr** — `herdrdev/herdr/herdr` · 37,204 تثبيت
...
553. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 37,151 تثبيت
...
554. **golang-context** — `samber/cc-skills-golang/golang-context` · 37,119 تثبيت
...
555. **firebase-firestore-standard** — `firebase/agent-skills/firebase-firestore-standard` · 37,115 تثبيت ⭐
...
556. **golang-database** — `samber/cc-skills-golang/golang-database` · 37,014 تثبيت
...
557. **gws-slides** — `googleworkspace/cli/gws-slides` · 36,990 تثبيت ⭐
...
558. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 36,987 تثبيت
...
559. **clerk-backend-api** — `clerk/skills/clerk-backend-api` · 36,973 تثبيت ⭐
   CRITICAL: Mandatory checks before EVERY write request
   `npx skills add https://github.com/clerk/skills --skill clerk-backend-api`

560. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 36,916 تثبيت
...
561. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 36,895 تثبيت
...
562. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 36,873 تثبيت
...
563. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 36,811 تثبيت
...
564. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 36,723 تثبيت
...
565. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 36,617 تثبيت ⭐
...
566. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 36,600 تثبيت
...
567. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 36,564 تثبيت
...
568. **last30days** — `mvanhorn/last30days-skill/last30days` · 36,513 تثبيت
...
569. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 36,444 تثبيت
...
570. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 36,415 تثبيت
...
571. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 36,396 تثبيت
...
572. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 36,312 تثبيت
...
573. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 36,310 تثبيت ⭐
...
574. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 36,267 تثبيت
...
575. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 36,245 تثبيت
...
576. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 36,233 تثبيت
...
577. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 36,126 تثبيت
...
578. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 36,124 تثبيت
...
579. **firebase-firestore-enterprise-native-mode** — `firebase/agent-skills/firebase-firestore-enterprise-native-mode` · 36,052 تثبيت ⭐
...
580. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 35,814 تثبيت
...
581. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 35,680 تثبيت
...
582. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 35,604 تثبيت
...
583. **value** — `hugmouse/skills/value` · 35,523 تثبيت
   This skill does absolutely nothing.
   `npx skills add https://github.com/hugmouse/skills --skill value`

584. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 35,518 تثبيت
...
585. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 35,487 تثبيت
...
586. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 35,452 تثبيت
...
587. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 35,432 تثبيت
...
588. **gws-forms** — `googleworkspace/cli/gws-forms` · 35,416 تثبيت ⭐
...
589. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 35,416 تثبيت
...
590. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 35,402 تثبيت
...
591. **replicas-agent** — `replicas-group/skill/replicas-agent` · 34,962 تثبيت
...
592. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 34,915 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

593. **gws-meet** — `googleworkspace/cli/gws-meet` · 34,870 تثبيت ⭐
...
594. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 34,645 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

595. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 34,639 تثبيت
...
596. **firebase-ai-logic** — `firebase/agent-skills/firebase-ai-logic` · 34,578 تثبيت ⭐
...
597. **clerk-orgs** — `clerk/skills/clerk-orgs` · 34,448 تثبيت ⭐
...
598. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 34,412 تثبيت
...
599. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 34,373 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

600. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 34,367 تثبيت
...
601. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 34,340 تثبيت
...
602. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 34,292 تثبيت
...
603. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 34,291 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

604. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 34,275 تثبيت
...
605. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 34,239 تثبيت
...
606. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 34,238 تثبيت
...
607. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 34,220 تثبيت
...
608. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 34,219 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

609. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 34,137 تثبيت
...
610. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 34,129 تثبيت
...
611. **karpathy-guidelines** — `multica-ai/andrej-karpathy-skills/karpathy-guidelines` · 34,116 تثبيت
   Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   `npx skills add https://github.com/multica-ai/andrej-karpathy-skills --skill karpathy-guidelines`

612. **vite** — `antfu/skills/vite` · 34,113 تثبيت
...
613. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 34,001 تثبيت
...
614. **vitest** — `antfu/skills/vitest` · 33,972 تثبيت
...
615. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 33,962 تثبيت
...
616. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 33,893 تثبيت
...
617. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 33,839 تثبيت
...
618. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,635 تثبيت ⭐
...
619. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 33,630 تثبيت
...
620. **offers** — `coreyhaines31/marketingskills/offers` · 33,622 تثبيت
...
621. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 33,563 تثبيت
...
622. **higgsfield-youtube-thumbnail** — `higgsfield-ai/skills/higgsfield-youtube-thumbnail` · 33,560 تثبيت
   Higgsfield YouTube Thumbnail
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-youtube-thumbnail`

623. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 33,488 تثبيت ⭐
...
627. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 33,228 تثبيت ⭐
...
628. **retro** — `mattpocock/skills/retro` · 33,210 تثبيت
   The user has asked for a retrospective. You are suggesting improvements to the coding agent's environment to improve future runs.
   `npx skills add https://github.com/mattpocock/skills --skill retro`

629. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 33,149 تثبيت
...
630. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 33,091 تثبيت
...
631. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 33,036 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

632. **gws-keep** — `googleworkspace/cli/gws-keep` · 32,905 تثبيت ⭐
...
633. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,846 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:design-system`

634. **vue** — `antfu/skills/vue` · 32,834 تثبيت
...
635. **angular-developer** — `angular/skills/angular-developer` · 32,601 تثبيت
...
636. **archify** — `tt-a1i/archify/archify` · 32,571 تثبيت
...
637. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 32,567 تثبيت ⭐
...
638. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,548 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:design`

639. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,481 تثبيت
...
640. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 32,432 تثبيت
...
641. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,338 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

642. **performance** — `addyosmani/web-quality-skills/performance` · 32,310 تثبيت
...
643. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 32,196 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

644. **ckm:brand** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:brand` · 32,047 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:brand`

645. **expo-module** — `expo/skills/expo-module` · 32,047 تثبيت ⭐
...
646. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 32,043 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

647. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 32,038 تثبيت ⭐
...
648. **ckm:banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:banner-design` · 32,018 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:banner-design`

649. **ckm:slides** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:slides` · 31,930 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ckm:slides`

650. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 31,882 تثبيت
...
651. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 31,773 تثبيت ⭐
...
652. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 31,725 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

653. **wind-find-finance-skill** — `wind-information-co-ltd/wind-skills/wind-find-finance-skill` · 31,588 تثبيت
...
654. **improve** — `shadcn/improve/improve` · 31,509 تثبيت
...
655. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 31,499 تثبيت ⭐
...
656. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,432 تثبيت ⭐
...
657. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 31,361 تثبيت
...
658. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 31,317 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

659. **product-photography** — `skills-101/superpowers/product-photography` · 31,296 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

660. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 31,269 تثبيت ⭐
...
661. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 31,257 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

662. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 31,247 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

663. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 31,240 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

664. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 31,238 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

665. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 31,235 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

666. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 31,234 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

667. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 31,230 تثبيت ⭐
...
668. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,177 تثبيت ⭐
...
669. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 31,131 تثبيت ⭐
...
670. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 31,088 تثبيت ⭐
...
671. **baoyu-infographic** — `jimliu/baoyu-skills/baoyu-infographic` · 31,086 تثبيت
...
672. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 31,044 تثبيت ⭐
...
673. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 31,029 تثبيت ⭐
...
674. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 31,017 تثبيت ⭐
...
675. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 31,014 تثبيت ⭐
...
676. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 30,978 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

677. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 30,970 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

678. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 30,953 تثبيت
...
679. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 30,946 تثبيت ⭐
...
680. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 30,929 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

681. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 30,920 تثبيت
...
682. **use-dom** — `expo/skills/use-dom` · 30,903 تثبيت ⭐
...
683. **shape** — `pbakaus/impeccable/shape` · 30,795 تثبيت
...
684. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 30,662 تثبيت
...
685. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 30,654 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

686. **tavily-search** — `tavily-ai/skills/tavily-search` · 30,592 تثبيت ⭐
...
687. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 30,474 تثبيت
...
688. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 30,459 تثبيت
...
689. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 30,409 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

690. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 30,407 تثبيت ⭐
...
691. **swiftui-expert-skill** — `avdlee/swiftui-agent-skill/swiftui-expert-skill` · 30,296 تثبيت
   Expert SwiftUI code review, refactoring, and implementation guidance with iOS 26+ and macOS support.
   `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill swiftui-expert-skill`

692. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 30,064 تثبيت
...
693. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 30,007 تثبيت
...
694. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 29,901 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

695. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,866 تثبيت ⭐
...
696. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 29,830 تثبيت ⭐
...
697. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,727 تثبيت
...
698. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 29,637 تثبيت
...
699. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 29,617 تثبيت ⭐
...
700. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 29,421 تثبيت
...
701. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 29,329 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

702. **gws-chat** — `googleworkspace/cli/gws-chat` · 29,236 تثبيت ⭐
...
703. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 29,194 تثبيت ⭐
...
704. **gws-people** — `googleworkspace/cli/gws-people` · 29,121 تثبيت ⭐
...
705. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 29,079 تثبيت ⭐
...
706. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 29,029 تثبيت
...
707. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 28,973 تثبيت
...
708. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 28,838 تثبيت ⭐
...
709. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 28,829 تثبيت
...
710. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 28,774 تثبيت ⭐
...
711. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 28,665 تثبيت
...
712. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 28,642 تثبيت
...
713. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 28,585 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

714. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 28,557 تثبيت ⭐
...
715. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 28,542 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

716. **baoyu-comic** — `jimliu/baoyu-skills/baoyu-comic` · 28,511 تثبيت
...
717. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 28,480 تثبيت ⭐
...
718. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 28,479 تثبيت ⭐
...
719. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 28,328 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

720. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 28,294 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

721. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 28,202 تثبيت ⭐
...
722. **gws-chat-send** — `googleworkspace/cli/gws-chat-send` · 28,150 تثبيت ⭐
   Send plain-text messages to Google Chat spaces.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-chat-send`

723. **recipe-draft-email-from-doc** — `googleworkspace/cli/recipe-draft-email-from-doc` · 28,081 تثبيت ⭐
...
724. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 28,044 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

725. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 28,002 تثبيت ⭐
...
726. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 27,972 تثبيت ⭐
...
727. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 27,957 تثبيت ⭐
...
728. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 27,950 تثبيت ⭐
...
729. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 27,890 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

730. **azure-postgres** — `microsoft/azure-skills/azure-postgres` · 27,848 تثبيت ⭐
   No SKILL.md available for this skill.
   `npx skills add https://github.com/microsoft/azure-skills --skill azure-postgres`

731. **gws-events** — `googleworkspace/cli/gws-events` · 27,836 تثبيت ⭐
...
732. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 27,787 تثبيت ⭐
...
733. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 27,751 تثبيت
...
734. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 27,695 تثبيت
...
735. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 27,632 تثبيت
...
736. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 27,601 تثبيت ⭐
...
737. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 27,560 تثبيت ⭐
...
738. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 27,511 تثبيت ⭐
...
739. **api-design-principles** — `wshobson/agents/api-design-principles` · 27,495 تثبيت
...
740. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 27,480 تثبيت ⭐
...
741. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 27,454 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

742. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 27,413 تثبيت ⭐
...
743. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 27,389 تثبيت
...
744. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 27,353 تثبيت ⭐
...
745. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 27,275 تثبيت ⭐
...
746. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 27,234 تثبيت ⭐
...
747. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 27,231 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

748. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 27,224 تثبيت ⭐
...
749. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 27,212 تثبيت ⭐
...
750. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 27,210 تثبيت ⭐
...
751. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 27,208 تثبيت ⭐
...
752. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 27,196 تثبيت ⭐
...
753. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 27,110 تثبيت ⭐
...
754. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 27,058 تثبيت ⭐
...
755. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 27,027 تثبيت ⭐
...
756. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 27,000 تثبيت
...
757. **layout** — `pbakaus/impeccable/layout` · 26,997 تثبيت
...
758. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 26,920 تثبيت ⭐
...
759. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 26,920 تثبيت ⭐
...
760. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 26,912 تثبيت
...
761. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 26,889 تثبيت ⭐
...
762. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 26,870 تثبيت
...
763. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 26,867 تثبيت ⭐
...
764. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 26,861 تثبيت ⭐
...
765. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 26,840 تثبيت ⭐
...
766. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 26,831 تثبيت ⭐
...
767. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 26,826 تثبيت
...
768. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 26,762 تثبيت ⭐
...
769. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 26,753 تثبيت ⭐
...
770. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 26,745 تثبيت ⭐
...
771. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 26,739 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

772. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 26,692 تثبيت
...
773. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,683 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

774. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 26,677 تثبيت ⭐
...
775. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 26,676 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

776. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 26,642 تثبيت ⭐
...
777. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 26,628 تثبيت ⭐
...
778. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 26,616 تثبيت
...
779. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 26,606 تثبيت ⭐
...
780. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 26,560 تثبيت ⭐
...
781. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 26,551 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

782. **golang-linter** — `samber/cc-skills-golang/golang-linter` · 26,543 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/samber/cc-skills-golang --skill golang-linter`

783. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 26,536 تثبيت ⭐
...
784. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 26,505 تثبيت ⭐
...
785. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 26,502 تثبيت ⭐
...
786. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 26,494 تثبيت ⭐
...
787. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 26,492 تثبيت ⭐
...
788. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 26,474 تثبيت ⭐
...
789. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 26,449 تثبيت ⭐
...
790. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 26,447 تثبيت ⭐
...
791. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 26,426 تثبيت
...
792. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 26,426 تثبيت ⭐
...
793. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 26,419 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

794. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 26,416 تثبيت ⭐
...
795. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 26,404 تثبيت ⭐
...
796. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 26,377 تثبيت ⭐
...
797. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 26,365 تثبيت
...
798. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 26,340 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

799. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 26,299 تثبيت ⭐
...
800. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 26,284 تثبيت ⭐
...
801. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 26,235 تثبيت ⭐
...
802. **eas-update-insights** — `expo/skills/eas-update-insights` · 26,177 تثبيت ⭐
...
803. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 26,163 تثبيت ⭐
...
804. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 26,127 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

805. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,094 تثبيت
...
806. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 26,076 تثبيت ⭐
...
807. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 26,072 تثبيت ⭐
...
808. **caveman-optimize** — `juliusbrussee/caveman/caveman-optimize` · 26,067 تثبيت
   Evaluate an optimization observation
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-optimize`

809. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 26,009 تثبيت
...
810. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 25,998 تثبيت ⭐
...
811. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 25,965 تثبيت ⭐
...
812. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 25,930 تثبيت ⭐
...
813. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 25,904 تثبيت
...
814. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 25,901 تثبيت
...
815. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 25,873 تثبيت
...
816. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 25,824 تثبيت
...
817. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 25,767 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

818. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 25,712 تثبيت
...
819. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 25,704 تثبيت
...
820. **lean-build** — `juliusbrussee/caveman/lean-build` · 25,654 تثبيت
...
821. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 25,649 تثبيت ⭐
...
822. **caveman-manage** — `juliusbrussee/caveman/caveman-manage` · 25,628 تثبيت
   Manage eval-gated experiments
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-manage`

823. **migration** — `juliusbrussee/caveman/migration` · 25,525 تثبيت
...
824. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,465 تثبيت ⭐
...
825. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 25,463 تثبيت
...
826. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 25,462 تثبيت
...
827. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 25,442 تثبيت
...
828. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 25,396 تثبيت
...
829. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 25,391 تثبيت
...
830. **interface-design** — `dammyjay93/interface-design/interface-design` · 25,237 تثبيت
...
831. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 25,140 تثبيت
...
832. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 24,965 تثبيت ⭐
...
833. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 24,738 تثبيت
...
834. **clerk** — `clerk/skills/clerk` · 24,687 تثبيت ⭐
...
835. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 24,567 تثبيت
...
836. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 24,483 تثبيت
...
837. **build-tam** — `code.deepline.com/build-tam` · 24,353 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

838. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 24,302 تثبيت
...
839. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 24,263 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

840. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 24,256 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

841. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 24,246 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

842. **release-skills** — `jimliu/baoyu-skills/release-skills` · 24,226 تثبيت
...
843. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 24,219 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

844. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 24,205 تثبيت ⭐
...
845. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 24,152 تثبيت
...
846. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 24,082 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

847. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 24,016 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

848. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 24,015 تثبيت
...
849. **design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/design-system` · 23,950 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

850. **stripe-directory** — `docs.stripe.com/stripe-directory` · 23,868 تثبيت
...
851. **interview-me** — `addyosmani/agent-skills/interview-me` · 23,758 تثبيت
...
852. **review-pr** — `warpdotdev/common-skills/review-pr` · 23,755 تثبيت
...
853. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 23,669 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

854. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 23,597 تثبيت
...
855. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 23,593 تثبيت
...
856. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 23,586 تثبيت
...
857. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 23,531 تثبيت
...
858. **animate-expo** — `emilkowalski/skills/animate-expo` · 23,523 تثبيت
   Building Animations in Expo
   `npx skills add https://github.com/emilkowalski/skills --skill animate-expo`

859. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 23,508 تثبيت
...
860. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 23,506 تثبيت
...
861. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 23,497 تثبيت
...
862. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 23,476 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

863. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 23,463 تثبيت
...
864. **create-pr** — `warpdotdev/common-skills/create-pr` · 23,434 تثبيت
...
865. **update-skill** — `warpdotdev/common-skills/update-skill` · 23,411 تثبيت
...
866. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 23,398 تثبيت
...
867. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 23,204 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

868. **brandalf** — `warpdotdev/common-skills/brandalf` · 23,145 تثبيت
...
869. **dbs** — `dontbesilent2025/dbskill/dbs` · 23,122 تثبيت
   你是 dontbesilent 商业工具箱的公开入口。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs`

870. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 23,063 تثبيت
...
871. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 22,840 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

872. **summarize** — `openclaw/openclaw/summarize` · 22,705 تثبيت
   Fast CLI to summarize URLs, local files, and YouTube links.
   `npx skills add https://github.com/openclaw/openclaw --skill summarize`

873. **prd** — `github/awesome-copilot/prd` · 22,624 تثبيت ⭐
...
874. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 22,559 تثبيت
...
875. **council** — `warpdotdev/common-skills/council` · 22,512 تثبيت
...
876. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 22,505 تثبيت ⭐
...
877. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 22,495 تثبيت ⭐
...
878. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 22,458 تثبيت
...
879. **gws-script** — `googleworkspace/cli/gws-script` · 22,440 تثبيت ⭐
...
880. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 22,401 تثبيت
...
881. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 22,328 تثبيت
...
882. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 22,291 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

883. **gstack** — `garrytan/gstack/gstack` · 22,223 تثبيت
...
884. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 22,220 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

885. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 22,169 تثبيت ⭐
...
886. **nuxt** — `antfu/skills/nuxt` · 21,949 تثبيت
...
887. **check-impl-against-spec** — `warpdotdev/common-skills/check-impl-against-spec` · 21,933 تثبيت
   Check implementation against spec
   `npx skills add https://github.com/warpdotdev/common-skills --skill check-impl-against-spec`

888. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,894 تثبيت ⭐
...
889. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 21,869 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

890. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 21,846 تثبيت
...
891. **best-practices** — `addyosmani/web-quality-skills/best-practices` · 21,832 تثبيت
   Modern web development standards based on Lighthouse best practices audits. Covers security, browser compatibility, and code quality patterns.
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill best-practices`

892. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 21,781 تثبيت
...
893. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 21,740 تثبيت
...
894. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 21,638 تثبيت
...
895. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 21,538 تثبيت
...
896. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 21,422 تثبيت
...
897. **refactor** — `github/awesome-copilot/refactor` · 21,369 تثبيت ⭐
   Surgical code refactoring to improve maintainability without changing behavior.
   `npx skills add https://github.com/github/awesome-copilot --skill refactor`

898. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 21,315 تثبيت
...
899. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 21,245 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

900. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 21,169 تثبيت
...
901. **laravel-specialist** — `jeffallan/claude-skills/laravel-specialist` · 21,068 تثبيت
...
902. **mediabunny** — `remotion-dev/skills/mediabunny` · 20,913 تثبيت ⭐
   Mediabunny is a multimedia library for dealing with audio and video in the browser.
   `npx skills add https://github.com/remotion-dev/skills --skill mediabunny`

903. **skill-vetter** — `useai-pro/openclaw-skills-security/skill-vetter` · 20,907 تثبيت
...
904. **vueuse-functions** — `antfu/skills/vueuse-functions` · 20,741 تثبيت
...
905. **prompt-engineering-patterns** — `wshobson/agents/prompt-engineering-patterns` · 20,701 تثبيت
...
906. **clerk-cli** — `clerk/skills/clerk-cli` · 20,592 تثبيت ⭐
...
907. **sandbox-stable** — `cloudflare/skills/sandbox-stable` · 20,540 تثبيت ⭐
   Sandbox SDK — stable package
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-stable`

908. **error-handling-patterns** — `wshobson/agents/error-handling-patterns` · 20,524 تثبيت
...
909. **baoyu-post-to-weibo** — `jimliu/baoyu-skills/baoyu-post-to-weibo` · 20,490 تثبيت
...
910. **firestore-security-rules-auditor** — `firebase/agent-skills/firestore-security-rules-auditor` · 20,411 تثبيت ⭐
...
911. **sandbox-next** — `cloudflare/skills/sandbox-next` · 20,373 تثبيت ⭐
   Sandbox SDK — @next (1.0 preview)
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-next`

912. **sandbox-migrate-to-next** — `cloudflare/skills/sandbox-migrate-to-next` · 20,342 تثبيت ⭐
...
913. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 20,244 تثبيت
...
914. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 20,146 تثبيت
...
915. **validate-changes-match-specs** — `warpdotdev/common-skills/validate-changes-match-specs` · 20,076 تثبيت
   Validate changes match specs
   `npx skills add https://github.com/warpdotdev/common-skills --skill validate-changes-match-specs`

916. **pnpm** — `antfu/skills/pnpm` · 20,003 تثبيت
...
917. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 19,829 تثبيت ⭐
...
918. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 19,783 تثبيت
...
919. **java-springboot** — `github/awesome-copilot/java-springboot` · 19,699 تثبيت ⭐
...
920. **baoyu-youtube-transcript** — `jimliu/baoyu-skills/baoyu-youtube-transcript` · 19,649 تثبيت
...
921. **python-design-patterns** — `wshobson/agents/python-design-patterns` · 19,592 تثبيت
...
922. **dbs-chatroom** — `dontbesilent2025/dbskill/dbs-chatroom` · 19,529 تثبيت
   你是定向聊天室的主持人。根据话题推荐或接受用户指定的专家，模拟多角色对话。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-chatroom`

923. **gemini-api-dev** — `google-gemini/gemini-skills/gemini-api-dev` · 19,447 تثبيت ⭐
...
928. **wecomcli-doc** — `wecomteam/wecom-cli/wecomcli-doc` · 19,264 تثبيت
...
929. **opencli-usage** — `jackwener/opencli/opencli-usage` · 19,245 تثبيت
...
930. **wecomcli-todo** — `wecomteam/wecom-cli/wecomcli-todo` · 19,074 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-todo`

931. **wecomcli-contact** — `wecomteam/wecom-cli/wecomcli-contact` · 19,030 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-contact`

932. **html-ppt** — `lewislulu/html-ppt-skill/html-ppt` · 19,004 تثبيت
   html-ppt — HTML PPT Studio
   `npx skills add https://github.com/lewislulu/html-ppt-skill --skill html-ppt`

933. **wecomcli-meeting** — `wecomteam/wecom-cli/wecomcli-meeting` · 18,985 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-meeting`

934. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 18,888 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

935. **baseline-ui** — `ibelick/ui-skills/baseline-ui` · 18,648 تثبيت
...
936. **security-requirement-extraction** — `wshobson/agents/security-requirement-extraction` · 18,644 تثبيت
   Transform threat analysis into actionable security requirements.
   `npx skills add https://github.com/wshobson/agents --skill security-requirement-extraction`

937. **ponytail-review** — `dietrichgebert/ponytail/ponytail-review` · 18,586 تثبيت
   Review diffs for unnecessary complexity. One line per finding: location, what
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-review`

938. **modern-javascript-patterns** — `wshobson/agents/modern-javascript-patterns` · 18,471 تثبيت
...
939. **javascript-testing-patterns** — `wshobson/agents/javascript-testing-patterns` · 18,224 تثبيت
...
940. **dbs-report** — `dontbesilent2025/dbskill/dbs-report` · 18,211 تثبيت
...
941. **feature-sliced-design** — `feature-sliced/skills/feature-sliced-design` · 18,195 تثبيت
   Feature-Sliced Design (FSD) v2.1
   `npx skills add https://github.com/feature-sliced/skills --skill feature-sliced-design`

942. **dbs-save** — `dontbesilent2025/dbskill/dbs-save` · 18,189 تثبيت
...
943. **dbs-restore** — `dontbesilent2025/dbskill/dbs-restore` · 18,180 تثبيت
...
944. **vue-router-best-practices** — `antfu/skills/vue-router-best-practices` · 18,092 تثبيت
...
945. **aso-audit** — `coreyhaines31/marketingskills/aso-audit` · 18,005 تثبيت
...
946. **dbs-goal** — `dontbesilent2025/dbskill/dbs-goal` · 17,998 تثبيت
...
947. **opencli-browser** — `jackwener/opencli/opencli-browser` · 17,971 تثبيت
...
948. **playwright-generate-test** — `github/awesome-copilot/playwright-generate-test` · 17,869 تثبيت ⭐
...
949. **create-readme** — `github/awesome-copilot/create-readme` · 17,869 تثبيت ⭐
...
950. **rust-async-patterns** — `wshobson/agents/rust-async-patterns` · 17,859 تثبيت
...
951. **modern-web-guidance** — `googlechrome/modern-web-guidance/modern-web-guidance` · 17,799 تثبيت
   A skill to search for specific web development use cases and retrieve their corresponding best practice guides.
   `npx skills add https://github.com/googlechrome/modern-web-guidance --skill modern-web-guidance`

952. **responsive-design** — `wshobson/agents/responsive-design` · 17,779 تثبيت
...
953. **agent development** — `anthropics/claude-code/agent-development` · 17,722 تثبيت ⭐
   Agent Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Agent Development&#x27;`

954. **skill development** — `anthropics/claude-code/skill-development` · 17,528 تثبيت ⭐
   Skill Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Skill Development&#x27;`

955. **pinia** — `antfu/skills/pinia` · 17,407 تثبيت
...
956. **sql-optimization-patterns** — `wshobson/agents/sql-optimization-patterns` · 17,389 تثبيت
...
957. **planning-with-files-zh** — `othmanadi/planning-with-files/planning-with-files-zh` · 17,220 تثبيت
...
958. **fixing-accessibility** — `ibelick/ui-skills/fixing-accessibility` · 17,204 تثبيت
...
959. **the-news** — `sfkislev/the-news/the-news` · 17,165 تثبيت
...
960. **golang-pro** — `jeffallan/claude-skills/golang-pro` · 17,124 تثبيت
