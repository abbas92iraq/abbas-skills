...
**آخر تحديث:** 2026-09-10 · **العدد:** 1,005 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,331,779 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 1,103,576 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 941,806 تثبيت
...
4. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 901,626 تثبيت
...
7. **agent-browser** — `vercel-labs/agent-browser/agent-browser` · 820,677 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/vercel-labs/agent-browser --skill agent-browser`

8. **setup-matt-pocock-skills** — `mattpocock/skills/setup-matt-pocock-skills` · 806,212 تثبيت
...
9. **handoff** — `mattpocock/skills/handoff` · 774,772 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 760,259 تثبيت
...
11. **prototype** — `mattpocock/skills/prototype` · 753,088 تثبيت
...
12. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 701,586 تثبيت ⭐
...
16. **lark-drive** — `open.feishu.cn/lark-drive` · 676,093 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

17. **lark-approval** — `open.feishu.cn/lark-approval` · 675,715 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

18. **lark-shared** — `open.feishu.cn/lark-shared` · 675,665 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

19. **lark-im** — `open.feishu.cn/lark-im` · 675,610 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

20. **lark-calendar** — `open.feishu.cn/lark-calendar` · 675,522 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

21. **lark-sheets** — `open.feishu.cn/lark-sheets` · 675,204 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/`

22. **lark-wiki** — `open.feishu.cn/lark-wiki` · 674,954 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

23. **lark-contact** — `open.feishu.cn/lark-contact` · 674,939 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/`

24. **lark-minutes** — `open.feishu.cn/lark-minutes` · 674,857 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

25. **lark-event** — `open.feishu.cn/lark-event` · 674,613 تثبيت
...
26. **lark-task** — `open.feishu.cn/lark-task` · 674,578 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

27. **lark-slides** — `open.feishu.cn/lark-slides` · 674,577 تثبيت
   本技能文档较长，务必使用 Read 工具阅读两次，必须阅读完整全文。
   `npx skills add https://open.feishu.cn/`

28. **lark-mail** — `open.feishu.cn/lark-mail` · 674,570 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/`

29. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 674,552 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/`

30. **lark-attendance** — `open.feishu.cn/lark-attendance` · 674,485 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

31. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 674,425 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/`

32. **lark-vc** — `open.feishu.cn/lark-vc` · 674,225 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

33. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 674,115 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

34. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 673,980 تثبيت
...
35. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 673,833 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

36. **grilling** — `mattpocock/skills/grilling` · 664,743 تثبيت
...
37. **lark-okr** — `open.feishu.cn/lark-okr` · 655,185 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

38. **lark-markdown** — `open.feishu.cn/lark-markdown` · 640,517 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

39. **teach** — `mattpocock/skills/teach` · 626,831 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

40. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 621,416 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

41. **lark-vc-agent** — `open.feishu.cn/lark-vc-agent` · 618,814 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

42. **domain-modeling** — `mattpocock/skills/domain-modeling` · 603,363 تثبيت
...
47. **codebase-design** — `mattpocock/skills/codebase-design` · 584,983 تثبيت
...
48. **lark-apps** — `open.feishu.cn/lark-apps` · 584,934 تثبيت
...
49. **microsoft-foundry** — `microsoft/azure-skills/microsoft-foundry` · 580,251 تثبيت ⭐
   End-to-end deployment, evaluation, and management of AI agents on Microsoft Foundry.
   `npx skills add https://github.com/microsoft/azure-skills --skill microsoft-foundry`

50. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 574,340 تثبيت
   A discipline for hard bugs. Skip phases only when explicitly justified.
   `npx skills add https://github.com/mattpocock/skills --skill diagnosing-bugs`

51. **azure-diagnostics** — `microsoft/azure-skills/azure-diagnostics` · 572,476 تثبيت ⭐
...
52. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 571,877 تثبيت ⭐
...
53. **azure-ai** — `microsoft/azure-skills/azure-ai` · 571,784 تثبيت ⭐
...
54. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 571,740 تثبيت ⭐
...
55. **azure-validate** — `microsoft/azure-skills/azure-validate` · 571,193 تثبيت ⭐
...
56. **azure-storage** — `microsoft/azure-skills/azure-storage` · 570,647 تثبيت ⭐
...
57. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 570,387 تثبيت ⭐
...
58. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 570,131 تثبيت ⭐
...
59. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 570,069 تثبيت ⭐
...
60. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 570,049 تثبيت ⭐
...
61. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 570,027 تثبيت ⭐
...
62. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 569,822 تثبيت ⭐
...
63. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 569,744 تثبيت ⭐
...
64. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 559,466 تثبيت ⭐
...
70. **azure-compute** — `microsoft/azure-skills/azure-compute` · 513,469 تثبيت ⭐
...
71. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 503,494 تثبيت ⭐
...
72. **caveman** — `juliusbrussee/caveman/caveman` · 495,621 تثبيت
   Ultra-compressed communication mode cutting token usage ~75% while preserving technical accuracy.
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman`

73. **hyperframes** — `heygen-com/hyperframes/hyperframes` · 493,049 تثبيت
...
74. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 489,365 تثبيت ⭐
...
75. **wayfinder** — `mattpocock/skills/wayfinder` · 483,297 تثبيت
...
76. **research** — `mattpocock/skills/research` · 476,627 تثبيت
   Spin up a background agent to do the research, so you keep working while it reads.
   `npx skills add https://github.com/mattpocock/skills --skill research`

77. **to-spec** — `mattpocock/skills/to-spec` · 474,487 تثبيت
...
78. **to-tickets** — `mattpocock/skills/to-tickets` · 466,253 تثبيت
   Break a plan, spec, or conversation into a set of tickets: tracer-bullet vertical slices, each declaring the tickets that block it.
   `npx skills add https://github.com/mattpocock/skills --skill to-tickets`

79. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 462,141 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

80. **lark-note** — `open.feishu.cn/lark-note` · 458,650 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

81. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 457,314 تثبيت
...
82. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,846 تثبيت
...
83. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,088 تثبيت
...
84. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 450,001 تثبيت
...
85. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 449,972 تثبيت
...
86. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 448,765 تثبيت
...
87. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 440,693 تثبيت ⭐
...
88. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 439,642 تثبيت ⭐
...
89. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 431,759 تثبيت ⭐
...
90. **video-edit** — `prime-skills/runcomfy-agent-skills/video-edit` · 417,217 تثبيت
   Video Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill video-edit`

91. **image-to-video** — `prime-skills/runcomfy-agent-skills/image-to-video` · 415,581 تثبيت
...
92. **nano-banana-2** — `prime-skills/runcomfy-agent-skills/nano-banana-2` · 415,260 تثبيت
   Nano Banana 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill nano-banana-2`

93. **image-edit** — `prime-skills/runcomfy-agent-skills/image-edit` · 414,860 تثبيت
   Image Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill image-edit`

94. **nano-banana-edit** — `prime-skills/runcomfy-agent-skills/nano-banana-edit` · 414,839 تثبيت
...
95. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 414,628 تثبيت
...
96. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 414,085 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

97. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 413,912 تثبيت
...
98. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 413,907 تثبيت
...
99. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 413,864 تثبيت
...
100. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 413,693 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

101. **ai-music** — `genmedia-labs/skills/ai-music` · 410,673 تثبيت
...
102. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 406,282 تثبيت ⭐
...
103. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 399,141 تثبيت ⭐
...
104. **hyperframes-core** — `heygen-com/hyperframes/hyperframes-core` · 397,482 تثبيت
...
105. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 393,944 تثبيت ⭐
...
106. **media-use** — `heygen-com/hyperframes/media-use` · 391,402 تثبيت
   The media OS for HyperFrames: resolve · generate · operate · remember — every media type, one skill, zero context noise.
   `npx skills add https://github.com/heygen-com/hyperframes --skill media-use`

107. **kling-3-0** — `prime-skills/runcomfy-agent-skills/kling-3-0` · 390,846 تثبيت
   Kling 3.0 - Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill kling-3-0`

108. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 387,430 تثبيت
...
113. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 368,572 تثبيت
...
114. **to-prd** — `mattpocock/skills/to-prd` · 367,115 تثبيت
...
115. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 357,788 تثبيت
...
116. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 357,482 تثبيت
...
117. **brainstorming** — `obra/superpowers/brainstorming` · 357,178 تثبيت
   Structured design dialogue that validates ideas before implementation begins.
   `npx skills add https://github.com/obra/superpowers --skill brainstorming`

118. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 355,838 تثبيت
...
119. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 355,351 تثبيت
...
120. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 355,139 تثبيت
...
121. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 355,096 تثبيت
...
122. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 354,694 تثبيت
...
123. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 354,551 تثبيت
...
124. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 354,416 تثبيت
...
125. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 354,335 تثبيت
...
126. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 354,236 تثبيت
...
127. **to-issues** — `mattpocock/skills/to-issues` · 354,093 تثبيت
...
128. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 351,332 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

129. **caveman-commit** — `juliusbrussee/caveman/caveman-commit` · 347,400 تثبيت
...
130. **ace-step** — `prime-skills/runcomfy-agent-skills/ace-step` · 346,125 تثبيت
   ACE Step — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ace-step`

131. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 344,082 تثبيت
...
132. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 342,439 تثبيت
...
133. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 341,360 تثبيت
...
134. **git-guardrails-claude-code** — `mattpocock/skills/git-guardrails-claude-code` · 338,207 تثبيت
   Sets up a PreToolUse hook that intercepts and blocks dangerous git commands before Claude executes them.
   `npx skills add https://github.com/mattpocock/skills --skill git-guardrails-claude-code`

135. **redesign-existing-projects** — `leonxlnx/taste-skill/redesign-existing-projects` · 337,673 تثبيت
   Audit and upgrade existing websites to premium design standards without breaking functionality.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill redesign-existing-projects`

136. **wizard** — `mattpocock/skills/wizard` · 335,662 تثبيت
...
137. **caveman-help** — `juliusbrussee/caveman/caveman-help` · 335,114 تثبيت
...
138. **setup-pre-commit** — `mattpocock/skills/setup-pre-commit` · 330,812 تثبيت
   lint-staged running Prettier on all staged files
   `npx skills add https://github.com/mattpocock/skills --skill setup-pre-commit`

139. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 328,930 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

140. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 324,892 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

141. **writing-beats** — `mattpocock/skills/writing-beats` · 324,572 تثبيت
...
142. **writing-shape** — `mattpocock/skills/writing-shape` · 324,092 تثبيت
...
143. **writing-fragments** — `mattpocock/skills/writing-fragments` · 323,955 تثبيت
...
144. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 322,635 تثبيت
...
145. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 321,372 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

146. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 318,271 تثبيت ⭐
...
147. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 313,516 تثبيت
...
148. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,199 تثبيت
...
149. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 310,993 تثبيت
...
150. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,935 تثبيت
...
151. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,624 تثبيت
...
152. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,589 تثبيت
...
153. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,466 تثبيت
...
154. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,451 تثبيت
...
155. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 298,992 تثبيت
...
156. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 292,771 تثبيت
...
157. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 292,550 تثبيت
...
158. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 292,403 تثبيت ⭐
...
159. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 291,887 تثبيت
...
160. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 291,571 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

161. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 291,036 تثبيت
...
162. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 285,439 تثبيت
...
163. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 283,001 تثبيت
...
164. **brandkit** — `leonxlnx/taste-skill/brandkit` · 281,530 تثبيت
...
165. **loop-me** — `mattpocock/skills/loop-me` · 278,054 تثبيت
...
166. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 276,702 تثبيت
...
167. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 274,902 تثبيت
...
168. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 273,423 تثبيت ⭐
...
169. **prisma-client-api** — `prisma/skills/prisma-client-api` · 272,968 تثبيت ⭐
...
170. **shadcn** — `shadcn/ui/shadcn` · 271,675 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

171. **prisma-cli** — `prisma/skills/prisma-cli` · 270,693 تثبيت ⭐
...
172. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 269,547 تثبيت
...
173. **impeccable** — `pbakaus/impeccable/impeccable` · 269,414 تثبيت
   Frontend design and iteration for production-grade interfaces, from concept to ship.
   `npx skills add https://github.com/pbakaus/impeccable --skill impeccable`

174. **prisma-postgres** — `prisma/skills/prisma-postgres` · 266,605 تثبيت ⭐
...
175. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 266,447 تثبيت
...
176. **supabase** — `supabase/agent-skills/supabase` · 265,850 تثبيت ⭐
...
177. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 261,929 تثبيت ⭐
...
178. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 261,695 تثبيت ⭐
...
179. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 260,949 تثبيت ⭐
...
180. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 259,040 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

181. **prisma-compute** — `prisma/skills/prisma-compute` · 257,007 تثبيت ⭐
...
182. **prisma-mongodb-upgrade** — `prisma/skills/prisma-mongodb-upgrade` · 255,701 تثبيت ⭐
   Prisma MongoDB Upgrade Path
   `npx skills add https://github.com/prisma/skills --skill prisma-mongodb-upgrade`

183. **claude-handoff** — `mattpocock/skills/claude-handoff` · 254,799 تثبيت
...
184. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 253,649 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

185. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 251,558 تثبيت ⭐
...
186. **just-scrape** — `scrapegraphai/just-scrape/just-scrape` · 244,959 تثبيت
...
191. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 233,179 تثبيت
...
192. **write-a-skill** — `mattpocock/skills/write-a-skill` · 230,018 تثبيت
...
193. **zoom-out** — `mattpocock/skills/zoom-out` · 229,449 تثبيت
...
194. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 227,328 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

195. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 225,216 تثبيت
...
196. **wait-what** — `mattpocock/skills/wait-what` · 224,798 تثبيت
...
197. **requesting-code-review** — `obra/superpowers/requesting-code-review` · 223,979 تثبيت
   Dispatch code review subagents with focused context to catch issues before they compound.
   `npx skills add https://github.com/obra/superpowers --skill requesting-code-review`

198. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 222,627 تثبيت
...
199. **test-driven-development** — `obra/superpowers/test-driven-development` · 221,894 تثبيت
   Write tests first, watch them fail, then implement minimal code to pass.
   `npx skills add https://github.com/obra/superpowers --skill test-driven-development`

200. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 219,250 تثبيت
...
203. **design-an-interface** — `mattpocock/skills/design-an-interface` · 216,157 تثبيت
...
204. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 212,082 تثبيت
...
205. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 209,517 تثبيت
...
206. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,473 تثبيت ⭐
...
207. **executing-plans** — `obra/superpowers/executing-plans` · 207,542 تثبيت
...
208. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 206,602 تثبيت ⭐
...
209. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 205,582 تثبيت
...
210. **qa** — `mattpocock/skills/qa` · 205,424 تثبيت
...
211. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 204,209 تثبيت
...
212. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 204,098 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

213. **embedded-captions** — `heygen-com/hyperframes/embedded-captions` · 203,604 تثبيت
...
214. **obsidian-vault** — `mattpocock/skills/obsidian-vault` · 201,849 تثبيت
   /mnt/d/Obsidian Vault/AI Research/
   `npx skills add https://github.com/mattpocock/skills --skill obsidian-vault`

215. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 200,504 تثبيت
...
216. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 199,472 تثبيت
...
217. **edit-article** — `mattpocock/skills/edit-article` · 198,163 تثبيت
...
218. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 197,112 تثبيت
...
221. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 189,244 تثبيت
...
222. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 186,712 تثبيت
...
223. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 186,174 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

224. **writing-skills** — `obra/superpowers/writing-skills` · 186,085 تثبيت
...
225. **docx** — `anthropics/skills/docx` · 185,242 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

226. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 182,814 تثبيت
...
227. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 178,287 تثبيت
...
228. **slideshow** — `heygen-com/hyperframes/slideshow` · 175,090 تثبيت
...
229. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 174,657 تثبيت ⭐
...
230. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 173,161 تثبيت
...
231. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 172,813 تثبيت
...
232. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 172,781 تثبيت
...
233. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 172,722 تثبيت
...
234. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 172,720 تثبيت
...
235. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 172,705 تثبيت
...
236. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 172,575 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

237. **xlsx** — `anthropics/skills/xlsx` · 165,739 تثبيت ⭐
   Create, edit, and analyze Excel spreadsheets with formulas, formatting, and error-free calculations.
   `npx skills add https://github.com/anthropics/skills --skill xlsx`

238. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 162,242 تثبيت
...
239. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 159,124 تثبيت
...
240. **webapp-testing** — `anthropics/skills/webapp-testing` · 153,314 تثبيت ⭐
   Native Python Playwright scripts for testing local web applications with server lifecycle management.
   `npx skills add https://github.com/anthropics/skills --skill webapp-testing`

241. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 150,530 تثبيت ⭐
...
242. **firebase-basics** — `firebase/agent-skills/firebase-basics` · 149,084 تثبيت ⭐
...
243. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 148,991 تثبيت
...
244. **wind-mcp-skill** — `wind-alice/alicemarket/wind-mcp-skill` · 148,271 تثبيت
...
245. **playwright-cli** — `microsoft/playwright-cli/playwright-cli` · 148,229 تثبيت ⭐
   Browser automation with 40+ commands for navigation, interaction, form filling, and web testing.
   `npx skills add https://github.com/microsoft/playwright-cli --skill playwright-cli`

246. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 148,026 تثبيت ⭐
...
247. **review-animations** — `emilkowalski/skills/review-animations` · 147,950 تثبيت
...
248. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 144,460 تثبيت ⭐
...
249. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 143,952 تثبيت ⭐
...
250. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 143,134 تثبيت ⭐
...
251. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 140,662 تثبيت
...
252. **computer-use** — `stablyai/orca/computer-use` · 140,283 تثبيت
   This discovery stub loads the version-matched guide from the Orca executable used for this session.
   `npx skills add https://github.com/stablyai/orca --skill computer-use`

253. **sentry-cli** — `sentry/dev/sentry-cli` · 140,243 تثبيت
...
254. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 139,529 تثبيت
...
255. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 138,417 تثبيت
...
256. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 137,692 تثبيت
...
257. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 136,897 تثبيت
...
258. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 135,750 تثبيت
...
259. **ui-radar** — `uizze.com/ui-radar` · 135,613 تثبيت
   Don't let your AI agents design blind.
   `npx skills add https://uizze.com/`

260. **apple-design** — `emilkowalski/skills/apple-design` · 129,823 تثبيت
...
261. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 129,817 تثبيت
...
262. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 128,765 تثبيت
...
263. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 126,435 تثبيت
...
264. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 125,982 تثبيت
...
265. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 123,570 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

266. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 123,198 تثبيت
...
267. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 122,627 تثبيت
...
268. **improve-animations** — `emilkowalski/skills/improve-animations` · 120,158 تثبيت
...
269. **design-mobile-apps** — `designed-by-ai/skills/design-mobile-apps` · 118,563 تثبيت
...
270. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 116,916 تثبيت ⭐
...
271. **figma** — `heygen-com/hyperframes/figma` · 116,397 تثبيت
...
272. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 114,151 تثبيت
...
273. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 113,762 تثبيت
...
274. **mcp-builder** — `anthropics/skills/mcp-builder` · 112,817 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

275. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 112,006 تثبيت ⭐
...
276. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 109,878 تثبيت ⭐
...
277. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 109,488 تثبيت
...
278. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 108,587 تثبيت ⭐
...
279. **browser-act** — `browser-act/skills/browser-act` · 107,961 تثبيت
...
280. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 107,398 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

281. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 106,641 تثبيت ⭐
...
282. **canvas-design** — `anthropics/skills/canvas-design` · 106,285 تثبيت ⭐
...
283. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 106,203 تثبيت
...
284. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 105,768 تثبيت ⭐
...
285. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 105,058 تثبيت
...
286. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 105,024 تثبيت ⭐
...
287. **neon** — `neondatabase/agent-skills/neon` · 104,618 تثبيت ⭐
...
288. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 102,668 تثبيت
...
289. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 100,719 تثبيت
...
290. **firecrawl** — `firecrawl/cli/firecrawl` · 100,639 تثبيت ⭐
...
291. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 100,070 تثبيت
...
292. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 99,341 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

293. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,314 تثبيت ⭐
...
294. **revops** — `coreyhaines31/marketingskills/revops` · 95,851 تثبيت
...
295. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 95,483 تثبيت ⭐
...
296. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 95,468 تثبيت ⭐
...
297. **gsap** — `heygen-com/hyperframes/gsap` · 95,260 تثبيت
...
298. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,499 تثبيت
...
299. **review** — `mattpocock/skills/review` · 94,292 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

300. **browser-use** — `browser-use/browser-use/browser-use` · 94,170 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

301. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,065 تثبيت
...
302. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,061 تثبيت
...
303. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 92,940 تثبيت
...
304. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 92,418 تثبيت
...
305. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 91,858 تثبيت
...
306. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 90,910 تثبيت
...
307. **convex** — `get-convex/agent-skills/convex` · 90,492 تثبيت
...
308. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 89,210 تثبيت ⭐
...
309. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 89,101 تثبيت ⭐
...
310. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 89,004 تثبيت ⭐
...
311. **polish** — `pbakaus/impeccable/polish` · 87,246 تثبيت
...
312. **implement-spec** — `mattpocock/skills/implement-spec` · 86,784 تثبيت
   You have been provided a spec. This spec should have tickets associated with it, describing how to implement the spec.
   `npx skills add https://github.com/mattpocock/skills --skill implement-spec`

313. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,078 تثبيت
...
314. **critique** — `pbakaus/impeccable/critique` · 84,640 تثبيت
...
315. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 84,593 تثبيت
...
316. **cloudflare** — `cloudflare/skills/cloudflare` · 84,131 تثبيت ⭐
...
317. **audit** — `pbakaus/impeccable/audit` · 83,860 تثبيت
...
318. **animate** — `pbakaus/impeccable/animate` · 83,715 تثبيت
...
319. **adapt** — `pbakaus/impeccable/adapt` · 83,703 تثبيت
...
320. **theme-factory** — `anthropics/skills/theme-factory` · 83,482 تثبيت ⭐
...
321. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 83,453 تثبيت ⭐
...
322. **clarify** — `pbakaus/impeccable/clarify` · 83,194 تثبيت
...
323. **optimize** — `pbakaus/impeccable/optimize` · 83,050 تثبيت
...
324. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 82,897 تثبيت ⭐
...
325. **colorize** — `pbakaus/impeccable/colorize` · 82,856 تثبيت
...
326. **bolder** — `pbakaus/impeccable/bolder` · 81,974 تثبيت
...
327. **delight** — `pbakaus/impeccable/delight` · 81,808 تثبيت
...
328. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 81,601 تثبيت ⭐
...
329. **wrangler** — `cloudflare/skills/wrangler` · 81,592 تثبيت ⭐
...
330. **distill** — `pbakaus/impeccable/distill` · 81,417 تثبيت
...
331. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 81,299 تثبيت ⭐
...
332. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 80,811 تثبيت
...
333. **quieter** — `pbakaus/impeccable/quieter` · 80,584 تثبيت
...
334. **prototype** — `emilkowalski/skills/prototype` · 79,703 تثبيت
...
335. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 79,583 تثبيت ⭐
...
336. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 79,354 تثبيت
...
337. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 79,150 تثبيت ⭐
...
338. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 79,099 تثبيت ⭐
...
339. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 78,876 تثبيت
...
340. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 78,718 تثبيت ⭐
...
341. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 78,408 تثبيت ⭐
...
342. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,735 تثبيت
...
343. **wan-3-0-prime-reference-to-video** — `genmedia-labs/skills/wan-3-0-prime-reference-to-video` · 77,065 تثبيت
...
344. **seedance-2-5-image-to-video** — `genmedia-labs/skills/seedance-2-5-image-to-video` · 76,900 تثبيت
   Seedance 2.5 Image to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-image-to-video`

345. **seedance-2-5-reference-to-video** — `genmedia-labs/skills/seedance-2-5-reference-to-video` · 76,696 تثبيت
   Seedance 2.5 Reference to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-reference-to-video`

346. **remotion-render** — `remotion-dev/skills/remotion-render` · 76,538 تثبيت ⭐
   General rendering strategy
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-render`

347. **remotion-create** — `remotion-dev/skills/remotion-create` · 76,413 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

348. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 74,934 تثبيت ⭐
...
349. **web-search** — `skills-101/superpowers/web-search` · 74,752 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill web-search`

350. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 74,687 تثبيت ⭐
...
351. **wonda-cli** — `degausai/wonda/wonda-cli` · 74,605 تثبيت
...
352. **agent-tools** — `skills-101/superpowers/agent-tools` · 74,420 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill agent-tools`

353. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 74,407 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

354. **python-executor** — `skills-101/superpowers/python-executor` · 74,371 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

355. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 74,365 تثبيت ⭐
...
356. **css-animations** — `heygen-com/hyperframes/css-animations` · 74,288 تثبيت
...
357. **notion-api** — `intellectronica/agent-skills/notion-api` · 74,172 تثبيت
...
358. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 74,048 تثبيت
...
359. **lark-meeting** — `open.feishu.cn/lark-meeting` · 73,771 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/`

360. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 72,915 تثبيت
...
361. **retro** — `mattpocock/skills/retro` · 72,850 تثبيت
   The user has asked for a retrospective. You are suggesting improvements to the coding agent's environment to improve future runs.
   `npx skills add https://github.com/mattpocock/skills --skill retro`

362. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 72,812 تثبيت
...
363. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,458 تثبيت
...
364. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 72,320 تثبيت
...
365. **animejs** — `heygen-com/hyperframes/animejs` · 71,909 تثبيت
...
366. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 71,838 تثبيت ⭐
...
367. **internal-comms** — `anthropics/skills/internal-comms` · 71,406 تثبيت ⭐
...
368. **three** — `heygen-com/hyperframes/three` · 71,190 تثبيت
...
369. **lottie** — `heygen-com/hyperframes/lottie` · 70,923 تثبيت
...
370. **audit-website** — `squirrelscan/skills/audit-website` · 70,703 تثبيت
...
371. **waapi** — `heygen-com/hyperframes/waapi` · 70,551 تثبيت
...
372. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 70,124 تثبيت ⭐
...
373. **turborepo** — `vercel/turborepo/turborepo` · 70,085 تثبيت ⭐
...
374. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 69,735 تثبيت
...
375. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 69,727 تثبيت ⭐
...
376. **remotion-saas** — `remotion-dev/skills/remotion-saas` · 68,686 تثبيت ⭐
   One can build apps with Remotion.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-saas`

377. **gws-drive** — `googleworkspace/cli/gws-drive` · 68,199 تثبيت ⭐
...
378. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 68,090 تثبيت
...
379. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 68,069 تثبيت ⭐
...
380. **durable-objects** — `cloudflare/skills/durable-objects` · 67,809 تثبيت ⭐
...
381. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,757 تثبيت
...
382. **web-perf** — `cloudflare/skills/web-perf` · 67,721 تثبيت ⭐
...
383. **archify** — `tt-a1i/archify/archify` · 67,459 تثبيت
...
384. **defuddle** — `kepano/obsidian-skills/defuddle` · 67,448 تثبيت
...
385. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 67,347 تثبيت ⭐
...
386. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 67,190 تثبيت
...
387. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 67,165 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

388. **video** — `coreyhaines31/marketingskills/video` · 67,092 تثبيت
...
389. **image** — `coreyhaines31/marketingskills/image` · 67,000 تثبيت
...
390. **animate** — `emilkowalski/skills/animate` · 66,329 تثبيت
...
391. **typeset** — `pbakaus/impeccable/typeset` · 66,229 تثبيت
...
392. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 65,956 تثبيت
...
393. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 65,579 تثبيت ⭐
...
394. **agents-sdk** — `cloudflare/skills/agents-sdk` · 65,419 تثبيت ⭐
...
395. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 65,257 تثبيت ⭐
...
396. **cro** — `coreyhaines31/marketingskills/cro` · 64,718 تثبيت
   Conversion Rate Optimization (CRO)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill cro`

397. **batch-grill-me** — `mattpocock/skills/batch-grill-me` · 64,409 تثبيت
   Interview the user relentlessly until you reach a shared understanding. Map this as a design tree: every decision branches into the decisions that han
   `npx skills add https://github.com/mattpocock/skills --skill batch-grill-me`

398. **overdrive** — `pbakaus/impeccable/overdrive` · 64,301 تثبيت
   ──────────── ⚡ OVERDRIVE ─────────────
   `npx skills add https://github.com/pbakaus/impeccable --skill overdrive`

399. **template-skill** — `anthropics/skills/template-skill` · 64,215 تثبيت ⭐
   Replace with description of the skill and when Claude should use it.
   `npx skills add https://github.com/anthropics/skills --skill template-skill`

400. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 63,738 تثبيت ⭐
...
401. **claude-api** — `anthropics/skills/claude-api` · 63,737 تثبيت ⭐
...
402. **tailwind-design-system** — `wshobson/agents/tailwind-design-system` · 63,195 تثبيت
   CSS-first design system framework for Tailwind v4 with tokens, components, and responsive patterns.
   `npx skills add https://github.com/wshobson/agents --skill tailwind-design-system`

403. **stripe-projects** — `stripe/ai/stripe-projects` · 62,680 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

404. **developing-genkit-js** — `firebase/agent-skills/developing-genkit-js` · 62,585 تثبيت ⭐
...
405. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 62,568 تثبيت ⭐
...
406. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 62,529 تثبيت
...
407. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,447 تثبيت
   Cross-Border E-Commerce ✈️
   `npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill cross-border-ecommerce`

408. **developing-genkit-dart** — `firebase/agent-skills/developing-genkit-dart` · 62,270 تثبيت ⭐
...
409. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,905 تثبيت
...
410. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,903 تثبيت
...
411. **gpt-image-2** — `prime-skills/runcomfy-agent-skills/gpt-image-2` · 61,862 تثبيت
   GPT Image 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill gpt-image-2`

412. **social** — `coreyhaines31/marketingskills/social` · 61,329 تثبيت
...
413. **design-md** — `google-labs-code/stitch-skills/design-md` · 61,254 تثبيت ⭐
...
414. **analytics** — `coreyhaines31/marketingskills/analytics` · 61,187 تثبيت
...
415. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 60,861 تثبيت ⭐
...
416. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 60,581 تثبيت
...
417. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 59,956 تثبيت ⭐
...
418. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 59,889 تثبيت ⭐
...
419. **ads** — `coreyhaines31/marketingskills/ads` · 59,772 تثبيت
...
420. **gws-shared** — `googleworkspace/cli/gws-shared` · 59,656 تثبيت ⭐
...
421. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 59,632 تثبيت
...
422. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 59,587 تثبيت ⭐
...
423. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 59,576 تثبيت
...
424. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 59,481 تثبيت ⭐
...
425. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 59,376 تثبيت
   Cut the Curve — the technique catalog
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

426. **building-native-ui** — `expo/skills/building-native-ui` · 59,166 تثبيت ⭐
...
427. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 59,109 تثبيت
...
428. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 59,047 تثبيت ⭐
...
429. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 59,039 تثبيت
...
430. **oversized-cursor** — `heygen-com/hyperframes/oversized-cursor` · 58,999 تثبيت
   Oversized Cursor — the eye-carrier
   `npx skills add https://github.com/heygen-com/hyperframes --skill oversized-cursor`

431. **pricing** — `coreyhaines31/marketingskills/pricing` · 58,990 تثبيت
...
432. **review-loop** — `2dmurali/review-loop-skill/review-loop` · 58,951 تثبيت
...
433. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,513 تثبيت
...
434. **competitors** — `coreyhaines31/marketingskills/competitors` · 58,156 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

435. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,151 تثبيت
...
436. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,138 تثبيت
...
437. **agently-mail** — `agent.qq.com/agently-mail` · 58,071 تثبيت
   通过 agently-cli 命令行工具操作邮件，通过管理端 (agent.qq.com) 进行后台管理。
   `npx skills add https://agent.qq.com/`

438. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 58,057 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

439. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 57,979 تثبيت
...
440. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,642 تثبيت
...
441. **schema** — `coreyhaines31/marketingskills/schema` · 57,392 تثبيت
...
442. **expo-dev-client** — `expo/skills/expo-dev-client` · 57,092 تثبيت ⭐
...
443. **emails** — `coreyhaines31/marketingskills/emails` · 57,090 تثبيت
...
444. **launch** — `coreyhaines31/marketingskills/launch` · 57,075 تثبيت
...
445. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,721 تثبيت
...
446. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,663 تثبيت
...
447. **ab-testing** — `coreyhaines31/marketingskills/ab-testing` · 56,487 تثبيت
   You are an expert in experimentation and A/B testing. Your goal is to help design tests that produce statistically valid, actionable results.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill ab-testing`

448. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,398 تثبيت
...
449. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,160 تثبيت
...
450. **normalize** — `pbakaus/impeccable/normalize` · 55,807 تثبيت
...
451. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,766 تثبيت
...
452. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 55,542 تثبيت
...
453. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 55,523 تثبيت ⭐
...
454. **opentui** — `msmps/opentui-skill/opentui` · 55,355 تثبيت
...
455. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,319 تثبيت
...
456. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 55,303 تثبيت ⭐
...
457. **aso** — `coreyhaines31/marketingskills/aso` · 55,296 تثبيت
...
458. **nia** — `nozomio-labs/nia-skill/nia` · 55,173 تثبيت
...
459. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 55,173 تثبيت
...
460. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,814 تثبيت
...
461. **gsap-core** — `greensock/gsap-skills/gsap-core` · 54,801 تثبيت
...
462. **extract** — `pbakaus/impeccable/extract` · 54,725 تثبيت
...
463. **ponytail** — `dietrichgebert/ponytail/ponytail` · 54,621 تثبيت
   You are a lazy senior developer. Lazy means efficient, not careless. You have
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail`

464. **onboard** — `pbakaus/impeccable/onboard` · 54,562 تثبيت
...
465. **harden** — `pbakaus/impeccable/harden` · 54,489 تثبيت
...
466. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,290 تثبيت
...
467. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 54,281 تثبيت ⭐
...
468. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 54,201 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

469. **referrals** — `coreyhaines31/marketingskills/referrals` · 54,179 تثبيت
   Referral & Affiliate Programs
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill referrals`

470. **signup** — `coreyhaines31/marketingskills/signup` · 54,105 تثبيت
...
471. **ai-sdk** — `vercel/ai/ai-sdk` · 53,932 تثبيت ⭐
...
472. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 53,662 تثبيت ⭐
...
473. **popups** — `coreyhaines31/marketingskills/popups` · 53,608 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

474. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 53,555 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

475. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,204 تثبيت
...
476. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 52,964 تثبيت
...
477. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,904 تثبيت
...
478. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 52,902 تثبيت ⭐
...
479. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 52,751 تثبيت
...
480. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,727 تثبيت
...
481. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 52,722 تثبيت ⭐
...
482. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,462 تثبيت
...
483. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 52,420 تثبيت ⭐
...
484. **hallmark** — `nutlope/hallmark/hallmark` · 52,241 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

485. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 52,229 تثبيت ⭐
...
486. **gws-docs** — `googleworkspace/cli/gws-docs` · 52,222 تثبيت ⭐
...
487. **typegpu** — `heygen-com/hyperframes/typegpu` · 52,058 تثبيت
...
488. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,054 تثبيت
...
489. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,720 تثبيت
...
490. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 51,624 تثبيت
...
491. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,453 تثبيت
...
492. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 50,828 تثبيت ⭐
...
493. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 50,797 تثبيت
...
494. **react:components** — `google-labs-code/stitch-skills/react:components` · 50,670 تثبيت ⭐
   Stitch to React Components
   `npx skills add https://github.com/google-labs-code/stitch-skills --skill react:components`

495. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 50,574 تثبيت
...
496. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 50,112 تثبيت
...
497. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 50,092 تثبيت ⭐
...
498. **marketing-mindset** — `axelfreeman/marketing-mindset/marketing-mindset` · 49,784 تثبيت
...
499. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 49,655 تثبيت ⭐
...
500. **developing-genkit-go** — `firebase/agent-skills/developing-genkit-go` · 49,541 تثبيت ⭐
...
501. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 49,528 تثبيت
...
502. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 49,405 تثبيت ⭐
...
503. **momentic-test** — `momentic-ai/skills/momentic-test` · 49,202 تثبيت
...
504. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 49,181 تثبيت
...
505. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 49,056 تثبيت
...
506. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 49,009 تثبيت
...
507. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 48,520 تثبيت
...
508. **gsap-react** — `greensock/gsap-skills/gsap-react` · 48,497 تثبيت
...
509. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 47,931 تثبيت
...
510. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 47,754 تثبيت
...
511. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 47,659 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

512. **sms** — `coreyhaines31/marketingskills/sms` · 47,246 تثبيت
...
513. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,216 تثبيت ⭐
...
514. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 47,176 تثبيت
...
515. **compress** — `juliusbrussee/caveman/compress` · 46,807 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

516. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 46,439 تثبيت
...
517. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 46,324 تثبيت
...
518. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 46,284 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

519. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 46,268 تثبيت
...
520. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 45,901 تثبيت
...
521. **mastra** — `mastra-ai/skills/mastra` · 45,797 تثبيت ⭐
...
522. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 45,542 تثبيت
...
523. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 45,432 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

524. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 45,394 تثبيت
...
525. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 45,393 تثبيت
...
526. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 45,393 تثبيت
...
527. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 45,375 تثبيت
...
528. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 45,359 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

529. **higgsfield-youtube-thumbnail** — `higgsfield-ai/skills/higgsfield-youtube-thumbnail` · 45,353 تثبيت
   Higgsfield YouTube Thumbnail
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-youtube-thumbnail`

530. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 45,346 تثبيت ⭐
...
531. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 45,325 تثبيت
...
532. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 45,324 تثبيت
...
533. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 45,270 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

534. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 44,828 تثبيت
...
535. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,802 تثبيت
...
536. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 44,776 تثبيت ⭐
...
537. **git-commit** — `github/awesome-copilot/git-commit` · 44,606 تثبيت ⭐
...
538. **seo** — `addyosmani/web-quality-skills/seo` · 44,543 تثبيت
...
539. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 44,435 تثبيت ⭐
...
540. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 44,228 تثبيت
...
541. **herdr** — `herdrdev/herdr/herdr` · 44,227 تثبيت
...
542. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 44,090 تثبيت ⭐
...
543. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 43,290 تثبيت ⭐
...
544. **clerk-setup** — `clerk/skills/clerk-setup` · 43,169 تثبيت ⭐
...
545. **upgrading-expo** — `expo/skills/upgrading-expo` · 43,076 تثبيت ⭐
...
546. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 43,039 تثبيت
...
547. **byted-web-search** — `skills.volces.com/byted-web-search` · 42,743 تثبيت
...
548. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 42,466 تثبيت
...
549. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 42,307 تثبيت
...
550. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 41,977 تثبيت ⭐
...
551. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 41,911 تثبيت ⭐
...
552. **caveman-optimize** — `juliusbrussee/caveman/caveman-optimize` · 41,898 تثبيت
   Evaluate an optimization observation
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-optimize`

553. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 41,851 تثبيت
...
554. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 41,696 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

555. **gws-gmail-triage** — `googleworkspace/cli/gws-gmail-triage` · 41,639 تثبيت ⭐
...
556. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 41,621 تثبيت
...
557. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 41,600 تثبيت
...
558. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 41,491 تثبيت
...
559. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 41,474 تثبيت ⭐
...
560. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 41,413 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

561. **weread-skills** — `tencent/wechatreading/weread-skills` · 41,382 تثبيت
   通过 Agent API Gateway 调用微信读书接口，提供搜索、书架、笔记、书评等能力。
   `npx skills add https://github.com/tencent/wechatreading --skill weread-skills`

562. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 41,292 تثبيت
...
563. **lean-build** — `juliusbrussee/caveman/lean-build` · 41,211 تثبيت
...
564. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 41,209 تثبيت
...
568. **expo-deployment** — `expo/skills/expo-deployment` · 40,972 تثبيت ⭐
...
569. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 40,923 تثبيت
...
570. **clerk-backend-api** — `clerk/skills/clerk-backend-api` · 40,687 تثبيت ⭐
   CRITICAL: Mandatory checks before EVERY write request
   `npx skills add https://github.com/clerk/skills --skill clerk-backend-api`

571. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 40,653 تثبيت
...
572. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 40,474 تثبيت
...
573. **arrange** — `pbakaus/impeccable/arrange` · 40,176 تثبيت
...
574. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 39,952 تثبيت ⭐
...
575. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 39,906 تثبيت ⭐
...
576. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 39,877 تثبيت
...
577. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 39,813 تثبيت
...
578. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 39,785 تثبيت
...
579. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 39,730 تثبيت ⭐
...
580. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 39,573 تثبيت
...
581. **last30days** — `mvanhorn/last30days-skill/last30days` · 39,277 تثبيت
...
582. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 39,070 تثبيت
...
583. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 39,018 تثبيت
...
584. **remotion** — `google-labs-code/stitch-skills/remotion` · 39,017 تثبيت ⭐
...
585. **golang-security** — `samber/cc-skills-golang/golang-security` · 38,955 تثبيت
...
586. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 38,485 تثبيت
...
587. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 38,447 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

588. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 38,154 تثبيت
...
589. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 38,051 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

590. **clerk-orgs** — `clerk/skills/clerk-orgs` · 38,025 تثبيت ⭐
...
591. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 37,993 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

592. **golang-context** — `samber/cc-skills-golang/golang-context` · 37,971 تثبيت
...
593. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 37,970 تثبيت
...
594. **animate-expo** — `emilkowalski/skills/animate-expo` · 37,931 تثبيت
   Building Animations in Expo
   `npx skills add https://github.com/emilkowalski/skills --skill animate-expo`

595. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,893 تثبيت ⭐
...
596. **golang-database** — `samber/cc-skills-golang/golang-database` · 37,870 تثبيت
...
597. **gws-slides** — `googleworkspace/cli/gws-slides` · 37,864 تثبيت ⭐
...
598. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 37,808 تثبيت
...
599. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 37,738 تثبيت
...
600. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 37,716 تثبيت
...
601. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 37,687 تثبيت
...
602. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 37,626 تثبيت
...
603. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,610 تثبيت
...
604. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 37,525 تثبيت
...
605. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 37,472 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

606. **product-photography** — `skills-101/superpowers/product-photography` · 37,454 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

607. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 37,421 تثبيت ⭐
...
608. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 37,401 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

609. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 37,388 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

610. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 37,380 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

611. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 37,378 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

612. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 37,377 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

613. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 37,376 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

614. **offers** — `coreyhaines31/marketingskills/offers` · 37,373 تثبيت
...
615. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 37,368 تثبيت
...
616. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 37,361 تثبيت
...
617. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 37,238 تثبيت
...
618. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 37,206 تثبيت
...
619. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 37,176 تثبيت
...
620. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 37,144 تثبيت
...
621. **firebase-firestore-standard** — `firebase/agent-skills/firebase-firestore-standard` · 37,119 تثبيت ⭐
...
622. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 37,073 تثبيت
...
623. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 37,049 تثبيت
...
624. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 36,980 تثبيت
...
625. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 36,978 تثبيت
...
626. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 36,879 تثبيت
...
627. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 36,872 تثبيت
...
628. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 36,468 تثبيت
...
631. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 36,362 تثبيت
...
632. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 36,308 تثبيت
...
633. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 36,199 تثبيت
...
634. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 36,171 تثبيت
...
635. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 36,129 تثبيت
...
636. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 36,109 تثبيت
...
637. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 36,101 تثبيت
...
638. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 36,077 تثبيت
...
640. **gws-meet** — `googleworkspace/cli/gws-meet` · 35,899 تثبيت ⭐
...
641. **karpathy-guidelines** — `multica-ai/andrej-karpathy-skills/karpathy-guidelines` · 35,571 تثبيت
   Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   `npx skills add https://github.com/multica-ai/andrej-karpathy-skills --skill karpathy-guidelines`

642. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 35,561 تثبيت
...
643. **value** — `hugmouse/skills/value` · 35,528 تثبيت
   This skill does absolutely nothing.
   `npx skills add https://github.com/hugmouse/skills --skill value`

644. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 35,466 تثبيت
...
645. **vitest** — `antfu/skills/vitest` · 35,249 تثبيت
...
646. **replicas-agent** — `replicas-group/skill/replicas-agent` · 35,085 تثبيت
...
647. **vite** — `antfu/skills/vite` · 35,044 تثبيت
...
648. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 34,986 تثبيت
...
649. **wind-find-finance-skill** — `wind-alice/alicemarket/wind-find-finance-skill` · 34,975 تثبيت
...
650. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 34,923 تثبيت
...
651. **angular-developer** — `angular/skills/angular-developer` · 34,853 تثبيت
...
652. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 34,836 تثبيت
...
653. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 34,831 تثبيت
...
654. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 34,777 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

655. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 34,680 تثبيت
...
656. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 34,674 تثبيت
...
657. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 34,608 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

658. **firebase-ai-logic** — `firebase/agent-skills/firebase-ai-logic` · 34,582 تثبيت ⭐
...
659. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 34,562 تثبيت
...
660. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 34,500 تثبيت
...
661. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 34,457 تثبيت
...
662. **expo-module** — `expo/skills/expo-module` · 34,220 تثبيت ⭐
...
663. **performance** — `addyosmani/web-quality-skills/performance` · 34,079 تثبيت
...
664. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 33,985 تثبيت ⭐
...
665. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 33,857 تثبيت
...
666. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 33,851 تثبيت
...
667. **gws-keep** — `googleworkspace/cli/gws-keep` · 33,848 تثبيت ⭐
...
668. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 33,830 تثبيت ⭐
...
669. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 33,818 تثبيت ⭐
...
670. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,639 تثبيت ⭐
...
671. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 33,578 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

672. **self-improving-agent** — `zhaono1/agent-playbook/self-improving-agent` · 33,548 تثبيت
...
673. **sandbox-sdk** — `cloudflare/skills/sandbox-sdk` · 33,530 تثبيت ⭐
   Build secure, isolated code execution environments on Cloudflare Workers.
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-sdk`

674. **vue** — `antfu/skills/vue` · 33,429 تثبيت
...
675. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 33,423 تثبيت
...
676. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 33,245 تثبيت
...
677. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 32,996 تثبيت
...
678. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 32,969 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

679. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,862 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

680. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 32,811 تثبيت ⭐
...
681. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 32,791 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

682. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 32,713 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

683. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,599 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

684. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,563 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

685. **improve** — `shadcn/improve/improve` · 32,534 تثبيت
...
686. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,497 تثبيت
...
687. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 32,194 تثبيت
...
688. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 32,108 تثبيت
...
689. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 32,090 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

690. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 32,078 تثبيت
...
691. **ckm:brand** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:brand` · 32,063 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

692. **ckm:banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:banner-design` · 32,035 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

693. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 31,994 تثبيت ⭐
...
694. **ckm:slides** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:slides` · 31,946 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

695. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 31,894 تثبيت ⭐
...
696. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 31,862 تثبيت ⭐
...
697. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 31,773 تثبيت
...
698. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 31,723 تثبيت ⭐
...
699. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,638 تثبيت ⭐
...
700. **tavily-search** — `tavily-ai/skills/tavily-search` · 31,593 تثبيت ⭐
...
701. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 31,465 تثبيت ⭐
...
702. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 31,453 تثبيت ⭐
...
703. **baoyu-infographic** — `jimliu/baoyu-skills/baoyu-infographic` · 31,438 تثبيت
...
704. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 31,343 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

705. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,340 تثبيت ⭐
...
706. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 31,249 تثبيت ⭐
...
707. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 31,207 تثبيت ⭐
...
708. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 31,198 تثبيت
...
709. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 31,179 تثبيت ⭐
...
710. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 31,178 تثبيت ⭐
...
711. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 31,173 تثبيت ⭐
...
712. **write-swift** — `emilkowalski/skills/write-swift` · 31,162 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/emilkowalski/skills --skill write-swift`

713. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 31,133 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

714. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 31,107 تثبيت ⭐
...
715. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 31,086 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

716. **swiftui-expert-skill** — `avdlee/swiftui-agent-skill/swiftui-expert-skill` · 31,035 تثبيت
   Expert SwiftUI code review, refactoring, and implementation guidance with iOS 26+ and macOS support.
   `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill swiftui-expert-skill`

717. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 30,964 تثبيت ⭐
...
718. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 30,961 تثبيت
...
719. **use-dom** — `expo/skills/use-dom` · 30,949 تثبيت ⭐
...
720. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 30,840 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

721. **shape** — `pbakaus/impeccable/shape` · 30,837 تثبيت
...
722. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 30,833 تثبيت
...
723. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 30,764 تثبيت
...
724. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 30,699 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

725. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 30,610 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

726. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 30,598 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

727. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 30,540 تثبيت ⭐
...
728. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 30,524 تثبيت ⭐
...
729. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 30,336 تثبيت ⭐
...
730. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 30,280 تثبيت
...
731. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 30,245 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

732. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 29,999 تثبيت
...
733. **gws-chat** — `googleworkspace/cli/gws-chat` · 29,980 تثبيت ⭐
...
734. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 29,917 تثبيت
...
735. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,886 تثبيت ⭐
...
736. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 29,848 تثبيت ⭐
...
737. **gws-people** — `googleworkspace/cli/gws-people` · 29,820 تثبيت ⭐
...
738. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 29,795 تثبيت ⭐
...
739. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 29,788 تثبيت ⭐
...
740. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,776 تثبيت
...
741. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 29,642 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

742. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 29,615 تثبيت
...
743. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 29,603 تثبيت
...
744. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 29,597 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

745. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 29,568 تثبيت
...
746. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 29,515 تثبيت ⭐
...
747. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 29,485 تثبيت ⭐
...
748. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 29,406 تثبيت
...
749. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 29,350 تثبيت
...
750. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 29,294 تثبيت
...
751. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 29,225 تثبيت ⭐
...
752. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 29,179 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

753. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 28,890 تثبيت
...
754. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 28,878 تثبيت ⭐
...
758. **recipe-draft-email-from-doc** — `googleworkspace/cli/recipe-draft-email-from-doc` · 28,729 تثبيت ⭐
...
759. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 28,679 تثبيت ⭐
...
760. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 28,629 تثبيت ⭐
...
761. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 28,620 تثبيت ⭐
...
762. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 28,618 تثبيت ⭐
...
763. **gws-events** — `googleworkspace/cli/gws-events` · 28,513 تثبيت ⭐
...
764. **sandbox-next** — `cloudflare/skills/sandbox-next` · 28,477 تثبيت ⭐
   Sandbox SDK — @next (1.0 preview)
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-next`

765. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 28,445 تثبيت ⭐
...
766. **sandbox-migrate-to-next** — `cloudflare/skills/sandbox-migrate-to-next` · 28,427 تثبيت ⭐
...
767. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 28,268 تثبيت ⭐
...
768. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 28,259 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

769. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 28,212 تثبيت ⭐
...
770. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 28,173 تثبيت ⭐
...
771. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 28,136 تثبيت ⭐
...
772. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 28,083 تثبيت
...
773. **eas-update-insights** — `expo/skills/eas-update-insights` · 28,072 تثبيت ⭐
...
774. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 28,070 تثبيت ⭐
...
775. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 28,004 تثبيت
...
776. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 28,002 تثبيت ⭐
...
777. **api-design-principles** — `wshobson/agents/api-design-principles` · 27,986 تثبيت
...
778. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 27,929 تثبيت ⭐
...
779. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 27,897 تثبيت ⭐
...
780. **interview-me** — `addyosmani/agent-skills/interview-me` · 27,879 تثبيت
...
781. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 27,879 تثبيت ⭐
...
782. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 27,878 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

783. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 27,872 تثبيت ⭐
...
784. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 27,865 تثبيت ⭐
...
785. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 27,864 تثبيت ⭐
...
786. **azure-postgres** — `microsoft/azure-skills/azure-postgres` · 27,851 تثبيت ⭐
   No SKILL.md available for this skill.
   `npx skills add https://github.com/microsoft/azure-skills --skill azure-postgres`

787. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 27,850 تثبيت ⭐
...
788. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 27,769 تثبيت ⭐
...
789. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 27,724 تثبيت ⭐
...
790. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 27,671 تثبيت ⭐
...
791. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 27,660 تثبيت
...
792. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 27,600 تثبيت ⭐
...
793. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 27,573 تثبيت ⭐
...
794. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 27,564 تثبيت ⭐
...
795. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 27,536 تثبيت ⭐
...
796. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 27,518 تثبيت ⭐
...
797. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 27,506 تثبيت ⭐
...
798. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 27,495 تثبيت ⭐
...
799. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 27,480 تثبيت ⭐
...
800. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 27,409 تثبيت ⭐
...
801. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 27,394 تثبيت ⭐
...
802. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 27,387 تثبيت ⭐
...
803. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 27,384 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

804. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 27,322 تثبيت ⭐
...
805. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 27,318 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

806. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 27,292 تثبيت ⭐
...
807. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 27,275 تثبيت ⭐
...
808. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 27,255 تثبيت
...
809. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 27,247 تثبيت ⭐
...
810. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 27,215 تثبيت ⭐
...
811. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 27,178 تثبيت ⭐
...
812. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 27,168 تثبيت ⭐
...
813. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 27,158 تثبيت ⭐
...
814. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 27,153 تثبيت
...
815. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 27,147 تثبيت ⭐
...
816. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 27,144 تثبيت ⭐
...
817. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 27,130 تثبيت
...
818. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 27,128 تثبيت ⭐
...
819. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 27,089 تثبيت ⭐
...
820. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 27,086 تثبيت ⭐
...
821. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 27,082 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

822. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 27,072 تثبيت
...
823. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 27,070 تثبيت
...
824. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 27,065 تثبيت ⭐
...
825. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 27,065 تثبيت
...
826. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 27,053 تثبيت ⭐
...
827. **design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/design-system` · 27,033 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

828. **layout** — `pbakaus/impeccable/layout` · 27,033 تثبيت
...
829. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 27,016 تثبيت ⭐
...
830. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 26,951 تثبيت ⭐
...
831. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 26,946 تثبيت ⭐
...
832. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 26,877 تثبيت ⭐
...
833. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 26,825 تثبيت
...
834. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 26,803 تثبيت ⭐
...
835. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 26,737 تثبيت ⭐
...
836. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 26,711 تثبيت ⭐
...
837. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,693 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

838. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 26,659 تثبيت ⭐
...
839. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 26,632 تثبيت ⭐
...
840. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 26,567 تثبيت ⭐
...
842. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 26,241 تثبيت ⭐
...
843. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 26,148 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

844. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,098 تثبيت
...
845. **interface-design** — `dammyjay93/interface-design/interface-design` · 26,077 تثبيت
...
846. **clerk** — `clerk/skills/clerk` · 25,983 تثبيت ⭐
...
847. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 25,837 تثبيت
...
848. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 25,786 تثبيت
...
849. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 25,726 تثبيت
...
850. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 25,679 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

851. **build-tam** — `code.deepline.com/build-tam` · 25,658 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

852. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 25,568 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

853. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 25,558 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

854. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 25,551 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

855. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 25,524 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

856. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 25,524 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

857. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,473 تثبيت ⭐
...
858. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 25,449 تثبيت
...
859. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 25,422 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

860. **stripe-directory** — `docs.stripe.com/stripe-directory` · 25,417 تثبيت
...
861. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 25,321 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

862. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 25,251 تثبيت ⭐
...
863. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 25,160 تثبيت
...
864. **review-pr** — `warpdotdev/common-skills/review-pr` · 25,041 تثبيت
...
865. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 25,041 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

866. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 25,028 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

867. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 24,954 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

868. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 24,940 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

869. **dbs** — `dontbesilent2025/dbskill/dbs` · 24,892 تثبيت
   你是 dontbesilent 商业工具箱的公开入口。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs`

870. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 24,873 تثبيت
...
871. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 24,804 تثبيت
...
872. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 24,771 تثبيت
...
873. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 24,750 تثبيت
...
874. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 24,718 تثبيت
...
875. **create-pr** — `warpdotdev/common-skills/create-pr` · 24,692 تثبيت
...
876. **update-skill** — `warpdotdev/common-skills/update-skill` · 24,665 تثبيت
...
877. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 24,651 تثبيت
...
878. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 24,591 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

879. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 24,493 تثبيت
...
880. **release-skills** — `jimliu/baoyu-skills/release-skills` · 24,459 تثبيت
...
881. **brandalf** — `warpdotdev/common-skills/brandalf` · 24,396 تثبيت
...
882. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 24,367 تثبيت ⭐
...
883. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 24,356 تثبيت
...
884. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 24,330 تثبيت
...
885. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 24,297 تثبيت
...
886. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 24,192 تثبيت
...
887. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 24,127 تثبيت
...
888. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 24,054 تثبيت
...
889. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 23,991 تثبيت
...
890. **council** — `warpdotdev/common-skills/council` · 23,799 تثبيت
...
891. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 23,711 تثبيت ⭐
...
892. **clerk-cli** — `clerk/skills/clerk-cli` · 23,697 تثبيت ⭐
...
893. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 23,471 تثبيت
...
894. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 23,265 تثبيت
...
898. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 23,044 تثبيت
...
899. **prd** — `github/awesome-copilot/prd` · 22,928 تثبيت ⭐
...
900. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 22,873 تثبيت ⭐
...
901. **gstack** — `garrytan/gstack/gstack` · 22,761 تثبيت
...
903. **nuxt** — `antfu/skills/nuxt` · 22,437 تثبيت
...
904. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 22,278 تثبيت
...
905. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 22,152 تثبيت
...
906. **ponytail-review** — `dietrichgebert/ponytail/ponytail-review` · 22,085 تثبيت
   Review diffs for unnecessary complexity. One line per finding: location, what
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-review`

907. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 21,972 تثبيت
...
908. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,919 تثبيت ⭐
...
909. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 21,909 تثبيت
...
910. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 21,886 تثبيت
...
911. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 21,658 تثبيت
...
912. **refactor** — `github/awesome-copilot/refactor` · 21,638 تثبيت ⭐
   Surgical code refactoring to improve maintainability without changing behavior.
   `npx skills add https://github.com/github/awesome-copilot --skill refactor`

913. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 21,514 تثبيت
...
914. **laravel-specialist** — `jeffallan/claude-skills/laravel-specialist` · 21,507 تثبيت
...
915. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 21,399 تثبيت
...
920. **vueuse-functions** — `antfu/skills/vueuse-functions` · 21,105 تثبيت
...
921. **dbs-agent-migration** — `dontbesilent2025/dbskill/dbs-agent-migration` · 21,026 تثبيت
   dbs-agent-migration：Agent 工作台迁移
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-agent-migration`

922. **skill-vetter** — `useai-pro/openclaw-skills-security/skill-vetter` · 20,958 تثبيت
...
923. **error-handling-patterns** — `wshobson/agents/error-handling-patterns` · 20,934 تثبيت
...
924. **mediabunny** — `remotion-dev/skills/mediabunny` · 20,927 تثبيت ⭐
   Mediabunny is a multimedia library for dealing with audio and video in the browser.
   `npx skills add https://github.com/remotion-dev/skills --skill mediabunny`

925. **baoyu-post-to-weibo** — `jimliu/baoyu-skills/baoyu-post-to-weibo` · 20,727 تثبيت
...
926. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 20,725 تثبيت ⭐
...
927. **ponytail-audit** — `dietrichgebert/ponytail/ponytail-audit` · 20,633 تثبيت
   ponytail-review, repo-wide. Scan the whole tree instead of a diff. Rank
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-audit`

928. **wecomcli-doc** — `wecomteam/wecom-cli/wecomcli-doc` · 20,507 تثبيت
...
929. **pnpm** — `antfu/skills/pnpm` · 20,451 تثبيت
...
930. **firestore-security-rules-auditor** — `firebase/agent-skills/firestore-security-rules-auditor` · 20,414 تثبيت ⭐
...
931. **wecomcli-todo** — `wecomteam/wecom-cli/wecomcli-todo` · 20,307 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-todo`

932. **wecomcli-contact** — `wecomteam/wecom-cli/wecomcli-contact` · 20,264 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-contact`

933. **wecomcli-meeting** — `wecomteam/wecom-cli/wecomcli-meeting` · 20,216 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-meeting`

934. **gemini-api-dev** — `google-gemini/gemini-skills/gemini-api-dev` · 20,213 تثبيت ⭐
...
935. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 20,191 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

936. **python-design-patterns** — `wshobson/agents/python-design-patterns` · 20,188 تثبيت
...
937. **baoyu-youtube-transcript** — `jimliu/baoyu-skills/baoyu-youtube-transcript` · 20,040 تثبيت
...
938. **java-springboot** — `github/awesome-copilot/java-springboot` · 19,991 تثبيت ⭐
...
939. **modern-web-guidance** — `googlechrome/modern-web-guidance/modern-web-guidance` · 19,966 تثبيت
   A skill to search for specific web development use cases and retrieve their corresponding best practice guides.
   `npx skills add https://github.com/googlechrome/modern-web-guidance --skill modern-web-guidance`

940. **dbs-report** — `dontbesilent2025/dbskill/dbs-report` · 19,930 تثبيت
...
941. **dbs-save** — `dontbesilent2025/dbskill/dbs-save` · 19,906 تثبيت
...
942. **dbs-restore** — `dontbesilent2025/dbskill/dbs-restore` · 19,896 تثبيت
...
943. **expo-ui** — `expo/skills/expo-ui` · 19,769 تثبيت ⭐
...
944. **dbs-goal** — `dontbesilent2025/dbskill/dbs-goal` · 19,727 تثبيت
...
945. **opencli-usage** — `jackwener/opencli/opencli-usage` · 19,632 تثبيت
...
946. **html-ppt** — `lewislulu/html-ppt-skill/html-ppt` · 19,423 تثبيت
   html-ppt — HTML PPT Studio
   `npx skills add https://github.com/lewislulu/html-ppt-skill --skill html-ppt`

947. **security-requirement-extraction** — `wshobson/agents/security-requirement-extraction` · 19,398 تثبيت
   Transform threat analysis into actionable security requirements.
   `npx skills add https://github.com/wshobson/agents --skill security-requirement-extraction`

948. **pricewin-hotel-deal-finder** — `price-win/pricewin-skills-hub/pricewin-hotel-deal-finder` · 19,389 تثبيت
   PriceWin Hotel Deal Finder
   `npx skills add https://github.com/price-win/pricewin-skills-hub --skill pricewin-hotel-deal-finder`

949. **dbs-slowisfast** — `dontbesilent2025/dbskill/dbs-slowisfast` · 19,325 تثبيت
...
950. **convex-auth** — `get-convex/agent-skills/convex-auth` · 19,315 تثبيت
...
951. **convex-expert** — `get-convex/agent-skills/convex-expert` · 19,283 تثبيت
...
952. **baseline-ui** — `ibelick/ui-skills/baseline-ui` · 19,283 تثبيت
...
960. **ponytail-debt** — `dietrichgebert/ponytail/ponytail-debt` · 19,196 تثبيت
   Every deliberate ponytail shortcut is marked with a ponytail: comment naming
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-debt`

961. **convex-design** — `get-convex/agent-skills/convex-design` · 19,191 تثبيت
...
962. **convex-deploy-guard** — `get-convex/agent-skills/convex-deploy-guard` · 19,168 تثبيت
...
963. **convex-env** — `get-convex/agent-skills/convex-env` · 19,162 تثبيت
...
964. **convex-crons** — `get-convex/agent-skills/convex-crons` · 19,152 تثبيت
   Add scheduled jobs (crons)
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-crons`

965. **convex-advisor** — `get-convex/agent-skills/convex-advisor` · 19,152 تثبيت
...
966. **convex-add** — `get-convex/agent-skills/convex-add` · 19,141 تثبيت
...
967. **convex-agent** — `get-convex/agent-skills/convex-agent` · 19,137 تثبيت
   Add an AI agent / RAG backend
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-agent`

968. **convex-migrate-rehearse** — `get-convex/agent-skills/convex-migrate-rehearse` · 19,132 تثبيت
...
969. **convex-cost** — `get-convex/agent-skills/convex-cost` · 19,123 تثبيت
   Preview what this app will cost
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-cost`

970. **convex-insights** — `get-convex/agent-skills/convex-insights` · 19,122 تثبيت
   Query logs + health in natural language
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-insights`

971. **find-qualified-titles** — `code.deepline.com/find-qualified-titles` · 18,868 تثبيت
   Find Qualified Titles (company_titles -> ICP filter -> contacts)
   `npx skills add https://code.deepline.com/`

972. **modern-javascript-patterns** — `wshobson/agents/modern-javascript-patterns` · 18,806 تثبيت
...
973. **expo-brownfield** — `expo/skills/expo-brownfield` · 18,753 تثبيت ⭐
...
978. **extension-email-verification** — `caffeinelabs/skills/extension-email-verification` · 18,653 تثبيت
...
979. **extension-object-storage** — `caffeinelabs/skills/extension-object-storage` · 18,652 تثبيت
...
980. **javascript-testing-patterns** — `wshobson/agents/javascript-testing-patterns` · 18,479 تثبيت
...
981. **feature-sliced-design** — `feature-sliced/skills/feature-sliced-design` · 18,458 تثبيت
   Feature-Sliced Design (FSD) v2.1
   `npx skills add https://github.com/feature-sliced/skills --skill feature-sliced-design`

982. **extension-email** — `caffeinelabs/skills/extension-email` · 18,415 تثبيت
   Email — Service/Transactional
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-email`

983. **extension-http-outcalls** — `caffeinelabs/skills/extension-http-outcalls` · 18,411 تثبيت
   HTTP outcalls extension for Caffeine AI.
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-http-outcalls`

984. **extension-authorization** — `caffeinelabs/skills/extension-authorization` · 18,411 تثبيت
...
985. **opencli-browser** — `jackwener/opencli/opencli-browser` · 18,408 تثبيت
...
986. **extension-invite-links** — `caffeinelabs/skills/extension-invite-links` · 18,408 تثبيت
...
987. **extension-core-infrastructure** — `caffeinelabs/skills/extension-core-infrastructure` · 18,406 تثبيت
...
988. **vue-router-best-practices** — `antfu/skills/vue-router-best-practices` · 18,329 تثبيت
...
993. **extension-posting-to-x** — `caffeinelabs/skills/extension-posting-to-x` · 18,153 تثبيت
...
994. **aso-audit** — `coreyhaines31/marketingskills/aso-audit` · 18,009 تثبيت
...
995. **create-readme** — `github/awesome-copilot/create-readme` · 17,955 تثبيت ⭐
...
996. **rust-async-patterns** — `wshobson/agents/rust-async-patterns` · 17,904 تثبيت
...
997. **playwright-generate-test** — `github/awesome-copilot/playwright-generate-test` · 17,869 تثبيت ⭐
...
998. **agent development** — `anthropics/claude-code/agent-development` · 17,722 تثبيت ⭐
   Agent Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Agent Development&#x27;`

999. **skill development** — `anthropics/claude-code/skill-development` · 17,528 تثبيت ⭐
   Skill Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Skill Development&#x27;`

1000. **pinia** — `antfu/skills/pinia` · 17,407 تثبيت
...
1001. **sql-optimization-patterns** — `wshobson/agents/sql-optimization-patterns` · 17,389 تثبيت
...
1002. **planning-with-files-zh** — `othmanadi/planning-with-files/planning-with-files-zh` · 17,220 تثبيت
...
1003. **fixing-accessibility** — `ibelick/ui-skills/fixing-accessibility` · 17,204 تثبيت
...
1004. **the-news** — `sfkislev/the-news/the-news` · 17,165 تثبيت
...
1005. **golang-pro** — `jeffallan/claude-skills/golang-pro` · 17,124 تثبيت
