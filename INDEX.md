...
**آخر تحديث:** 2026-09-21 · **العدد:** 1,022 مهارة

> للوكلاء: ابحث هنا أولًا بكلمة مفتاحية، ثم اقرأ البطاقة الكاملة من `abbas-skills.md`.

---

1. **find-skills** — `vercel-labs/skills/find-skills` · 3,490,051 تثبيت ⭐
   Discover and install specialized agent skills from the open ecosystem when users need extended capabilities.
   `npx skills add https://github.com/vercel-labs/skills --skill find-skills`

2. **grill-me** — `mattpocock/skills/grill-me` · 1,186,416 تثبيت
   Relentless interviewing skill that stress-tests plans and designs through systematic questioning.
   `npx skills add https://github.com/mattpocock/skills --skill grill-me`

3. **grill-with-docs** — `mattpocock/skills/grill-with-docs` · 1,013,224 تثبيت
...
4. **improve-codebase-architecture** — `mattpocock/skills/improve-codebase-architecture` · 964,731 تثبيت
...
7. **agent-browser** — `vercel-labs/agent-browser/agent-browser` · 894,354 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/vercel-labs/agent-browser --skill agent-browser`

8. **setup-matt-pocock-skills** — `mattpocock/skills/setup-matt-pocock-skills` · 865,365 تثبيت
...
9. **handoff** — `mattpocock/skills/handoff` · 839,291 تثبيت
...
10. **triage** — `mattpocock/skills/triage` · 816,048 تثبيت
...
11. **prototype** — `mattpocock/skills/prototype` · 812,675 تثبيت
...
12. **grilling** — `mattpocock/skills/grilling` · 741,328 تثبيت
...
13. **vercel-react-best-practices** — `vercel-labs/agent-skills/vercel-react-best-practices` · 729,584 تثبيت ⭐
   React and Next.js performance optimization across 70 rules prioritized by impact.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-react-best-practices`

14. **lark-doc** — `open.feishu.cn/lark-doc` · 713,852 تثبيت
...
15. **lark-base** — `open.feishu.cn/lark-base` · 713,609 تثبيت
...
16. **lark-drive** — `open.feishu.cn/lark-drive` · 713,447 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

17. **lark-shared** — `open.feishu.cn/lark-shared` · 713,063 تثبيت
   所有 lark-* skill 共享的底座：身份、认证、输出契约与高风险操作。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

18. **lark-im** — `open.feishu.cn/lark-im` · 712,869 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

19. **lark-approval** — `open.feishu.cn/lark-approval` · 712,845 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

20. **lark-calendar** — `open.feishu.cn/lark-calendar` · 712,705 تثبيت
   开始前先读 ../lark-shared/SKILL.md（认证、权限处理）。
   `npx skills add https://open.feishu.cn/`

21. **lark-sheets** — `open.feishu.cn/lark-sheets` · 712,455 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理。
   `npx skills add https://open.feishu.cn/`

22. **lark-wiki** — `open.feishu.cn/lark-wiki` · 712,226 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

23. **lark-contact** — `open.feishu.cn/lark-contact` · 711,997 تثبيت
   user 身份和 bot 身份是两条完全独立的路径。先确定当前身份,再按下表选命令:
   `npx skills add https://open.feishu.cn/`

24. **lark-minutes** — `open.feishu.cn/lark-minutes` · 711,753 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

25. **lark-slides** — `open.feishu.cn/lark-slides` · 711,739 تثبيت
   本技能文档较长，务必使用 Read 工具阅读两次，必须阅读完整全文。
   `npx skills add https://open.feishu.cn/`

26. **lark-mail** — `open.feishu.cn/lark-mail` · 711,709 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、身份切换、权限处理和 _notice 处理。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

27. **lark-task** — `open.feishu.cn/lark-task` · 711,699 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

28. **lark-event** — `open.feishu.cn/lark-event` · 711,636 تثبيت
...
29. **lark-whiteboard** — `open.feishu.cn/lark-whiteboard` · 711,614 تثبيت
   运行 lark-cli --version，确认可用，无需询问用户。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

30. **lark-attendance** — `open.feishu.cn/lark-attendance` · 711,475 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

31. **lark-openapi-explorer** — `open.feishu.cn/lark-openapi-explorer` · 711,423 تثبيت
   前置条件： 先阅读 ../lark-shared/SKILL.md 了解认证、身份切换和安全规则。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

32. **lark-skill-maker** — `open.feishu.cn/lark-skill-maker` · 711,084 تثبيت
   基于 lark-cli 创建新 Skill。Skill = 一份 SKILL.md，教 AI 用 CLI 命令完成任务。
   `npx skills add https://open.feishu.cn/`

33. **lark-vc** — `open.feishu.cn/lark-vc` · 711,081 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

34. **lark-workflow-meeting-summary** — `open.feishu.cn/lark-workflow-meeting-summary` · 710,950 تثبيت
...
35. **lark-workflow-standup-report** — `open.feishu.cn/lark-workflow-standup-report` · 710,771 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

36. **lark-okr** — `open.feishu.cn/lark-okr` · 692,228 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`
...
38. **teach** — `mattpocock/skills/teach` · 685,229 تثبيت
   The user has asked you to teach them something. This is a stateful request - they intend to learn the topic over multiple sessions.
   `npx skills add https://github.com/mattpocock/skills --skill teach`

39. **lark-markdown** — `open.feishu.cn/lark-markdown` · 677,691 تثبيت
   CRITICAL — 开始前 MUST 先用 Read 工具读取 ../lark-shared/SKILL.md，其中包含认证、权限处理
   `npx skills add https://open.feishu.cn/`

40. **domain-modeling** — `mattpocock/skills/domain-modeling` · 669,793 تثبيت
...
41. **lark-vc-agent** — `open.feishu.cn/lark-vc-agent` · 655,660 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

42. **web-design-guidelines** — `vercel-labs/agent-skills/web-design-guidelines` · 651,790 تثبيت ⭐
   Audit UI code against Vercel's Web Interface Guidelines for design and accessibility compliance.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill web-design-guidelines`

43. **codebase-design** — `mattpocock/skills/codebase-design` · 648,900 تثبيت
...
44. **diagnosing-bugs** — `mattpocock/skills/diagnosing-bugs` · 636,469 تثبيت
   A discipline for hard bugs. Skip phases only when explicitly justified.
   `npx skills add https://github.com/mattpocock/skills --skill diagnosing-bugs`

45. **hyperframes-cli** — `heygen-com/hyperframes/hyperframes-cli` · 626,890 تثبيت
...
46. **lark-apps** — `open.feishu.cn/lark-apps` · 622,222 تثبيت
...
47. **microsoft-foundry** — `microsoft/azure-skills/microsoft-foundry` · 600,589 تثبيت ⭐
   End-to-end deployment, evaluation, and management of AI agents on Microsoft Foundry.
   `npx skills add https://github.com/microsoft/azure-skills --skill microsoft-foundry`

48. **hyperframes** — `heygen-com/hyperframes/hyperframes` · 597,454 تثبيت
...
49. **ai-video-generation** — `skills-101/superpowers/ai-video-generation` · 593,457 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-video-generation`

50. **ai-image-generation** — `skills-101/superpowers/ai-image-generation` · 592,739 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-image-generation`

51. **ai-avatar-video** — `skills-101/superpowers/ai-avatar-video` · 592,601 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill ai-avatar-video`

52. **twitter-automation** — `skills-101/superpowers/twitter-automation` · 592,485 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill twitter-automation`

53. **azure-diagnostics** — `microsoft/azure-skills/azure-diagnostics` · 591,668 تثبيت ⭐
...
54. **azure-prepare** — `microsoft/azure-skills/azure-prepare` · 591,233 تثبيت ⭐
...
55. **azure-ai** — `microsoft/azure-skills/azure-ai` · 591,004 تثبيت ⭐
...
56. **azure-deploy** — `microsoft/azure-skills/azure-deploy` · 590,920 تثبيت ⭐
...
57. **azure-validate** — `microsoft/azure-skills/azure-validate` · 590,364 تثبيت ⭐
...
58. **azure-storage** — `microsoft/azure-skills/azure-storage` · 589,824 تثبيت ⭐
...
59. **entra-app-registration** — `microsoft/azure-skills/entra-app-registration` · 589,568 تثبيت ⭐
...
60. **azure-compliance** — `microsoft/azure-skills/azure-compliance` · 589,384 تثبيت ⭐
...
61. **appinsights-instrumentation** — `microsoft/azure-skills/appinsights-instrumentation` · 589,313 تثبيت ⭐
...
62. **azure-resource-visualizer** — `microsoft/azure-skills/azure-resource-visualizer` · 589,237 تثبيت ⭐
...
63. **azure-resource-lookup** — `microsoft/azure-skills/azure-resource-lookup` · 589,228 تثبيت ⭐
...
64. **azure-aigateway** — `microsoft/azure-skills/azure-aigateway` · 588,982 تثبيت ⭐
...
65. **azure-kusto** — `microsoft/azure-skills/azure-kusto` · 588,900 تثبيت ⭐
...
70. **image-to-video** — `genmedia-labs/skills/image-to-video` · 587,159 تثبيت
   Image-to-Video — Pro Pack on RunComfy
   `npx skills add https://github.com/genmedia-labs/skills --skill image-to-video`

71. **code-review** — `mattpocock/skills/code-review` · 587,116 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill code-review`

72. **azure-messaging** — `microsoft/azure-skills/azure-messaging` · 578,615 تثبيت ⭐
...
73. **reddit-automation** — `flowkit-labs/skills/reddit-automation` · 556,105 تثبيت
   Built by the team at doany.ai.
   `npx skills add https://github.com/flowkit-labs/skills --skill reddit-automation`

74. **hyperframes-registry** — `heygen-com/hyperframes/hyperframes-registry` · 541,596 تثبيت
...
75. **wayfinder** — `mattpocock/skills/wayfinder` · 541,040 تثبيت
...
76. **to-spec** — `mattpocock/skills/to-spec` · 535,996 تثبيت
...
77. **research** — `mattpocock/skills/research` · 535,768 تثبيت
   Spin up a background agent to do the research, so you keep working while it reads.
   `npx skills add https://github.com/mattpocock/skills --skill research`

78. **remotion-best-practices** — `remotion-dev/skills/remotion-best-practices` · 533,526 تثبيت ⭐
   Domain-specific knowledge base for building videos with Remotion and React.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices`

79. **azure-compute** — `microsoft/azure-skills/azure-compute` · 532,582 تثبيت ⭐
...
80. **to-tickets** — `mattpocock/skills/to-tickets` · 526,405 تثبيت
   Break a plan, spec, or conversation into a set of tickets: tracer-bullet vertical slices, each declaring the tickets that block it.
   `npx skills add https://github.com/mattpocock/skills --skill to-tickets`

81. **caveman** — `juliusbrussee/caveman/caveman` · 525,247 تثبيت
   Ultra-compressed communication mode cutting token usage ~75% while preserving technical accuracy.
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman`

82. **azure-cloud-migrate** — `microsoft/azure-skills/azure-cloud-migrate` · 522,607 تثبيت ⭐
...
83. **resolving-merge-conflicts** — `mattpocock/skills/resolving-merge-conflicts` · 514,638 تثبيت
...
84. **hyperframes-core** — `heygen-com/hyperframes/hyperframes-core` · 504,203 تثبيت
   Agent pitfalls (read first):
   `npx skills add https://github.com/heygen-com/hyperframes --skill hyperframes-core`

85. **design-taste-frontend** — `leonxlnx/taste-skill/design-taste-frontend` · 500,153 تثبيت
   Concise, distinctive landing pages and portfolios that avoid templated AI aesthetics.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend`

86. **media-use** — `heygen-com/hyperframes/media-use` · 498,565 تثبيت
   The media OS for HyperFrames: resolve · generate · operate · remember — every media type, one skill, zero context noise.
   `npx skills add https://github.com/heygen-com/hyperframes --skill media-use`

87. **lark-note** — `open.feishu.cn/lark-note` · 495,508 تثبيت
   MUST 完整读取 ../lark-meeting/SKILL.md，并按照其中的路由和行动指南执行。
   `npx skills add https://open.feishu.cn/`

88. **azure-rbac** — `microsoft/azure-skills/azure-rbac` · 491,480 تثبيت ⭐
...
89. **hyperframes-animation** — `heygen-com/hyperframes/hyperframes-animation` · 489,095 تثبيت
...
90. **hyperframes-creative** — `heygen-com/hyperframes/hyperframes-creative` · 468,259 تثبيت
...
91. **azure-quotas** — `microsoft/azure-skills/azure-quotas` · 458,701 تثبيت ⭐
...
92. **paper-context-resolver** — `lllllllama/rigorpilot-skills/paper-context-resolver` · 450,926 تثبيت
...
93. **azure-upgrade** — `microsoft/azure-skills/azure-upgrade` · 450,813 تثبيت ⭐
...
94. **repo-intake-and-plan** — `lllllllama/rigorpilot-skills/repo-intake-and-plan` · 450,137 تثبيت
...
95. **minimal-run-and-audit** — `lllllllama/rigorpilot-skills/minimal-run-and-audit` · 450,049 تثبيت
...
96. **env-and-assets-bootstrap** — `lllllllama/rigorpilot-skills/env-and-assets-bootstrap` · 450,016 تثبيت
...
97. **azure-hosted-copilot-sdk** — `microsoft/azure-skills/azure-hosted-copilot-sdk` · 442,415 تثبيت ⭐
...
98. **azure-enterprise-infra-planner** — `microsoft/azure-skills/azure-enterprise-infra-planner` · 425,351 تثبيت ⭐
...
99. **nano-banana-2** — `prime-skills/runcomfy-agent-skills/nano-banana-2` · 420,485 تثبيت
   Nano Banana 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill nano-banana-2`

100. **image-edit** — `prime-skills/runcomfy-agent-skills/image-edit` · 420,096 تثبيت
   Image Edit — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill image-edit`

101. **nano-banana-edit** — `prime-skills/runcomfy-agent-skills/nano-banana-edit` · 420,017 تثبيت
...
102. **flux-kontext** — `prime-skills/runcomfy-agent-skills/flux-kontext` · 419,816 تثبيت
...
103. **wan-2-7** — `prime-skills/runcomfy-agent-skills/wan-2-7` · 419,261 تثبيت
   Wan 2.7 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill wan-2-7`

104. **gpt-image-edit** — `prime-skills/runcomfy-agent-skills/gpt-image-edit` · 419,088 تثبيت
...
105. **seedance-v2** — `prime-skills/runcomfy-agent-skills/seedance-v2` · 419,087 تثبيت
...
106. **happyhorse-1-0** — `prime-skills/runcomfy-agent-skills/happyhorse-1-0` · 419,039 تثبيت
...
107. **flux-2-klein** — `prime-skills/runcomfy-agent-skills/flux-2-klein` · 418,867 تثبيت
   Flux 2 Klein — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill flux-2-klein`

108. **azure-kubernetes** — `microsoft/azure-skills/azure-kubernetes` · 418,203 تثبيت ⭐
...
109. **supabase-postgres-best-practices** — `supabase/agent-skills/supabase-postgres-best-practices` · 409,650 تثبيت ⭐
...
110. **kling-3-0** — `prime-skills/runcomfy-agent-skills/kling-3-0` · 396,045 تثبيت
   Kling 3.0 - Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill kling-3-0`

111. **azure-cost** — `microsoft/azure-skills/azure-cost` · 393,434 تثبيت ⭐
...
112. **wizard** — `mattpocock/skills/wizard` · 388,873 تثبيت
...
119. **to-prd** — `mattpocock/skills/to-prd` · 367,898 تثبيت
...
120. **high-end-visual-design** — `leonxlnx/taste-skill/high-end-visual-design` · 367,373 تثبيت
...
121. **writing-beats** — `mattpocock/skills/writing-beats` · 365,558 تثبيت
...
122. **scaffold-exercises** — `mattpocock/skills/scaffold-exercises` · 365,416 تثبيت
   Create exercise directory structures that pass pnpm ai-hero-cli internal lint, then commit with git commit.
   `npx skills add https://github.com/mattpocock/skills --skill scaffold-exercises`

123. **caveman-review** — `juliusbrussee/caveman/caveman-review` · 365,122 تثبيت
...
124. **writing-shape** — `mattpocock/skills/writing-shape` · 365,070 تثبيت
...
125. **writing-fragments** — `mattpocock/skills/writing-fragments` · 364,890 تثبيت
...
126. **ui-ux-pro-max** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-ux-pro-max` · 364,227 تثبيت
   Comprehensive design intelligence for web and mobile UI/UX across 10 technology stacks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-ux-pro-max`

127. **redesign-existing-projects** — `leonxlnx/taste-skill/redesign-existing-projects` · 364,058 تثبيت
   Audit and upgrade existing websites to premium design standards without breaking functionality.
   `npx skills add https://github.com/leonxlnx/taste-skill --skill redesign-existing-projects`

128. **hyperframes-keyframes** — `heygen-com/hyperframes/hyperframes-keyframes` · 364,001 تثبيت
...
129. **caveman-compress** — `juliusbrussee/caveman/caveman-compress` · 363,677 تثبيت
...
130. **runcomfy-cli** — `prime-skills/runcomfy-agent-skills/runcomfy-cli` · 362,987 تثبيت
...
131. **face-swap** — `prime-skills/runcomfy-agent-skills/face-swap` · 362,670 تثبيت
...
132. **migrate-to-shoehorn** — `mattpocock/skills/migrate-to-shoehorn` · 361,763 تثبيت
   shoehorn lets you pass partial data in tests while keeping TypeScript happy. It replaces as assertions with type-safe alternatives.
   `npx skills add https://github.com/mattpocock/skills --skill migrate-to-shoehorn`

133. **video-inpainting** — `prime-skills/runcomfy-agent-skills/video-inpainting` · 361,033 تثبيت
...
134. **image-inpainting** — `prime-skills/runcomfy-agent-skills/image-inpainting` · 360,542 تثبيت
...
135. **controlnet-pose** — `prime-skills/runcomfy-agent-skills/controlnet-pose` · 360,315 تثبيت
...
136. **lipsync** — `prime-skills/runcomfy-agent-skills/lipsync` · 360,284 تثبيت
...
137. **video-extend** — `prime-skills/runcomfy-agent-skills/video-extend` · 359,880 تثبيت
...
138. **elevenlabs-music-generation** — `prime-skills/runcomfy-agent-skills/elevenlabs-music-generation` · 359,741 تثبيت
...
139. **image-outpainting** — `prime-skills/runcomfy-agent-skills/image-outpainting` · 359,598 تثبيت
...
140. **relight** — `prime-skills/runcomfy-agent-skills/relight` · 359,512 تثبيت
...
141. **video-outpainting** — `prime-skills/runcomfy-agent-skills/video-outpainting` · 359,422 تثبيت
...
142. **caveman-help** — `juliusbrussee/caveman/caveman-help` · 355,948 تثبيت
...
143. **to-issues** — `mattpocock/skills/to-issues` · 354,833 تثبيت
...
144. **ace-step** — `prime-skills/runcomfy-agent-skills/ace-step` · 351,302 تثبيت
   ACE Step — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill ace-step`

145. **vercel-composition-patterns** — `vercel-labs/agent-skills/vercel-composition-patterns` · 346,992 تثبيت ⭐
   React composition patterns for scaling components and avoiding boolean prop proliferation.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-composition-patterns`

146. **minimalist-ui** — `leonxlnx/taste-skill/minimalist-ui` · 338,151 تثبيت
...
147. **to-questionnaire** — `mattpocock/skills/to-questionnaire` · 337,811 تثبيت
...
148. **airunway-aks-setup** — `microsoft/azure-skills/airunway-aks-setup` · 337,275 تثبيت ⭐
...
149. **design-mobile-apps** — `designed-by-ai/skills/design-mobile-apps` · 332,561 تثبيت
...
150. **writing-great-skills** — `mattpocock/skills/writing-great-skills` · 323,738 تثبيت
...
151. **full-output-enforcement** — `leonxlnx/taste-skill/full-output-enforcement` · 322,607 تثبيت
...
152. **general-video** — `heygen-com/hyperframes/general-video` · 321,417 تثبيت
   Before relying on this workflow, run:
   `npx skills add https://github.com/heygen-com/hyperframes --skill general-video`

153. **loop-me** — `mattpocock/skills/loop-me` · 319,973 تثبيت
...
154. **remotion-to-hyperframes** — `heygen-com/hyperframes/remotion-to-hyperframes` · 318,212 تثبيت
...
155. **industrial-brutalist-ui** — `leonxlnx/taste-skill/industrial-brutalist-ui` · 315,997 تثبيت
...
156. **gpt-taste** — `leonxlnx/taste-skill/gpt-taste` · 315,791 تثبيت
   CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING
   `npx skills add https://github.com/leonxlnx/taste-skill --skill gpt-taste`

157. **stitch-design-taste** — `leonxlnx/taste-skill/stitch-design-taste` · 314,409 تثبيت
...
158. **cavecrew** — `juliusbrussee/caveman/cavecrew` · 312,945 تثبيت
...
159. **caveman-stats** — `juliusbrussee/caveman/caveman-stats` · 312,361 تثبيت
...
160. **entra-agent-id** — `microsoft/azure-skills/entra-agent-id` · 311,392 تثبيت ⭐
...
161. **ai-research-explore** — `lllllllama/rigorpilot-skills/ai-research-explore` · 311,277 تثبيت
...
162. **analyze-project** — `lllllllama/rigorpilot-skills/analyze-project` · 311,039 تثبيت
...
163. **ai-research-reproduction** — `lllllllama/rigorpilot-skills/ai-research-reproduction` · 310,963 تثبيت
...
164. **explore-code** — `lllllllama/rigorpilot-skills/explore-code` · 310,662 تثبيت
...
165. **safe-debug** — `lllllllama/rigorpilot-skills/safe-debug` · 310,646 تثبيت
...
166. **run-train** — `lllllllama/rigorpilot-skills/run-train` · 310,496 تثبيت
...
167. **explore-run** — `lllllllama/rigorpilot-skills/explore-run` · 310,479 تثبيت
...
168. **brandkit** — `leonxlnx/taste-skill/brandkit` · 305,629 تثبيت
...
169. **image-to-code** — `leonxlnx/taste-skill/image-to-code` · 300,960 تثبيت
...
170. **prisma-database-setup** — `prisma/skills/prisma-database-setup` · 300,545 تثبيت ⭐
...
171. **prisma-client-api** — `prisma/skills/prisma-client-api` · 300,143 تثبيت ⭐
...
172. **imagegen-frontend-web** — `leonxlnx/taste-skill/imagegen-frontend-web` · 298,578 تثبيت
...
173. **prisma-cli** — `prisma/skills/prisma-cli` · 297,790 تثبيت ⭐
...
174. **claude-handoff** — `mattpocock/skills/claude-handoff` · 296,538 تثبيت
...
175. **prisma-postgres** — `prisma/skills/prisma-postgres` · 293,428 تثبيت ⭐
...
176. **imagegen-frontend-mobile** — `leonxlnx/taste-skill/imagegen-frontend-mobile` · 293,005 تثبيت
...
177. **writing-for-agents** — `mattpocock/skills/writing-for-agents` · 291,460 تثبيت
...
178. **prisma-driver-adapter-implementation** — `prisma/skills/prisma-driver-adapter-implementation` · 288,551 تثبيت ⭐
...
179. **prisma-upgrade-v7** — `prisma/skills/prisma-upgrade-v7` · 288,288 تثبيت ⭐
...
180. **prisma-postgres-setup** — `prisma/skills/prisma-postgres-setup` · 287,754 تثبيت ⭐
...
181. **product-launch-video** — `heygen-com/hyperframes/product-launch-video` · 286,221 تثبيت
...
182. **google-agents-cli-adk-code** — `google/agents-cli/google-agents-cli-adk-code` · 285,813 تثبيت
...
183. **google-agents-cli-workflow** — `google/agents-cli/google-agents-cli-workflow` · 285,428 تثبيت
...
184. **google-agents-cli-eval** — `google/agents-cli/google-agents-cli-eval` · 285,399 تثبيت
...
185. **google-agents-cli-deploy** — `google/agents-cli/google-agents-cli-deploy` · 285,342 تثبيت
...
186. **google-agents-cli-scaffold** — `google/agents-cli/google-agents-cli-scaffold` · 285,338 تثبيت
...
187. **google-agents-cli-observability** — `google/agents-cli/google-agents-cli-observability` · 285,315 تثبيت
...
188. **impeccable** — `pbakaus/impeccable/impeccable` · 285,305 تثبيت
   Frontend design and iteration for production-grade interfaces, from concept to ship.
   `npx skills add https://github.com/pbakaus/impeccable --skill impeccable`

189. **google-agents-cli-publish** — `google/agents-cli/google-agents-cli-publish` · 285,174 تثبيت
   Gemini Enterprise Registration
   `npx skills add https://github.com/google/agents-cli --skill google-agents-cli-publish`

190. **emil-design-eng** — `emilkowalski/skills/emil-design-eng` · 284,699 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill emil-design-eng`

191. **supabase** — `supabase/agent-skills/supabase` · 284,477 تثبيت ⭐
...
192. **prisma-compute** — `prisma/skills/prisma-compute` · 283,576 تثبيت ⭐
...
193. **prisma-mongodb-upgrade** — `prisma/skills/prisma-mongodb-upgrade` · 282,221 تثبيت ⭐
   Prisma MongoDB Upgrade Path
   `npx skills add https://github.com/prisma/skills --skill prisma-mongodb-upgrade`

194. **faceless-explainer** — `heygen-com/hyperframes/faceless-explainer` · 281,959 تثبيت
...
195. **wait-what** — `mattpocock/skills/wait-what` · 279,263 تثبيت
...
196. **motion-graphics** — `heygen-com/hyperframes/motion-graphics` · 278,233 تثبيت
...
197. **shadcn** — `shadcn/ui/shadcn` · 271,676 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/shadcn-ui/ui --skill shadcn`

198. **azure-reliability** — `microsoft/azure-skills/azure-reliability` · 270,528 تثبيت ⭐
...
199. **systematic-debugging** — `obra/superpowers/systematic-debugging` · 265,408 تثبيت
   Structured debugging methodology that mandates root cause investigation before attempting any fixes.
   `npx skills add https://github.com/obra/superpowers --skill systematic-debugging`

200. **embedded-captions** — `heygen-com/hyperframes/embedded-captions` · 257,857 تثبيت
...
201. **wan-3-0-prime-reference-to-video** — `genmedia-labs/skills/wan-3-0-prime-reference-to-video` · 254,402 تثبيت
...
202. **seedance-2-5-image-to-video** — `genmedia-labs/skills/seedance-2-5-image-to-video` · 254,147 تثبيت
   Seedance 2.5 Image to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-image-to-video`

203. **writing-plans** — `obra/superpowers/writing-plans` · 254,118 تثبيت
   Comprehensive implementation plans for multi-step tasks, breaking down specs into bite-sized, testable steps.
   `npx skills add https://github.com/obra/superpowers --skill writing-plans`

204. **seedance-2-5-reference-to-video** — `genmedia-labs/skills/seedance-2-5-reference-to-video` · 253,874 تثبيت
   Seedance 2.5 Reference to Video
   `npx skills add https://github.com/genmedia-labs/skills --skill seedance-2-5-reference-to-video`

205. **setup-ts-deep-modules** — `mattpocock/skills/setup-ts-deep-modules` · 252,434 تثبيت
...
206. **pr-to-video** — `heygen-com/hyperframes/pr-to-video` · 251,958 تثبيت
...
207. **design-taste-frontend-v1** — `leonxlnx/taste-skill/design-taste-frontend-v1` · 250,382 تثبيت
   High-Agency Frontend Skill
   `npx skills add https://github.com/leonxlnx/taste-skill --skill design-taste-frontend-v1`

208. **using-superpowers** — `obra/superpowers/using-superpowers` · 248,326 تثبيت
   IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST USE IT.
   `npx skills add https://github.com/obra/superpowers --skill using-superpowers`

209. **just-scrape** — `scrapegraphai/just-scrape/just-scrape` · 244,970 تثبيت
...
212. **requesting-code-review** — `obra/superpowers/requesting-code-review` · 233,373 تثبيت
   Dispatch code review subagents with focused context to catch issues before they compound.
   `npx skills add https://github.com/obra/superpowers --skill requesting-code-review`

213. **test-driven-development** — `obra/superpowers/test-driven-development` · 231,798 تثبيت
   Write tests first, watch them fail, then implement minimal code to pass.
   `npx skills add https://github.com/obra/superpowers --skill test-driven-development`

214. **music-to-video** — `heygen-com/hyperframes/music-to-video` · 231,579 تثبيت
...
215. **write-a-skill** — `mattpocock/skills/write-a-skill` · 230,439 تثبيت
...
216. **zoom-out** — `mattpocock/skills/zoom-out` · 229,908 تثبيت
...
217. **orchestration** — `stablyai/orca/orchestration` · 226,469 تثبيت
...
218. **slideshow** — `heygen-com/hyperframes/slideshow` · 225,913 تثبيت
...
219. **pptx** — `anthropics/skills/pptx` · 224,290 تثبيت ⭐
...
220. **hyperframes-audio** — `heygen-com/hyperframes/hyperframes-audio` · 219,388 تثبيت
...
221. **executing-plans** — `obra/superpowers/executing-plans` · 216,815 تثبيت
...
222. **design-an-interface** — `mattpocock/skills/design-an-interface` · 216,665 تثبيت
...
223. **vercel-react-native-skills** — `vercel-labs/agent-skills/vercel-react-native-skills` · 216,581 تثبيت ⭐
...
224. **talking-head-recut** — `heygen-com/hyperframes/talking-head-recut` · 216,247 تثبيت
...
225. **verification-before-completion** — `obra/superpowers/verification-before-completion` · 216,229 تثبيت
...
226. **seo-audit** — `coreyhaines31/marketingskills/seo-audit` · 210,908 تثبيت
...
227. **request-refactor-plan** — `mattpocock/skills/request-refactor-plan` · 209,988 تثبيت
...
228. **subagent-driven-development** — `obra/superpowers/subagent-driven-development` · 209,802 تثبيت
...
229. **azure-cost-optimization** — `microsoft/azure-skills/azure-cost-optimization` · 209,621 تثبيت ⭐
...
230. **qa** — `mattpocock/skills/qa` · 205,899 تثبيت
...
231. **ubiquitous-language** — `mattpocock/skills/ubiquitous-language` · 204,551 تثبيت
   Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to a local file.
   `npx skills add https://github.com/mattpocock/skills --skill ubiquitous-language`

232. **copywriting** — `coreyhaines31/marketingskills/copywriting` · 204,430 تثبيت
...
236. **receiving-code-review** — `obra/superpowers/receiving-code-review` · 197,863 تثبيت
...
237. **dispatching-parallel-agents** — `obra/superpowers/dispatching-parallel-agents` · 195,360 تثبيت
...
238. **using-git-worktrees** — `obra/superpowers/using-git-worktrees` · 194,820 تثبيت
   Isolated git worktrees with smart directory selection and safety verification.
   `npx skills add https://github.com/obra/superpowers --skill using-git-worktrees`

239. **writing-skills** — `obra/superpowers/writing-skills` · 194,764 تثبيت
...
240. **python-appservice-deploy** — `microsoft/azure-skills/python-appservice-deploy` · 193,503 تثبيت ⭐
...
241. **finishing-a-development-branch** — `obra/superpowers/finishing-a-development-branch` · 191,403 تثبيت
...
242. **docx** — `anthropics/skills/docx` · 190,855 تثبيت ⭐
   Create, read, edit, and manipulate Word documents (.docx files) with full formatting control.
   `npx skills add https://github.com/anthropics/skills --skill docx`

243. **neon-postgres** — `neondatabase/agent-skills/neon-postgres` · 176,929 تثبيت ⭐
...
244. **higgsfield-generate** — `higgsfield-ai/skills/higgsfield-generate` · 174,478 تثبيت
...
245. **xlsx** — `anthropics/skills/xlsx` · 171,288 تثبيت ⭐
   Create, edit, and analyze Excel spreadsheets with formulas, formatting, and error-free calculations.
   `npx skills add https://github.com/anthropics/skills --skill xlsx`

246. **review-animations** — `emilkowalski/skills/review-animations` · 168,695 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill review-animations`

247. **wind-mcp-skill** — `wind-alice/alicemarket/wind-mcp-skill` · 167,806 تثبيت
...
248. **computer-use** — `stablyai/orca/computer-use` · 163,494 تثبيت
   This discovery stub loads the version-matched guide from the Orca executable used for this session.
   `npx skills add https://github.com/stablyai/orca --skill computer-use`

249. **figma** — `heygen-com/hyperframes/figma` · 160,796 تثبيت
...
253. **animation-vocabulary** — `emilkowalski/skills/animation-vocabulary` · 155,990 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill animation-vocabulary`

254. **firebase-auth-basics** — `firebase/agent-skills/firebase-auth-basics` · 154,894 تثبيت ⭐
...
255. **higgsfield-product-photoshoot** — `higgsfield-ai/skills/higgsfield-product-photoshoot` · 154,391 تثبيت
...
256. **higgsfield-soul-id** — `higgsfield-ai/skills/higgsfield-soul-id` · 153,262 تثبيت
...
257. **apple-design** — `emilkowalski/skills/apple-design` · 152,206 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill apple-design`

258. **higgsfield-marketplace-cards** — `higgsfield-ai/skills/higgsfield-marketplace-cards` · 151,664 تثبيت
...
259. **firebase-hosting-basics** — `firebase/agent-skills/firebase-hosting-basics` · 151,172 تثبيت ⭐
...
260. **firebase-app-hosting-basics** — `firebase/agent-skills/firebase-app-hosting-basics` · 150,626 تثبيت ⭐
...
261. **firebase-data-connect** — `firebase/agent-skills/firebase-data-connect` · 149,787 تثبيت ⭐
...
262. **hyperframes-media** — `heygen-com/hyperframes/hyperframes-media` · 149,579 تثبيت
...
263. **marketing-psychology** — `coreyhaines31/marketingskills/marketing-psychology` · 145,621 تثبيت
...
264. **sentry-cli** — `sentry/dev/sentry-cli` · 145,418 تثبيت
...
265. **content-strategy** — `coreyhaines31/marketingskills/content-strategy` · 142,890 تثبيت
...
266. **improve-animations** — `emilkowalski/skills/improve-animations` · 140,507 تثبيت
   When this skill is first invoked without a specific question, respond only with:
...
268. **programmatic-seo** — `coreyhaines31/marketingskills/programmatic-seo` · 134,183 تثبيت
...
269. **deploy-to-vercel** — `vercel-labs/agent-skills/deploy-to-vercel` · 132,615 تثبيت ⭐
   Deploy applications and websites to Vercel with automatic git integration and preview URLs.
   `npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel`

270. **neon** — `neondatabase/agent-skills/neon` · 130,629 تثبيت ⭐
...
271. **marketing-ideas** — `coreyhaines31/marketingskills/marketing-ideas` · 130,439 تثبيت
...
272. **extract-design-system** — `arvindrk/extract-design-system/extract-design-system` · 129,307 تثبيت
...
273. **copy-editing** — `coreyhaines31/marketingskills/copy-editing` · 128,248 تثبيت
...
274. **ai-seo** — `coreyhaines31/marketingskills/ai-seo` · 128,214 تثبيت
...
275. **implement-spec** — `mattpocock/skills/implement-spec` · 127,568 تثبيت
   You have been provided a spec. This spec should have tickets associated with it, describing how to implement the spec.
   `npx skills add https://github.com/mattpocock/skills --skill implement-spec`

276. **find-animation-opportunities** — `emilkowalski/skills/find-animation-opportunities` · 127,310 تثبيت
   Finding Animation Opportunities
   `npx skills add https://github.com/emilkowalski/skills --skill find-animation-opportunities`

277. **vercel-react-view-transitions** — `vercel-labs/agent-skills/vercel-react-view-transitions` · 126,909 تثبيت ⭐
...
278. **firebase-security-rules-auditor** — `firebase/agent-skills/firebase-security-rules-auditor` · 118,868 تثبيت ⭐
...
279. **convex-quickstart** — `get-convex/agent-skills/convex-quickstart` · 118,520 تثبيت
...
280. **convex-create-component** — `get-convex/agent-skills/convex-create-component` · 118,190 تثبيت
...
281. **mcp-builder** — `anthropics/skills/mcp-builder` · 116,708 تثبيت ⭐
   Comprehensive guide for building high-quality MCP servers that connect LLMs to external services.
   `npx skills add https://github.com/anthropics/skills --skill mcp-builder`

282. **firebase-ai-logic-basics** — `firebase/agent-skills/firebase-ai-logic-basics` · 116,579 تثبيت ⭐
...
283. **firebase-firestore** — `firebase/agent-skills/firebase-firestore` · 115,515 تثبيت ⭐
...
284. **ad-creative** — `coreyhaines31/marketingskills/ad-creative` · 114,345 تثبيت
...
285. **retro** — `mattpocock/skills/retro` · 114,145 تثبيت
   The user has asked for a retrospective. You are suggesting improvements to the coding agent's environment to improve future runs.
   `npx skills add https://github.com/mattpocock/skills --skill retro`

286. **firebase-crashlytics** — `firebase/agent-skills/firebase-crashlytics` · 112,469 تثبيت ⭐
...
287. **better-auth-best-practices** — `better-auth/skills/better-auth-best-practices` · 112,036 تثبيت ⭐
...
288. **xcode-project-setup** — `firebase/agent-skills/xcode-project-setup` · 111,729 تثبيت ⭐
...
289. **lark-meeting** — `open.feishu.cn/lark-meeting` · 110,828 تثبيت
   飞书视频会议业务的统一入口，支持查询会议记录、实时会议互动、管理妙记、阅读智能纪要等操作。本技能负责领域关系、任务路由和跨命令编排。
   `npx skills add https://open.feishu.cn/lark-cli/skills/regular`

290. **cold-email** — `coreyhaines31/marketingskills/cold-email` · 110,659 تثبيت
...
291. **pick-ui-library** — `emilkowalski/skills/pick-ui-library` · 109,620 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill pick-ui-library`

292. **canvas-design** — `anthropics/skills/canvas-design` · 109,419 تثبيت ⭐
...
293. **browser-act** — `browser-act/skills/browser-act` · 108,070 تثبيت
...
294. **azure-app-onboard** — `microsoft/azure-skills/azure-app-onboard` · 107,679 تثبيت ⭐
...
295. **azure-app-onboard-prereq** — `microsoft/azure-skills/azure-app-onboard-prereq` · 107,581 تثبيت ⭐
...
296. **site-architecture** — `coreyhaines31/marketingskills/site-architecture` · 106,770 تثبيت
...
297. **website-to-video** — `heygen-com/hyperframes/website-to-video` · 105,648 تثبيت
...
298. **churn-prevention** — `coreyhaines31/marketingskills/churn-prevention` · 104,989 تثبيت
...
299. **sales-enablement** — `coreyhaines31/marketingskills/sales-enablement` · 103,942 تثبيت
...
300. **vercel-cli-with-tokens** — `vercel-labs/agent-skills/vercel-cli-with-tokens` · 103,457 تثبيت ⭐
...
301. **web-artifacts-builder** — `anthropics/skills/web-artifacts-builder` · 102,467 تثبيت ⭐
   Multi-component React artifacts for Claude with bundling, state management, and shadcn/ui component library.
   `npx skills add https://github.com/anthropics/skills --skill web-artifacts-builder`

302. **firebase-remote-config-basics** — `firebase/agent-skills/firebase-remote-config-basics` · 102,137 تثبيت ⭐
...
303. **firecrawl** — `firecrawl/cli/firecrawl` · 101,418 تثبيت ⭐
...
304. **revops** — `coreyhaines31/marketingskills/revops` · 99,583 تثبيت
...
305. **archify** — `tt-a1i/archify/archify` · 98,553 تثبيت
...
306. **prototype** — `emilkowalski/skills/prototype` · 98,437 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill prototype`

307. **azure-observability** — `microsoft/azure-skills/azure-observability` · 98,327 تثبيت ⭐
...
308. **lead-magnets** — `coreyhaines31/marketingskills/lead-magnets` · 97,172 تثبيت
...
309. **customer-research** — `coreyhaines31/marketingskills/customer-research` · 96,620 تثبيت
...
310. **gsap** — `heygen-com/hyperframes/gsap` · 95,629 تثبيت
...
311. **browser-use** — `browser-use/browser-use/browser-use` · 95,207 تثبيت ⭐
   Fast, persistent browser automation with session continuity across sequential agent commands.
   `npx skills add https://github.com/browser-use/browser-use --skill browser-use`

312. **convex** — `get-convex/agent-skills/convex` · 95,023 تثبيت
...
313. **cloudflare** — `cloudflare/skills/cloudflare` · 94,996 تثبيت ⭐
...
314. **convex-performance-audit** — `get-convex/agent-skills/convex-performance-audit` · 94,523 تثبيت
...
315. **review** — `mattpocock/skills/review` · 94,511 تثبيت
   Two-axis review of the diff between HEAD and a fixed point the user supplies:
   `npx skills add https://github.com/mattpocock/skills --skill review`

316. **convex-setup-auth** — `get-convex/agent-skills/convex-setup-auth` · 94,088 تثبيت
...
317. **convex-migration-helper** — `get-convex/agent-skills/convex-migration-helper` · 94,086 تثبيت
...
318. **brand-guidelines** — `anthropics/skills/brand-guidelines` · 93,916 تثبيت ⭐
...
319. **higgsfield-websites** — `higgsfield-ai/skills/higgsfield-websites` · 93,662 تثبيت
...
320. **anti-detect-browser** — `antibrow/anti-detect-browser-skills/anti-detect-browser` · 93,297 تثبيت
...
321. **website-to-hyperframes** — `heygen-com/hyperframes/website-to-hyperframes` · 92,766 تثبيت
...
322. **wrangler** — `cloudflare/skills/wrangler` · 92,255 تثبيت ⭐
...
323. **remotion-render** — `remotion-dev/skills/remotion-render` · 89,959 تثبيت ⭐
   General rendering strategy
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-render`

324. **remotion-create** — `remotion-dev/skills/remotion-create` · 89,691 تثبيت ⭐
   These are instructions for making a new Remotion project and composition.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-create`

325. **remotion-captions** — `remotion-dev/skills/remotion-captions` · 87,527 تثبيت ⭐
...
326. **polish** — `pbakaus/impeccable/polish` · 87,321 تثبيت
...
327. **stripe-best-practices** — `stripe/ai/stripe-best-practices` · 87,121 تثبيت ⭐
...
328. **animate** — `emilkowalski/skills/animate` · 86,633 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill animate`

329. **obsidian-markdown** — `kepano/obsidian-skills/obsidian-markdown` · 86,483 تثبيت
...
330. **theme-factory** — `anthropics/skills/theme-factory` · 86,055 تثبيت ⭐
...
331. **workers-best-practices** — `cloudflare/skills/workers-best-practices` · 85,429 تثبيت ⭐
...
332. **doc-coauthoring** — `anthropics/skills/doc-coauthoring` · 85,328 تثبيت ⭐
...
333. **browser-act-skill-forge** — `browser-act/skills/browser-act-skill-forge` · 85,104 تثبيت
...
334. **critique** — `pbakaus/impeccable/critique` · 84,715 تثبيت
...
335. **remotion-markup** — `remotion-dev/skills/remotion-markup` · 84,653 تثبيت ⭐
...
336. **playwright-best-practices** — `currents-dev/playwright-best-practices-skill/playwright-best-practices` · 84,465 تثبيت
...
337. **audit** — `pbakaus/impeccable/audit` · 83,933 تثبيت
...
338. **animate** — `pbakaus/impeccable/animate` · 83,785 تثبيت
...
339. **adapt** — `pbakaus/impeccable/adapt` · 83,774 تثبيت
...
340. **clarify** — `pbakaus/impeccable/clarify` · 83,266 تثبيت
...
341. **optimize** — `pbakaus/impeccable/optimize` · 83,122 تثبيت
...
342. **colorize** — `pbakaus/impeccable/colorize` · 82,926 تثبيت
...
343. **remotion-interactivity** — `remotion-dev/skills/remotion-interactivity` · 82,625 تثبيت ⭐
...
344. **firecrawl-search** — `firecrawl/cli/firecrawl-search` · 82,268 تثبيت ⭐
...
345. **bolder** — `pbakaus/impeccable/bolder` · 82,047 تثبيت
...
346. **firecrawl-scrape** — `firecrawl/cli/firecrawl-scrape` · 81,979 تثبيت ⭐
...
347. **higgsfield-video-explainer** — `higgsfield-ai/skills/higgsfield-video-explainer` · 81,915 تثبيت
   Higgsfield Video Explainer
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-video-explainer`

348. **delight** — `pbakaus/impeccable/delight` · 81,877 تثبيت
...
349. **algorithmic-art** — `anthropics/skills/algorithmic-art` · 81,645 تثبيت ⭐
...
350. **distill** — `pbakaus/impeccable/distill` · 81,487 تثبيت
...
351. **remotion-saas** — `remotion-dev/skills/remotion-saas` · 81,004 تثبيت ⭐
   One can build apps with Remotion.
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-saas`

352. **quieter** — `pbakaus/impeccable/quieter` · 80,653 تثبيت
...
353. **firecrawl-crawl** — `firecrawl/cli/firecrawl-crawl` · 79,687 تثبيت ⭐
...
354. **firecrawl-agent** — `firecrawl/cli/firecrawl-agent` · 79,605 تثبيت ⭐
...
355. **firecrawl-map** — `firecrawl/cli/firecrawl-map` · 79,241 تثبيت ⭐
...
356. **firecrawl-download** — `firecrawl/cli/firecrawl-download` · 78,921 تثبيت ⭐
...
357. **remotion-docs** — `remotion-dev/skills/remotion-docs` · 78,278 تثبيت ⭐
...
358. **durable-objects** — `cloudflare/skills/durable-objects` · 77,977 تثبيت ⭐
...
359. **amazon-product-research** — `nexscope-ai/amazon-skills/amazon-product-research` · 77,838 تثبيت
...
360. **web-perf** — `cloudflare/skills/web-perf` · 77,666 تثبيت ⭐
...
361. **typescript-advanced-types** — `wshobson/agents/typescript-advanced-types` · 77,635 تثبيت
...
362. **notion-api** — `intellectronica/agent-skills/notion-api` · 77,283 تثبيت
...
363. **competitor-profiling** — `coreyhaines31/marketingskills/competitor-profiling` · 76,798 تثبيت
...
364. **gws-gmail** — `googleworkspace/cli/gws-gmail` · 76,497 تثبيت ⭐
...
365. **vercel-optimize** — `vercel-labs/agent-skills/vercel-optimize` · 76,381 تثبيت ⭐
...
366. **obsidian-cli** — `kepano/obsidian-skills/obsidian-cli` · 75,688 تثبيت
...
367. **agents-sdk** — `cloudflare/skills/agents-sdk` · 75,267 تثبيت ⭐
...
369. **wonda-cli** — `degausai/wonda/wonda-cli` · 74,605 تثبيت
...
370. **obsidian-bases** — `kepano/obsidian-skills/obsidian-bases` · 74,502 تثبيت
...
371. **css-animations** — `heygen-com/hyperframes/css-animations` · 74,492 تثبيت
...
372. **agent-tools** — `skills-101/superpowers/agent-tools` · 74,420 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill agent-tools`

373. **infsh-cli** — `skills-101/superpowers/infsh-cli` · 74,407 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill infsh-cli`

374. **python-executor** — `skills-101/superpowers/python-executor` · 74,371 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill python-executor`

375. **turborepo** — `vercel/turborepo/turborepo` · 74,279 تثبيت ⭐
...
376. **community-marketing** — `coreyhaines31/marketingskills/community-marketing` · 74,038 تثبيت
...
377. **internal-comms** — `anthropics/skills/internal-comms` · 73,383 تثبيت ⭐
...
378. **tailwind** — `heygen-com/hyperframes/tailwind` · 72,654 تثبيت
...
379. **review-loop** — `2dmurali/review-loop-skill/review-loop` · 72,523 تثبيت
...
380. **animejs** — `heygen-com/hyperframes/animejs` · 72,100 تثبيت
...
381. **solana-dev** — `solana-foundation/solana-dev-skill/solana-dev` · 71,511 تثبيت
...
382. **audit-website** — `squirrelscan/skills/audit-website` · 71,463 تثبيت
...
383. **remotion-upgrade** — `remotion-dev/skills/remotion-upgrade` · 71,399 تثبيت ⭐
...
384. **three** — `heygen-com/hyperframes/three` · 71,378 تثبيت
...
385. **image** — `coreyhaines31/marketingskills/image` · 71,236 تثبيت
...
386. **writing-guidelines** — `vercel-labs/agent-skills/writing-guidelines` · 71,206 تثبيت ⭐
...
387. **lottie** — `heygen-com/hyperframes/lottie` · 71,110 تثبيت
...
388. **video** — `coreyhaines31/marketingskills/video` · 70,949 تثبيت
...
389. **gws-gmail-send** — `googleworkspace/cli/gws-gmail-send` · 70,833 تثبيت ⭐
...
390. **cloudflare-email-service** — `cloudflare/skills/cloudflare-email-service` · 70,759 تثبيت ⭐
...
391. **waapi** — `heygen-com/hyperframes/waapi` · 70,736 تثبيت
...
392. **directory-submissions** — `coreyhaines31/marketingskills/directory-submissions` · 70,086 تثبيت
...
393. **cro** — `coreyhaines31/marketingskills/cro` · 69,734 تثبيت
   Conversion Rate Optimization (CRO)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill cro`

394. **json-canvas** — `kepano/obsidian-skills/json-canvas` · 69,574 تثبيت
...
395. **gws-drive** — `googleworkspace/cli/gws-drive` · 69,538 تثبيت ⭐
...
396. **slack-gif-creator** — `anthropics/skills/slack-gif-creator` · 69,186 تثبيت ⭐
...
397. **defuddle** — `kepano/obsidian-skills/defuddle` · 69,131 تثبيت
...
398. **ask-sonner** — `emilkowalski/skills/ask-sonner` · 67,898 تثبيت
   When this skill is first invoked without a specific question, respond only with:
   `npx skills add https://github.com/emilkowalski/skills --skill ask-sonner`

399. **social-content** — `coreyhaines31/marketingskills/social-content` · 67,790 تثبيت
...
400. **gpt-image-2** — `prime-skills/runcomfy-agent-skills/gpt-image-2` · 67,089 تثبيت
   GPT Image 2 — Pro Pack on RunComfy
   `npx skills add https://github.com/prime-skills/runcomfy-agent-skills --skill gpt-image-2`

401. **upgrade-stripe** — `stripe/ai/upgrade-stripe` · 67,062 تثبيت ⭐
   This guide covers upgrading Stripe API versions, server-side SDKs, Stripe.js, and mobile SDKs.
   `npx skills add https://github.com/stripe/ai --skill upgrade-stripe`

402. **product-marketing** — `coreyhaines31/marketingskills/product-marketing` · 67,040 تثبيت
...
403. **typeset** — `pbakaus/impeccable/typeset` · 66,279 تثبيت
...
404. **claude-api** — `anthropics/skills/claude-api` · 65,949 تثبيت ⭐
...
405. **template-skill** — `anthropics/skills/template-skill` · 65,908 تثبيت ⭐
   Replace with description of the skill and when Claude should use it.
   `npx skills add https://github.com/anthropics/skills --skill template-skill`

406. **analytics** — `coreyhaines31/marketingskills/analytics` · 65,871 تثبيت
...
407. **social** — `coreyhaines31/marketingskills/social` · 65,560 تثبيت
...
408. **remotion-maps** — `remotion-dev/skills/remotion-maps` · 65,279 تثبيت ⭐
...
409. **remotion-multimedia** — `remotion-dev/skills/remotion-multimedia` · 65,110 تثبيت ⭐
...
410. **tailwind-design-system** — `wshobson/agents/tailwind-design-system` · 64,858 تثبيت
   CSS-first design system framework for Tailwind v4 with tokens, components, and responsive patterns.
   `npx skills add https://github.com/wshobson/agents --skill tailwind-design-system`

411. **co-marketing** — `coreyhaines31/marketingskills/co-marketing` · 64,784 تثبيت
...
412. **batch-grill-me** — `mattpocock/skills/batch-grill-me` · 64,604 تثبيت
   Interview the user relentlessly until you reach a shared understanding. Map this as a design tree: every decision branches into the decisions that han
   `npx skills add https://github.com/mattpocock/skills --skill batch-grill-me`

413. **stripe-projects** — `stripe/ai/stripe-projects` · 64,498 تثبيت ⭐
   Stripe Projects — Service Provisioning
   `npx skills add https://github.com/stripe/ai --skill stripe-projects`

414. **overdrive** — `pbakaus/impeccable/overdrive` · 64,351 تثبيت
   ──────────── ⚡ OVERDRIVE ─────────────
   `npx skills add https://github.com/pbakaus/impeccable --skill overdrive`

415. **ads** — `coreyhaines31/marketingskills/ads` · 64,321 تثبيت
...
416. **firecrawl-interact** — `firecrawl/cli/firecrawl-interact` · 64,196 تثبيت ⭐
...
417. **pricing** — `coreyhaines31/marketingskills/pricing` · 63,157 تثبيت
...
418. **browser-mcp-agent** — `antibrow/anti-detect-browser-skills/browser-mcp-agent` · 62,931 تثبيت
...
419. **multi-account-isolation** — `antibrow/anti-detect-browser-skills/multi-account-isolation` · 62,901 تثبيت
...
420. **developing-genkit-js** — `firebase/agent-skills/developing-genkit-js` · 62,589 تثبيت ⭐
...
421. **cross-border-ecommerce** — `nexscope-ai/ecommerce-skills/cross-border-ecommerce` · 62,552 تثبيت
   Cross-Border E-Commerce ✈️
   `npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill cross-border-ecommerce`

422. **competitors** — `coreyhaines31/marketingskills/competitors` · 62,461 تثبيت
   Competitor & Alternative Pages
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill competitors`

423. **developing-genkit-dart** — `firebase/agent-skills/developing-genkit-dart` · 62,273 تثبيت ⭐
...
424. **caveman-explore** — `juliusbrussee/caveman/caveman-explore` · 62,238 تثبيت
...
425. **design-md** — `google-labs-code/stitch-skills/design-md` · 62,143 تثبيت ⭐
...
426. **turnstile-spin** — `cloudflare/skills/turnstile-spin` · 61,947 تثبيت ⭐
...
427. **product-marketing-context** — `coreyhaines31/marketingskills/product-marketing-context` · 61,939 تثبيت
...
428. **pricing-strategy** — `coreyhaines31/marketingskills/pricing-strategy` · 61,936 تثبيت
...
432. **caveman-learn** — `juliusbrussee/caveman/caveman-learn` · 61,589 تثبيت
...
433. **emails** — `coreyhaines31/marketingskills/emails` · 61,405 تثبيت
...
434. **launch** — `coreyhaines31/marketingskills/launch` · 61,379 تثبيت
...
435. **safe-refactor** — `juliusbrussee/caveman/safe-refactor` · 61,289 تثبيت
...
436. **investigate-first** — `juliusbrussee/caveman/investigate-first` · 61,281 تثبيت
...
437. **verify-and-stop** — `juliusbrussee/caveman/verify-and-stop` · 61,119 تثبيت
...
438. **gws-shared** — `googleworkspace/cli/gws-shared` · 61,031 تثبيت ⭐
...
439. **surgical-patch** — `juliusbrussee/caveman/surgical-patch` · 60,987 تثبيت
   Reproduce failure first when economical; otherwise capture strongest available evidence.
   `npx skills add https://github.com/juliusbrussee/caveman --skill surgical-patch`

440. **motion-doctrine** — `heygen-com/hyperframes/motion-doctrine` · 60,869 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill motion-doctrine`

441. **ab-testing** — `coreyhaines31/marketingskills/ab-testing` · 60,846 تثبيت
   You are an expert in experimentation and A/B testing. Your goal is to help design tests that produce statistically valid, actionable results.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill ab-testing`

442. **caveman-evidence-review** — `juliusbrussee/caveman/caveman-evidence-review` · 60,819 تثبيت
...
443. **captions-overlay** — `heygen-com/hyperframes/captions-overlay` · 60,789 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill captions-overlay`

444. **lean-build** — `juliusbrussee/caveman/lean-build` · 60,727 تثبيت
...
445. **caveman-discover** — `juliusbrussee/caveman/caveman-discover` · 60,710 تثبيت
...
446. **caveman-manage** — `juliusbrussee/caveman/caveman-manage` · 60,644 تثبيت
   Manage eval-gated experiments
   `npx skills add https://github.com/juliusbrussee/caveman --skill caveman-manage`

447. **cut-the-curve** — `heygen-com/hyperframes/cut-the-curve` · 60,583 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill cut-the-curve`

448. **agentix-ceo** — `agentix-cloud/skills/agentix-ceo` · 60,555 تثبيت
...
449. **firecrawl-build-scrape** — `firecrawl/skills/firecrawl-build-scrape` · 60,425 تثبيت ⭐
...
450. **landing-page-conversion-audit** — `autonnel/autonnel-skills/landing-page-conversion-audit` · 60,418 تثبيت
   Landing Page Conversion Audit
   `npx skills add https://github.com/autonnel/autonnel-skills --skill landing-page-conversion-audit`

451. **migration** — `juliusbrussee/caveman/migration` · 60,407 تثبيت
...
452. **firecrawl-build-search** — `firecrawl/skills/firecrawl-build-search` · 60,359 تثبيت ⭐
...
453. **seam-craft** — `heygen-com/hyperframes/seam-craft` · 60,300 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill seam-craft`

454. **changelog-video** — `heygen-com/hyperframes/changelog-video` · 60,249 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill changelog-video`

455. **expo-dev-client** — `expo/skills/expo-dev-client` · 60,229 تثبيت ⭐
...
456. **oversized-cursor** — `heygen-com/hyperframes/oversized-cursor` · 60,198 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/heygen-com/hyperframes --skill oversized-cursor`

457. **higgsfield-brandkit** — `higgsfield-ai/skills/higgsfield-brandkit` · 60,124 تثبيت
...
458. **higgsfield-youtube-thumbnail** — `higgsfield-ai/skills/higgsfield-youtube-thumbnail` · 60,084 تثبيت
   Higgsfield YouTube Thumbnail
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-youtube-thumbnail`

459. **firecrawl-build-interact** — `firecrawl/skills/firecrawl-build-interact` · 60,064 تثبيت ⭐
...
460. **firecrawl-build-onboarding** — `firecrawl/skills/firecrawl-build-onboarding` · 59,983 تثبيت ⭐
...
461. **caveman-setup** — `juliusbrussee/caveman/caveman-setup` · 59,982 تثبيت
...
462. **agently-mail** — `agent.qq.com/agently-mail` · 59,799 تثبيت
   通过 agently-cli 命令行工具操作邮件，通过管理端 (agent.qq.com) 进行后台管理。
   `npx skills add https://agent.qq.com/`

463. **cloudflare-one** — `cloudflare/skills/cloudflare-one` · 59,642 تثبيت ⭐
...
464. **aso** — `coreyhaines31/marketingskills/aso` · 59,543 تثبيت
...
465. **sales-funnel-blueprint** — `autonnel/autonnel-skills/sales-funnel-blueprint` · 59,475 تثبيت
...
466. **onboarding** — `coreyhaines31/marketingskills/onboarding` · 59,402 تثبيت
...
467. **server-side-conversion-tracking** — `autonnel/autonnel-skills/server-side-conversion-tracking` · 59,344 تثبيت
   Server-Side Conversion Tracking
   `npx skills add https://github.com/autonnel/autonnel-skills --skill server-side-conversion-tracking`

468. **browser-fingerprint-audit** — `liarjsdev/liarjs-skills/browser-fingerprint-audit` · 59,279 تثبيت
...
469. **funnel-platform-picker** — `autonnel/autonnel-skills/funnel-platform-picker` · 59,249 تثبيت
...
470. **playwright-stealth-verify** — `liarjsdev/liarjs-skills/playwright-stealth-verify` · 59,245 تثبيت
...
471. **building-native-ui** — `expo/skills/building-native-ui` · 59,233 تثبيت ⭐
...
472. **post-purchase-upsell-flow** — `autonnel/autonnel-skills/post-purchase-upsell-flow` · 59,211 تثبيت
...
473. **fingerprint-ci-gate** — `liarjsdev/liarjs-skills/fingerprint-ci-gate` · 59,197 تثبيت
   Fail the build, not the ban rate
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-ci-gate`

474. **self-hosted-funnel-launch** — `autonnel/autonnel-skills/self-hosted-funnel-launch` · 59,196 تثبيت
...
475. **fingerprint-failure-triage** — `liarjsdev/liarjs-skills/fingerprint-failure-triage` · 59,139 تثبيت
   Triage a fingerprint report
   `npx skills add https://github.com/liarjsdev/liarjs-skills --skill fingerprint-failure-triage`

476. **cloudflare-one-migrations** — `cloudflare/skills/cloudflare-one-migrations` · 58,831 تثبيت ⭐
...
477. **analytics-tracking** — `coreyhaines31/marketingskills/analytics-tracking` · 58,543 تثبيت
...
478. **free-tools** — `coreyhaines31/marketingskills/free-tools` · 58,382 تثبيت
   Free Tool Strategy (Engineering as Marketing)
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill free-tools`

479. **page-cro** — `coreyhaines31/marketingskills/page-cro` · 58,183 تثبيت
...
480. **is-this-photo-real** — `useosint/skills/is-this-photo-real` · 58,176 تثبيت
...
481. **investigate-without-getting-made** — `useosint/skills/investigate-without-getting-made` · 58,096 تثبيت
   Investigate without getting made
   `npx skills add https://github.com/useosint/skills --skill investigate-without-getting-made`

482. **referrals** — `coreyhaines31/marketingskills/referrals` · 57,972 تثبيت
   Referral & Affiliate Programs
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill referrals`

483. **gsap-core** — `greensock/gsap-skills/gsap-core` · 57,885 تثبيت
...
484. **signup** — `coreyhaines31/marketingskills/signup` · 57,863 تثبيت
...
485. **what-leaked-about-you** — `useosint/skills/what-leaked-about-you` · 57,681 تثبيت
...
486. **ai-sdk** — `vercel/ai/ai-sdk` · 57,389 تثبيت ⭐
...
487. **make-interfaces-feel-better** — `jakubkrehel/make-interfaces-feel-better/make-interfaces-feel-better` · 57,383 تثبيت
...
488. **popups** — `coreyhaines31/marketingskills/popups` · 57,342 تثبيت
   You are an expert in popup and modal optimization. Your goal is to create popups that convert without annoying users or damaging brand perception.
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill popups`

489. **paywalls** — `coreyhaines31/marketingskills/paywalls` · 57,285 تثبيت
   Paywall and Upgrade Screen CRO
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill paywalls`

490. **contribute-catalog** — `heygen-com/hyperframes/contribute-catalog` · 56,785 تثبيت
...
491. **launch-strategy** — `coreyhaines31/marketingskills/launch-strategy` · 56,753 تثبيت
...
492. **gws-calendar** — `googleworkspace/cli/gws-calendar` · 56,521 تثبيت ⭐
...
493. **find-the-original-image** — `useosint/skills/find-the-original-image` · 56,446 تثبيت
...
494. **enhance-prompt** — `google-labs-code/stitch-skills/enhance-prompt` · 56,319 تثبيت ⭐
...
495. **schema-markup** — `coreyhaines31/marketingskills/schema-markup` · 56,190 تثبيت
...
496. **animate-expo** — `emilkowalski/skills/animate-expo` · 55,900 تثبيت
   Building Animations in Expo
   `npx skills add https://github.com/emilkowalski/skills --skill animate-expo`

497. **normalize** — `pbakaus/impeccable/normalize` · 55,869 تثبيت
...
498. **email-sequence** — `coreyhaines31/marketingskills/email-sequence` · 55,799 تثبيت
...
499. **gsap-scrolltrigger** — `greensock/gsap-skills/gsap-scrolltrigger` · 55,726 تثبيت
...
500. **opentui** — `msmps/opentui-skill/opentui` · 55,520 تثبيت
...
501. **hallmark** — `nutlope/hallmark/hallmark` · 55,358 تثبيت
   A design skill for AI coding assistants. Makes the UIs they generate look made, not generated.
   `npx skills add https://github.com/nutlope/hallmark --skill hallmark`

502. **paid-ads** — `coreyhaines31/marketingskills/paid-ads` · 55,348 تثبيت
...
503. **nia** — `nozomio-labs/nia-skill/nia` · 55,280 تثبيت
...
504. **competitor-alternatives** — `coreyhaines31/marketingskills/competitor-alternatives` · 54,846 تثبيت
...
505. **extract** — `pbakaus/impeccable/extract` · 54,786 تثبيت
...
506. **remotion-studio** — `remotion-dev/skills/remotion-studio` · 54,667 تثبيت ⭐
   Execute the following command:
   `npx skills add https://github.com/remotion-dev/skills --skill remotion-studio`

507. **onboard** — `pbakaus/impeccable/onboard` · 54,625 تثبيت
...
508. **harden** — `pbakaus/impeccable/harden` · 54,550 تثبيت
...
509. **accessibility** — `addyosmani/web-quality-skills/accessibility` · 54,453 تثبيت
...
510. **expo-tailwind-setup** — `expo/skills/expo-tailwind-setup` · 54,406 تثبيت ⭐
...
511. **stitch-loop** — `google-labs-code/stitch-skills/stitch-loop` · 54,374 تثبيت ⭐
...
512. **onboarding-cro** — `coreyhaines31/marketingskills/onboarding-cro` · 54,317 تثبيت
...
513. **gws-sheets** — `googleworkspace/cli/gws-sheets` · 54,057 تثبيت ⭐
...
514. **gsap-performance** — `greensock/gsap-skills/gsap-performance` · 53,670 تثبيت
...
515. **fastify-best-practices** — `mcollina/skills/fastify-best-practices` · 53,585 تثبيت
   Use this skill when you need to:
   `npx skills add https://github.com/mcollina/skills --skill fastify-best-practices`

516. **gws-docs** — `googleworkspace/cli/gws-docs` · 53,539 تثبيت ⭐
...
517. **gsap-timeline** — `greensock/gsap-skills/gsap-timeline` · 53,461 تثبيت
...
518. **form-cro** — `coreyhaines31/marketingskills/form-cro` · 53,230 تثبيت
...
519. **free-tool-strategy** — `coreyhaines31/marketingskills/free-tool-strategy` · 52,992 تثبيت
...
520. **referral-program** — `coreyhaines31/marketingskills/referral-program` · 52,932 تثبيت
...
521. **momentic-test** — `momentic-ai/skills/momentic-test` · 52,848 تثبيت
...
522. **momentic-result-classification** — `momentic-ai/skills/momentic-result-classification` · 52,826 تثبيت
...
523. **ab-test-setup** — `coreyhaines31/marketingskills/ab-test-setup` · 52,753 تثبيت
...
524. **mastra** — `mastra-ai/skills/mastra` · 52,700 تثبيت ⭐
...
525. **signup-flow-cro** — `coreyhaines31/marketingskills/signup-flow-cro` · 52,489 تثبيت
...
526. **design-doc-mermaid** — `spillwavesolutions/design-doc-mermaid/design-doc-mermaid` · 52,288 تثبيت
...
527. **gsap-plugins** — `greensock/gsap-skills/gsap-plugins` · 52,249 تثبيت
...
528. **herdr** — `herdrdev/herdr/herdr` · 52,210 تثبيت
...
529. **typegpu** — `heygen-com/hyperframes/typegpu` · 52,168 تثبيت
...
530. **paywall-upgrade-cro** — `coreyhaines31/marketingskills/paywall-upgrade-cro` · 52,080 تثبيت
...
531. **marketing-plan** — `coreyhaines31/marketingskills/marketing-plan` · 52,050 تثبيت
...
532. **popup-cro** — `coreyhaines31/marketingskills/popup-cro` · 51,748 تثبيت
...
533. **shadcn-ui** — `google-labs-code/stitch-skills/shadcn-ui` · 51,591 تثبيت ⭐
...
534. **teach-impeccable** — `pbakaus/impeccable/teach-impeccable` · 51,513 تثبيت
...
535. **gsap-react** — `greensock/gsap-skills/gsap-react` · 51,331 تثبيت
...
536. **gsap-utils** — `greensock/gsap-skills/gsap-utils` · 51,172 تثبيت
...
537. **prospecting** — `coreyhaines31/marketingskills/prospecting` · 50,995 تثبيت
...
538. **sms** — `coreyhaines31/marketingskills/sms` · 50,875 تثبيت
...
539. **react:components** — `google-labs-code/stitch-skills/react:components` · 50,701 تثبيت ⭐
   Stitch to React Components
   `npx skills add https://github.com/google-labs-code/stitch-skills --skill react:components`

540. **firecrawl-parse** — `firecrawl/cli/firecrawl-parse` · 50,129 تثبيت ⭐
...
543. **humanizer-zh** — `op7418/humanizer-zh/humanizer-zh` · 49,365 تثبيت
...
544. **gsap-frameworks** — `greensock/gsap-skills/gsap-frameworks` · 49,024 تثبيت
...
545. **write-swift** — `emilkowalski/skills/write-swift` · 48,595 تثبيت
   This skill contains shell command directives (!`command`) that may execute system commands. Review carefully before installing.
   `npx skills add https://github.com/emilkowalski/skills --skill write-swift`

546. **nx-workspace** — `nrwl/nx-ai-agents-config/nx-workspace` · 48,260 تثبيت
...
547. **seo-geo** — `resciencelab/opc-skills/seo-geo` · 48,227 تثبيت
...
548. **clerk-setup** — `clerk/skills/clerk-setup` · 47,368 تثبيت ⭐
...
549. **native-data-fetching** — `expo/skills/native-data-fetching` · 47,274 تثبيت ⭐
...
550. **huashu-design** — `alchaincyf/huashu-design/huashu-design` · 46,896 تثبيت
...
551. **compress** — `juliusbrussee/caveman/compress` · 46,860 تثبيت
   Compress natural language memory files into caveman-speak to reduce input tokens.
   `npx skills add https://github.com/juliusbrussee/caveman --skill compress`

552. **agent-pulse** — `jane-o-o-o-o/agent-pulse-skill/agent-pulse` · 46,571 تثبيت
...
553. **gws-sheets-read** — `googleworkspace/cli/gws-sheets-read` · 46,510 تثبيت ⭐
...
554. **seo** — `addyosmani/web-quality-skills/seo` · 46,474 تثبيت
...
555. **code-review-and-quality** — `addyosmani/agent-skills/code-review-and-quality` · 46,118 تثبيت
...
556. **clerk-custom-ui** — `clerk/skills/clerk-custom-ui` · 46,076 تثبيت ⭐
...
557. **gws-docs-write** — `googleworkspace/cli/gws-docs-write` · 45,934 تثبيت ⭐
...
558. **nodejs-backend-patterns** — `wshobson/agents/nodejs-backend-patterns` · 45,692 تثبيت
...
559. **clerk-nextjs-patterns** — `clerk/skills/clerk-nextjs-patterns` · 45,571 تثبيت ⭐
...
560. **gws-calendar-agenda** — `googleworkspace/cli/gws-calendar-agenda` · 45,541 تثبيت ⭐
...
561. **git-commit** — `github/awesome-copilot/git-commit` · 45,393 تثبيت ⭐
...
562. **insforge** — `insforge/insforge-skills/insforge` · 45,325 تثبيت
   InsForge App Integration Skill
   `npx skills add https://github.com/insforge/insforge-skills --skill insforge`

563. **byted-web-search** — `skills.volces.com/byted-web-search` · 45,309 تثبيت
...
564. **gws-drive-upload** — `googleworkspace/cli/gws-drive-upload` · 45,220 تثبيت ⭐
...
565. **insforge-cli** — `insforge/insforge-skills/insforge-cli` · 45,216 تثبيت
...
566. **decision-mapping** — `mattpocock/skills/decision-mapping` · 44,918 تثبيت
...
567. **clerk-backend-api** — `clerk/skills/clerk-backend-api` · 44,793 تثبيت ⭐
   CRITICAL: Mandatory checks before EVERY write request
   `npx skills add https://github.com/clerk/skills --skill clerk-backend-api`

568. **gws-calendar-insert** — `googleworkspace/cli/gws-calendar-insert` · 44,371 تثبيت ⭐
...
569. **planning-with-files** — `othmanadi/planning-with-files/planning-with-files` · 44,126 تثبيت
...
570. **weread-skills** — `tencent/wechatreading/weread-skills` · 44,115 تثبيت
   通过 Agent API Gateway 调用微信读书接口，提供搜索、书架、笔记、书评等能力。
   `npx skills add https://github.com/tencent/wechatreading --skill weread-skills`

571. **clerk-webhooks** — `clerk/skills/clerk-webhooks` · 43,912 تثبيت ⭐
...
572. **upgrading-expo** — `expo/skills/upgrading-expo` · 43,134 تثبيت ⭐
...
573. **gws-gmail-triage** — `googleworkspace/cli/gws-gmail-triage` · 42,748 تثبيت ⭐
...
574. **gws-sheets-append** — `googleworkspace/cli/gws-sheets-append` · 42,620 تثبيت ⭐
...
575. **clerk-orgs** — `clerk/skills/clerk-orgs` · 42,036 تثبيت ⭐
...
576. **security-and-hardening** — `addyosmani/agent-skills/security-and-hardening` · 41,883 تثبيت
...
577. **golang-code-style** — `samber/cc-skills-golang/golang-code-style` · 41,840 تثبيت
...
578. **public-relations** — `coreyhaines31/marketingskills/public-relations` · 41,739 تثبيت
   Public Relations & Earned Media
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill public-relations`

579. **last30days** — `mvanhorn/last30days-skill/last30days` · 41,708 تثبيت
...
580. **frontend-ui-engineering** — `addyosmani/agent-skills/frontend-ui-engineering` · 41,676 تثبيت
...
581. **insforge-debug** — `insforge/insforge-skills/insforge-debug` · 41,469 تثبيت
...
582. **offers** — `coreyhaines31/marketingskills/offers` · 41,468 تثبيت
...
583. **golang-error-handling** — `samber/cc-skills-golang/golang-error-handling` · 41,152 تثبيت
...
584. **golang-testing** — `samber/cc-skills-golang/golang-testing` · 41,141 تثبيت
...
585. **expo-deployment** — `expo/skills/expo-deployment` · 41,025 تثبيت ⭐
...
586. **gws-tasks** — `googleworkspace/cli/gws-tasks` · 40,802 تثبيت ⭐
...
587. **insforge-integrations** — `insforge/insforge-skills/insforge-integrations` · 40,730 تثبيت
...
588. **planning-and-task-breakdown** — `addyosmani/agent-skills/planning-and-task-breakdown` · 40,605 تثبيت
   Planning and Task Breakdown
   `npx skills add https://github.com/addyosmani/agent-skills --skill planning-and-task-breakdown`

589. **spec-driven-development** — `addyosmani/agent-skills/spec-driven-development` · 40,486 تثبيت
...
590. **golang-design-patterns** — `samber/cc-skills-golang/golang-design-patterns` · 40,321 تثبيت
...
591. **golang-performance** — `samber/cc-skills-golang/golang-performance` · 40,264 تثبيت
...
592. **arrange** — `pbakaus/impeccable/arrange` · 40,220 تثبيت
...
593. **golang-security** — `samber/cc-skills-golang/golang-security` · 40,207 تثبيت
...
594. **pexo-agent** — `pexoai/pexo-skills/pexo-agent` · 40,054 تثبيت
...
595. **expo-cicd-workflows** — `expo/skills/expo-cicd-workflows` · 40,000 تثبيت ⭐
...
596. **performance-optimization** — `addyosmani/agent-skills/performance-optimization` · 39,790 تثبيت
...
597. **golang-concurrency** — `samber/cc-skills-golang/golang-concurrency` · 39,757 تثبيت
...
598. **clerk-testing** — `clerk/skills/clerk-testing` · 39,739 تثبيت ⭐
   https://clerk.com/docs/guides/development/testing/overview
   `npx skills add https://github.com/clerk/skills --skill clerk-testing`

599. **remotion** — `google-labs-code/stitch-skills/remotion` · 39,666 تثبيت ⭐
...
600. **vue-best-practices** — `vuejs-ai/skills/vue-best-practices` · 39,216 تثبيت
   Vue Best Practices Workflow
   `npx skills add https://github.com/vuejs-ai/skills --skill vue-best-practices`

601. **golang-context** — `samber/cc-skills-golang/golang-context` · 39,199 تثبيت
...
602. **golang-naming** — `samber/cc-skills-golang/golang-naming` · 39,150 تثبيت
...
603. **documentation-and-adrs** — `addyosmani/agent-skills/documentation-and-adrs` · 39,148 تثبيت
...
604. **golang-database** — `samber/cc-skills-golang/golang-database` · 39,085 تثبيت
...
605. **golang-documentation** — `samber/cc-skills-golang/golang-documentation` · 38,957 تثبيت
...
606. **debugging-and-error-recovery** — `addyosmani/agent-skills/debugging-and-error-recovery` · 38,905 تثبيت
   Debugging and Error Recovery
   `npx skills add https://github.com/addyosmani/agent-skills --skill debugging-and-error-recovery`

607. **golang-safety** — `samber/cc-skills-golang/golang-safety` · 38,897 تثبيت
...
608. **golang-data-structures** — `samber/cc-skills-golang/golang-data-structures` · 38,896 تثبيت
...
609. **golang-modernize** — `samber/cc-skills-golang/golang-modernize` · 38,838 تثبيت
...
610. **gws-slides** — `googleworkspace/cli/gws-slides` · 38,823 تثبيت ⭐
...
611. **golang-project-layout** — `samber/cc-skills-golang/golang-project-layout` · 38,811 تثبيت
...
612. **typesafe-ai** — `typesafe-ai/skills/typesafe-ai` · 38,782 تثبيت
...
613. **code-simplification** — `addyosmani/agent-skills/code-simplification` · 38,760 تثبيت
...
614. **golang-lint** — `samber/cc-skills-golang/golang-lint` · 38,704 تثبيت
...
615. **momentic-mobile-test** — `momentic-ai/skills/momentic-mobile-test` · 38,636 تثبيت
...
616. **incremental-implementation** — `addyosmani/agent-skills/incremental-implementation` · 38,573 تثبيت
   Incremental Implementation
   `npx skills add https://github.com/addyosmani/agent-skills --skill incremental-implementation`

617. **golang-troubleshooting** — `samber/cc-skills-golang/golang-troubleshooting` · 38,508 تثبيت
...
618. **golang-observability** — `samber/cc-skills-golang/golang-observability` · 38,492 تثبيت
...
619. **brand-landingpage** — `wshobson/agents/brand-landingpage` · 38,452 تثبيت
...
620. **golang-dependency-management** — `samber/cc-skills-golang/golang-dependency-management` · 38,378 تثبيت
...
621. **gws-gmail-read** — `googleworkspace/cli/gws-gmail-read` · 38,316 تثبيت ⭐
...
622. **wind-find-finance-skill** — `wind-alice/alicemarket/wind-find-finance-skill` · 38,314 تثبيت
...
623. **golang-structs-interfaces** — `samber/cc-skills-golang/golang-structs-interfaces` · 38,293 تثبيت
...
624. **golang-popular-libraries** — `samber/cc-skills-golang/golang-popular-libraries` · 38,226 تثبيت
...
625. **golang-dependency-injection** — `samber/cc-skills-golang/golang-dependency-injection` · 38,199 تثبيت
...
626. **golang-benchmark** — `samber/cc-skills-golang/golang-benchmark` · 38,172 تثبيت
...
627. **sandbox-stable** — `cloudflare/skills/sandbox-stable` · 38,157 تثبيت ⭐
   Sandbox SDK — stable package
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-stable`

628. **golang-cli** — `samber/cc-skills-golang/golang-cli` · 38,116 تثبيت
...
629. **golang-stretchr-testify** — `samber/cc-skills-golang/golang-stretchr-testify` · 38,064 تثبيت
...
630. **context-engineering** — `addyosmani/agent-skills/context-engineering` · 38,033 تثبيت
...
631. **landing-page-design** — `skills-101/superpowers/landing-page-design` · 37,993 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill landing-page-design`

632. **golang-continuous-integration** — `samber/cc-skills-golang/golang-continuous-integration` · 37,983 تثبيت
...
633. **golang-grpc** — `samber/cc-skills-golang/golang-grpc` · 37,950 تثبيت
...
634. **expo-api-routes** — `expo/skills/expo-api-routes` · 37,941 تثبيت ⭐
...
635. **anysearch** — `anysearch-ai/anysearch-skill/anysearch` · 37,870 تثبيت
...
636. **sandbox-next** — `cloudflare/skills/sandbox-next` · 37,760 تثبيت ⭐
   Sandbox SDK — @next (1.0 preview)
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-next`

637. **sandbox-migrate-to-next** — `cloudflare/skills/sandbox-migrate-to-next` · 37,699 تثبيت ⭐
...
638. **api-and-interface-design** — `addyosmani/agent-skills/api-and-interface-design` · 37,601 تثبيت
...
639. **extension-to-functions-codebase** — `firebase/agent-skills/extension-to-functions-codebase` · 37,582 تثبيت ⭐
...
640. **app-store-screenshots** — `skills-101/superpowers/app-store-screenshots` · 37,472 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill app-store-screenshots`

641. **gws-forms** — `googleworkspace/cli/gws-forms` · 37,458 تثبيت ⭐
...
642. **product-photography** — `skills-101/superpowers/product-photography` · 37,454 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-photography`

643. **golang-stay-updated** — `samber/cc-skills-golang/golang-stay-updated` · 37,411 تثبيت
...
644. **storyboard-creation** — `skills-101/superpowers/storyboard-creation` · 37,401 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill storyboard-creation`

645. **character-design-sheet** — `skills-101/superpowers/character-design-sheet` · 37,388 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill character-design-sheet`

646. **competitor-teardown** — `skills-101/superpowers/competitor-teardown` · 37,380 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill competitor-teardown`

647. **product-hunt-launch** — `skills-101/superpowers/product-hunt-launch` · 37,378 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill product-hunt-launch`

648. **youtube-thumbnail-design** — `skills-101/superpowers/youtube-thumbnail-design` · 37,377 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill youtube-thumbnail-design`

649. **video-ad-specs** — `skills-101/superpowers/video-ad-specs` · 37,376 تثبيت
   Install the belt CLI skill: npx skills add belt-sh/cli
   `npx skills add https://github.com/skills-101/superpowers --skill video-ad-specs`

650. **golang-samber-lo** — `samber/cc-skills-golang/golang-samber-lo` · 37,355 تثبيت
...
651. **golang-samber-do** — `samber/cc-skills-golang/golang-samber-do` · 37,244 تثبيت
...
652. **golang-samber-slog** — `samber/cc-skills-golang/golang-samber-slog` · 37,220 تثبيت
...
653. **golang-samber-oops** — `samber/cc-skills-golang/golang-samber-oops` · 37,173 تثبيت
...
654. **golang-samber-mo** — `samber/cc-skills-golang/golang-samber-mo` · 37,151 تثبيت
...
655. **angular-developer** — `angular/skills/angular-developer` · 37,150 تثبيت
...
656. **golang-samber-hot** — `samber/cc-skills-golang/golang-samber-hot` · 37,144 تثبيت
...
657. **golang-samber-ro** — `samber/cc-skills-golang/golang-samber-ro` · 37,121 تثبيت
...
658. **firebase-firestore-standard** — `firebase/agent-skills/firebase-firestore-standard` · 37,121 تثبيت ⭐
...
659. **karpathy-guidelines** — `multica-ai/andrej-karpathy-skills/karpathy-guidelines` · 37,097 تثبيت
   Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   `npx skills add https://github.com/multica-ai/andrej-karpathy-skills --skill karpathy-guidelines`

660. **gws-meet** — `googleworkspace/cli/gws-meet` · 36,997 تثبيت ⭐
...
661. **expo-module** — `expo/skills/expo-module` · 36,915 تثبيت ⭐
...
662. **vitest** — `antfu/skills/vitest` · 36,776 تثبيت
...
663. **using-agent-skills** — `addyosmani/agent-skills/using-agent-skills` · 36,430 تثبيت
...
664. **flutter-apply-architecture-best-practices** — `flutter/agent-plugins/flutter-apply-architecture-best-practices` · 36,400 تثبيت ⭐
   Architecting Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-apply-architecture-best-practices`

665. **git-workflow-and-versioning** — `addyosmani/agent-skills/git-workflow-and-versioning` · 36,309 تثبيت
   Git Workflow and Versioning
   `npx skills add https://github.com/addyosmani/agent-skills --skill git-workflow-and-versioning`

666. **email-and-password-best-practices** — `better-auth/skills/email-and-password-best-practices` · 36,291 تثبيت ⭐
...
667. **idea-refine** — `addyosmani/agent-skills/idea-refine` · 36,079 تثبيت
   Refines raw ideas into sharp, actionable concepts worth building through structured divergent and convergent thinking.
   `npx skills add https://github.com/addyosmani/agent-skills --skill idea-refine`

668. **firebase-firestore-enterprise-native-mode** — `firebase/agent-skills/firebase-firestore-enterprise-native-mode` · 36,058 تثبيت ⭐
...
669. **vite** — `antfu/skills/vite` · 36,007 تثبيت
...
670. **performance** — `addyosmani/web-quality-skills/performance` · 35,985 تثبيت
...
671. **golang-swagger** — `samber/cc-skills-golang/golang-swagger` · 35,982 تثبيت
...
672. **golang-graphql** — `samber/cc-skills-golang/golang-graphql` · 35,896 تثبيت
...
673. **golang-spf13-cobra** — `samber/cc-skills-golang/golang-spf13-cobra` · 35,892 تثبيت
...
674. **browser-testing-with-devtools** — `addyosmani/agent-skills/browser-testing-with-devtools` · 35,763 تثبيت
   Browser Testing with DevTools
   `npx skills add https://github.com/addyosmani/agent-skills --skill browser-testing-with-devtools`

675. **golang-google-wire** — `samber/cc-skills-golang/golang-google-wire` · 35,741 تثبيت
...
676. **golang-spf13-viper** — `samber/cc-skills-golang/golang-spf13-viper` · 35,733 تثبيت
...
677. **golang-uber-fx** — `samber/cc-skills-golang/golang-uber-fx` · 35,599 تثبيت
...
678. **golang-uber-dig** — `samber/cc-skills-golang/golang-uber-dig` · 35,547 تثبيت
...
679. **value** — `hugmouse/skills/value` · 35,529 تثبيت
   This skill does absolutely nothing.
   `npx skills add https://github.com/hugmouse/skills --skill value`

680. **replicas-agent** — `replicas-group/skill/replicas-agent` · 35,527 تثبيت
...
681. **ci-cd-and-automation** — `addyosmani/agent-skills/ci-cd-and-automation` · 35,482 تثبيت
...
682. **flutter-build-responsive-layout** — `flutter/agent-plugins/flutter-build-responsive-layout` · 35,468 تثبيت ⭐
   Implementing Adaptive Layouts
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-build-responsive-layout`

683. **better-auth-security-best-practices** — `better-auth/skills/better-auth-security-best-practices` · 35,440 تثبيت ⭐
   import { betterAuth } from "better-auth";
   `npx skills add https://github.com/better-auth/skills --skill better-auth-security-best-practices`

684. **source-driven-development** — `addyosmani/agent-skills/source-driven-development` · 35,212 تثبيت
...
685. **shipping-and-launch** — `addyosmani/agent-skills/shipping-and-launch` · 35,109 تثبيت
...
686. **golang-how-to** — `samber/cc-skills-golang/golang-how-to` · 34,952 تثبيت
...
687. **gws-keep** — `googleworkspace/cli/gws-keep` · 34,864 تثبيت ⭐
...
688. **deprecation-and-migration** — `addyosmani/agent-skills/deprecation-and-migration` · 34,839 تثبيت
...
689. **gws-gmail-watch** — `googleworkspace/cli/gws-gmail-watch` · 34,829 تثبيت ⭐
...
691. **firecrawl-deep-research** — `firecrawl/firecrawl-workflows/firecrawl-deep-research` · 34,456 تثبيت ⭐
...
692. **vue** — `antfu/skills/vue` · 34,051 تثبيت
...
693. **baoyu-post-to-wechat** — `jimliu/baoyu-skills/baoyu-post-to-wechat` · 33,911 تثبيت
...
694. **self-improving-agent** — `zhaono1/agent-playbook/self-improving-agent` · 33,868 تثبيت
...
695. **improve** — `shadcn/improve/improve` · 33,760 تثبيت
...
696. **flutter-fix-layout-issues** — `flutter/agent-plugins/flutter-fix-layout-issues` · 33,750 تثبيت ⭐
   Resolving Flutter Layout Errors
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-fix-layout-issues`

697. **developing-genkit-python** — `firebase/agent-skills/developing-genkit-python` · 33,643 تثبيت ⭐
...
698. **sandbox-sdk** — `cloudflare/skills/sandbox-sdk` · 33,616 تثبيت ⭐
   Build secure, isolated code execution environments on Cloudflare Workers.
   `npx skills add https://github.com/cloudflare/skills --skill sandbox-sdk`

699. **interview-me** — `addyosmani/agent-skills/interview-me` · 33,527 تثبيت
...
700. **python-performance-optimization** — `wshobson/agents/python-performance-optimization` · 33,348 تثبيت
   Profile and optimize Python code using cProfile, memory profilers, and performance best practices.
   `npx skills add https://github.com/wshobson/agents --skill python-performance-optimization`

701. **doubt-driven-development** — `addyosmani/agent-skills/doubt-driven-development` · 33,264 تثبيت
...
702. **firecrawl-research-papers** — `firecrawl/firecrawl-workflows/firecrawl-research-papers` · 33,100 تثبيت ⭐
...
703. **python-testing-patterns** — `wshobson/agents/python-testing-patterns` · 33,010 تثبيت
...
704. **tavily-search** — `tavily-ai/skills/tavily-search` · 32,975 تثبيت ⭐
...
705. **flutter-add-widget-test** — `flutter/agent-plugins/flutter-add-widget-test` · 32,972 تثبيت ⭐
   Writing Flutter Widget Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-test`

706. **organization-best-practices** — `better-auth/skills/organization-best-practices` · 32,938 تثبيت ⭐
...
707. **ckm:design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design-system` · 32,876 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

708. **firecrawl-website-design-clone** — `firecrawl/firecrawl-workflows/firecrawl-website-design-clone` · 32,875 تثبيت ⭐
   Firecrawl Website Design Clone
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-website-design-clone`

709. **marketing-loops** — `coreyhaines31/marketingskills/marketing-loops` · 32,822 تثبيت
...
710. **baoyu-image-gen** — `jimliu/baoyu-skills/baoyu-image-gen` · 32,794 تثبيت
...
711. **gws-gmail-reply** — `googleworkspace/cli/gws-gmail-reply` · 32,716 تثبيت ⭐
...
712. **ckm:design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:design` · 32,577 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

713. **ckm:ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:ui-styling` · 32,511 تثبيت
...
714. **swiftui-expert-skill** — `avdlee/swiftui-agent-skill/swiftui-expert-skill` · 32,349 تثبيت
   Expert SwiftUI code review, refactoring, and implementation guidance with iOS 26+ and macOS support.
   `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill swiftui-expert-skill`

715. **firecrawl-monitor** — `firecrawl/cli/firecrawl-monitor` · 32,347 تثبيت ⭐
...
716. **flutter-add-integration-test** — `flutter/agent-plugins/flutter-add-integration-test` · 32,256 تثبيت ⭐
   Implementing Flutter Integration Tests
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-integration-test`

717. **firecrawl-market-research** — `firecrawl/firecrawl-workflows/firecrawl-market-research` · 32,210 تثبيت ⭐
...
718. **ckm:brand** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:brand` · 32,077 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

719. **ckm:banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:banner-design` · 32,050 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

720. **flutter-setup-declarative-routing** — `flutter/agent-plugins/flutter-setup-declarative-routing` · 32,043 تثبيت ⭐
...
721. **baoyu-infographic** — `jimliu/baoyu-skills/baoyu-infographic` · 31,997 تثبيت
...
722. **firecrawl-knowledge-base** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-base` · 31,989 تثبيت ⭐
...
723. **firecrawl-workflows** — `firecrawl/firecrawl-workflows/firecrawl-workflows` · 31,969 تثبيت ⭐
...
724. **ckm:slides** — `nextlevelbuilder/ui-ux-pro-max-skill/ckm:slides` · 31,960 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

725. **firecrawl-seo-audit** — `firecrawl/firecrawl-workflows/firecrawl-seo-audit` · 31,836 تثبيت ⭐
...
726. **baoyu-markdown-to-html** — `jimliu/baoyu-skills/baoyu-markdown-to-html` · 31,685 تثبيت
...
727. **firecrawl-dashboard-reporting** — `firecrawl/firecrawl-workflows/firecrawl-dashboard-reporting` · 31,531 تثبيت ⭐
...
728. **baoyu-cover-image** — `jimliu/baoyu-skills/baoyu-cover-image` · 31,484 تثبيت
...
729. **firecrawl-lead-gen** — `firecrawl/firecrawl-workflows/firecrawl-lead-gen` · 31,420 تثبيت ⭐
...
730. **firecrawl-lead-research** — `firecrawl/firecrawl-workflows/firecrawl-lead-research` · 31,373 تثبيت ⭐
...
731. **gws-gmail-forward** — `googleworkspace/cli/gws-gmail-forward` · 31,369 تثبيت ⭐
...
732. **firecrawl-competitive-intel** — `firecrawl/firecrawl-workflows/firecrawl-competitive-intel` · 31,358 تثبيت ⭐
...
733. **firecrawl-qa** — `firecrawl/firecrawl-workflows/firecrawl-qa` · 31,335 تثبيت ⭐
...
734. **firecrawl-shop** — `firecrawl/firecrawl-workflows/firecrawl-shop` · 31,334 تثبيت ⭐
...
735. **firecrawl-knowledge-ingest** — `firecrawl/firecrawl-workflows/firecrawl-knowledge-ingest` · 31,306 تثبيت ⭐
   Firecrawl Knowledge Ingest
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-knowledge-ingest`

736. **flutter-implement-json-serialization** — `flutter/agent-plugins/flutter-implement-json-serialization` · 31,293 تثبيت ⭐
...
737. **firecrawl-company-directories** — `firecrawl/firecrawl-workflows/firecrawl-company-directories` · 31,283 تثبيت ⭐
...
738. **baoyu-article-illustrator** — `jimliu/baoyu-skills/baoyu-article-illustrator` · 31,281 تثبيت
...
739. **firecrawl-demo-walkthrough** — `firecrawl/firecrawl-workflows/firecrawl-demo-walkthrough` · 31,258 تثبيت ⭐
   Firecrawl Demo Walkthrough
   `npx skills add https://github.com/firecrawl/firecrawl-workflows --skill firecrawl-demo-walkthrough`

740. **gws-workflow** — `googleworkspace/cli/gws-workflow` · 31,151 تثبيت ⭐
...
741. **observability-and-instrumentation** — `addyosmani/agent-skills/observability-and-instrumentation` · 31,141 تثبيت
   Observability and Instrumentation
   `npx skills add https://github.com/addyosmani/agent-skills --skill observability-and-instrumentation`

742. **flutter-setup-localization** — `flutter/agent-plugins/flutter-setup-localization` · 31,128 تثبيت ⭐
   Internationalizing Flutter Applications
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-setup-localization`

743. **marketing-council** — `coreyhaines31/marketingskills/marketing-council` · 31,121 تثبيت
...
744. **flutter-add-widget-preview** — `flutter/agent-plugins/flutter-add-widget-preview` · 31,073 تثبيت ⭐
   Previewing Flutter Widgets
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-add-widget-preview`

745. **two-factor-authentication-best-practices** — `better-auth/skills/two-factor-authentication-best-practices` · 31,020 تثبيت ⭐
...
746. **use-dom** — `expo/skills/use-dom` · 30,996 تثبيت ⭐
...
747. **shape** — `pbakaus/impeccable/shape` · 30,853 تثبيت
...
748. **gws-chat** — `googleworkspace/cli/gws-chat` · 30,803 تثبيت ⭐
...
749. **baoyu-xhs-images** — `jimliu/baoyu-skills/baoyu-xhs-images` · 30,771 تثبيت
...
750. **gws-people** — `googleworkspace/cli/gws-people` · 30,624 تثبيت ⭐
...
751. **gws-gmail-reply-all** — `googleworkspace/cli/gws-gmail-reply-all` · 30,617 تثبيت ⭐
...
752. **flutter-use-http-package** — `flutter/agent-plugins/flutter-use-http-package` · 30,615 تثبيت ⭐
   Implementing Flutter Networking
   `npx skills add https://github.com/flutter/agent-plugins --skill flutter-use-http-package`

753. **baoyu-slide-deck** — `jimliu/baoyu-skills/baoyu-slide-deck` · 30,434 تثبيت
...
754. **nextjs-app-router-patterns** — `wshobson/agents/nextjs-app-router-patterns` · 30,340 تثبيت
...
755. **eas-update-insights** — `expo/skills/eas-update-insights` · 30,331 تثبيت ⭐
...
756. **gws-workflow-email-to-task** — `googleworkspace/cli/gws-workflow-email-to-task` · 30,314 تثبيت ⭐
...
757. **design-system** — `nextlevelbuilder/ui-ux-pro-max-skill/design-system` · 30,301 تثبيت
   Token architecture, component specifications, systematic design, slide generation.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design-system`

758. **recipe-create-presentation** — `googleworkspace/cli/recipe-create-presentation` · 30,280 تثبيت ⭐
...
759. **mmx-cli** — `minimax-ai/cli/mmx-cli` · 30,277 تثبيت
...
760. **excalidraw-diagram-generator** — `github/awesome-copilot/excalidraw-diagram-generator` · 29,930 تثبيت ⭐
...
761. **create-auth-skill** — `better-auth/skills/create-auth-skill` · 29,913 تثبيت ⭐
...
762. **graphic-overlays** — `heygen-com/hyperframes/graphic-overlays` · 29,843 تثبيت
...
763. **baoyu-url-to-markdown** — `jimliu/baoyu-skills/baoyu-url-to-markdown` · 29,801 تثبيت
...
764. **gws-workflow-meeting-prep** — `googleworkspace/cli/gws-workflow-meeting-prep` · 29,672 تثبيت ⭐
...
765. **gws-chat-send** — `googleworkspace/cli/gws-chat-send` · 29,667 تثبيت ⭐
   Send plain-text messages to Google Chat spaces.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-chat-send`

766. **recipe-draft-email-from-doc** — `googleworkspace/cli/recipe-draft-email-from-doc` · 29,498 تثبيت ⭐
...
767. **persona-project-manager** — `googleworkspace/cli/persona-project-manager` · 29,477 تثبيت ⭐
...
768. **swiftui-pro** — `twostraws/swiftui-agent-skill/swiftui-pro` · 29,432 تثبيت
   Comprehensive SwiftUI code review against modern APIs, accessibility, and performance standards.
   `npx skills add https://github.com/twostraws/swiftui-agent-skill --skill swiftui-pro`

769. **gws-workflow-weekly-digest** — `googleworkspace/cli/gws-workflow-weekly-digest` · 29,424 تثبيت ⭐
...
770. **gws-workflow-standup-report** — `googleworkspace/cli/gws-workflow-standup-report` · 29,411 تثبيت ⭐
...
771. **recipe-email-drive-link** — `googleworkspace/cli/recipe-email-drive-link` · 29,383 تثبيت ⭐
...
772. **design** — `nextlevelbuilder/ui-ux-pro-max-skill/design` · 29,295 تثبيت
   Unified design skill: brand, tokens, UI, logo, CIP, slides, banners, social photos, icons.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill design`

773. **gws-events** — `googleworkspace/cli/gws-events` · 29,289 تثبيت ⭐
...
774. **baoyu-comic** — `jimliu/baoyu-skills/baoyu-comic` · 29,266 تثبيت
...
775. **recipe-create-gmail-filter** — `googleworkspace/cli/recipe-create-gmail-filter` · 29,211 تثبيت ⭐
...
776. **persona-researcher** — `googleworkspace/cli/persona-researcher` · 29,058 تثبيت ⭐
...
777. **recipe-save-email-attachments** — `googleworkspace/cli/recipe-save-email-attachments` · 28,983 تثبيت ⭐
...
778. **recipe-backup-sheet-as-csv** — `googleworkspace/cli/recipe-backup-sheet-as-csv` · 28,950 تثبيت ⭐
...
779. **recipe-organize-drive-folder** — `googleworkspace/cli/recipe-organize-drive-folder` · 28,901 تثبيت ⭐
...
780. **persona-exec-assistant** — `googleworkspace/cli/persona-exec-assistant` · 28,838 تثبيت ⭐
...
781. **recipe-find-free-time** — `googleworkspace/cli/recipe-find-free-time` · 28,777 تثبيت ⭐
...
782. **ui-styling** — `nextlevelbuilder/ui-ux-pro-max-skill/ui-styling` · 28,703 تثبيت
   Comprehensive skill for creating beautiful, accessible user interfaces combining shadcn/ui components, Tailwind CSS utility styling, and canvas-based 
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill ui-styling`

783. **recipe-compare-sheet-tabs** — `googleworkspace/cli/recipe-compare-sheet-tabs` · 28,699 تثبيت ⭐
...
784. **gws-workflow-file-announce** — `googleworkspace/cli/gws-workflow-file-announce` · 28,681 تثبيت ⭐
...
785. **gws-events-renew** — `googleworkspace/cli/gws-events-renew` · 28,653 تثبيت ⭐
...
786. **recipe-plan-weekly-schedule** — `googleworkspace/cli/recipe-plan-weekly-schedule` · 28,648 تثبيت ⭐
   Review your Google Calendar week, identify gaps, and add events to fill them.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-plan-weekly-schedule`

787. **gws-events-subscribe** — `googleworkspace/cli/gws-events-subscribe` · 28,640 تثبيت ⭐
...
788. **recipe-create-doc-from-template** — `googleworkspace/cli/recipe-create-doc-from-template` · 28,633 تثبيت ⭐
...
789. **recipe-bulk-download-folder** — `googleworkspace/cli/recipe-bulk-download-folder` · 28,631 تثبيت ⭐
...
790. **code-review-excellence** — `wshobson/agents/code-review-excellence` · 28,630 تثبيت
...
791. **recipe-sync-contacts-to-sheet** — `googleworkspace/cli/recipe-sync-contacts-to-sheet` · 28,607 تثبيت ⭐
...
792. **persona-content-creator** — `googleworkspace/cli/persona-content-creator` · 28,549 تثبيت ⭐
...
793. **api-design-principles** — `wshobson/agents/api-design-principles` · 28,533 تثبيت
...
794. **gws-admin-reports** — `googleworkspace/cli/gws-admin-reports` · 28,502 تثبيت ⭐
...
795. **baoyu-post-to-x** — `jimliu/baoyu-skills/baoyu-post-to-x` · 28,456 تثبيت
...
796. **recipe-generate-report-from-sheet** — `googleworkspace/cli/recipe-generate-report-from-sheet` · 28,438 تثبيت ⭐
...
797. **recipe-reschedule-meeting** — `googleworkspace/cli/recipe-reschedule-meeting` · 28,336 تثبيت ⭐
...
798. **recipe-label-and-archive-emails** — `googleworkspace/cli/recipe-label-and-archive-emails` · 28,326 تثبيت ⭐
...
799. **recipe-save-email-to-doc** — `googleworkspace/cli/recipe-save-email-to-doc` · 28,304 تثبيت ⭐
...
800. **recipe-block-focus-time** — `googleworkspace/cli/recipe-block-focus-time` · 28,288 تثبيت ⭐
...
801. **recipe-watch-drive-changes** — `googleworkspace/cli/recipe-watch-drive-changes` · 28,265 تثبيت ⭐
...
802. **persona-team-lead** — `googleworkspace/cli/persona-team-lead` · 28,253 تثبيت ⭐
...
803. **recipe-create-shared-drive** — `googleworkspace/cli/recipe-create-shared-drive` · 28,240 تثبيت ⭐
...
804. **recipe-share-doc-and-notify** — `googleworkspace/cli/recipe-share-doc-and-notify` · 28,172 تثبيت ⭐
...
805. **recipe-create-task-list** — `googleworkspace/cli/recipe-create-task-list` · 28,153 تثبيت ⭐
...
806. **recipe-schedule-recurring-event** — `googleworkspace/cli/recipe-schedule-recurring-event` · 28,148 تثبيت ⭐
...
807. **recipe-find-large-files** — `googleworkspace/cli/recipe-find-large-files` · 28,145 تثبيت ⭐
   Identify large Google Drive files consuming storage quota.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-find-large-files`

808. **recipe-review-overdue-tasks** — `googleworkspace/cli/recipe-review-overdue-tasks` · 28,092 تثبيت ⭐
...
809. **recipe-copy-sheet-for-new-month** — `googleworkspace/cli/recipe-copy-sheet-for-new-month` · 28,076 تثبيت ⭐
   Duplicate a Google Sheets template tab for a new month of tracking.
   `npx skills add https://github.com/googleworkspace/cli --skill recipe-copy-sheet-for-new-month`

810. **recipe-batch-invite-to-event** — `googleworkspace/cli/recipe-batch-invite-to-event` · 28,054 تثبيت ⭐
...
811. **brand** — `nextlevelbuilder/ui-ux-pro-max-skill/brand` · 28,039 تثبيت
   Brand identity, voice, messaging, asset management, and consistency frameworks.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill brand`

812. **recipe-collect-form-responses** — `googleworkspace/cli/recipe-collect-form-responses` · 28,035 تثبيت ⭐
...
813. **recipe-create-events-from-sheet** — `googleworkspace/cli/recipe-create-events-from-sheet` · 28,006 تثبيت ⭐
...
814. **persona-it-admin** — `googleworkspace/cli/persona-it-admin` · 27,977 تثبيت ⭐
...
815. **recipe-share-folder-with-team** — `googleworkspace/cli/recipe-share-folder-with-team` · 27,941 تثبيت ⭐
...
816. **recipe-create-vacation-responder** — `googleworkspace/cli/recipe-create-vacation-responder` · 27,931 تثبيت ⭐
...
817. **nestjs-best-practices** — `kadajett/agent-nestjs-skills/nestjs-best-practices` · 27,927 تثبيت
...
818. **persona-event-coordinator** — `googleworkspace/cli/persona-event-coordinator` · 27,919 تثبيت ⭐
...
819. **persona-customer-support** — `googleworkspace/cli/persona-customer-support` · 27,911 تثبيت ⭐
...
820. **recipe-forward-labeled-emails** — `googleworkspace/cli/recipe-forward-labeled-emails` · 27,904 تثبيت ⭐
...
821. **recipe-review-meet-participants** — `googleworkspace/cli/recipe-review-meet-participants` · 27,894 تثبيت ⭐
...
822. **persona-sales-ops** — `googleworkspace/cli/persona-sales-ops` · 27,889 تثبيت ⭐
...
823. **mcp-apps-builder** — `mcp-use/mcp-use/mcp-apps-builder` · 27,883 تثبيت ⭐
...
824. **azure-postgres** — `microsoft/azure-skills/azure-postgres` · 27,854 تثبيت ⭐
   No SKILL.md available for this skill.
   `npx skills add https://github.com/microsoft/azure-skills --skill azure-postgres`

825. **banner-design** — `nextlevelbuilder/ui-ux-pro-max-skill/banner-design` · 27,852 تثبيت
   Banner Design - Multi-Format Creative Banner System
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill banner-design`

826. **gws-modelarmor** — `googleworkspace/cli/gws-modelarmor` · 27,850 تثبيت ⭐
   Google Model Armor: Filter user-generated content for safety.
   `npx skills add https://github.com/googleworkspace/cli --skill gws-modelarmor`

827. **recipe-create-meet-space** — `googleworkspace/cli/recipe-create-meet-space` · 27,849 تثبيت ⭐
...
828. **recipe-create-expense-tracker** — `googleworkspace/cli/recipe-create-expense-tracker` · 27,823 تثبيت ⭐
...
829. **recipe-create-feedback-form** — `googleworkspace/cli/recipe-create-feedback-form` · 27,813 تثبيت ⭐
...
830. **recipe-post-mortem-setup** — `googleworkspace/cli/recipe-post-mortem-setup` · 27,776 تثبيت ⭐
...
831. **baoyu-compress-image** — `jimliu/baoyu-skills/baoyu-compress-image` · 27,718 تثبيت
...
832. **gws-modelarmor-create-template** — `googleworkspace/cli/gws-modelarmor-create-template` · 27,710 تثبيت ⭐
...
833. **persona-hr-coordinator** — `googleworkspace/cli/persona-hr-coordinator` · 27,709 تثبيت ⭐
...
834. **niche-signal-discovery** — `code.deepline.com/niche-signal-discovery` · 27,665 تثبيت
...
835. **recipe-share-event-materials** — `googleworkspace/cli/recipe-share-event-materials` · 27,636 تثبيت ⭐
...
836. **baoyu-format-markdown** — `jimliu/baoyu-skills/baoyu-format-markdown` · 27,601 تثبيت
...
837. **baoyu-danger-x-to-markdown** — `jimliu/baoyu-skills/baoyu-danger-x-to-markdown` · 27,588 تثبيت
...
838. **recipe-send-team-announcement** — `googleworkspace/cli/recipe-send-team-announcement` · 27,558 تثبيت ⭐
...
839. **build-tam** — `code.deepline.com/build-tam` · 27,536 تثبيت
   Provider-Led Account And Contact Sourcing
   `npx skills add https://code.deepline.com/`

840. **baoyu-danger-gemini-web** — `jimliu/baoyu-skills/baoyu-danger-gemini-web` · 27,512 تثبيت
...
841. **gws-modelarmor-sanitize-prompt** — `googleworkspace/cli/gws-modelarmor-sanitize-prompt` · 27,501 تثبيت ⭐
...
842. **recipe-log-deal-update** — `googleworkspace/cli/recipe-log-deal-update` · 27,467 تثبيت ⭐
...
843. **slides** — `nextlevelbuilder/ui-ux-pro-max-skill/slides` · 27,449 تثبيت
   Strategic HTML presentation design with data visualization.
   `npx skills add https://github.com/nextlevelbuilder/ui-ux-pro-max-skill --skill slides`

844. **portfolio-prospecting** — `code.deepline.com/portfolio-prospecting` · 27,446 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

845. **deepline-feedback** — `code.deepline.com/deepline-feedback` · 27,436 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

846. **clay-to-deepline** — `code.deepline.com/clay-to-deepline` · 27,429 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

847. **web-quality-audit** — `addyosmani/web-quality-skills/web-quality-audit` · 27,428 تثبيت
...
848. **gws-modelarmor-sanitize-response** — `googleworkspace/cli/gws-modelarmor-sanitize-response` · 27,422 تثبيت ⭐
...
849. **gws-classroom** — `googleworkspace/cli/gws-classroom` · 27,407 تثبيت ⭐
...
850. **linkedin-url-lookup** — `code.deepline.com/linkedin-url-lookup` · 27,402 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

851. **clerk** — `clerk/skills/clerk` · 27,380 تثبيت ⭐
...
852. **recipe-create-classroom-course** — `googleworkspace/cli/recipe-create-classroom-course` · 27,320 تثبيت ⭐
...
853. **deepline-gtm** — `code.deepline.com/deepline-gtm` · 27,304 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

854. **deepline-quickstart** — `code.deepline.com/deepline-quickstart` · 27,199 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

855. **interface-design** — `dammyjay93/interface-design/interface-design` · 27,095 تثبيت
...
856. **clerk-cli** — `clerk/skills/clerk-cli` · 27,091 تثبيت ⭐
...
857. **layout** — `pbakaus/impeccable/layout` · 27,046 تثبيت
...
858. **docker-expert** — `sickn33/agentic-awesome-skills/docker-expert` · 26,956 تثبيت
...
859. **stripe-directory** — `docs.stripe.com/stripe-directory` · 26,775 تثبيت
...
860. **core-web-vitals** — `addyosmani/web-quality-skills/core-web-vitals` · 26,757 تثبيت
   Core Web Vitals optimization
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill core-web-vitals`

861. **higgsfield-game-generation** — `higgsfield-ai/skills/higgsfield-game-generation` · 26,703 تثبيت
   Higgsfield Game Generation
   `npx skills add https://github.com/higgsfield-ai/skills --skill higgsfield-game-generation`

862. **documentation-writer** — `github/awesome-copilot/documentation-writer` · 26,691 تثبيت ⭐
...
863. **golang-linter** — `samber/cc-skills-golang/golang-linter` · 26,543 تثبيت
   No SKILL.md available for this skill.
   `npx skills add https://github.com/samber/cc-skills-golang --skill golang-linter`

864. **sanity-best-practices** — `sanity-io/agent-toolkit/sanity-best-practices` · 26,410 تثبيت ⭐
...
865. **react-native-best-practices** — `callstackincubator/agent-skills/react-native-best-practices` · 26,367 تثبيت ⭐
...
866. **multi-stage-dockerfile** — `github/awesome-copilot/multi-stage-dockerfile` · 26,113 تثبيت ⭐
...
867. **review-pr** — `warpdotdev/common-skills/review-pr` · 26,104 تثبيت
...
868. **guizang-ppt-skill** — `op7418/guizang-ppt-skill/guizang-ppt-skill` · 26,099 تثبيت
...
869. **backlink-analyzer** — `aaron-he-zhu/seo-geo-claude-skills/backlink-analyzer` · 26,099 تثبيت
...
870. **ponytail-review** — `dietrichgebert/ponytail/ponytail-review` · 26,073 تثبيت
   Review diffs for unnecessary complexity. One line per finding: location, what
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-review`

871. **huashu-nuwa** — `alchaincyf/nuwa-skill/huashu-nuwa` · 26,007 تثبيت
...
872. **spec-driven-implementation** — `warpdotdev/common-skills/spec-driven-implementation` · 25,972 تثبيت
   spec-driven-implementation
   `npx skills add https://github.com/warpdotdev/common-skills --skill spec-driven-implementation`

873. **write-product-spec** — `warpdotdev/common-skills/write-product-spec` · 25,911 تثبيت
...
874. **dbs** — `dontbesilent2025/dbskill/dbs` · 25,885 تثبيت
   你是 dontbesilent 商业工具箱的公开入口。
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs`

875. **postgresql-table-design** — `wshobson/agents/postgresql-table-design` · 25,858 تثبيت
...
876. **write-tech-spec** — `warpdotdev/common-skills/write-tech-spec` · 25,839 تثبيت
...
877. **fix-errors** — `warpdotdev/common-skills/fix-errors` · 25,802 تثبيت
...
878. **resolve-merge-conflicts** — `warpdotdev/common-skills/resolve-merge-conflicts` · 25,774 تثبيت
...
879. **implement-specs** — `warpdotdev/common-skills/implement-specs` · 25,746 تثبيت
...
880. **create-pr** — `warpdotdev/common-skills/create-pr` · 25,718 تثبيت
...
881. **update-skill** — `warpdotdev/common-skills/update-skill` · 25,685 تثبيت
...
882. **diagnose-ci-failures** — `warpdotdev/common-skills/diagnose-ci-failures` · 25,674 تثبيت
...
883. **stitch-design** — `google-labs-code/stitch-skills/stitch-design` · 25,488 تثبيت ⭐
...
884. **brandalf** — `warpdotdev/common-skills/brandalf` · 25,412 تثبيت
...
885. **pr-walkthrough** — `warpdotdev/common-skills/pr-walkthrough` · 25,354 تثبيت
...
886. **dbs-content** — `dontbesilent2025/dbskill/dbs-content` · 25,272 تثبيت
...
887. **dbs-diagnosis** — `dontbesilent2025/dbskill/dbs-diagnosis` · 25,163 تثبيت
...
888. **dbs-benchmark** — `dontbesilent2025/dbskill/dbs-benchmark` · 25,099 تثبيت
...
889. **dbs-deconstruct** — `dontbesilent2025/dbskill/dbs-deconstruct` · 25,018 تثبيت
...
890. **baoyu-translate** — `jimliu/baoyu-skills/baoyu-translate` · 24,895 تثبيت
...
891. **release-skills** — `jimliu/baoyu-skills/release-skills` · 24,894 تثبيت
...
892. **vue-debug-guides** — `vuejs-ai/skills/vue-debug-guides` · 24,874 تثبيت
...
893. **council** — `warpdotdev/common-skills/council` · 24,863 تثبيت
...
894. **best-practices** — `addyosmani/web-quality-skills/best-practices` · 24,696 تثبيت
   Modern web development standards based on Lighthouse best practices audits. Covers security, browser compatibility, and code quality patterns.
   `npx skills add https://github.com/addyosmani/web-quality-skills --skill best-practices`

895. **better-ui** — `jakubkrehel/skills/better-ui` · 24,587 تثبيت
...
896. **fastapi-templates** — `wshobson/agents/fastapi-templates` · 24,470 تثبيت
...
897. **dbs-hook** — `dontbesilent2025/dbskill/dbs-hook` · 24,441 تثبيت
...
898. **ponytail-audit** — `dietrichgebert/ponytail/ponytail-audit` · 24,306 تثبيت
   ponytail-review, repo-wide. Scan the whole tree instead of a diff. Rank
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-audit`

899. **dbs-action** — `dontbesilent2025/dbskill/dbs-action` · 24,236 تثبيت
...
900. **check-impl-against-spec** — `warpdotdev/common-skills/check-impl-against-spec` · 24,211 تثبيت
   Check implementation against spec
   `npx skills add https://github.com/warpdotdev/common-skills --skill check-impl-against-spec`

901. **reproduce-bug-report** — `warpdotdev/common-skills/reproduce-bug-report` · 24,064 تثبيت
...
902. **gws-script** — `googleworkspace/cli/gws-script` · 23,966 تثبيت ⭐
...
903. **gws-script-push** — `googleworkspace/cli/gws-script-push` · 23,672 تثبيت ⭐
...
904. **convex-auth** — `get-convex/agent-skills/convex-auth` · 23,654 تثبيت
...
905. **convex-expert** — `get-convex/agent-skills/convex-expert` · 23,632 تثبيت
...
910. **convex-optimize** — `get-convex/agent-skills/convex-optimize` · 23,527 تثبيت
   Audit and optimize an existing Convex app
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-optimize`

911. **convex-design** — `get-convex/agent-skills/convex-design` · 23,524 تثبيت
...
912. **convex-deploy-guard** — `get-convex/agent-skills/convex-deploy-guard` · 23,493 تثبيت
...
913. **convex-env** — `get-convex/agent-skills/convex-env` · 23,486 تثبيت
...
914. **convex-crons** — `get-convex/agent-skills/convex-crons` · 23,481 تثبيت
   Add scheduled jobs (crons)
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-crons`

915. **convex-advisor** — `get-convex/agent-skills/convex-advisor` · 23,476 تثبيت
...
916. **convex-add** — `get-convex/agent-skills/convex-add` · 23,457 تثبيت
...
917. **convex-agent** — `get-convex/agent-skills/convex-agent` · 23,452 تثبيت
   Add an AI agent / RAG backend
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-agent`

918. **convex-migrate-rehearse** — `get-convex/agent-skills/convex-migrate-rehearse` · 23,442 تثبيت
...
923. **convex-launch-readiness** — `get-convex/agent-skills/convex-launch-readiness` · 23,425 تثبيت
...
924. **convex-domains** — `get-convex/agent-skills/convex-domains` · 23,422 تثبيت
...
925. **convex-test** — `get-convex/agent-skills/convex-test` · 23,419 تثبيت
...
926. **convex-billing** — `get-convex/agent-skills/convex-billing` · 23,415 تثبيت
...
927. **convex-monitor** — `get-convex/agent-skills/convex-monitor` · 23,414 تثبيت
   Watch for the next thing to react to
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-monitor`

928. **convex-improve-convex-plugin** — `get-convex/agent-skills/convex-improve-convex-plugin` · 23,393 تثبيت
...
929. **convex-seed** — `get-convex/agent-skills/convex-seed` · 23,392 تثبيت
...
930. **convex-verify** — `get-convex/agent-skills/convex-verify` · 23,387 تثبيت
   Prove a feature works — seed, drive, assert
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-verify`

931. **convex-suggest** — `get-convex/agent-skills/convex-suggest` · 23,377 تثبيت
...
932. **convex-self-heal** — `get-convex/agent-skills/convex-self-heal` · 23,373 تثبيت
   Gated production self-healing loop
   `npx skills add https://github.com/get-convex/agent-skills --skill convex-self-heal`

933. **convex-sentinel** — `get-convex/agent-skills/convex-sentinel` · 23,328 تثبيت
...
934. **prd** — `github/awesome-copilot/prd` · 23,273 تثبيت ⭐
...
935. **gstack** — `garrytan/gstack/gstack` · 23,208 تثبيت
...
936. **influencer-marketing** — `coreyhaines31/marketingskills/influencer-marketing` · 23,036 تثبيت
   Influencer & Creator Marketing
   `npx skills add https://github.com/coreyhaines31/marketingskills --skill influencer-marketing`

937. **fixing-motion-performance** — `ibelick/ui-skills/fixing-motion-performance` · 22,947 تثبيت
...
938. **dbs-xhs-title** — `dontbesilent2025/dbskill/dbs-xhs-title` · 22,944 تثبيت
...
939. **nuxt** — `antfu/skills/nuxt` · 22,892 تثبيت
...
940. **e2e-testing-patterns** — `wshobson/agents/e2e-testing-patterns` · 22,797 تثبيت
...
941. **mobile-android-design** — `wshobson/agents/mobile-android-design` · 22,763 تثبيت
...
942. **attribution** — `coreyhaines31/marketingskills/attribution` · 22,728 تثبيت
...
943. **ponytail-help** — `dietrichgebert/ponytail/ponytail-help` · 22,725 تثبيت
   Display this reference card when invoked. One-shot, do NOT change mode,
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-help`

944. **summarize** — `openclaw/openclaw/summarize` · 22,705 تثبيت
   Fast CLI to summarize URLs, local files, and YouTube links.
   `npx skills add https://github.com/openclaw/openclaw --skill summarize`

945. **expo-ui** — `expo/skills/expo-ui` · 22,664 تثبيت ⭐
...
946. **modern-web-guidance** — `googlechrome/modern-web-guidance/modern-web-guidance` · 22,462 تثبيت
   A skill to search for specific web development use cases and retrieve their corresponding best practice guides.
   `npx skills add https://github.com/googlechrome/modern-web-guidance --skill modern-web-guidance`

947. **dbs-ai-check** — `dontbesilent2025/dbskill/dbs-ai-check` · 22,337 تثبيت
...
948. **architecture-patterns** — `wshobson/agents/architecture-patterns` · 22,297 تثبيت
...
949. **respond-to-pr-comments-in-blocklist** — `warpdotdev/common-skills/respond-to-pr-comments-in-blocklist` · 22,294 تثبيت
...
950. **validate-changes-match-specs** — `warpdotdev/common-skills/validate-changes-match-specs` · 22,097 تثبيت
   Validate changes match specs
   `npx skills add https://github.com/warpdotdev/common-skills --skill validate-changes-match-specs`

951. **mobile-ios-design** — `wshobson/agents/mobile-ios-design` · 22,050 تثبيت
...
952. **gh-cli** — `github/awesome-copilot/gh-cli` · 21,937 تثبيت ⭐
...
957. **dbs-agent-migration** — `dontbesilent2025/dbskill/dbs-agent-migration` · 21,678 تثبيت
   dbs-agent-migration：Agent 工作台迁移
   `npx skills add https://github.com/dontbesilent2025/dbskill --skill dbs-agent-migration`

958. **prompt-engineering-patterns** — `wshobson/agents/prompt-engineering-patterns` · 21,453 تثبيت
...
959. **vueuse-functions** — `antfu/skills/vueuse-functions` · 21,312 تثبيت
...
960. **firecrawl-research-index** — `firecrawl/skills/firecrawl-research-index` · 21,274 تثبيت ⭐
...
961. **deepline-analytics** — `code.deepline.com/deepline-analytics` · 21,233 تثبيت
   # Fallback for secure sandboxes: mkdir -p "$HOME/.local" && npm config set prefix "$HOME/.local" && export PATH="$HOME/.local/bin:$PATH" && npm instal
   `npx skills add https://code.deepline.com/`

962. **error-handling-patterns** — `wshobson/agents/error-handling-patterns` · 21,158 تثبيت
...
963. **wecomcli-doc** — `wecomteam/wecom-cli/wecomcli-doc` · 20,999 تثبيت
...
964. **skill-vetter** — `useai-pro/openclaw-skills-security/skill-vetter` · 20,984 تثبيت
...
965. **mediabunny** — `remotion-dev/skills/mediabunny` · 20,928 تثبيت ⭐
   Mediabunny is a multimedia library for dealing with audio and video in the browser.
   `npx skills add https://github.com/remotion-dev/skills --skill mediabunny`

966. **baoyu-post-to-weibo** — `jimliu/baoyu-skills/baoyu-post-to-weibo` · 20,903 تثبيت
...
967. **wecomcli-todo** — `wecomteam/wecom-cli/wecomcli-todo` · 20,608 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-todo`

968. **pnpm** — `antfu/skills/pnpm` · 20,582 تثبيت
...
969. **wecomcli-contact** — `wecomteam/wecom-cli/wecomcli-contact` · 20,559 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-contact`

970. **wecomcli-meeting** — `wecomteam/wecom-cli/wecomcli-meeting` · 20,517 تثبيت
   执行任何 wecom-cli 命令前，必须先读取并完成 wecomcli-shared 技能的公共前置检查。
   `npx skills add https://github.com/wecomteam/wecom-cli --skill wecomcli-meeting`

971. **gemini-api-dev** — `google-gemini/gemini-skills/gemini-api-dev` · 20,426 تثبيت ⭐
...
972. **firestore-security-rules-auditor** — `firebase/agent-skills/firestore-security-rules-auditor` · 20,414 تثبيت ⭐
...
973. **python-design-patterns** — `wshobson/agents/python-design-patterns` · 20,328 تثبيت
...
974. **baoyu-youtube-transcript** — `jimliu/baoyu-skills/baoyu-youtube-transcript` · 20,090 تثبيت
...
975. **dbs-report** — `dontbesilent2025/dbskill/dbs-report` · 20,082 تثبيت
...
976. **dbs-save** — `dontbesilent2025/dbskill/dbs-save` · 20,057 تثبيت
...
977. **dbs-restore** — `dontbesilent2025/dbskill/dbs-restore` · 20,047 تثبيت
...
978. **java-springboot** — `github/awesome-copilot/java-springboot` · 20,026 تثبيت ⭐
...
979. **dbs-goal** — `dontbesilent2025/dbskill/dbs-goal` · 19,879 تثبيت
...
980. **opencli-usage** — `jackwener/opencli/opencli-usage` · 19,632 تثبيت
...
981. **html-ppt** — `lewislulu/html-ppt-skill/html-ppt` · 19,423 تثبيت
   html-ppt — HTML PPT Studio
   `npx skills add https://github.com/lewislulu/html-ppt-skill --skill html-ppt`

982. **security-requirement-extraction** — `wshobson/agents/security-requirement-extraction` · 19,398 تثبيت
   Transform threat analysis into actionable security requirements.
   `npx skills add https://github.com/wshobson/agents --skill security-requirement-extraction`

983. **pricewin-hotel-deal-finder** — `price-win/pricewin-skills-hub/pricewin-hotel-deal-finder` · 19,389 تثبيت
   PriceWin Hotel Deal Finder
   `npx skills add https://github.com/price-win/pricewin-skills-hub --skill pricewin-hotel-deal-finder`

984. **dbs-slowisfast** — `dontbesilent2025/dbskill/dbs-slowisfast` · 19,325 تثبيت
...
985. **baseline-ui** — `ibelick/ui-skills/baseline-ui` · 19,283 تثبيت
...
986. **extension-email-calendar-events** — `caffeinelabs/skills/extension-email-calendar-events` · 19,219 تثبيت
...
987. **ponytail-debt** — `dietrichgebert/ponytail/ponytail-debt` · 19,196 تثبيت
   Every deliberate ponytail shortcut is marked with a ponytail: comment naming
   `npx skills add https://github.com/dietrichgebert/ponytail --skill ponytail-debt`

988. **find-qualified-titles** — `code.deepline.com/find-qualified-titles` · 18,868 تثبيت
   Find Qualified Titles (company_titles -> ICP filter -> contacts)
   `npx skills add https://code.deepline.com/`

989. **modern-javascript-patterns** — `wshobson/agents/modern-javascript-patterns` · 18,806 تثبيت
...
990. **expo-brownfield** — `expo/skills/expo-brownfield` · 18,753 تثبيت ⭐
...
995. **extension-email-verification** — `caffeinelabs/skills/extension-email-verification` · 18,653 تثبيت
...
996. **extension-object-storage** — `caffeinelabs/skills/extension-object-storage` · 18,652 تثبيت
...
997. **javascript-testing-patterns** — `wshobson/agents/javascript-testing-patterns` · 18,479 تثبيت
...
998. **feature-sliced-design** — `feature-sliced/skills/feature-sliced-design` · 18,458 تثبيت
   Feature-Sliced Design (FSD) v2.1
   `npx skills add https://github.com/feature-sliced/skills --skill feature-sliced-design`

999. **extension-email** — `caffeinelabs/skills/extension-email` · 18,415 تثبيت
   Email — Service/Transactional
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-email`

1000. **extension-http-outcalls** — `caffeinelabs/skills/extension-http-outcalls` · 18,411 تثبيت
   HTTP outcalls extension for Caffeine AI.
   `npx skills add https://github.com/caffeinelabs/skills --skill extension-http-outcalls`

1001. **extension-authorization** — `caffeinelabs/skills/extension-authorization` · 18,411 تثبيت
...
1002. **opencli-browser** — `jackwener/opencli/opencli-browser` · 18,408 تثبيت
...
1003. **extension-invite-links** — `caffeinelabs/skills/extension-invite-links` · 18,408 تثبيت
...
1004. **extension-core-infrastructure** — `caffeinelabs/skills/extension-core-infrastructure` · 18,406 تثبيت
...
1005. **vue-router-best-practices** — `antfu/skills/vue-router-best-practices` · 18,329 تثبيت
...
1010. **extension-posting-to-x** — `caffeinelabs/skills/extension-posting-to-x` · 18,153 تثبيت
...
1011. **aso-audit** — `coreyhaines31/marketingskills/aso-audit` · 18,009 تثبيت
...
1012. **create-readme** — `github/awesome-copilot/create-readme` · 17,955 تثبيت ⭐
...
1013. **rust-async-patterns** — `wshobson/agents/rust-async-patterns` · 17,904 تثبيت
...
1014. **playwright-generate-test** — `github/awesome-copilot/playwright-generate-test` · 17,869 تثبيت ⭐
...
1015. **agent development** — `anthropics/claude-code/agent-development` · 17,722 تثبيت ⭐
   Agent Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Agent Development&#x27;`

1016. **skill development** — `anthropics/claude-code/skill-development` · 17,528 تثبيت ⭐
   Skill Development for Claude Code Plugins
   `npx skills add https://github.com/anthropics/claude-code --skill &#x27;Skill Development&#x27;`

1017. **pinia** — `antfu/skills/pinia` · 17,407 تثبيت
...
1018. **sql-optimization-patterns** — `wshobson/agents/sql-optimization-patterns` · 17,389 تثبيت
...
1019. **planning-with-files-zh** — `othmanadi/planning-with-files/planning-with-files-zh` · 17,220 تثبيت
...
1020. **fixing-accessibility** — `ibelick/ui-skills/fixing-accessibility` · 17,204 تثبيت
...
1021. **the-news** — `sfkislev/the-news/the-news` · 17,165 تثبيت
...
1022. **golang-pro** — `jeffallan/claude-skills/golang-pro` · 17,124 تثبيت
